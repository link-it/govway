...
- aggiunti i seguenti tools command line presenti nella directory *dist/tools* prodotta dall'installer:
   ...
   - *govway-vault-cli* consente:
        ...
        - la cifratura o decifratura di informazioni o chiavi attraverso una master key;
   ...
   - *govway-config-loader* dispone delle medesime funzionalità presenti nella sezione 'Importa' della console di gestione, che consentono di importare o eliminare le configurazioni memorizzate in un archivio ottenuto con la funzionalità 'Esposta'.

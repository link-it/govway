...
.. list-table::
   ...
   * - ``3.4.x``
     ...
     - 21+
     - 11
     - 27 – 28 (JBoss EAP 8.0), 35 – 38 (JBoss EAP 8.1)
     - ``3.4.1.p1``
     - —
   * - ``3.3.x``
     - **EOL imminente**
...
**Java 11** ha raggiunto la fine del supporto pubblico da parte di Oracle.
La versione LTS raccomandata è **Java 21**, supportata dalla linea GovWay 3.4.x.

Apache Tomcat
-------------

**Apache Tomcat 9** (utilizzato dalla linea 3.3.x): il termine del supporto per Tomcat 9.0.x è previsto
...
La linea **Spring Framework 5.3.x** (utilizzata da GovWay 3.3.x e precedenti) ha raggiunto
...
Migrazione Javax → Jakarta
---------------------------

La linea 3.4.x adotta il namespace **Jakarta EE** (``jakarta.*``) in sostituzione
...
A partire dalla versione 3.4.x, il connettore HTTP di default utilizza
...
A partire dalla versione 3.4.x non viene più supportato IE11.    

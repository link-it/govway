...
#. *Application Server WildFly* (http://wildfly.org) versione 18, 19 o 20. In alternativa è possibile effettuare
...
-  *WildFly 18 (version: 18.0.1.Final)*, *WildFly 20 (version: 20.0.1.Final)* e *Tomcat 9 (version: 9.0.31)*

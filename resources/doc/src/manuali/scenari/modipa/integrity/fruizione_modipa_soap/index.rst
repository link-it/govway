.. _scenari_fruizione_soap_modipa_integrity:
...
Fruire di un servizio SOAP, definito tramite una interfaccia WSDL, accessibile in accordo al pattern di sicurezza 'INTEGRITY_SOAP_01' descritto nella sezione :ref:`modipa_idar03`.
...
.. figure:: ../../../_figure_scenari/FruizioneModIPA_integrity_soap.png
 :scale: 70%
 :align: center
 :name: fruizione_modipa_soap_integrity_fig

 Fruizione di una API SOAP con profilo 'ModI', pattern INTEGRITY_SOAP_01 con ID_AUTH_SOAP_01

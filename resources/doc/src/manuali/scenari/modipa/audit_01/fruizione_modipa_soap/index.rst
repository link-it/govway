.. _scenari_fruizione_soap_modipa_audit_01:
...
.. figure:: ../../../_figure_scenari/FruizioneModIPA_audit_01_soap.jpg
 :scale: 70%
 :align: center
 :name: fruizione_modipa_soap_audit_01_fig

 Fruizione di una API SOAP con profilo 'ModI', pattern AUDIT_REST_01 e pattern ID_AUTH_SOAP_01 via PDND

.. _scenari_erogazione_soap_modipa_audit_01:
...
.. figure:: ../../../_figure_scenari/ErogazioneModIPA_audit_01_soap.png
 :scale: 70%
 :align: center
 :name: erogazione_modipa_soap_audit_01_fig

 Erogazione di una API SOAP con profilo 'ModI', pattern AUDIT_REST_01 e pattern ID_AUTH_REST_01 via PDND

.. _scenari_fruizione_soap_modipa_integrity_pdnd:
...
Fruire di un servizio SOAP, definito tramite una interfaccia WSDL, accessibile in accordo al pattern di sicurezza descritto nella sezione :ref:`modipa_pdnd_integrity`.
...
.. figure:: ../../../_figure_scenari/FruizioneModIPA_integrity_pdnd_soap.png
 :scale: 70%
 :align: center
 :name: fruizione_modipa_soap_integrity_pdnd_fig

 Fruizione di una API SOAP con profilo 'ModI', pattern INTEGRITY_SOAP_01 e pattern ID_AUTH_REST_01 via PDND

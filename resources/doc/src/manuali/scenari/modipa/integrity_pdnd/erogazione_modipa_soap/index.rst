.. _scenari_erogazione_soap_modipa_integrity_pdnd:
...
Esporre un servizio SOAP, definito tramite una interfaccia WSDL, accessibile in accordo al pattern di sicurezza descritto nella sezione :ref:`modipa_pdnd_integrity`.
...
Oltre al voucher devono anche presentare il token di sicurezza "Agid-JWT-Signature" previsto dal pattern "INTEGRITY_SOAP_01" a garanzia dell'integrità del messaggio.

La figura seguente descrive graficamente questo scenario.

.. figure:: ../../../_figure_scenari/ErogazioneModIPA_integrity_pdnd_soap.png
 :scale: 70%
 :align: center
 :name: erogazione_modipa_soap_integrity_pdnd_fig

 Erogazione di una API SOAP con profilo 'ModI', pattern INTEGRITY_SOAP_01 e pattern ID_AUTH_REST_01 via PDND

.. _scenari_fruizione_rest_modipa_auth:
...
Fruire di un servizio REST, definito tramite una API REST (OpenAPI 3.0), accessibile in accordo al pattern di sicurezza 'ID_AUTH_REST_01' descritto nella sezione :ref:`modipa_idar01`.
...
.. figure:: ../../../_figure_scenari/FruizioneModIPA_idAuth_rest.png
 :scale: 70%
 :align: center
 :name: fruizione_modipa_fig

 Fruizione di una API REST con profilo 'ModI', pattern ID_AUTH_REST_01

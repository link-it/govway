...
L'interfaccia OpenAPI, che descrive la configurazione di default dei parametri, è disponibile nel file `api-pdnd-push-signals.yaml <https://github.com/link-it/govway/blob/master/protocolli/modipa/example/openapi/api-pdnd-push-signals.yaml>`__.

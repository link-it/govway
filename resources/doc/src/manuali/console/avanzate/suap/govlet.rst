...
.. list-table::
   ...
   * - v1
     ...
     - `protocolli/modipa/example/config/SUAP/v1 <https://github.com/link-it/govway/tree/master/protocolli/modipa/example/config/SUAP/v1>`_
   * - v2
     - `approved02 <https://github.com/AgID/specifiche-tecniche-DPR-160-2010/tree/approved02/openAPI>`_
     - `protocolli/modipa/example/config/SUAP/v2 <https://github.com/link-it/govway/tree/master/protocolli/modipa/example/config/SUAP/v2>`_
...
.. note::
    Nella cartella `resources <https://github.com/link-it/govway/tree/master/protocolli/modipa/example/config/SUAP/resources>`_ sono fornite chiavi generate al momento della redazione della documentazione: verificare che siano aggiornate prima dell'utilizzo effettivo.

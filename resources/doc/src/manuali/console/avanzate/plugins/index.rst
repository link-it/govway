...
- **DPoP-Token Validazione**: consente di implementare una logica di parser personalizzato della DPoP proof ricevuta durante la validazione di un token DPoP (:ref:`tokenValidazionePolicy_dpop`) attraverso l'implementazione dell'interfaccia *org.openspcoop2.pdd.core.token.parser.IDPoPTokenParser*.

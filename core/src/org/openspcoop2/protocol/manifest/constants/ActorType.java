...
/**     
 * Enumeration dell'elemento ActorType xsd (tipo:string) 
 *
...
public enum ActorType implements IEnumeration , Serializable , Cloneable {
	...
	public boolean equals(ActorType object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		...
		return this.equals(((ActorType)object));
	}
	...
	public static ActorType toEnumConstant(String value){
		try{
	...
	public static ActorType toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		ActorType res = null;
		for (ActorType tmp : values()) {

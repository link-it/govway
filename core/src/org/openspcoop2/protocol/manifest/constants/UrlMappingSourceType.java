...
public enum UrlMappingSourceType implements IEnumeration , Serializable , Cloneable {
	...
	UrlMappingSourceType(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(UrlMappingSourceType object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof UrlMappingSourceType) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((UrlMappingSourceType)object));
	}

...
/**     
 * Enumeration dell'elemento ResourceIdentificationType xsd (tipo:string) 
 *
...
public enum ResourceIdentificationType implements IEnumeration , Serializable , Cloneable {
	...
	ResourceIdentificationType(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof ResourceIdentificationType) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((ResourceIdentificationType)object));
	}
	...
	public static String[] toArray(){
		...
		int i=0;
		for (ResourceIdentificationType tmp : values()) {
			res[i]=tmp.getValue();
			i++;
		}
		return res;
	...
	public static ResourceIdentificationType toEnumConstant(String value){
		try{
	...
	public static ResourceIdentificationType toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		ResourceIdentificationType res = null;
		for (ResourceIdentificationType tmp : values()) {

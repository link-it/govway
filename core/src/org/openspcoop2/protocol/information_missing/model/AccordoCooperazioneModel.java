...
public class AccordoCooperazioneModel extends AbstractModel<AccordoCooperazione> {
	...
	public AccordoCooperazioneModel(){
		...
		this.DEFAULT = new org.openspcoop2.protocol.information_missing.model.DefaultModel(new Field("default",org.openspcoop2.protocol.information_missing.Default.class,"accordo-cooperazione",AccordoCooperazione.class));
		this.DESCRIZIONE = new Field("descrizione",java.lang.String.class,"accordo-cooperazione",AccordoCooperazione.class);
		this.TIPO = new Field("tipo",java.lang.String.class,"accordo-cooperazione",AccordoCooperazione.class);
		this.STATO = new Field("stato",java.lang.String.class,"accordo-cooperazione",AccordoCooperazione.class);
		this.PROTOCOLLO = new Field("protocollo",java.lang.String.class,"accordo-cooperazione",AccordoCooperazione.class);
	...
	public AccordoCooperazioneModel(IField father){
		...
		this.DEFAULT = new org.openspcoop2.protocol.information_missing.model.DefaultModel(new ComplexField(father,"default",org.openspcoop2.protocol.information_missing.Default.class,"accordo-cooperazione",AccordoCooperazione.class));
		...
		this.TIPO = new ComplexField(father,"tipo",java.lang.String.class,"accordo-cooperazione",AccordoCooperazione.class);
		this.STATO = new ComplexField(father,"stato",java.lang.String.class,"accordo-cooperazione",AccordoCooperazione.class);
		this.PROTOCOLLO = new ComplexField(father,"protocollo",java.lang.String.class,"accordo-cooperazione",AccordoCooperazione.class);

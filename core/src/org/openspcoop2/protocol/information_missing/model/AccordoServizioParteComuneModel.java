...
public class AccordoServizioParteComuneModel extends AbstractModel<AccordoServizioParteComune> {
	...
	public AccordoServizioParteComuneModel(){
		...
		this.CONDITIONS = new org.openspcoop2.protocol.information_missing.model.ConditionsTypeModel(new Field("conditions",org.openspcoop2.protocol.information_missing.ConditionsType.class,"accordo-servizio-parte-comune",AccordoServizioParteComune.class));
	...
	public AccordoServizioParteComuneModel(IField father){
		...
		this.CONDITIONS = new org.openspcoop2.protocol.information_missing.model.ConditionsTypeModel(new ComplexField(father,"conditions",org.openspcoop2.protocol.information_missing.ConditionsType.class,"accordo-servizio-parte-comune",AccordoServizioParteComune.class));

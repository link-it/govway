 ...
 * @version $Rev$, $Date$
 */
@javax.xml.bind.annotation.XmlType(name = "AccordoCooperazioneReplaceType")
@javax.xml.bind.annotation.XmlEnum(String.class)
public enum AccordoCooperazioneReplaceType implements IEnumeration , Serializable , Cloneable {
	...
	AccordoCooperazioneReplaceType(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(AccordoCooperazioneReplaceType object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof AccordoCooperazioneReplaceType) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((AccordoCooperazioneReplaceType)object));
	}

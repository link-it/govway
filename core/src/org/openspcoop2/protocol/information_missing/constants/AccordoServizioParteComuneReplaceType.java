 ...
 * @version $Rev$, $Date$
 */
@javax.xml.bind.annotation.XmlType(name = "AccordoServizioParteComuneReplaceType")
@javax.xml.bind.annotation.XmlEnum(String.class)
public enum AccordoServizioParteComuneReplaceType implements IEnumeration , Serializable , Cloneable {
	...
	AccordoServizioParteComuneReplaceType(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(AccordoServizioParteComuneReplaceType object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof AccordoServizioParteComuneReplaceType) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((AccordoServizioParteComuneReplaceType)object));
	}

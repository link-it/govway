 ...
 * @version $Rev$, $Date$
 */
@javax.xml.bind.annotation.XmlType(name = "AccordoServizioParteSpecificaReplaceType")
@javax.xml.bind.annotation.XmlEnum(String.class)
public enum AccordoServizioParteSpecificaReplaceType implements IEnumeration , Serializable , Cloneable {
	...
	AccordoServizioParteSpecificaReplaceType(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(AccordoServizioParteSpecificaReplaceType object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof AccordoServizioParteSpecificaReplaceType) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((AccordoServizioParteSpecificaReplaceType)object));
	}

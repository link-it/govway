...
public class RequestConfig implements java.io.Serializable {
	...
	private static String buildKeyAccordoServizioWrapper(InformationApiSource infoWsdlSource,boolean buildSchemaXSD,boolean processIncludeForOpenApi) {
		if(infoWsdlSource!=null) {
			return infoWsdlSource.name()+"_"+buildSchemaXSD+"_"+processIncludeForOpenApi;
		}
		else {
			return "NULL_"+buildSchemaXSD+"_"+processIncludeForOpenApi;
		}
	}
	
	public org.openspcoop2.core.registry.wsdl.AccordoServizioWrapper getAsWrapper_soap(InformationApiSource infoWsdlSource,boolean buildSchemaXSD) {
		if(this.asWrapper_soap==null) {
			return null;
		}
		String key = buildKeyAccordoServizioWrapper(infoWsdlSource, buildSchemaXSD, false);
		return this.asWrapper_soap.get(key);
	}
	public void setAsWrapper_soap(org.openspcoop2.core.registry.wsdl.AccordoServizioWrapper asWrapper_soap, InformationApiSource infoWsdlSource,boolean buildSchemaXSD, String idTransazione) {
		String key = buildKeyAccordoServizioWrapper(infoWsdlSource, buildSchemaXSD, false);
		if(this.semaphore==null) {
	...
	public org.openspcoop2.core.registry.rest.AccordoServizioWrapper getAsWrapper_rest(InformationApiSource infoWsdlSource,boolean buildSchemaXSD,boolean processIncludeForOpenApi) {
		if(this.asWrapper_rest==null) {
			return null;
		}
		String key = buildKeyAccordoServizioWrapper(infoWsdlSource, buildSchemaXSD, processIncludeForOpenApi);
		return this.asWrapper_rest.get(key);
	}
	public void setAsWrapper_rest(org.openspcoop2.core.registry.rest.AccordoServizioWrapper asWrapper_rest, InformationApiSource infoWsdlSource,boolean buildSchemaXSD,boolean processIncludeForOpenApi, String idTransazione) {
		String key = buildKeyAccordoServizioWrapper(infoWsdlSource, buildSchemaXSD, processIncludeForOpenApi);
		if(this.semaphore==null) {
			// serializzazione da transient
			initSemaphore();

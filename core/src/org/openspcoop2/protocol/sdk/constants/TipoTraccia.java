...
public enum TipoTraccia implements Serializable {
	...
	public boolean equals(TipoTraccia tipoPdD){
		return this.tipo.equals(tipoPdD.getTipo());
	}
	
	public static final TipoTraccia toTipoTraccia(String v){

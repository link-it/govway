 ...
 */
public class DiagnosticDriverUnionUtilities {
...
//		sqlQueryObject.addOrderBy("servizio");
		...
		if(filter.isPartial()){
			...
			return sqlQueryObject.createSQLUnion(false, 
					DiagnosticDriverUnionUtilities.createSQLQueryObjCorrelazione(filter,true,log,tipoDatabase,properties),
					DiagnosticDriverUnionUtilities.createSqlQueryObjDiagnostici(filter,true,log,tipoDatabase,properties));
		}else{
			return sqlQueryObject.createSQLUnion(false, 
					DiagnosticDriverUnionUtilities.createSQLQueryObjCorrelazione(filter,true,log,tipoDatabase,properties),
					DiagnosticDriverUnionUtilities.createSqlQueryObjDiagnostici(filter,true,log,tipoDatabase,properties),
					DiagnosticDriverUnionUtilities.createQueryObjDiagnosticiNotExist(filter,true,log,tipoDatabase,properties));
		}
	}

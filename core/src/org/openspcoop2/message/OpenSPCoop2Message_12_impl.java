...
public class OpenSPCoop2Message_12_impl extends Message1_2_FIX_Impl implements org.openspcoop2.message.OpenSPCoop2Message
{
	...
	public OpenSPCoop2Message_12_impl() throws SOAPException, IOException{	
		super();
	}
	
	public OpenSPCoop2Message_12_impl(MimeHeaders mhs, InputStream is, boolean fileCacheEnable, String attachmentRepoDir, String fileThreshold, long overhead) throws SOAPException, IOException{
	...
	public OpenSPCoop2Message_12_impl(SOAPMessage msg) throws SOAPException, IOException{	
	...
	public void removeAttachments(MimeHeaders mhs){
		...
		if(super.countAttachments() == 0){
			this.setContentType(SOAPConstants.SOAP_1_2_CONTENT_TYPE);
		}
	}
...
//		return ((OpenSPCoop2Message_12_impl) fac.createMessage(SOAPVersion.SOAP12)).getSOAPBody().addDocument(doc);
		try{
			return OpenSPCoop2MessageFactory.getMessageFactory().getSoapFactory12().createElement(XMLUtils.getInstance().newElement(bytes));
		}catch(Exception e){
	...
	@Override
	public void setFaultCode(SOAPFault fault, SOAPFaultCode code, QName eccezioneName) throws SOAPException {

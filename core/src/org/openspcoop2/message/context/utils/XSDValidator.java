 ...
 *
 */
package org.openspcoop2.message.context.utils;
...
public class XSDValidator {
	...
	private static synchronized void initValidator(Class<?> validatorImpl,Logger log) throws ServiceException{
		if(validator==null){
			validator = new org.openspcoop2.generic_project.utils.XSDValidator(log,MessageContext.class, 
				"/openspcoopMessageContext.xsd"
				// elencare in questa posizione altri schemi xsd che vengono inclusi/importati dallo schema /openspcoopMessageContext.xsd
			);
		}
	}

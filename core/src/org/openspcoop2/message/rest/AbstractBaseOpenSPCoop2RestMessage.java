 ...
 * @version $Rev$, $Date$
 */
public abstract class AbstractBaseOpenSPCoop2RestMessage<T> extends AbstractBaseOpenSPCoop2MessageDynamicContent<T> implements OpenSPCoop2RestMessage<T> {
	...
	protected AbstractBaseOpenSPCoop2RestMessage(OpenSPCoop2MessageFactory messageFactory, InputStream isParam,String contentType) throws MessageException {
		super(messageFactory, isParam, contentType, false, null);
	}

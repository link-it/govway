...
public class MsgDiagnosticiProperties {	
	...
	private static final String[] MSG_DIAGNOSTICI_PERSONALIZZATI = {
		...
		MsgDiagnosticiProperties.MSG_DIAG_RICEZIONE_CONTENUTI_APPLICATIVI+"contentEncoding.decompressed",
		MsgDiagnosticiProperties.MSG_DIAG_RICEZIONE_CONTENUTI_APPLICATIVI+"contentEncoding.unsupported",
		...
		MsgDiagnosticiProperties.MSG_DIAG_RICEZIONE_BUSTE+"contentEncoding.decompressed",
		MsgDiagnosticiProperties.MSG_DIAG_RICEZIONE_BUSTE+"contentEncoding.unsupported",

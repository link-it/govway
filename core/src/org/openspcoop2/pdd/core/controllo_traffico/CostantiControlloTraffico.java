...
public class CostantiControlloTraffico {
	...
	public final static String PDD_CONTEXT_POLICY_CONFIG_PORTA = "POLICY_CONFIG_PORTA";
	public final static String PDD_CONTEXT_POLICY_CONFIG_GLOBALE = "POLICY_CONFIG_GLOBALE";
	public final static String PDD_CONTEXT_LIST_API_OR_GLOBAL_OR_DEFAULT = "POLICY_API_OR_GLOBAL_OR_DEFAULT";

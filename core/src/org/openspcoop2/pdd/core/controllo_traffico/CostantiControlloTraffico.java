...
public class CostantiControlloTraffico {
	...
	public final static MapKey<String> PDD_CONTEXT_POLICY_CONFIG_PORTA = Map.newMapKey("POLICY_CONFIG_PORTA");
	public final static MapKey<String> PDD_CONTEXT_POLICY_CONFIG_GLOBALE = Map.newMapKey("POLICY_CONFIG_GLOBALE");
	public final static MapKey<String> PDD_CONTEXT_LIST_API_OR_GLOBAL_OR_DEFAULT = Map.newMapKey("POLICY_API_OR_GLOBAL_OR_DEFAULT");
	public final static String PDD_CONTEXT_LIST_API_OR_GLOBAL_OR_DEFAULT_VALUE_API = "API";
	public final static String PDD_CONTEXT_LIST_API_OR_GLOBAL_OR_DEFAULT_VALUE_GLOBAL = "GLOBAL";
	public final static String PDD_CONTEXT_LIST_API_OR_GLOBAL_OR_DEFAULT_VALUE_DEFAULT = "DEFAULT";

...
/**
 * Esito di un processo di validazione DPoP token (Porta Delegata).
 *
 * @author Andrea Poli (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public class EsitoValidazioneDPoPPortaDelegata extends EsitoValidazioneDPoP implements Serializable {

...
/**
 * Esito di un processo di ricerca DPoP token (Porta Delegata).
 *
 * @author Andrea Poli (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public class EsitoPresenzaDPoPPortaDelegata extends EsitoPresenzaDPoP implements Serializable {

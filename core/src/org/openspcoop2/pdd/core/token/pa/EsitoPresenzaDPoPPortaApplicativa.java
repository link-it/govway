...
/**
 * Esito di un processo di ricerca DPoP token (Porta Applicativa).
 *
 * @author Andrea Poli (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public class EsitoPresenzaDPoPPortaApplicativa extends EsitoPresenzaDPoP implements Serializable {

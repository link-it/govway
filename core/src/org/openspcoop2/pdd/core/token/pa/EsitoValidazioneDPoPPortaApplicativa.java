...
/**
 * Esito di un processo di validazione DPoP token (Porta Applicativa).
 *
 * @author Andrea Poli (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public class EsitoValidazioneDPoPPortaApplicativa extends EsitoValidazioneDPoP implements Serializable {

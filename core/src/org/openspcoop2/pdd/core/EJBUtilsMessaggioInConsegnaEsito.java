...
/**
 * EJBUtilsMessaggioInConsegnaEsito
 * 
 *  
 ...
 * @version $Rev$, $Date$
 */
public class EJBUtilsMessaggioInConsegnaEsito {
	...
	public void setGestioneStatelessConIntegrationManager(boolean gestioneStatelessConIntegrationManager) {
		this.gestioneStatelessConIntegrationManager = gestioneStatelessConIntegrationManager;
	}

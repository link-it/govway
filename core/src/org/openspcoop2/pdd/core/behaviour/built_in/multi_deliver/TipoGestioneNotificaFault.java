 ...
 * @version $Rev$, $Date$
 */
public enum TipoGestioneNotificaFault implements IEnumeration , Serializable , Cloneable {
	...
	TipoGestioneNotificaFault(String value, String label)
	{
		this.value = value;
		this.label = label;
	}
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof TipoGestioneNotificaFault) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((TipoGestioneNotificaFault)object));
	}
	...
	public static String[] toArray(){
		...
		int i=0;
		for (TipoGestioneNotificaFault tmp : values()) {
			res[i]=tmp.getValue();
			i++;
		}
		return res;
	...
	public static TipoGestioneNotificaFault toEnumConstant(String value){
		try{
	...
	public static TipoGestioneNotificaFault toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		TipoGestioneNotificaFault res = null;
		for (TipoGestioneNotificaFault tmp : values()) {

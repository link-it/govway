...
public enum LoadBalancerType implements IEnumeration , Serializable , Cloneable {
	...
	IP_HASH (Costanti.IP_HASH ,"Source IP hash",
			"Combina l'indirizzo IP di origine e di destinazione in una richiesta per generare una chiave hash, che viene quindi designata per un connettore specifico."),
	...
	LoadBalancerType(String value, String label, String descrizione)
	{
		this.value = value;
		this.label = label;

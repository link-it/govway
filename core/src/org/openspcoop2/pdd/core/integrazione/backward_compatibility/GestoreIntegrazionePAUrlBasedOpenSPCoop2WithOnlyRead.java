 ...
 * @version $Rev$, $Date$
 */
public class GestoreIntegrazionePAUrlBasedOpenSPCoop2WithOnlyRead extends AbstractGestoreIntegrazionePAUrlBasedWithOnlyReadBC{

	public GestoreIntegrazionePAUrlBasedOpenSPCoop2WithOnlyRead() {

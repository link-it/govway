 ...
 * @version $Rev$, $Date$
 */
public class GestoreIntegrazionePAUrlBasedWithOnlyRead extends AbstractCore implements IGestoreIntegrazionePA{
	...
	public GestoreIntegrazionePAUrlBasedWithOnlyRead(){
		this.log = OpenSPCoop2Logger.getLoggerOpenSPCoopCore();
		if(this.log==null){
			this.log = LoggerWrapperFactory.getLogger(GestoreIntegrazionePAUrlBasedWithOnlyRead.class);
		}
		try{

 ...
 * @version $Rev$, $Date$
 */
public class ConnettoreHTTPJava_connection extends AbstractConnettoreHTTPCORE_connection<HttpClient>{

	public ConnettoreHTTPJava_connection(String key, HttpClient client) {
		super(key, client);
	}

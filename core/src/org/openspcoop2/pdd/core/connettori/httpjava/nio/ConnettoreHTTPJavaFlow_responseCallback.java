 ...
 * @version $Rev$, $Date$
 */
public class ConnettoreHTTPJavaFlow_responseCallback {
	private ConnettoreHTTPJavaFlow connettore;
	...
	public ConnettoreHTTPJavaFlow_responseCallback( ConnettoreHTTPJavaFlow connettore, ConnettoreMsg request, HttpBodyParameters httpBody ) {
	...
	public void completed( final ConnettoreHTTPJavaFlow_responseConsumer responseParam ) {
			...
			if ( this.connettore.getCodiceTrasporto() >= 400 ) {
				...
				if ( this.connettore.getCodiceTrasporto() > 299 ) {
					...
					if(this.connettore.isFollowRedirects()){
						...
						org.openspcoop2.pdd.core.connettori.httpjava.nio.ConnettoreHTTPJavaFlow connettoreySyncRedirect = new org.openspcoop2.pdd.core.connettori.httpjava.nio.ConnettoreHTTPJavaFlow();

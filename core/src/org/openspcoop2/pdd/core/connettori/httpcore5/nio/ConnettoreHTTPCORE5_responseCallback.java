			...
			if(this.connettore.getCodiceTrasporto()>=400){
				...
				if(this.connettore.getCodiceTrasporto()>299){
					...
					if(this.connettore.isFollowRedirects()){
						...
						org.openspcoop2.pdd.core.connettori.httpcore5.ConnettoreHTTPCORE5 connettoreySyncRedirect = new org.openspcoop2.pdd.core.connettori.httpcore5.ConnettoreHTTPCORE5();

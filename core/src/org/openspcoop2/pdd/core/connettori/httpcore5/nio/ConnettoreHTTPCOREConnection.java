 ...
 * @version $Rev$, $Date$
 */
public class ConnettoreHTTPCOREConnection extends AbstractConnettoreConnection<CloseableHttpAsyncClient>{

	private RequestConfig requestConfig;
	
	public ConnettoreHTTPCOREConnection(String key, CloseableHttpAsyncClient client, RequestConfig requestConfig,
	...
	public void close() throws ConnettoreException {
		try {
			this.httpclient.close(CloseMode.GRACEFUL);  // tenta di chiudere le connessioni in modo ordinato, permettendo alle richieste in corso di completarsi.
		}catch(Exception e) {

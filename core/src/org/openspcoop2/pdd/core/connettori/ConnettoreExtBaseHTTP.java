...
public abstract class ConnettoreExtBaseHTTP extends ConnettoreBaseHTTP {
    ...
    protected void setRequestHeader(boolean validazioneHeaderRFC2047, String key, String value, ConnettoreLogger logger, Properties propertiesTrasportoDebug) {
    ...
    protected void setRequestHeader(String key,String value, Properties propertiesTrasportoDebug) {
    ...
    protected abstract void setRequestHeader(String key,String value);
}

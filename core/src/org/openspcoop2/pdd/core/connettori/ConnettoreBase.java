...
public abstract class ConnettoreBase extends AbstractCore implements IConnettore {
	...
	private void generateDPoP(org.openspcoop2.pdd.core.token.dpop.DPoPParams dpopParams, EsitoNegoziazioneToken esitoNegoziazione) throws ConnettoreException, CoreException, TokenException, SecurityException, UtilsException {
		...
		if(esitoNegoziazione.getInformazioniNegoziazioneToken() != null) {

...
//			}
			...
			ConnettoreHTTPCORE5_connection httpClient = ConnettoreHTTPCORE5_connectionManager.getConnettoreNIO(this.httpConnectionConfig, this.loader, this.logger, bfDebug, this.requestInfo);
			if(this.debug) {

...
public class CostantiPdD {
    ...
    public final static MapKey<String> HEADER_INTEGRAZIONE_TIPO_MITTENTE_TOKEN = new MapKey<String>("tipoMittenteToken",14);
    /** Costante che indica il valore dell'header di integrazione: mittenteToken*/
    public final static MapKey<String> HEADER_INTEGRAZIONE_MITTENTE_TOKEN = new MapKey<String>("mittenteToken",15);
    /** Costante che indica il valore dell'header di integrazione: servizioApplicativoToken*/
    public final static MapKey<String> HEADER_INTEGRAZIONE_SERVIZIO_APPLICATIVO_TOKEN = new MapKey<String>("servizioApplicativoToken",16);
    /** Costante che indica il valore dell'header di integrazione: identificativo di transazione*/
    public final static MapKey<String> HEADER_INTEGRAZIONE_ID_TRANSAZIONE = new MapKey<String>("idTransazione",17);
    
    /** Costante che indica l'invio delle informazioni di versionamento */
    public final static MapKey<String> HEADER_INTEGRAZIONE_PROTOCOL_INFO = new MapKey<String>("protocolInfo",18);
    
    /** Costante che indica l'invio delle informazioni di versionamento */
    public final static MapKey<String> HEADER_INTEGRAZIONE_INFO = new MapKey<String>("info",19);
    public final static MapKey<String> HEADER_INTEGRAZIONE_USER_AGENT = new MapKey<String>("userAgent",20);
    ...
    public final static MapKey<String> KEY_INFO_IN_CACHE_FUNZIONE_AUTENTICAZIONE_TOKEN = Map.newMapKey("RESULT_AUTHN_TOKEN_IN_CACHE");
    ...
    public final static MapKey<String> FILTRO_DUPLICATI_TEST = Map.newMapKey("FILTRO_DUPLICATI_TEST");
}

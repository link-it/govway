...
/**
 * NotifierOutResponseHandler
 * 
 * @author Poli Andrea (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public class NotifierOutResponseHandler implements OutResponseHandler {
	...
	public void invoke(OutResponseContext context) throws HandlerException {
		...
		try{
			...
			NotifierUtilities.updateNotifierState(context.getMessaggio(), NotifierType.OUT_RESPONSE, context);

...
/**
 * NotifierPreInResponseHandler
 * 
 * @author Poli Andrea (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public class NotifierPreInResponseHandler implements PreInResponseHandler {

	@Override
	public void invoke(PreInResponseContext context) throws HandlerException {
		...
		try{
			...
			if(notifierInputStreamCallback!=null){
				...
				if(notifierCallback.enableNotifierInputStream(NotifierType.PRE_IN_RESPONSE, context)){
					
					NotifierInputStreamParams notifierInputStreamParams = new NotifierInputStreamParams();
					
					// Notify
					NotifierResult notifierResult = notifierCallback.notify(NotifierType.PRE_IN_RESPONSE, context);
					...
					notifierInputStreamParams.setThrowStreamingHandlerException(notifierCallback.throwStreamingHandlerException(NotifierType.PRE_IN_RESPONSE, context));

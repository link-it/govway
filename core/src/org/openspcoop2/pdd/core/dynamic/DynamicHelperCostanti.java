...
public class DynamicHelperCostanti {
	...
	public static final String LABEL_CONFIGURAZIONE_PURPOSE_ID = StringEscapeUtils.escapeHtml4("Il purposeId può essere configurato attraverso differenti modalità.")+
			...
			StringEscapeUtils.escapeHtml4("- 1-1 con l'applicativo fruitore: utilizzando il valore '${clientApplicationConfig}' viene richiesta la registrazione della proprietà 'purposeId' nell'applicativo fruitore.")+org.openspcoop2.core.constants.Costanti.WEB_NEW_LINE+
			StringEscapeUtils.escapeHtml4("- N applicativi fruitore censiti sulla fruzione: utilizzando il valore '${dynamicConfig:apiSearchByClientApplication(purposeId)}' è possibile registrare molteplici proprietà '&lt;clientApplicationName&gt;.purposeId' sulla fruizione, una per ogni applicativo fruitore il cui nome va indicato come prefisso della proprietà stessa. È possibile utilizzare la proprietà senza prefisso come finalità di default.")+org.openspcoop2.core.constants.Costanti.WEB_NEW_LINE+

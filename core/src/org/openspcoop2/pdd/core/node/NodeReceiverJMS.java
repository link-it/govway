...
public class NodeReceiverJMS extends AbstractCore implements INodeReceiver{
	...
	public Object receive(MsgDiagnostico msgDiag, IDSoggetto codicePorta,String idModulo,String idMessaggio, 
		...
		try{
			JMSReceiver receiverJMS = new JMSReceiver(codicePorta,idModulo,NodeReceiverJMS.openspcoopProperties.singleConnectionNodeReceiver(),log, PdDContext.getValue(org.openspcoop2.core.constants.Costanti.ID_TRANSAZIONE, this.getPddContext()));

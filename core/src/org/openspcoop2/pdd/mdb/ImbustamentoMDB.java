	...
	public void onMessage(Message message) {
		if(message instanceof ObjectMessage) {
			...
			if( TimerMonitoraggioRisorse.risorseDisponibili == false){
				this.log.error("["+Imbustamento.ID_MODULO+"] Risorse di sistema non disponibili: "+TimerMonitoraggioRisorse.risorsaNonDisponibile.getMessage(),TimerMonitoraggioRisorse.risorsaNonDisponibile);
				this.ctxMDB.setRollbackOnly();
				return;
			}

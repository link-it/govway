...
//			return esito;
	   ...
	   -----------------------*/
			...
			if(location!=null){
				String locationWithUrl = ConnettoreUtils.buildLocationWithURLBasedParameter(this.log, responseMessage, tipoConnector, connettoreMsg.getPropertiesUrlBased(), location,

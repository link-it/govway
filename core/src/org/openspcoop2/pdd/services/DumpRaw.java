...
public class DumpRaw {
	...
	public DumpRaw(Logger log,IDSoggetto dominio,String modulo,TipoPdD tipoPdD, 
			...
			boolean fileTraceHeaders, boolean fileTraceBody) throws ConnectorException{
		this.log = log;

...
public class DirectVMProtocolInfo {
	...
	private static final MapKey<String> ID = Map.newMapKey("DirectVM-IDTransazione");
	private static final MapKey<String> ID_MESSAGGIO_RICHIESTA = Map.newMapKey("DirectVM-IDMessaggioRichiesta");
	private static final MapKey<String> ID_MESSAGGIO_RISPOSTA = Map.newMapKey("DirectVM-IDMessaggioRisposta");

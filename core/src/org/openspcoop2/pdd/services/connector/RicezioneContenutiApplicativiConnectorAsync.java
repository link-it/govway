...
public class RicezioneContenutiApplicativiConnectorAsync extends AbstractRicezioneConnectorAsync {
	...
	private static IDService getIdServiceFromProperties() {
		...
		if(op2Properties!=null && op2Properties.isEnabledPDChannelNIODefault()) {
			...
			return IDService.PORTA_DELEGATA_NIO;
		}
	}
	@Override
	...
	protected IRicezioneService newRicezioneService(AbstractErrorGenerator generatoreErroreParam) {
		RicezioneContenutiApplicativiInternalErrorGenerator generatoreErrore = (RicezioneContenutiApplicativiInternalErrorGenerator) generatoreErroreParam;
		return new RicezioneContenutiApplicativiService(generatoreErrore);
	}

		...
		try {
			...
			try{
				...
				if(bustaToSend.getTipoMittente()!=null && bustaToSend.getMittente()!=null) {
					implementazioneMittente = this.registroServiziReader.getImplementazionePdD(new IDSoggetto(bustaToSend.getTipoMittente(),bustaToSend.getMittente()), null, null);
				}
				...
				PortaApplicativa pa = this.configurazionePdDReader.getPortaApplicativa_SafeMethod(idPA, null);

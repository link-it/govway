...
public enum TipoLock implements Serializable {
	...
	GENERAZIONE_PDND_TRACCIAMENTO_GENERAZIONE (getLockStatistico(TipoIntervalloStatistico.PDND_GENERAZIONE_TRACCIAMENTO)), 
	GENERAZIONE_PDND_TRACCIAMENTO_PUBBLICAZIONE (getLockStatistico(TipoIntervalloStatistico.PDND_PUBBLICAZIONE_TRACCIAMENTO)), 

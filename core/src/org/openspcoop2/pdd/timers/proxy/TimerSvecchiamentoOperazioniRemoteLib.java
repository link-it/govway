...
public class TimerSvecchiamentoOperazioniRemoteLib {
	...
	public void check() throws TimerException {
		...
		if( !TimerMonitoraggioRisorseThread.risorseDisponibili){
			this.logTimerError("["+TimerSvecchiamentoOperazioniRemote.ID_MODULO+"] Risorse di sistema non disponibili: "+TimerMonitoraggioRisorseThread.risorsaNonDisponibile.getMessage(),TimerMonitoraggioRisorseThread.risorsaNonDisponibile);
			return;
		}

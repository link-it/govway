...
/**
 * FSRecoveryTransazioniApplicativoServerConsegnaTerminataImpl
 *
 * @author Poli Andrea (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public class FSRecoveryTransazioniApplicativoServerConsegnaTerminataImpl extends AbstractFSRecovery {

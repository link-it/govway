...
public class JDBCConfigurazioneTransazioneServiceSearch implements IDBConfigurazioneTransazioneServiceSearch, IDBServiceUtilities<ConfigurazioneTransazione> {
	...
	public JDBCConfigurazioneTransazioneServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCConfigurazioneTransazioneServiceSearch.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterObjIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+ConfigurazioneTransazione.class.getName()+") 'obj' is null");
	}
	...
	private ServiceException newServiceExceptionParameterWithTypeTableIdLessEqualsZero(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdConfigurazioneTransazione.class.getName()+") 'tableId' is lessEquals 0");
	}

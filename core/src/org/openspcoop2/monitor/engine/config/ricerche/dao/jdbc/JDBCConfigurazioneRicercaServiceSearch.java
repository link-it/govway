...
public class JDBCConfigurazioneRicercaServiceSearch implements IDBConfigurazioneRicercaServiceSearch, IDBServiceUtilities<ConfigurazioneRicerca> {
	...
	public JDBCConfigurazioneRicercaServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCConfigurazioneRicercaServiceSearch.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterObjIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+ConfigurazioneRicerca.class.getName()+") 'obj' is null");
	}
	...
	private ServiceException newServiceExceptionParameterWithTypeTableIdLessEqualsZero(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdConfigurazioneRicerca.class.getName()+") 'tableId' is lessEquals 0");
	}

...
import org.openspcoop2.monitor.engine.config.ricerche.dao.jdbc.JDBCLimitedServiceManager;
import org.openspcoop2.monitor.engine.config.ricerche.ConfigurazioneRicerca;
import org.openspcoop2.monitor.engine.config.ricerche.dao.IDBConfigurazioneRicercaServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.monitor.engine.config.ricerche.ConfigurazioneRicerca} 
 *
 * @author Poli Andrea (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
*/
public class JDBCConfigurazioneRicercaServiceSearch implements IDBConfigurazioneRicercaServiceSearch, IDBServiceUtilities<ConfigurazioneRicerca> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<ConfigurazioneRicerca, IdConfigurazioneRicerca, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCConfigurazioneRicercaServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCConfigurazioneRicercaServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.monitor.engine.config.ricerche.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("configurazioneRicerca");
	...
	@Override
	public void validate(ConfigurazioneRicerca configurazioneRicerca) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(configurazioneRicerca, this.log, 
				org.openspcoop2.monitor.engine.config.ricerche.utils.XSDValidator.getXSDValidator(this.log));
	}
	...
	@Override
	public IdConfigurazioneRicerca convertToId(ConfigurazioneRicerca obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+ConfigurazioneRicerca.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public ConfigurazioneRicerca get(IdConfigurazioneRicerca id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public ConfigurazioneRicerca get(IdConfigurazioneRicerca id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdConfigurazioneRicerca id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdConfigurazioneRicerca> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<IdConfigurazioneRicerca> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<ConfigurazioneRicerca> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<ConfigurazioneRicerca> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public ConfigurazioneRicerca find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public ConfigurazioneRicerca find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdConfigurazioneRicerca id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdConfigurazioneRicerca id, ConfigurazioneRicerca obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, ConfigurazioneRicerca obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
			
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdConfigurazioneRicerca.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+ConfigurazioneRicerca.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public ConfigurazioneRicerca get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public ConfigurazioneRicerca get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdConfigurazioneRicerca findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdConfigurazioneRicerca id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {

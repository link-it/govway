...
import org.openspcoop2.monitor.engine.config.base.dao.IDBPluginService;
...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.openspcoop2.monitor.engine.config.base.Plugin} 
 *
...
public class JDBCPluginService extends JDBCPluginServiceSearch  implements IDBPluginService {
	...
	public JDBCPluginService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCPluginService.class.getName()+ " initialized");
		this.serviceCRUD = JDBCProperties.getInstance(org.openspcoop2.monitor.engine.config.base.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceCRUD("plugin");
	...
	@Override
	public void create(Plugin plugin, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
	...
	@Override
	public void create(Plugin plugin, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			// check parameters
			if(plugin==null){
				throw new Exception("Parameter (type:"+Plugin.class.getName()+") 'plugin' is null");
			}
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,plugin,idMappingResolutionBehaviour);			
	...
	@Override
	public void update(IdPlugin oldId, Plugin plugin, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException {
		try{
	...
	@Override
	public void update(IdPlugin oldId, Plugin plugin, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		...
		try{
			...
			if(oldId==null){
				throw new Exception("Parameter (type:"+IdPlugin.class.getName()+") 'oldId' is null");
			}
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,plugin,idMappingResolutionBehaviour);
	...
	@Override
	public void update(long tableId, Plugin plugin, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException {
		try{
	...
	@Override
	public void update(long tableId, Plugin plugin, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,tableId,plugin,idMappingResolutionBehaviour);
	...
	public void updateFields(IdPlugin id, UpdateField ... updateFields) throws ServiceException, NotFoundException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(id==null){
				throw new Exception("Parameter (type:"+IdPlugin.class.getName()+") 'id' is null");
			}
	...
	@Override
	public void updateOrCreate(IdPlugin oldId, Plugin plugin, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
	...
	@Override
	public void updateOrCreate(IdPlugin oldId, Plugin plugin, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,plugin,idMappingResolutionBehaviour);
	...
	@Override
	public void updateOrCreate(long tableId, Plugin plugin, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
	...
	@Override
	public void updateOrCreate(long tableId, Plugin plugin, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,tableId,plugin,idMappingResolutionBehaviour);
	...
	public void delete(Plugin plugin) throws ServiceException,NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.delete(this.jdbcProperties,this.log,connection,sqlQueryObject,plugin);	

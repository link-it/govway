...
public class HandlersDriverUtils {
	...
	public static int numeroHandlerList(String tipologia, RuoloPorta ruoloPorta, Long idPorta, TipoPlugin tipoPlugin, String nomeMetodo, Connection con, Logger log, String tipoDB) throws ServiceException {
	...
	public static List<ConfigurazioneHandlerBean> handlerList(ISearch ricerca, String tipologia, RuoloPorta ruoloPorta,
		...
		try {
			...
			while (risultato.next()) { 
				...
				handler.setStato(DriverConfigurazioneDB_LIB.getEnumStatoFunzionalita(risultato.getString("stato")));
	...
	public static int getMaxPosizioneHandlers(String tipologia, RuoloPorta ruoloPorta, Long idPorta, String nomeMetodo, TipoPlugin tipoPlugin, Connection con, Logger log, String tipoDB) throws ServiceException {
		String tabella = CostantiDB.CONFIGURAZIONE_HANDLERS;
		if(ruoloPorta !=null) {
			if(ruoloPorta.equals(RuoloPorta.DELEGATA)) {
				tabella = CostantiDB.PORTE_DELEGATE_HANDLERS;
	...
	public static boolean existsHandler(String tipologia, RuoloPorta ruoloPorta, Long idPorta, String nomeMetodo, TipoPlugin tipoPlugin, String tipo, Connection con, Logger log, String tipoDB) throws ServiceException {
		String tabella = CostantiDB.CONFIGURAZIONE_HANDLERS;
		if(ruoloPorta !=null) {
			if(ruoloPorta.equals(RuoloPorta.DELEGATA)) {
				tabella = CostantiDB.PORTE_DELEGATE_HANDLERS;
	...
	public static ConfigurazioneHandlerBean getHandler(String tipologia, RuoloPorta ruoloPorta,

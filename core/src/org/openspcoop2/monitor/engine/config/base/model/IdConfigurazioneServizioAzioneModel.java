...
public class IdConfigurazioneServizioAzioneModel extends AbstractModel<IdConfigurazioneServizioAzione> {
	...
	public IdConfigurazioneServizioAzioneModel(){
		...
		this.ID_CONFIGURAZIONE_SERVIZIO = new org.openspcoop2.monitor.engine.config.base.model.IdConfigurazioneServizioModel(new Field("id-configurazione-servizio",org.openspcoop2.monitor.engine.config.base.IdConfigurazioneServizio.class,"id-configurazione-servizio-azione",IdConfigurazioneServizioAzione.class));
	...
	public IdConfigurazioneServizioAzioneModel(IField father){
		...
		this.ID_CONFIGURAZIONE_SERVIZIO = new org.openspcoop2.monitor.engine.config.base.model.IdConfigurazioneServizioModel(new ComplexField(father,"id-configurazione-servizio",org.openspcoop2.monitor.engine.config.base.IdConfigurazioneServizio.class,"id-configurazione-servizio-azione",IdConfigurazioneServizioAzione.class));

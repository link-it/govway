...
import org.openspcoop2.monitor.engine.config.base.dao.IDBConfigurazioneFiltroServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.monitor.engine.config.base.ConfigurazioneFiltro} 
 *
 * @author Poli Andrea (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
*/
public class JDBCConfigurazioneFiltroServiceSearch implements IDBConfigurazioneFiltroServiceSearch, IDBServiceUtilities<ConfigurazioneFiltro> {
	...
	public JDBCConfigurazioneFiltroServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCConfigurazioneFiltroServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.monitor.engine.config.base.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("configurazioneFiltro");
	...
	@Override
	public void validate(ConfigurazioneFiltro configurazioneFiltro) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(configurazioneFiltro, this.log, 
	...
	@Override
	public IdConfigurazioneFiltro convertToId(ConfigurazioneFiltro obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+ConfigurazioneFiltro.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public ConfigurazioneFiltro get(IdConfigurazioneFiltro id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public List<IdConfigurazioneFiltro> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<ConfigurazioneFiltro> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public ConfigurazioneFiltro find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	public void mappingTableIds(long tableId, ConfigurazioneFiltro obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdConfigurazioneFiltro.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+ConfigurazioneFiltro.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public ConfigurazioneFiltro get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdConfigurazioneFiltro findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdConfigurazioneFiltro id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {

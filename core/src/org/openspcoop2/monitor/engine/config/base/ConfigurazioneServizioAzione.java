...
public class ConfigurazioneServizioAzione extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  ...
  private static org.openspcoop2.monitor.engine.config.base.model.ConfigurazioneServizioAzioneModel modelStaticInstance = null;
  private static synchronized void initModelStaticInstance(){
	  if(org.openspcoop2.monitor.engine.config.base.ConfigurazioneServizioAzione.modelStaticInstance==null){
  			org.openspcoop2.monitor.engine.config.base.ConfigurazioneServizioAzione.modelStaticInstance = new org.openspcoop2.monitor.engine.config.base.model.ConfigurazioneServizioAzioneModel();
	  }
  }
  public static org.openspcoop2.monitor.engine.config.base.model.ConfigurazioneServizioAzioneModel model(){
	  if(org.openspcoop2.monitor.engine.config.base.ConfigurazioneServizioAzione.modelStaticInstance==null){
	  		initModelStaticInstance();
	  }
	  return org.openspcoop2.monitor.engine.config.base.ConfigurazioneServizioAzione.modelStaticInstance;
  }

...
public class ConfigurazioneServizioModel extends AbstractModel<ConfigurazioneServizio> {
	...
	public ConfigurazioneServizioModel(){
		...
		this.CONFIGURAZIONE_SERVIZIO_AZIONE = new org.openspcoop2.monitor.engine.config.base.model.IdConfigurazioneServizioAzioneModel(new Field("configurazione-servizio-azione",org.openspcoop2.monitor.engine.config.base.IdConfigurazioneServizioAzione.class,"configurazione-servizio",ConfigurazioneServizio.class));
	...
	public ConfigurazioneServizioModel(IField father){
		...
		this.CONFIGURAZIONE_SERVIZIO_AZIONE = new org.openspcoop2.monitor.engine.config.base.model.IdConfigurazioneServizioAzioneModel(new ComplexField(father,"configurazione-servizio-azione",org.openspcoop2.monitor.engine.config.base.IdConfigurazioneServizioAzione.class,"configurazione-servizio",ConfigurazioneServizio.class));
	...
	public org.openspcoop2.monitor.engine.config.base.model.IdConfigurazioneServizioAzioneModel CONFIGURAZIONE_SERVIZIO_AZIONE = null;

...
public class PluginServizioCompatibilitaModel extends AbstractModel<PluginServizioCompatibilita> {
	...
	public PluginServizioCompatibilitaModel(){
		...
		this.PLUGIN_SERVIZIO_AZIONE_COMPATIBILITA = new org.openspcoop2.monitor.engine.config.base.model.PluginServizioAzioneCompatibilitaModel(new Field("plugin-servizio-azione-compatibilita",org.openspcoop2.monitor.engine.config.base.PluginServizioAzioneCompatibilita.class,"plugin-servizio-compatibilita",PluginServizioCompatibilita.class));
	...
	public PluginServizioCompatibilitaModel(IField father){
		...
		this.PLUGIN_SERVIZIO_AZIONE_COMPATIBILITA = new org.openspcoop2.monitor.engine.config.base.model.PluginServizioAzioneCompatibilitaModel(new ComplexField(father,"plugin-servizio-azione-compatibilita",org.openspcoop2.monitor.engine.config.base.PluginServizioAzioneCompatibilita.class,"plugin-servizio-compatibilita",PluginServizioCompatibilita.class));
	...
	public org.openspcoop2.monitor.engine.config.base.model.PluginServizioAzioneCompatibilitaModel PLUGIN_SERVIZIO_AZIONE_COMPATIBILITA = null;

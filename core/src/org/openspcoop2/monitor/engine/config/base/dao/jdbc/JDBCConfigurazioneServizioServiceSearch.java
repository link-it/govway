...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.monitor.engine.config.base.ConfigurazioneServizio} 
 *
...
public class JDBCConfigurazioneServizioServiceSearch implements IDBConfigurazioneServizioServiceSearch, IDBServiceUtilities<ConfigurazioneServizio> {
	...
	public JDBCConfigurazioneServizioServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCConfigurazioneServizioServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.monitor.engine.config.base.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("configurazioneServizio");
	...
	public IdConfigurazioneServizio convertToId(ConfigurazioneServizio obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+ConfigurazioneServizio.class.getName()+") 'obj' is null");
			}
	...
	public void mappingTableIds(long tableId, ConfigurazioneServizio obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdConfigurazioneServizio.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+ConfigurazioneServizio.class.getName()+") 'obj' is null");
			}

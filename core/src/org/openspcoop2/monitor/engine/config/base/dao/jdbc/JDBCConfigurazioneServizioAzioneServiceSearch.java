...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.monitor.engine.config.base.ConfigurazioneServizioAzione} 
 *
...
public class JDBCConfigurazioneServizioAzioneServiceSearch implements IDBConfigurazioneServizioAzioneServiceSearch, IDBServiceUtilities<ConfigurazioneServizioAzione> {
	...
	public JDBCConfigurazioneServizioAzioneServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.monitor.engine.config.base.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("configurazioneServizioAzione");

...
import org.openspcoop2.monitor.engine.config.statistiche.dao.jdbc.JDBCLimitedServiceManager;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.monitor.engine.config.statistiche.ConfigurazioneStatistica} 
 *
 * @author Poli Andrea (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
*/
public class JDBCConfigurazioneStatisticaServiceSearch implements IDBConfigurazioneStatisticaServiceSearch, IDBServiceUtilities<ConfigurazioneStatistica> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<ConfigurazioneStatistica, IdConfigurazioneStatistica, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCConfigurazioneStatisticaServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCConfigurazioneStatisticaServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.monitor.engine.config.statistiche.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("configurazioneStatistica");
	...
	@Override
	public void validate(ConfigurazioneStatistica configurazioneStatistica) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(configurazioneStatistica, this.log, 
				org.openspcoop2.monitor.engine.config.statistiche.utils.XSDValidator.getXSDValidator(this.log));
	}
	...
	@Override
	public IdConfigurazioneStatistica convertToId(ConfigurazioneStatistica obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+ConfigurazioneStatistica.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public ConfigurazioneStatistica get(IdConfigurazioneStatistica id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public ConfigurazioneStatistica get(IdConfigurazioneStatistica id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdConfigurazioneStatistica id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdConfigurazioneStatistica> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdConfigurazioneStatistica id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdConfigurazioneStatistica id, ConfigurazioneStatistica obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	public void mappingTableIds(long tableId, ConfigurazioneStatistica obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdConfigurazioneStatistica.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+ConfigurazioneStatistica.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public ConfigurazioneStatistica get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdConfigurazioneStatistica findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdConfigurazioneStatistica id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {

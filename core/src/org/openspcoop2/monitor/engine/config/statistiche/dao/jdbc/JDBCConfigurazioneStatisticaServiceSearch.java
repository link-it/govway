...
public class JDBCConfigurazioneStatisticaServiceSearch implements IDBConfigurazioneStatisticaServiceSearch, IDBServiceUtilities<ConfigurazioneStatistica> {
	...
	public JDBCConfigurazioneStatisticaServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCConfigurazioneStatisticaServiceSearch.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterObjIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+ConfigurazioneStatistica.class.getName()+") 'obj' is null");
	}
	...
	private ServiceException newServiceExceptionParameterWithTypeTableIdLessEqualsZero(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdConfigurazioneStatistica.class.getName()+") 'tableId' is lessEquals 0");
	}

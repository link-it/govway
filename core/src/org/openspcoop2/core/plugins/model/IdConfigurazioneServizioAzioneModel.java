...
public class IdConfigurazioneServizioAzioneModel extends AbstractModel<IdConfigurazioneServizioAzione> {
	...
	public IdConfigurazioneServizioAzioneModel(){
		...
		this.ID_CONFIGURAZIONE_SERVIZIO = new org.openspcoop2.core.plugins.model.IdConfigurazioneServizioModel(new Field("id-configurazione-servizio",org.openspcoop2.core.plugins.IdConfigurazioneServizio.class,"id-configurazione-servizio-azione",IdConfigurazioneServizioAzione.class));
	...
	public IdConfigurazioneServizioAzioneModel(IField father){
		...
		this.ID_CONFIGURAZIONE_SERVIZIO = new org.openspcoop2.core.plugins.model.IdConfigurazioneServizioModel(new ComplexField(father,"id-configurazione-servizio",org.openspcoop2.core.plugins.IdConfigurazioneServizio.class,"id-configurazione-servizio-azione",IdConfigurazioneServizioAzione.class));
	...
	public org.openspcoop2.core.plugins.model.IdConfigurazioneServizioModel ID_CONFIGURAZIONE_SERVIZIO = null;

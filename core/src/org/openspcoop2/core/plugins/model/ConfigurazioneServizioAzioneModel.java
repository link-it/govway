...
public class ConfigurazioneServizioAzioneModel extends AbstractModel<ConfigurazioneServizioAzione> {
	...
	public ConfigurazioneServizioAzioneModel(){
		...
		this.ID_CONFIGURAZIONE_SERVIZIO = new org.openspcoop2.core.plugins.model.IdConfigurazioneServizioModel(new Field("id-configurazione-servizio",org.openspcoop2.core.plugins.IdConfigurazioneServizio.class,"configurazione-servizio-azione",ConfigurazioneServizioAzione.class));
	...
	public ConfigurazioneServizioAzioneModel(IField father){
		...
		this.ID_CONFIGURAZIONE_SERVIZIO = new org.openspcoop2.core.plugins.model.IdConfigurazioneServizioModel(new ComplexField(father,"id-configurazione-servizio",org.openspcoop2.core.plugins.IdConfigurazioneServizio.class,"configurazione-servizio-azione",ConfigurazioneServizioAzione.class));

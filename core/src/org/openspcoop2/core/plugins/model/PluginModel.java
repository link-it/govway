...
public class PluginModel extends AbstractModel<Plugin> {
	...
	public PluginModel(){
		...
		this.PLUGIN_SERVIZIO_COMPATIBILITA = new org.openspcoop2.core.plugins.model.PluginServizioCompatibilitaModel(new Field("plugin-servizio-compatibilita",org.openspcoop2.core.plugins.PluginServizioCompatibilita.class,"plugin",Plugin.class));
		this.PLUGIN_PROPRIETA_COMPATIBILITA = new org.openspcoop2.core.plugins.model.PluginProprietaCompatibilitaModel(new Field("plugin-proprieta-compatibilita",org.openspcoop2.core.plugins.PluginProprietaCompatibilita.class,"plugin",Plugin.class));
	...
	public PluginModel(IField father){
		...
		this.PLUGIN_SERVIZIO_COMPATIBILITA = new org.openspcoop2.core.plugins.model.PluginServizioCompatibilitaModel(new ComplexField(father,"plugin-servizio-compatibilita",org.openspcoop2.core.plugins.PluginServizioCompatibilita.class,"plugin",Plugin.class));
		this.PLUGIN_PROPRIETA_COMPATIBILITA = new org.openspcoop2.core.plugins.model.PluginProprietaCompatibilitaModel(new ComplexField(father,"plugin-proprieta-compatibilita",org.openspcoop2.core.plugins.PluginProprietaCompatibilita.class,"plugin",Plugin.class));
	...
	public org.openspcoop2.core.plugins.model.PluginServizioCompatibilitaModel PLUGIN_SERVIZIO_COMPATIBILITA = null;
	 
	public org.openspcoop2.core.plugins.model.PluginProprietaCompatibilitaModel PLUGIN_PROPRIETA_COMPATIBILITA = null;

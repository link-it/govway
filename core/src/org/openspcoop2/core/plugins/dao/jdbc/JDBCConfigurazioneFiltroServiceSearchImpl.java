...
import org.openspcoop2.core.plugins.dao.jdbc.converter.ConfigurazioneFiltroFieldConverter;
import org.openspcoop2.core.plugins.dao.jdbc.fetch.ConfigurazioneFiltroFetch;
...
public class JDBCConfigurazioneFiltroServiceSearchImpl implements IJDBCServiceSearchWithId<ConfigurazioneFiltro, IdConfigurazioneFiltro, JDBCServiceManager> {
	...
	public ConfigurazioneFiltro get(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, IdConfigurazioneFiltro id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotFoundException, MultipleResultException, NotImplementedException, ServiceException,Exception {
		...
		return this.getEngine(jdbcProperties, log, connection, sqlQueryObject, id_configurazioneFiltro,idMappingResolutionBehaviour);
	...
	public InUse inUse(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, IdConfigurazioneFiltro id) throws NotFoundException, NotImplementedException, ServiceException,Exception {
        ...
        return this.inUseEngine(jdbcProperties, log, connection, sqlQueryObject, id_configurazioneFiltro);
	...
	private ConfigurazioneFiltro getEngine(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, Long tableId, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotFoundException, MultipleResultException, NotImplementedException, ServiceException, Exception {
	...
	protected java.util.List<Object> getRootTablePrimaryKeyValuesEngine(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, IdConfigurazioneFiltro id) throws NotFoundException, ServiceException, NotImplementedException, Exception{
	    // Identificativi
	...
	public IdConfigurazioneFiltro findId(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, long tableId, boolean throwNotFound)
		...
		org.openspcoop2.core.plugins.IdConfigurazioneFiltro id_configurazioneFiltro = null;
		...
		if(listaFieldId_configurazioneFiltro==null || listaFieldId_configurazioneFiltro.size()<=0){
			...
			id_configurazioneFiltro = new org.openspcoop2.core.plugins.IdConfigurazioneFiltro();

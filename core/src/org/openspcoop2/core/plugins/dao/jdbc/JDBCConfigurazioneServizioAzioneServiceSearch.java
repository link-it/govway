...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.core.plugins.ConfigurazioneServizioAzione} 
 *
 * @author Poli Andrea (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
*/
public class JDBCConfigurazioneServizioAzioneServiceSearch implements IDBConfigurazioneServizioAzioneServiceSearch, IDBServiceUtilities<ConfigurazioneServizioAzione> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<ConfigurazioneServizioAzione, IdConfigurazioneServizioAzione, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCConfigurazioneServizioAzioneServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCConfigurazioneServizioAzioneServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.core.plugins.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("configurazioneServizioAzione");
	...
	@Override
	public void validate(ConfigurazioneServizioAzione configurazioneServizioAzione) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(configurazioneServizioAzione, this.log, 
				org.openspcoop2.core.plugins.utils.XSDValidator.getXSDValidator(this.log));
	}
	...
	@Override
	public IdConfigurazioneServizioAzione convertToId(ConfigurazioneServizioAzione obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+ConfigurazioneServizioAzione.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public ConfigurazioneServizioAzione get(IdConfigurazioneServizioAzione id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public ConfigurazioneServizioAzione get(IdConfigurazioneServizioAzione id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdConfigurazioneServizioAzione id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdConfigurazioneServizioAzione> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<IdConfigurazioneServizioAzione> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<ConfigurazioneServizioAzione> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<ConfigurazioneServizioAzione> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public ConfigurazioneServizioAzione find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public ConfigurazioneServizioAzione find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdConfigurazioneServizioAzione id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdConfigurazioneServizioAzione id, ConfigurazioneServizioAzione obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, ConfigurazioneServizioAzione obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
			
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdConfigurazioneServizioAzione.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+ConfigurazioneServizioAzione.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public ConfigurazioneServizioAzione get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public ConfigurazioneServizioAzione get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdConfigurazioneServizioAzione findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdConfigurazioneServizioAzione id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {

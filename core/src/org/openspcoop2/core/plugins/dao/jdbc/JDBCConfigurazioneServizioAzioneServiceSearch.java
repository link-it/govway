...
public class JDBCConfigurazioneServizioAzioneServiceSearch implements IDBConfigurazioneServizioAzioneServiceSearch, IDBServiceUtilities<ConfigurazioneServizioAzione> {
	...
	public JDBCConfigurazioneServizioAzioneServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCConfigurazioneServizioAzioneServiceSearch.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterWithTypeTableIdLessEqualsZero(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdConfigurazioneServizioAzione.class.getName()+") 'tableId' is lessEquals 0");
	}

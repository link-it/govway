...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.core.plugins.ConfigurazioneFiltro} 
 *
...
public class JDBCConfigurazioneFiltroServiceSearch implements IDBConfigurazioneFiltroServiceSearch, IDBServiceUtilities<ConfigurazioneFiltro> {
	...
	public JDBCConfigurazioneFiltroServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.core.plugins.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("configurazioneFiltro");

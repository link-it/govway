...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.core.plugins.Plugin} 
 *
...
public class JDBCPluginServiceSearch implements IDBPluginServiceSearch, IDBServiceUtilities<Plugin> {
	...
	public JDBCPluginServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCPluginServiceSearch.class.getName()+ " initialized";
		this.log.debug(msgInit);
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.core.plugins.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("plugin");
	...
	private ServiceException newServiceExceptionParameterWithTypeTableIdLessEqualsZero(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdPlugin.class.getName()+") 'tableId' is lessEquals 0");
	}

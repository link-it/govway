...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.openspcoop2.core.plugins.Plugin} 
 *
...
public class JDBCPluginService extends JDBCPluginServiceSearch  implements IDBPluginService {
	...
	public JDBCPluginService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.serviceCRUD = JDBCProperties.getInstance(org.openspcoop2.core.plugins.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceCRUD("plugin");

...
public class PdDConfig {
	...
	public void setPddOperativaCtrlstatSinglePdd(
			String pddOperativaCtrlstatSinglePdd) {
		this.pddOperativaCtrlstatSinglePdd = pddOperativaCtrlstatSinglePdd;
	}
	public String getTipoPdd() {
		return this.tipoPdd;
	}
	public void setTipoPdd(String tipoPdd) {

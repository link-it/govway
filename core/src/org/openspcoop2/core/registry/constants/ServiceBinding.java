...
/**     
 * Enumeration dell'elemento ServiceBinding xsd (tipo:string) 
 *
...
public enum ServiceBinding implements IEnumeration , Serializable , Cloneable {
	...
	public boolean equals(ServiceBinding object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		...
		return this.equals(((ServiceBinding)object));
	}
	...
	public static ServiceBinding toEnumConstant(String value){
		try{
	...
	public static ServiceBinding toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		ServiceBinding res = null;
		for (ServiceBinding tmp : values()) {

...
/**     
 * Enumeration dell'elemento HttpMethod xsd (tipo:string) 
 *
...
public enum HttpMethod implements IEnumeration , Serializable , Cloneable {
	...
	public boolean equals(HttpMethod object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		...
		return this.equals(((HttpMethod)object));
	}
	...
	public static HttpMethod toEnumConstant(String value){
		try{
	...
	public static HttpMethod toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		HttpMethod res = null;
		for (HttpMethod tmp : values()) {

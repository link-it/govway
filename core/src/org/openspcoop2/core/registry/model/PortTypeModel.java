...
public class PortTypeModel extends AbstractModel<PortType> {
	...
	public PortTypeModel(){
		...
		this.ID_RIFERIMENTO_RICHIESTA = new Field("id-riferimento-richiesta",java.lang.String.class,"port-type",PortType.class);
	...
	public PortTypeModel(IField father){
		...
		this.ID_RIFERIMENTO_RICHIESTA = new ComplexField(father,"id-riferimento-richiesta",java.lang.String.class,"port-type",PortType.class);

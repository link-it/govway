...
public class JDBCFruitoreServiceSearch implements IDBFruitoreServiceSearch, IDBServiceUtilities<Fruitore> {
	...
	public JDBCFruitoreServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCFruitoreServiceSearch.class.getName()+ " initialized");
	...
	public IdFruitore convertToId(Fruitore obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+Fruitore.class.getName()+") 'obj' is null");
			}
	...
	public Fruitore get(IdFruitore id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(id==null){
				throw new Exception("Parameter (type:"+IdFruitore.class.getName()+") 'id' is null");
			}
	...
	public void mappingTableIds(long tableId, Fruitore obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdFruitore.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+Fruitore.class.getName()+") 'obj' is null");
			}

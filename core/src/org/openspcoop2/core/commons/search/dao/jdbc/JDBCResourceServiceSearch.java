...
public class JDBCResourceServiceSearch implements IDBResourceServiceSearch, IDBServiceUtilities<Resource> {
	...
	public JDBCResourceServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCResourceServiceSearch.class.getName()+ " initialized");
	...
	public IdResource convertToId(Resource obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+Resource.class.getName()+") 'obj' is null");
			}
	...
	public Resource get(IdResource id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(id==null){
				throw new Exception("Parameter (type:"+IdResource.class.getName()+") 'id' is null");
			}
	...
	public void mappingTableIds(long tableId, Resource obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdResource.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+Resource.class.getName()+") 'obj' is null");
			}

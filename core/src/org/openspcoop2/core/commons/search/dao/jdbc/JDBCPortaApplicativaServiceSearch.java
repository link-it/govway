...
public class JDBCPortaApplicativaServiceSearch implements IDBPortaApplicativaServiceSearch, IDBServiceUtilities<PortaApplicativa> {
	...
	public JDBCPortaApplicativaServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCPortaApplicativaServiceSearch.class.getName()+ " initialized");
	...
	public IdPortaApplicativa convertToId(PortaApplicativa obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+PortaApplicativa.class.getName()+") 'obj' is null");
			}
	...
	public PortaApplicativa get(IdPortaApplicativa id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(id==null){
				throw new Exception("Parameter (type:"+IdPortaApplicativa.class.getName()+") 'id' is null");
			}
	...
	public void mappingTableIds(long tableId, PortaApplicativa obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdPortaApplicativa.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+PortaApplicativa.class.getName()+") 'obj' is null");
			}

...
public class JDBCPortTypeServiceSearch implements IDBPortTypeServiceSearch, IDBServiceUtilities<PortType> {
	...
	public JDBCPortTypeServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCPortTypeServiceSearch.class.getName()+ " initialized");
	...
	public IdPortType convertToId(PortType obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+PortType.class.getName()+") 'obj' is null");
			}
	...
	public PortType get(IdPortType id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(id==null){
				throw new Exception("Parameter (type:"+IdPortType.class.getName()+") 'id' is null");
			}
	...
	public void mappingTableIds(long tableId, PortType obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdPortType.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+PortType.class.getName()+") 'obj' is null");
			}

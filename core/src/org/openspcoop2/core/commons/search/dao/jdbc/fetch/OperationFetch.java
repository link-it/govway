 ...
 * @version $Rev$, $Date$
 */
public class OperationFetch extends AbstractJDBCFetch {
	...
	public Object fetch(TipiDatabase tipoDatabase, IModel<?> model , ResultSet rs) throws ServiceException {
		...
		try{
			...
			if(model.equals(Operation.model())){
				...
				setParameter(object, "setNome", Operation.model().NOME.getFieldType(),
					jdbcParameterUtilities.readParameter(rs, "nome", Operation.model().NOME.getFieldType()));
				return object;
			}

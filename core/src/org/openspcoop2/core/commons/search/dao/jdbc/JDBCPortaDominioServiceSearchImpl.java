...
/**     
 * JDBCPortaDominioServiceSearchImpl
 *
 * @author Poli Andrea (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public class JDBCPortaDominioServiceSearchImpl implements IJDBCServiceSearchWithId<PortaDominio, IdPortaDominio, JDBCServiceManager> {

	private PortaDominioFieldConverter _portaDominioFieldConverter = null;
	public PortaDominioFieldConverter getPortaDominioFieldConverter() {
		if(this._portaDominioFieldConverter==null){
			this._portaDominioFieldConverter = new PortaDominioFieldConverter(this.jdbcServiceManager.getJdbcProperties().getDatabaseType());
		}		
		return this._portaDominioFieldConverter;
	}
	@Override
	public ISQLFieldConverter getFieldConverter() {
		return this.getPortaDominioFieldConverter();
	}
	
	private PortaDominioFetch portaDominioFetch = new PortaDominioFetch();
	public PortaDominioFetch getPortaDominioFetch() {
		return this.portaDominioFetch;
	}
	@Override
	public IJDBCFetch getFetch() {
		return getPortaDominioFetch();
	}
	...
	@Override
	public PortaDominio get(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, IdPortaDominio id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotFoundException, MultipleResultException, NotImplementedException, ServiceException,Exception {
		Long id_portaDominio = ( (id!=null && id.getId()!=null && id.getId()>0) ? id.getId() : this.findIdPortaDominio(jdbcProperties, log, connection, sqlQueryObject, id, true));
		return this.getEngine(jdbcProperties, log, connection, sqlQueryObject, id_portaDominio,idMappingResolutionBehaviour);
		
		
	}
	
	@Override
	public boolean exists(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, IdPortaDominio id) throws MultipleResultException, NotImplementedException, ServiceException,Exception {

		Long id_portaDominio = this.findIdPortaDominio(jdbcProperties, log, connection, sqlQueryObject, id, false);
		return id_portaDominio != null && id_portaDominio > 0;
		
	}
	
	@Override
	public List<IdPortaDominio> findAllIds(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotImplementedException, ServiceException,Exception {

		List<IdPortaDominio> list = new ArrayList<IdPortaDominio>();

		// TODO: implementazione non efficiente. 
		// Per ottenere una implementazione efficiente:
		// 1. Usare metodo select di questa classe indirizzando esattamente i field necessari a create l'ID logico
		// 2. Usare metodo getPortaDominioFetch() sul risultato della select per ottenere un oggetto PortaDominio
        ...
        for(Long id: ids) {
        	PortaDominio portaDominio = this.get(jdbcProperties, log, connection, sqlQueryObject, id, idMappingResolutionBehaviour);
			IdPortaDominio idPortaDominio = this.convertToId(jdbcProperties,log,connection,sqlQueryObject,portaDominio);
        	list.add(idPortaDominio);
        }
	...
	@Override
	public List<PortaDominio> findAll(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotImplementedException, ServiceException,Exception {
	...
	@Override
	public PortaDominio find(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) 
	...
	public NonNegativeNumber count(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCExpression expression) throws NotImplementedException, ServiceException,Exception {
		...
		List<Object> listaQuery = org.openspcoop2.generic_project.dao.jdbc.utils.GenericJDBCUtilities.prepareCount(jdbcProperties, log, connection, sqlQueryObject, expression,
												this.getPortaDominioFieldConverter(), PortaDominio.model());
		
		sqlQueryObject.addSelectCountField(this.getPortaDominioFieldConverter().toTable(PortaDominio.model())+".id","tot",true);
		...
		return org.openspcoop2.generic_project.dao.jdbc.utils.GenericJDBCUtilities.count(jdbcProperties, log, connection, sqlQueryObject, expression,
																			this.getPortaDominioFieldConverter(), PortaDominio.model(),listaQuery);
	}

	@Override
	public InUse inUse(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, IdPortaDominio id) throws NotFoundException, NotImplementedException, ServiceException,Exception {
		
		Long id_portaDominio = this.findIdPortaDominio(jdbcProperties, log, connection, sqlQueryObject, id, true);
        return this.inUseEngine(jdbcProperties, log, connection, sqlQueryObject, id_portaDominio);
		...
		try{
			...
			ISQLQueryObject sqlQueryObjectDistinct = 
						org.openspcoop2.generic_project.dao.jdbc.utils.GenericJDBCUtilities.prepareSqlQueryObjectForSelectDistinct(distinct,sqlQueryObject, paginatedExpression, log,
												this.getPortaDominioFieldConverter(), field);
	...
	protected List<Map<String,Object>> selectEngine(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, 
		...
		List<Object> returnField = org.openspcoop2.generic_project.dao.jdbc.utils.GenericJDBCUtilities.prepareSelect(jdbcProperties, log, connection, sqlQueryObject, 
        						expression, this.getPortaDominioFieldConverter(), PortaDominio.model(), 
	...
	public JDBCExpression newExpression(Logger log) throws NotImplementedException, ServiceException {
		try{
			return new JDBCExpression(this.getPortaDominioFieldConverter());
		}catch(Exception e){
	...
	public JDBCPaginatedExpression newPaginatedExpression(Logger log) throws NotImplementedException, ServiceException {
		try{
			return new JDBCPaginatedExpression(this.getPortaDominioFieldConverter());
		}catch(Exception e){
			throw new ServiceException(e);
		}
	}
	...
	@Override
	public void mappingTableIds(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, IdPortaDominio id, PortaDominio obj) throws NotFoundException,NotImplementedException,ServiceException,Exception{
		_mappingTableIds(jdbcProperties,log,connection,sqlQueryObject,obj,
				this.get(jdbcProperties,log,connection,sqlQueryObject,id,null));
	}
	
	@Override
	public void mappingTableIds(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, long tableId, PortaDominio obj) throws NotFoundException,NotImplementedException,ServiceException,Exception{
		_mappingTableIds(jdbcProperties,log,connection,sqlQueryObject,obj,
				this.get(jdbcProperties,log,connection,sqlQueryObject,tableId,null));
	}
	private void _mappingTableIds(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, PortaDominio obj, PortaDominio imgSaved) throws NotFoundException,NotImplementedException,ServiceException,Exception{
		if(imgSaved==null){
			return;
		}
	...
	@Override
	public PortaDominio get(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, long tableId, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotFoundException, MultipleResultException, NotImplementedException, ServiceException, Exception {
		return this.getEngine(jdbcProperties, log, connection, sqlQueryObject, Long.valueOf(tableId), idMappingResolutionBehaviour);
	}
	
	private PortaDominio getEngine(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, Long tableId, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotFoundException, MultipleResultException, NotImplementedException, ServiceException, Exception {
		...
		PortaDominio portaDominio = new PortaDominio();
		

		// Object portaDominio
		ISQLQueryObject sqlQueryObjectGet_portaDominio = sqlQueryObjectGet.newSQLQueryObject();
		sqlQueryObjectGet_portaDominio.setANDLogicOperator(true);
		sqlQueryObjectGet_portaDominio.addFromTable(this.getPortaDominioFieldConverter().toTable(PortaDominio.model()));
		sqlQueryObjectGet_portaDominio.addSelectField("id");
		sqlQueryObjectGet_portaDominio.addSelectField(this.getPortaDominioFieldConverter().toColumn(PortaDominio.model().NOME,true));
		sqlQueryObjectGet_portaDominio.addSelectField(this.getPortaDominioFieldConverter().toColumn(PortaDominio.model().TIPO,true));
		sqlQueryObjectGet_portaDominio.addWhereCondition("id=?");

		// Get portaDominio
		portaDominio = (PortaDominio) jdbcUtilities.executeQuerySingleResult(sqlQueryObjectGet_portaDominio.createSQLQuery(), jdbcProperties.isShowSql(), PortaDominio.model(), this.getPortaDominioFetch(),
	...
	private boolean _exists(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, Long tableId) throws MultipleResultException, NotImplementedException, ServiceException, Exception {
		...
		boolean existsPortaDominio = false;

		sqlQueryObject = sqlQueryObject.newSQLQueryObject();
		sqlQueryObject.setANDLogicOperator(true);

		sqlQueryObject.addFromTable(this.getPortaDominioFieldConverter().toTable(PortaDominio.model()));
		sqlQueryObject.addSelectField(this.getPortaDominioFieldConverter().toColumn(PortaDominio.model().NOME,true));
		sqlQueryObject.addWhereCondition("id=?");


		// Exists portaDominio
		existsPortaDominio = jdbcUtilities.exists(sqlQueryObject.createSQLQuery(), jdbcProperties.isShowSql(),
			new JDBCObject(tableId,Long.class));

		
        return existsPortaDominio;
	...
	protected java.util.List<Object> getRootTablePrimaryKeyValuesEngine(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, IdPortaDominio id) throws NotFoundException, ServiceException, NotImplementedException, Exception{
	    // Identificativi
	...
	protected Map<String, List<IField>> getMapTableToPKColumnEngine() throws NotImplementedException, Exception{
		...
		PortaDominioFieldConverter converter = this.getPortaDominioFieldConverter();
	...
	public List<Long> findAllTableIds(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCPaginatedExpression paginatedExpression) throws ServiceException, NotImplementedException, Exception {
		...
		sqlQueryObject.setANDLogicOperator(true);
		sqlQueryObject.addSelectField(this.getPortaDominioFieldConverter().toTable(PortaDominio.model())+".id");
		...
		List<Object> listObjects = org.openspcoop2.generic_project.dao.jdbc.utils.GenericJDBCUtilities.findAll(jdbcProperties, log, connection, sqlQueryObject, paginatedExpression,
																			this.getPortaDominioFieldConverter(), PortaDominio.model(), objectIdClass, listaQuery);
	...
	@Override
	public IdPortaDominio findId(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, long tableId, boolean throwNotFound)
		...
		if(listaFieldId_portaDominio==null || listaFieldId_portaDominio.size()<=0){
			if(throwNotFound){
				throw org.openspcoop2.generic_project.dao.jdbc.utils.GenericJDBCUtilities.newNotFoundException();
			}
		}
	...
	@Override
	public Long findTableId(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, IdPortaDominio id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException, Exception {
	
		return this.findIdPortaDominio(jdbcProperties,log,connection,sqlQueryObject,id,throwNotFound);
	...
	protected Long findIdPortaDominio(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, IdPortaDominio id, boolean throwNotFound) throws NotFoundException, ServiceException, NotImplementedException, Exception {
		...
		try{
			id_portaDominio = (Long) jdbcUtilities.executeQuerySingleResult(sqlQueryObjectGet.createSQLQuery(), jdbcProperties.isShowSql(),
						Long.class, searchParams_portaDominio);
		}catch(NotFoundException notFound){
			if(throwNotFound){
				throw new NotFoundException(notFound);
			}
		}
		if(id_portaDominio==null || id_portaDominio<=0){
			if(throwNotFound){
				throw org.openspcoop2.generic_project.dao.jdbc.utils.GenericJDBCUtilities.newNotFoundException();
			}
		}

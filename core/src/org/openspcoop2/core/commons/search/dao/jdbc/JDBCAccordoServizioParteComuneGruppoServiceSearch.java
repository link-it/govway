...
import org.openspcoop2.core.commons.search.dao.IDBAccordoServizioParteComuneGruppoServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.core.commons.search.AccordoServizioParteComuneGruppo} 
 *
 * @author Poli Andrea (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
*/
public class JDBCAccordoServizioParteComuneGruppoServiceSearch implements IDBAccordoServizioParteComuneGruppoServiceSearch, IDBServiceUtilities<AccordoServizioParteComuneGruppo> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<AccordoServizioParteComuneGruppo, IdAccordoServizioParteComuneGruppo, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCAccordoServizioParteComuneGruppoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCAccordoServizioParteComuneGruppoServiceSearch.class.getName()+ " initialized";
		this.log.debug(msgInit);
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.core.commons.search.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("accordoServizioParteComuneGruppo");
	...
	private ServiceException newServiceExceptionParameterObjIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+AccordoServizioParteComuneGruppo.class.getName()+") 'obj' is null");
	}
	protected ServiceException newServiceExceptionParameterIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdAccordoServizioParteComuneGruppo.class.getName()+") 'id' is null");
	}
	...
	private ServiceException newServiceExceptionParameterWithTypeTableIdLessEqualsZero(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdAccordoServizioParteComuneGruppo.class.getName()+") 'tableId' is lessEquals 0");
	}
	...
	@Override
	public void validate(AccordoServizioParteComuneGruppo accordoServizioParteComuneGruppo) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(accordoServizioParteComuneGruppo, this.log, 
				org.openspcoop2.core.commons.search.utils.XSDValidator.getXSDValidator(this.log));
	}
	...
	@Override
	public IdAccordoServizioParteComuneGruppo convertToId(AccordoServizioParteComuneGruppo obj)
	...
	@Override
	public AccordoServizioParteComuneGruppo get(IdAccordoServizioParteComuneGruppo id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public AccordoServizioParteComuneGruppo get(IdAccordoServizioParteComuneGruppo id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdAccordoServizioParteComuneGruppo id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdAccordoServizioParteComuneGruppo> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<IdAccordoServizioParteComuneGruppo> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<AccordoServizioParteComuneGruppo> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<AccordoServizioParteComuneGruppo> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public AccordoServizioParteComuneGruppo find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public AccordoServizioParteComuneGruppo find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdAccordoServizioParteComuneGruppo id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdAccordoServizioParteComuneGruppo id, AccordoServizioParteComuneGruppo obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, AccordoServizioParteComuneGruppo obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public AccordoServizioParteComuneGruppo get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public AccordoServizioParteComuneGruppo get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdAccordoServizioParteComuneGruppo findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdAccordoServizioParteComuneGruppo id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {

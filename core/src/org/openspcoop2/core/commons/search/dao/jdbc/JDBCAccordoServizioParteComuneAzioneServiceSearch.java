...
public class JDBCAccordoServizioParteComuneAzioneServiceSearch implements IDBAccordoServizioParteComuneAzioneServiceSearch, IDBServiceUtilities<AccordoServizioParteComuneAzione> {
	...
	public JDBCAccordoServizioParteComuneAzioneServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCAccordoServizioParteComuneAzioneServiceSearch.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterWithTypeTableIdLessEqualsZero(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdAccordoServizioParteComuneAzione.class.getName()+") 'tableId' is lessEquals 0");
	}

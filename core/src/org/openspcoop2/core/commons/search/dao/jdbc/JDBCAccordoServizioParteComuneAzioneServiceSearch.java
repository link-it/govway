...
import org.openspcoop2.core.commons.search.dao.IDBAccordoServizioParteComuneAzioneServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.core.commons.search.AccordoServizioParteComuneAzione} 
 *
 * @author Poli Andrea (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
*/
public class JDBCAccordoServizioParteComuneAzioneServiceSearch implements IDBAccordoServizioParteComuneAzioneServiceSearch, IDBServiceUtilities<AccordoServizioParteComuneAzione> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<AccordoServizioParteComuneAzione, IdAccordoServizioParteComuneAzione, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCAccordoServizioParteComuneAzioneServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCAccordoServizioParteComuneAzioneServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.core.commons.search.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("accordoServizioParteComuneAzione");
	...
	@Override
	public void validate(AccordoServizioParteComuneAzione accordoServizioParteComuneAzione) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(accordoServizioParteComuneAzione, this.log, 
	...
	@Override
	public IdAccordoServizioParteComuneAzione convertToId(AccordoServizioParteComuneAzione obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+AccordoServizioParteComuneAzione.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public AccordoServizioParteComuneAzione get(IdAccordoServizioParteComuneAzione id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(id==null){
				throw new Exception("Parameter (type:"+IdAccordoServizioParteComuneAzione.class.getName()+") 'id' is null");
			}
	...
	@Override
	public AccordoServizioParteComuneAzione get(IdAccordoServizioParteComuneAzione id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdAccordoServizioParteComuneAzione id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdAccordoServizioParteComuneAzione> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<IdAccordoServizioParteComuneAzione> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<AccordoServizioParteComuneAzione> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<AccordoServizioParteComuneAzione> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public AccordoServizioParteComuneAzione find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public AccordoServizioParteComuneAzione find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdAccordoServizioParteComuneAzione id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdAccordoServizioParteComuneAzione id, AccordoServizioParteComuneAzione obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, AccordoServizioParteComuneAzione obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
			
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdAccordoServizioParteComuneAzione.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+AccordoServizioParteComuneAzione.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public AccordoServizioParteComuneAzione get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public AccordoServizioParteComuneAzione get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdAccordoServizioParteComuneAzione findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdAccordoServizioParteComuneAzione id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {

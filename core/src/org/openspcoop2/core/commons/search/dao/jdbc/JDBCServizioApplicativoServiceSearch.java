...
public class JDBCServizioApplicativoServiceSearch implements IDBServizioApplicativoServiceSearch, IDBServiceUtilities<ServizioApplicativo> {
	...
	public JDBCServizioApplicativoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCServizioApplicativoServiceSearch.class.getName()+ " initialized");
	...
	public IdServizioApplicativo convertToId(ServizioApplicativo obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+ServizioApplicativo.class.getName()+") 'obj' is null");
			}
	...
	public ServizioApplicativo get(IdServizioApplicativo id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(id==null){
				throw new Exception("Parameter (type:"+IdServizioApplicativo.class.getName()+") 'id' is null");
			}
	...
	public void mappingTableIds(long tableId, ServizioApplicativo obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdServizioApplicativo.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+ServizioApplicativo.class.getName()+") 'obj' is null");
			}

...
public class IdRuoloModel extends AbstractModel<IdRuolo> {
	...
	public IdRuoloModel(){
		...
		this.NOME = new Field("nome",java.lang.String.class,"id-ruolo",IdRuolo.class);
	...
	public IdRuoloModel(IField father){
		...
		this.NOME = new ComplexField(father,"nome",java.lang.String.class,"id-ruolo",IdRuolo.class);

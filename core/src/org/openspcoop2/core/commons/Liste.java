...
public final class Liste
{
    ...
    public static final int CONFIGURAZIONE_GESTIONE_LLM_PROVIDER;
    public static final int CONFIGURAZIONE_GESTIONE_LLM_MODEL;
    public static final int CONFIGURAZIONE_GESTIONE_LLM_PROVIDER_BINDING;
    public static final int CONFIGURAZIONE_GESTIONE_LLM_PII_MASKING;
    ...
    static {
    	...
    	CONFIGURAZIONE_GESTIONE_LLM_PROVIDER = numeroListe ++;
    	CONFIGURAZIONE_GESTIONE_LLM_MODEL = numeroListe ++;
    	CONFIGURAZIONE_GESTIONE_LLM_PROVIDER_BINDING = numeroListe ++;
    	CONFIGURAZIONE_GESTIONE_LLM_PII_MASKING = numeroListe ++;

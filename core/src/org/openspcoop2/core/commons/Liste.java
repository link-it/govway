...
public final class Liste
{
	...
	public final static int PORTE_APPLICATIVE_VALIDAZIONE_CONTENUTI_PATTERN;
	public final static int PORTE_APPLICATIVE_VALIDAZIONE_CONTENUTI_RICHIESTA;
	public final static int PORTE_APPLICATIVE_VALIDAZIONE_CONTENUTI_RISPOSTA;
	public final static int PORTE_APPLICATIVE_VALIDAZIONE_CONTENUTI_RICHIESTA_PATTERN;
	public final static int PORTE_APPLICATIVE_VALIDAZIONE_CONTENUTI_RISPOSTA_PATTERN;
	...
	public final static int PORTE_DELEGATE_VALIDAZIONE_CONTENUTI_PATTERN;
	public final static int PORTE_DELEGATE_VALIDAZIONE_CONTENUTI_RICHIESTA;
	public final static int PORTE_DELEGATE_VALIDAZIONE_CONTENUTI_RISPOSTA;
	public final static int PORTE_DELEGATE_VALIDAZIONE_CONTENUTI_RICHIESTA_PATTERN;
	public final static int PORTE_DELEGATE_VALIDAZIONE_CONTENUTI_RISPOSTA_PATTERN;
    ...
    static {
    	...
    	PORTE_APPLICATIVE_VALIDAZIONE_CONTENUTI_PATTERN = numeroListe ++;
    	PORTE_APPLICATIVE_VALIDAZIONE_CONTENUTI_RICHIESTA = numeroListe ++;
    	PORTE_APPLICATIVE_VALIDAZIONE_CONTENUTI_RISPOSTA = numeroListe ++;
    	PORTE_APPLICATIVE_VALIDAZIONE_CONTENUTI_RICHIESTA_PATTERN = numeroListe ++;
    	PORTE_APPLICATIVE_VALIDAZIONE_CONTENUTI_RISPOSTA_PATTERN = numeroListe ++;
    	...
    	PORTE_DELEGATE_VALIDAZIONE_CONTENUTI_PATTERN = numeroListe ++;
    	PORTE_DELEGATE_VALIDAZIONE_CONTENUTI_RICHIESTA = numeroListe ++;
    	PORTE_DELEGATE_VALIDAZIONE_CONTENUTI_RISPOSTA = numeroListe ++;
    	PORTE_DELEGATE_VALIDAZIONE_CONTENUTI_RICHIESTA_PATTERN = numeroListe ++;
    	PORTE_DELEGATE_VALIDAZIONE_CONTENUTI_RISPOSTA_PATTERN = numeroListe ++;

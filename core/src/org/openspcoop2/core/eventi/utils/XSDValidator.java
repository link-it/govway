...
public class XSDValidator {
	...
	private static synchronized void initValidator(Class<?> validatorImpl,Logger log) throws ServiceException{
		if(validator==null){
			validator = new org.openspcoop2.generic_project.utils.XSDValidator(log,Evento.class, 
				"/openspcoopEventi.xsd"
				// elencare in questa posizione altri schemi xsd che vengono inclusi/importati dallo schema /openspcoopEventi.xsd
			);
		}
	}

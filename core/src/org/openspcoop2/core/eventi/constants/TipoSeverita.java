...
/**     
 * Enumeration dell'elemento TipoSeverita xsd (tipo:string) 
 *
 * @author Poli Andrea (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
@jakarta.xml.bind.annotation.XmlType(name = "TipoSeverita")
@jakarta.xml.bind.annotation.XmlEnum(String.class)
public enum TipoSeverita implements IEnumeration , Serializable , Cloneable {

	@jakarta.xml.bind.annotation.XmlEnumValue("DEBUG")
	DEBUG ("DEBUG"),
	@jakarta.xml.bind.annotation.XmlEnumValue("INFO")
	INFO ("INFO"),
	@jakarta.xml.bind.annotation.XmlEnumValue("ERROR")
	ERROR ("ERROR"),
	@jakarta.xml.bind.annotation.XmlEnumValue("WARN")
	WARN ("WARN"),
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof TipoSeverita) ){
	...
	public static TipoSeverita toEnumConstant(String value){
		try{
	...
	public static TipoSeverita toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		TipoSeverita res = null;
		for (TipoSeverita tmp : values()) {

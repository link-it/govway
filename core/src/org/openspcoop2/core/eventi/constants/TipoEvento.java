...
/**     
 * Enumeration dell'elemento TipoEvento xsd (tipo:string) 
 *
...
public enum TipoEvento implements IEnumeration , Serializable , Cloneable {
	...
	@javax.xml.bind.annotation.XmlEnumValue("ControlloTraffico_ConnectionTimeout")
	CONTROLLO_TRAFFICO_CONNECTION_TIMEOUT ("ControlloTraffico_ConnectionTimeout"),
	@javax.xml.bind.annotation.XmlEnumValue("ControlloTraffico_RequestReadTimeout")
	CONTROLLO_TRAFFICO_REQUEST_READ_TIMEOUT ("ControlloTraffico_RequestReadTimeout"),
	@javax.xml.bind.annotation.XmlEnumValue("ControlloTraffico_ReadTimeout")
	...
	public static TipoEvento toEnumConstant(String value){
		try{
	...
	public static TipoEvento toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		TipoEvento res = null;
		for (TipoEvento tmp : values()) {

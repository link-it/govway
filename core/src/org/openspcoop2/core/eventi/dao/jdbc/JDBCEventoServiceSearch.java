...
import org.openspcoop2.core.eventi.dao.jdbc.JDBCLimitedServiceManager;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.core.eventi.Evento} 
 *
...
public class JDBCEventoServiceSearch implements IDBEventoServiceSearch, IDBServiceUtilities<Evento> {
	...
	public JDBCEventoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.core.eventi.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("evento");
	...
	public void validate(Evento evento) throws ServiceException,
		...
		org.openspcoop2.generic_project.utils.XSDValidator.validate(evento, this.log, 
				org.openspcoop2.core.eventi.utils.XSDValidator.getXSDValidator(this.log));
	}

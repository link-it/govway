...
/**     
 * Enumeration dell'elemento export-state xsd (tipo:string) 
 *
...
public enum ExportState implements IEnumeration , Serializable , Cloneable {
	...
	public boolean equals(ExportState object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof ExportState) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((ExportState)object));
	}
	...
	public static ExportState toEnumConstant(String value){
		try{
	...
	public static ExportState toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		ExportState res = null;
		for (ExportState tmp : values()) {

...
public enum DeleteState implements IEnumeration , Serializable , Cloneable {
	...
	public boolean equals(DeleteState object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof DeleteState) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((DeleteState)object));
	}
	...
	public static DeleteState toEnumConstant(String value){
		try{
	...
	public static DeleteState toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		DeleteState res = null;
		for (DeleteState tmp : values()) {

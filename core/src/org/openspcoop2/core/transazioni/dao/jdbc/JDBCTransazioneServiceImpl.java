...
public class JDBCTransazioneServiceImpl extends JDBCTransazioneServiceSearchImpl
	...
	public void create(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, Transazione transazione, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotImplementedException,ServiceException,Exception {
		...
		listaJDBCObject.add(new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(transazione.getDataIngressoRichiestaStream(),Transazione.model().DATA_INGRESSO_RICHIESTA_STREAM.getFieldType()) );
		...
		listaJDBCObject.add(new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(transazione.getDataUscitaRichiestaStream(),Transazione.model().DATA_USCITA_RICHIESTA_STREAM.getFieldType()) );
		...
		listaJDBCObject.add(new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(transazione.getDataIngressoRispostaStream(),Transazione.model().DATA_INGRESSO_RISPOSTA_STREAM.getFieldType()) );
		...
		listaJDBCObject.add(new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(transazione.getDataUscitaRispostaStream(),Transazione.model().DATA_USCITA_RISPOSTA_STREAM.getFieldType()) );

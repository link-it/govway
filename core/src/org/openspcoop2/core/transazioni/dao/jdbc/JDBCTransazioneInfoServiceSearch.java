 ...
 * @version $Rev$, $Date$
*/
public class JDBCTransazioneInfoServiceSearch implements ITransazioneInfoServiceSearch, IDBServiceUtilities<TransazioneInfo> {
	...
	public JDBCTransazioneInfoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCTransazioneInfoServiceSearch.class.getName()+ " initialized");

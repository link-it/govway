...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.openspcoop2.core.transazioni.Transazione} 
 *
...
public class JDBCTransazioneService extends JDBCTransazioneServiceSearch  implements ITransazioneService {


	private IJDBCServiceCRUDWithId<Transazione, String, JDBCServiceManager> serviceCRUD = null;
	public JDBCTransazioneService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		super(jdbcServiceManager);
		String msgInit = JDBCTransazioneService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+Transazione.class.getName()+") 'transazione' is null");
	}
	...
	@Override
	public void create(Transazione transazione) throws ServiceException, NotImplementedException {
		try{
			this.create(transazione, false, null);
	...
	@Override
	public void create(Transazione transazione, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
			this.create(transazione, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void create(Transazione transazione, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		this.create(transazione, validate, null);
	}
	
	@Override
	public void create(Transazione transazione, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,transazione,idMappingResolutionBehaviour);			
	...
	@Override
	public void update(String oldId, Transazione transazione) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(oldId, transazione, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(String oldId, Transazione transazione, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(oldId, transazione, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(String oldId, Transazione transazione, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		this.update(oldId, transazione, validate, null);
	}
		
	@Override
	public void update(String oldId, Transazione transazione, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,transazione,idMappingResolutionBehaviour);
	...
	@Override
	public void updateFields(String id, UpdateField ... updateFields) throws ServiceException, NotFoundException, NotImplementedException {
	...
	@Override
	public void updateFields(String id, IExpression condition, UpdateField ... updateFields) throws ServiceException, NotFoundException, NotImplementedException {
	...
	@Override
	public void updateFields(String id, UpdateModel ... updateModels) throws ServiceException, NotFoundException, NotImplementedException {
	...
	@Override
	public void updateOrCreate(String oldId, Transazione transazione) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(oldId, transazione, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(String oldId, Transazione transazione, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(oldId, transazione, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(String oldId, Transazione transazione, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		this.updateOrCreate(oldId, transazione, validate, null);
	}

	@Override
	public void updateOrCreate(String oldId, Transazione transazione, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,transazione,idMappingResolutionBehaviour);
	...
	@Override
	public void delete(Transazione transazione) throws ServiceException,NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.delete(this.jdbcProperties,this.log,connection,sqlQueryObject,transazione);	
	...
	@Override
	public void deleteById(String id) throws ServiceException, NotImplementedException {

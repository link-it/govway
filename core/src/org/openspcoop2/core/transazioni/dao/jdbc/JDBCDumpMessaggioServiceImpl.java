...
public class JDBCDumpMessaggioServiceImpl extends JDBCDumpMessaggioServiceSearchImpl
	...
	public void create(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, DumpMessaggio dumpMessaggio, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotImplementedException,ServiceException,Exception {
		...
		sqlQueryObjectInsert.addInsertField(this.getDumpMessaggioFieldConverter().toColumn(DumpMessaggio.model().POST_PROCESS_CONTENT_TYPE,false),"?");
		...
		long id = jdbcUtilities.insertAndReturnGeneratedKey(sqlQueryObjectInsert, keyGenerator, jdbcProperties.isShowSql(),
			...
			new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(dumpMessaggio.getPostProcessContentType(),DumpMessaggio.model().POST_PROCESS_CONTENT_TYPE.getFieldType()),
		...
		for (int i = 0; i < dumpMessaggio.getAllegatoList().size(); i++) {
			...
			sqlQueryObjectInsert_allegato.addInsertField(this.getDumpMessaggioFieldConverter().toColumn(DumpMessaggio.model().ALLEGATO.ID_ALLEGATO,false),"?");
			sqlQueryObjectInsert_allegato.addInsertField(this.getDumpMessaggioFieldConverter().toColumn(DumpMessaggio.model().ALLEGATO.LOCATION,false),"?");
			sqlQueryObjectInsert_allegato.addInsertField(this.getDumpMessaggioFieldConverter().toColumn(DumpMessaggio.model().ALLEGATO.MIMETYPE,false),"?");
			...
			long id_allegato = jdbcUtilities.insertAndReturnGeneratedKey(sqlQueryObjectInsert_allegato, keyGenerator_allegato, jdbcProperties.isShowSql(),
				new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(dumpMessaggio.getAllegatoList().get(i).getIdAllegato(),DumpMessaggio.model().ALLEGATO.ID_ALLEGATO.getFieldType()),
				new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(dumpMessaggio.getAllegatoList().get(i).getLocation(),DumpMessaggio.model().ALLEGATO.LOCATION.getFieldType()),
				new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(dumpMessaggio.getAllegatoList().get(i).getMimetype(),DumpMessaggio.model().ALLEGATO.MIMETYPE.getFieldType()),
	...
	public void update(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, long tableId, DumpMessaggio dumpMessaggio, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotFoundException, NotImplementedException, ServiceException, Exception {
		...
		sqlQueryObjectUpdate.addUpdateField(this.getDumpMessaggioFieldConverter().toColumn(DumpMessaggio.model().POST_PROCESS_CONTENT_TYPE,false), "?");
		lstObjects_dumpMessaggio.add(new JDBCObject(dumpMessaggio.getPostProcessContentType(), DumpMessaggio.model().POST_PROCESS_CONTENT_TYPE.getFieldType()));
		...
		for (Object dumpMessaggio_allegato_object : dumpMessaggio.getAllegatoList()) {
			...
			if(dumpMessaggio_allegato.getId() == null || dumpMessaggio_allegato.getId().longValue() <= 0) {
				...
				sqlQueryObjectInsert_dumpMessaggio_allegato.addInsertField(this.getDumpMessaggioFieldConverter().toColumn(DumpMessaggio.model().ALLEGATO.ID_ALLEGATO,false),"?");
				sqlQueryObjectInsert_dumpMessaggio_allegato.addInsertField(this.getDumpMessaggioFieldConverter().toColumn(DumpMessaggio.model().ALLEGATO.LOCATION,false),"?");
				sqlQueryObjectInsert_dumpMessaggio_allegato.addInsertField(this.getDumpMessaggioFieldConverter().toColumn(DumpMessaggio.model().ALLEGATO.MIMETYPE,false),"?");
				...
				long id_dumpMessaggio_allegato = jdbcUtilities.insertAndReturnGeneratedKey(sqlQueryObjectInsert_dumpMessaggio_allegato, keyGenerator_dumpMessaggio_allegato, jdbcProperties.isShowSql(),
					new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(dumpMessaggio_allegato.getIdAllegato(),DumpMessaggio.model().ALLEGATO.ID_ALLEGATO.getFieldType()),
					new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(dumpMessaggio_allegato.getLocation(),DumpMessaggio.model().ALLEGATO.LOCATION.getFieldType()),
					new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(dumpMessaggio_allegato.getMimetype(),DumpMessaggio.model().ALLEGATO.MIMETYPE.getFieldType()),
				...
				sqlQueryObjectUpdate_dumpMessaggio_allegato.addUpdateField(this.getDumpMessaggioFieldConverter().toColumn(DumpMessaggio.model().ALLEGATO.ID_ALLEGATO,false), "?");
				lstObjects_dumpMessaggio_allegato.add(new JDBCObject(dumpMessaggio_allegato.getIdAllegato(), DumpMessaggio.model().ALLEGATO.ID_ALLEGATO.getFieldType()));
				sqlQueryObjectUpdate_dumpMessaggio_allegato.addUpdateField(this.getDumpMessaggioFieldConverter().toColumn(DumpMessaggio.model().ALLEGATO.LOCATION,false), "?");
				lstObjects_dumpMessaggio_allegato.add(new JDBCObject(dumpMessaggio_allegato.getLocation(), DumpMessaggio.model().ALLEGATO.LOCATION.getFieldType()));
				sqlQueryObjectUpdate_dumpMessaggio_allegato.addUpdateField(this.getDumpMessaggioFieldConverter().toColumn(DumpMessaggio.model().ALLEGATO.MIMETYPE,false), "?");
				lstObjects_dumpMessaggio_allegato.add(new JDBCObject(dumpMessaggio_allegato.getMimetype(), DumpMessaggio.model().ALLEGATO.MIMETYPE.getFieldType()));
				...
				ids_dumpMessaggio_allegato_da_non_eliminare.add(dumpMessaggio_allegato.getId());
				lstObjects_dumpMessaggio_allegato.add(new JDBCObject(new Long(dumpMessaggio_allegato.getId()),Long.class));
		...
		for (Object dumpMessaggio_contenuto_object : dumpMessaggio.getContenutoList()) {
			...
			if(dumpMessaggio_contenuto.getId() == null || dumpMessaggio_contenuto.getId().longValue() <= 0) {
				...
				ids_dumpMessaggio_contenuto_da_non_eliminare.add(dumpMessaggio_contenuto.getId());
				lstObjects_dumpMessaggio_contenuto.add(new JDBCObject(new Long(dumpMessaggio_contenuto.getId()),Long.class));
		...
		for (Object dumpMessaggio_headerTrasporto_object : dumpMessaggio.getHeaderTrasportoList()) {
			...
			if(dumpMessaggio_headerTrasporto.getId() == null || dumpMessaggio_headerTrasporto.getId().longValue() <= 0) {
				...
				ids_dumpMessaggio_headerTrasporto_da_non_eliminare.add(dumpMessaggio_headerTrasporto.getId());
				lstObjects_dumpMessaggio_headerTrasporto.add(new JDBCObject(new Long(dumpMessaggio_headerTrasporto.getId()),Long.class));
	...
	private void _delete(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, Long id) throws NotImplementedException,ServiceException,Exception {
		...
		for (Object dumpMessaggio_allegato_object : dumpMessaggio_allegato_toDelete_list) {
			...
			if(dumpMessaggio_allegato != null){
				...
				new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(new Long(dumpMessaggio_allegato.getId()),Long.class));
			}
		} // fine for dumpMessaggio_allegato
		...
		for (Object dumpMessaggio_contenuto_object : dumpMessaggio_contenuto_toDelete_list) {
			...
			if(dumpMessaggio_contenuto != null){
				...
				new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(new Long(dumpMessaggio_contenuto.getId()),Long.class));
			}
		} // fine for dumpMessaggio_contenuto
		...
		for (Object dumpMessaggio_headerTrasporto_object : dumpMessaggio_headerTrasporto_toDelete_list) {
			...
			if(dumpMessaggio_headerTrasporto != null){
				...
				new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(new Long(dumpMessaggio_headerTrasporto.getId()),Long.class));
			}
		} // fine for dumpMessaggio_headerTrasporto

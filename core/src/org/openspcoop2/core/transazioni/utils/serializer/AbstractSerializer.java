...
public abstract class AbstractSerializer {
	...
	*/
	...
	/**
	 * Serialize to file system in <var>fileName</var> the object <var>transazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.TransazioneLlm}
	 * 
	 * @param fileName Xml file to serialize the object <var>transazioneLlm</var>
	 * @param transazioneLlm Object to be serialized in xml file <var>fileName</var>
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public void write(String fileName,TransazioneLlm transazioneLlm) throws SerializerException {
		this.objToXml(fileName, TransazioneLlm.class, transazioneLlm, false);
	}
	/**
	 * Serialize to file system in <var>fileName</var> the object <var>transazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.TransazioneLlm}
	 * 
	 ...
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public void write(String fileName,TransazioneLlm transazioneLlm,boolean prettyPrint) throws SerializerException {
		this.objToXml(fileName, TransazioneLlm.class, transazioneLlm, prettyPrint);
	}
	
	/**
	 * Serialize to file system in <var>file</var> the object <var>transazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.TransazioneLlm}
	 * 
	 * @param file Xml file to serialize the object <var>transazioneLlm</var>
	 * @param transazioneLlm Object to be serialized in xml file <var>fileName</var>
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public void write(File file,TransazioneLlm transazioneLlm) throws SerializerException {
		this.objToXml(file, TransazioneLlm.class, transazioneLlm, false);
	}
	/**
	 * Serialize to file system in <var>file</var> the object <var>transazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.TransazioneLlm}
	 * 
	 ...
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public void write(File file,TransazioneLlm transazioneLlm,boolean prettyPrint) throws SerializerException {
		this.objToXml(file, TransazioneLlm.class, transazioneLlm, prettyPrint);
	}
	
	/**
	 * Serialize to output stream <var>out</var> the object <var>transazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.TransazioneLlm}
	 * 
	 * @param out OutputStream to serialize the object <var>transazioneLlm</var>
	 * @param transazioneLlm Object to be serialized in xml file <var>fileName</var>
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public void write(OutputStream out,TransazioneLlm transazioneLlm) throws SerializerException {
		this.objToXml(out, TransazioneLlm.class, transazioneLlm, false);
	}
	/**
	 * Serialize to output stream <var>out</var> the object <var>transazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.TransazioneLlm}
	 * 
	 ...
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public void write(OutputStream out,TransazioneLlm transazioneLlm,boolean prettyPrint) throws SerializerException {
		this.objToXml(out, TransazioneLlm.class, transazioneLlm, prettyPrint);
	}
			
	/**
	 * Serialize to byte array the object <var>transazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.TransazioneLlm}
	 * 
	 * @param transazioneLlm Object to be serialized
	 * @return Object to be serialized in byte array
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public byte[] toByteArray(TransazioneLlm transazioneLlm) throws SerializerException {
		return this.objToXml(TransazioneLlm.class, transazioneLlm, false).toByteArray();
	}
	/**
	 * Serialize to byte array the object <var>transazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.TransazioneLlm}
	 * 
	 ...
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public byte[] toByteArray(TransazioneLlm transazioneLlm,boolean prettyPrint) throws SerializerException {
		return this.objToXml(TransazioneLlm.class, transazioneLlm, prettyPrint).toByteArray();
	}
	
	/**
	 * Serialize to String the object <var>transazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.TransazioneLlm}
	 * 
	 * @param transazioneLlm Object to be serialized
	 * @return Object to be serialized as String
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public String toString(TransazioneLlm transazioneLlm) throws SerializerException {
		return this.objToXml(TransazioneLlm.class, transazioneLlm, false).toString();
	}
	/**
	 * Serialize to String the object <var>transazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.TransazioneLlm}
	 * 
	 ...
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public String toString(TransazioneLlm transazioneLlm,boolean prettyPrint) throws SerializerException {
		return this.objToXml(TransazioneLlm.class, transazioneLlm, prettyPrint).toString();
	}
	...
	*/
	...
	/**
	 * Serialize to file system in <var>fileName</var> the object <var>idTransazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.IdTransazioneLlm}
	 * 
	 * @param fileName Xml file to serialize the object <var>idTransazioneLlm</var>
	 * @param idTransazioneLlm Object to be serialized in xml file <var>fileName</var>
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public void write(String fileName,IdTransazioneLlm idTransazioneLlm) throws SerializerException {
		this.objToXml(fileName, IdTransazioneLlm.class, idTransazioneLlm, false);
	}
	/**
	 * Serialize to file system in <var>fileName</var> the object <var>idTransazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.IdTransazioneLlm}
	 * 
	 ...
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public void write(String fileName,IdTransazioneLlm idTransazioneLlm,boolean prettyPrint) throws SerializerException {
		this.objToXml(fileName, IdTransazioneLlm.class, idTransazioneLlm, prettyPrint);
	}
	
	/**
	 * Serialize to file system in <var>file</var> the object <var>idTransazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.IdTransazioneLlm}
	 * 
	 * @param file Xml file to serialize the object <var>idTransazioneLlm</var>
	 * @param idTransazioneLlm Object to be serialized in xml file <var>fileName</var>
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public void write(File file,IdTransazioneLlm idTransazioneLlm) throws SerializerException {
		this.objToXml(file, IdTransazioneLlm.class, idTransazioneLlm, false);
	}
	/**
	 * Serialize to file system in <var>file</var> the object <var>idTransazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.IdTransazioneLlm}
	 * 
	 ...
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public void write(File file,IdTransazioneLlm idTransazioneLlm,boolean prettyPrint) throws SerializerException {
		this.objToXml(file, IdTransazioneLlm.class, idTransazioneLlm, prettyPrint);
	}
	
	/**
	 * Serialize to output stream <var>out</var> the object <var>idTransazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.IdTransazioneLlm}
	 * 
	 * @param out OutputStream to serialize the object <var>idTransazioneLlm</var>
	 * @param idTransazioneLlm Object to be serialized in xml file <var>fileName</var>
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public void write(OutputStream out,IdTransazioneLlm idTransazioneLlm) throws SerializerException {
		this.objToXml(out, IdTransazioneLlm.class, idTransazioneLlm, false);
	}
	/**
	 * Serialize to output stream <var>out</var> the object <var>idTransazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.IdTransazioneLlm}
	 * 
	 ...
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public void write(OutputStream out,IdTransazioneLlm idTransazioneLlm,boolean prettyPrint) throws SerializerException {
		this.objToXml(out, IdTransazioneLlm.class, idTransazioneLlm, prettyPrint);
	}
			
	/**
	 * Serialize to byte array the object <var>idTransazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.IdTransazioneLlm}
	 * 
	 * @param idTransazioneLlm Object to be serialized
	 * @return Object to be serialized in byte array
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public byte[] toByteArray(IdTransazioneLlm idTransazioneLlm) throws SerializerException {
		return this.objToXml(IdTransazioneLlm.class, idTransazioneLlm, false).toByteArray();
	}
	/**
	 * Serialize to byte array the object <var>idTransazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.IdTransazioneLlm}
	 * 
	 ...
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public byte[] toByteArray(IdTransazioneLlm idTransazioneLlm,boolean prettyPrint) throws SerializerException {
		return this.objToXml(IdTransazioneLlm.class, idTransazioneLlm, prettyPrint).toByteArray();
	}
	
	/**
	 * Serialize to String the object <var>idTransazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.IdTransazioneLlm}
	 * 
	 * @param idTransazioneLlm Object to be serialized
	 * @return Object to be serialized as String
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public String toString(IdTransazioneLlm idTransazioneLlm) throws SerializerException {
		return this.objToXml(IdTransazioneLlm.class, idTransazioneLlm, false).toString();
	}
	/**
	 * Serialize to String the object <var>idTransazioneLlm</var> of type {@link org.openspcoop2.core.transazioni.IdTransazioneLlm}
	 * 
	 ...
	 * @throws SerializerException The exception that is thrown when an error occurs during serialization
	 */
	public String toString(IdTransazioneLlm idTransazioneLlm,boolean prettyPrint) throws SerializerException {
		return this.objToXml(IdTransazioneLlm.class, idTransazioneLlm, prettyPrint).toString();
	}

 ...
 * @version $Rev$, $Date$
 */
public class CredenzialeTokenPDND extends AbstractCredenziale {

	private String credential;
	
	public CredenzialeTokenPDND(TipoCredenzialeMittente tipo, String credential, Long referenceId) {
		super(tipo, referenceId);

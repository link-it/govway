...
public class DumpMessaggioModel extends AbstractModel<DumpMessaggio> {
	...
	public DumpMessaggioModel(){
		...
		this.POST_PROCESS_CONTENT_TYPE = new Field("post-process-content-type",java.lang.String.class,"dump-messaggio",DumpMessaggio.class);
	...
	public DumpMessaggioModel(IField father){
		...
		this.POST_PROCESS_CONTENT_TYPE = new ComplexField(father,"post-process-content-type",java.lang.String.class,"dump-messaggio",DumpMessaggio.class);
	...
	public IField POST_PROCESS_CONTENT_TYPE = null;

...
/**     
 * Enumeration dell'elemento pdnd-methods xsd (tipo:string) 
 *
 ...
 * @version $Rev$, $Date$
 */
@jakarta.xml.bind.annotation.XmlType(name = "pdnd-methods")
@jakarta.xml.bind.annotation.XmlEnum(String.class)
public enum PdndMethods implements IEnumeration , Serializable , Cloneable {

	@jakarta.xml.bind.annotation.XmlEnumValue("REPLACE")
	REPLACE ("REPLACE"),
	@jakarta.xml.bind.annotation.XmlEnumValue("RECOVER")
	RECOVER ("RECOVER"),
	@jakarta.xml.bind.annotation.XmlEnumValue("SUBMIT")
	SUBMIT ("SUBMIT");
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof PdndMethods) ){
	...
	public static PdndMethods toEnumConstant(String value){
		try{
	...
	public static PdndMethods toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		PdndMethods res = null;
		for (PdndMethods tmp : values()) {

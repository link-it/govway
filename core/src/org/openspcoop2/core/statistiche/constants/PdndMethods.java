 ...
 * @version $Rev$, $Date$
 */
@javax.xml.bind.annotation.XmlType(name = "pdnd-methods")
@javax.xml.bind.annotation.XmlEnum(String.class)
public enum PdndMethods implements IEnumeration , Serializable , Cloneable {

	@javax.xml.bind.annotation.XmlEnumValue("REPLACE")
	REPLACE ("REPLACE"),
	@javax.xml.bind.annotation.XmlEnumValue("RECOVER")
	RECOVER ("RECOVER"),
	@javax.xml.bind.annotation.XmlEnumValue("SUBMIT")
	SUBMIT ("SUBMIT");

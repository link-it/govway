...
/**     
 * Enumeration dell'elemento possibili-stati-pdnd xsd (tipo:string) 
 *
 ...
 * @version $Rev$, $Date$
 */
@jakarta.xml.bind.annotation.XmlType(name = "possibili-stati-pdnd")
@jakarta.xml.bind.annotation.XmlEnum(String.class)
public enum PossibiliStatiPdnd implements IEnumeration , Serializable , Cloneable {

	@jakarta.xml.bind.annotation.XmlEnumValue("WAITING")
	WAITING ("WAITING"),
	@jakarta.xml.bind.annotation.XmlEnumValue("PENDING")
	PENDING ("PENDING"),
	...
	PossibiliStatiPdnd(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof PossibiliStatiPdnd) ){
	...
	public static String[] toArray(){
		...
		int i=0;
		for (PossibiliStatiPdnd tmp : values()) {
			res[i]=tmp.getValue();
			i++;
		}
		return res;
	...
	public static PossibiliStatiPdnd toEnumConstant(String value){
		try{
	...
	public static PossibiliStatiPdnd toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		PossibiliStatiPdnd res = null;
		for (PossibiliStatiPdnd tmp : values()) {

...
/**     
 * Enumeration dell'elemento possibili-stati-richieste xsd (tipo:string) 
 *
 ...
 * @version $Rev$, $Date$
 */
@jakarta.xml.bind.annotation.XmlType(name = "possibili-stati-richieste")
@jakarta.xml.bind.annotation.XmlEnum(String.class)
public enum PossibiliStatiRichieste implements IEnumeration , Serializable , Cloneable {

	@jakarta.xml.bind.annotation.XmlEnumValue("PUBLISHED")
	PUBLISHED ("PUBLISHED"),
	@jakarta.xml.bind.annotation.XmlEnumValue("FAILED")
	FAILED ("FAILED");
	...
	PossibiliStatiRichieste(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof PossibiliStatiRichieste) ){
	...
	public static String[] toArray(){
		...
		int i=0;
		for (PossibiliStatiRichieste tmp : values()) {
			res[i]=tmp.getValue();
			i++;
		}
		return res;
	...
	public static PossibiliStatiRichieste toEnumConstant(String value){
		try{
	...
	public static PossibiliStatiRichieste toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		PossibiliStatiRichieste res = null;
		for (PossibiliStatiRichieste tmp : values()) {

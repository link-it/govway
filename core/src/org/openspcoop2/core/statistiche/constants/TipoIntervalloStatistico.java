...
public enum TipoIntervalloStatistico implements IEnumeration , Serializable , Cloneable {
	...
	@jakarta.xml.bind.annotation.XmlEnumValue("PdndGenerazioneTracciamento")
	PDND_GENERAZIONE_TRACCIAMENTO ("PdndGenerazioneTracciamento"),
	@jakarta.xml.bind.annotation.XmlEnumValue("PdndPubblicazioneTracciamento")
	...
	TipoIntervalloStatistico(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof TipoIntervalloStatistico) ){
	...
	public static String[] toArray(){
		...
		int i=0;
		for (TipoIntervalloStatistico tmp : values()) {
			res[i]=tmp.getValue();
			i++;
		}
		return res;
	...
	public static TipoIntervalloStatistico toEnumConstant(String value){
		try{
	...
	public static TipoIntervalloStatistico toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		TipoIntervalloStatistico res = null;
		for (TipoIntervalloStatistico tmp : values()) {

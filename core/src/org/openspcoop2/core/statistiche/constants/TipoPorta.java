...
public enum TipoPorta implements IEnumeration , Serializable , Cloneable {
	...
	public boolean equals(TipoPorta object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof TipoPorta) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((TipoPorta)object));
	}
	...
	public static TipoPorta toEnumConstant(String value){
		try{
	...
	public static TipoPorta toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		TipoPorta res = null;
		for (TipoPorta tmp : values()) {

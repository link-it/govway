...
public class StatisticaMensileFieldConverter extends AbstractSQLFieldConverter {
	...
	public String toColumn(IField field,boolean returnAlias,boolean appendTablePrefix) throws ExpressionException {
		...
		if(field.equals(StatisticaMensile.model().STATISTICA_BASE.TRASPORTO_MITTENTE)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaMensile.model().STATISTICA_BASE.TOKEN_ISSUER)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaMensile.model().STATISTICA_BASE.TOKEN_CLIENT_ID)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaMensile.model().STATISTICA_BASE.TOKEN_SUBJECT)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaMensile.model().STATISTICA_BASE.TOKEN_USERNAME)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaMensile.model().STATISTICA_BASE.TOKEN_MAIL)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaMensile.model().STATISTICA_BASE.CLIENT_ADDRESS)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaMensile.model().STATISTICA_BASE.GRUPPI)){
			if(appendTablePrefix){

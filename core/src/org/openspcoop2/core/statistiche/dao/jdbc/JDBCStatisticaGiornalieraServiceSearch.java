...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.core.statistiche.StatisticaGiornaliera} 
 *
 * @author Poli Andrea (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
*/
public class JDBCStatisticaGiornalieraServiceSearch implements IDBStatisticaGiornalieraServiceSearch, IDBServiceUtilities<StatisticaGiornaliera> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithoutId<StatisticaGiornaliera, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCStatisticaGiornalieraServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
	...
	@Override
	public void validate(StatisticaGiornaliera statisticaGiornaliera) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(statisticaGiornaliera, this.log, 
	...
	@Override
	public List<StatisticaGiornaliera> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<StatisticaGiornaliera> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public StatisticaGiornaliera find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public StatisticaGiornaliera find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public StatisticaGiornaliera get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public StatisticaGiornaliera get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {

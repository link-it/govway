...
public class JDBCStatisticaOrariaService extends JDBCStatisticaOrariaServiceSearch  implements IDBStatisticaOrariaService {
	...
	public JDBCStatisticaOrariaService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCStatisticaOrariaService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+StatisticaOraria.class.getName()+") 'statisticaOraria' is null");
	}

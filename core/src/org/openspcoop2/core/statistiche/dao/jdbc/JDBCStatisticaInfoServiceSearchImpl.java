...
public class JDBCStatisticaInfoServiceSearchImpl implements IJDBCServiceSearchWithoutId<StatisticaInfo, JDBCServiceManager> {
	...
	protected java.util.List<Object> getRootTablePrimaryKeyValuesEngine(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, StatisticaInfo statisticaInfo) throws NotFoundException, ServiceException, NotImplementedException, Exception{
	    // Identificativi

...
/**     
 * StatisticaGiornalieraFieldConverter
 *
 * @author Poli Andrea (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public class StatisticaGiornalieraFieldConverter extends AbstractSQLFieldConverter {

	private TipiDatabase databaseType;
	
	public StatisticaGiornalieraFieldConverter(String databaseType){
		this.databaseType = TipiDatabase.toEnumConstant(databaseType);
	}
	public StatisticaGiornalieraFieldConverter(TipiDatabase databaseType){
	...
	public IModel<?> getRootModel() throws ExpressionException {
		return StatisticaGiornaliera.model();
	}
	...
	public String toColumn(IField field,boolean returnAlias,boolean appendTablePrefix) throws ExpressionException {
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_BASE.TIPO_PORTA)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_BASE.TIPO_MITTENTE)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_BASE.MITTENTE)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_BASE.TIPO_DESTINATARIO)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_BASE.DESTINATARIO)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_BASE.TIPO_SERVIZIO)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_BASE.SERVIZIO)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_BASE.VERSIONE_SERVIZIO)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_BASE.AZIONE)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_BASE.DIMENSIONI_BYTES_BANDA_COMPLESSIVA)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_BASE.DIMENSIONI_BYTES_BANDA_INTERNA)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_BASE.DIMENSIONI_BYTES_BANDA_ESTERNA)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_BASE.LATENZA_TOTALE)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_BASE.LATENZA_PORTA)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_BASE.LATENZA_SERVIZIO)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.DATA)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".data";
			}else{
				return "data";
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.RISORSA_NOME)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.RISORSA_VALORE)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_NOME_1)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_VALORE_1)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_NOME_2)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_VALORE_2)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_NOME_3)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_VALORE_3)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_NOME_4)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_VALORE_4)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_NOME_5)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_VALORE_5)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_NOME_6)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_VALORE_6)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_NOME_7)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_VALORE_7)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_NOME_8)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_VALORE_8)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_NOME_9)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_VALORE_9)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_NOME_10)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.FILTRO_VALORE_10)){
			if(appendTablePrefix){
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.NUMERO_TRANSAZIONI)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".richieste";
			}else{
				return "richieste";
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.DIMENSIONI_BYTES_BANDA_COMPLESSIVA)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".bytes_banda_complessiva";
			}else{
				return "bytes_banda_complessiva";
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.DIMENSIONI_BYTES_BANDA_INTERNA)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".bytes_banda_interna";
			}else{
				return "bytes_banda_interna";
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.DIMENSIONI_BYTES_BANDA_ESTERNA)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".bytes_banda_esterna";
			}else{
				return "bytes_banda_esterna";
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.LATENZA_TOTALE)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".latenza_totale";
			}else{
				return "latenza_totale";
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_CONTENUTI.LATENZA_PORTA)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".latenza_porta";
			}else{
				return "latenza_porta";
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_LLM.NUMERO_TRANSAZIONI)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".richieste";
			}else{
				return "richieste";
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_LLM.DIMENSIONI_BYTES_BANDA_COMPLESSIVA)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".bytes_banda_complessiva";
			}else{
				return "bytes_banda_complessiva";
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_LLM.DIMENSIONI_BYTES_BANDA_INTERNA)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".bytes_banda_interna";
			}else{
				return "bytes_banda_interna";
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_LLM.DIMENSIONI_BYTES_BANDA_ESTERNA)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".bytes_banda_esterna";
			}else{
				return "bytes_banda_esterna";
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_LLM.LATENZA_TOTALE)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".latenza_totale";
			}else{
				return "latenza_totale";
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_LLM.LATENZA_PORTA)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".latenza_porta";
			}else{
				return "latenza_porta";
		...
		if(field.equals(StatisticaGiornaliera.model().STATISTICA_GIORNALIERA_LLM.LATENZA_SERVIZIO)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".latenza_servizio";
			}else{
				return "latenza_servizio";

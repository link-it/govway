...
public class StatistichePdndTracingFetch extends AbstractJDBCFetch {
	...
	public IKeyGeneratorObject getKeyGeneratorObject( IModel<?> model )  throws ServiceException {
		...
		try{
			...
			if(model.equals(StatistichePdndTracing.model())){
				return new org.openspcoop2.utils.jdbc.CustomKeyGeneratorObject("statistiche_pdnd_tracing","id","seq_statistiche_pdnd_tracing","statistiche_pdnd_tracing_init_seq");
			}

...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.core.statistiche.StatistichePdndTracing} 
 *
 ...
 * @version $Rev$, $Date$
*/
public class JDBCStatistichePdndTracingServiceSearch implements IDBStatistichePdndTracingServiceSearch, IDBServiceUtilities<StatistichePdndTracing> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithoutId<StatistichePdndTracing, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCStatistichePdndTracingServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCStatistichePdndTracingServiceSearch.class.getName()+ " initialized";
		this.log.debug(msgInit);
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.core.statistiche.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("statistichePdndTracing");
	...
	@Override
	public void validate(StatistichePdndTracing statistichePdndTracing) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(statistichePdndTracing, this.log, 
	...
	@Override
	public List<StatistichePdndTracing> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<StatistichePdndTracing> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public StatistichePdndTracing find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public StatistichePdndTracing find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public StatistichePdndTracing get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public StatistichePdndTracing get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public JDBCStream getCsvInputStream(long tableId) throws NotFoundException, ServiceException {

...
public class JDBCStatisticaSettimanaleServiceImpl extends JDBCStatisticaSettimanaleServiceSearchImpl
	...
	public void create(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, StatisticaSettimanale statisticaSettimanale, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotImplementedException,ServiceException,Exception {
		...
		sqlQueryObjectInsert.addInsertField(this.getStatisticaSettimanaleFieldConverter().toColumn(StatisticaSettimanale.model().STATISTICA_BASE.STATO_RECORD,false),"?");
		...
		sqlQueryObjectInsert.addInsertField(this.getStatisticaSettimanaleFieldConverter().toColumn(StatisticaSettimanale.model().STATISTICA_BASE.URI_API,false),"?");
		sqlQueryObjectInsert.addInsertField(this.getStatisticaSettimanaleFieldConverter().toColumn(StatisticaSettimanale.model().STATISTICA_BASE.CLUSTER_ID,false),"?");
		...
		long id = jdbcUtilities.insertAndReturnGeneratedKey(sqlQueryObjectInsert, keyGenerator, jdbcProperties.isShowSql(),
			...
			new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(statisticaSettimanale.getStatisticaBase().getStatoRecord(),StatisticaSettimanale.model().STATISTICA_BASE.STATO_RECORD.getFieldType()),
			...
			new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(statisticaSettimanale.getStatisticaBase().getUriApi(),StatisticaSettimanale.model().STATISTICA_BASE.URI_API.getFieldType()),
			new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(statisticaSettimanale.getStatisticaBase().getClusterId(),StatisticaSettimanale.model().STATISTICA_BASE.CLUSTER_ID.getFieldType()),
	...
	public void update(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, long tableId, StatisticaSettimanale statisticaSettimanale, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotFoundException, NotImplementedException, ServiceException, Exception {
		...
		lstObjects.add(new JDBCObject(statisticaSettimanale_statisticaBase.getStatoRecord(), StatisticaSettimanale.model().STATISTICA_BASE.STATO_RECORD.getFieldType()));
		...
		sqlQueryObjectUpdate.addUpdateField(this.getStatisticaSettimanaleFieldConverter().toColumn(StatisticaSettimanale.model().STATISTICA_BASE.URI_API,false), "?");
		lstObjects.add(new JDBCObject(statisticaSettimanale_statisticaBase.getUriApi(), StatisticaSettimanale.model().STATISTICA_BASE.URI_API.getFieldType()));
		sqlQueryObjectUpdate.addUpdateField(this.getStatisticaSettimanaleFieldConverter().toColumn(StatisticaSettimanale.model().STATISTICA_BASE.CLUSTER_ID,false), "?");
		lstObjects.add(new JDBCObject(statisticaSettimanale_statisticaBase.getClusterId(), StatisticaSettimanale.model().STATISTICA_BASE.CLUSTER_ID.getFieldType()));
		...
		ISQLQueryObject sqlQueryObjectUpdate_statisticaSettimanaleContenutideleteEngineList = sqlQueryObjectUpdate.newSQLQueryObject();
		sqlQueryObjectUpdate_statisticaSettimanaleContenutideleteEngineList.setANDLogicOperator(true);
		sqlQueryObjectUpdate_statisticaSettimanaleContenutideleteEngineList.addDeleteTable(this.getStatisticaSettimanaleFieldConverter().toTable(StatisticaSettimanale.model().STATISTICA_SETTIMANALE_CONTENUTI));
		java.util.List<JDBCObject> jdbcObjects_statisticaSettimanaleContenutideleteEngine = new java.util.ArrayList<>();

		sqlQueryObjectUpdate_statisticaSettimanaleContenutideleteEngineList.addWhereCondition("id_stat=?");
		jdbcObjects_statisticaSettimanaleContenutideleteEngine.add(new JDBCObject(statisticaSettimanale.getId(), Long.class));
		...
		if(ids_statisticaSettimanaleContenuti_da_non_eliminare.size() > 0) {
			for(Long ids : ids_statisticaSettimanaleContenuti_da_non_eliminare) {
				...
				marks_statisticaSettimanaleContenuti.append("?");
				jdbcObjects_statisticaSettimanaleContenutideleteEngine.add(new JDBCObject(ids, Long.class));

			}
			sqlQueryObjectUpdate_statisticaSettimanaleContenutideleteEngineList.addWhereCondition("id NOT IN ("+marks_statisticaSettimanaleContenuti.toString()+")");
		}

		jdbcUtilities.execute(sqlQueryObjectUpdate_statisticaSettimanaleContenutideleteEngineList.createSQLDelete(), jdbcProperties.isShowSql(), jdbcObjects_statisticaSettimanaleContenutideleteEngine.toArray(new JDBCObject[]{}));
	...
	public void updateFields(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, StatisticaSettimanale statisticaSettimanale, UpdateField ... updateFields) throws NotFoundException, NotImplementedException, ServiceException, Exception {
		...
		GenericJDBCUtilities.updateFields(jdbcProperties, log, connection, sqlQueryObject, 
				...
				this.getRootTablePrimaryKeyValuesEngine(jdbcProperties, log, connection, sqlQueryObject, statisticaSettimanale),
	...
	private void deleteEngine(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, Long id) throws NotImplementedException,ServiceException,Exception {
		...
		ISQLQueryObject sqlQueryObjectDelete_statisticaSettimanaleContenutigetEngineToDelete = sqlQueryObjectDelete.newSQLQueryObject();
		sqlQueryObjectDelete_statisticaSettimanaleContenutigetEngineToDelete.setANDLogicOperator(true);
		sqlQueryObjectDelete_statisticaSettimanaleContenutigetEngineToDelete.addFromTable(this.getStatisticaSettimanaleFieldConverter().toTable(StatisticaSettimanale.model().STATISTICA_SETTIMANALE_CONTENUTI));
		sqlQueryObjectDelete_statisticaSettimanaleContenutigetEngineToDelete.addWhereCondition("id_stat=?");
		java.util.List<Object> statisticaSettimanale_statisticaSettimanaleContenuti_toDelete_list = jdbcUtilities.executeQuery(sqlQueryObjectDelete_statisticaSettimanaleContenutigetEngineToDelete.createSQLQuery(), jdbcProperties.isShowSql(), StatisticaSettimanale.model().STATISTICA_SETTIMANALE_CONTENUTI, this.getStatisticaSettimanaleFetch(),

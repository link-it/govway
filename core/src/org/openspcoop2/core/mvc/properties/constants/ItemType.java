...
/**     
 * Enumeration dell'elemento itemType xsd (tipo:string) 
 *
...
public enum ItemType implements IEnumeration , Serializable , Cloneable {
	...
	NUMBER ("number"),
	@jakarta.xml.bind.annotation.XmlEnumValue("lock")
	LOCK ("lock"),
	@jakarta.xml.bind.annotation.XmlEnumValue("lock_hidden")
	...
	public static ItemType toEnumConstant(String value){
		try{
	...
	public static ItemType toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		ItemType res = null;
		for (ItemType tmp : values()) {

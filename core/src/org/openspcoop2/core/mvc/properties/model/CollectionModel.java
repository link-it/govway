...
public class CollectionModel extends AbstractModel<Collection> {
	...
	public CollectionModel(){
		...
		this.NAME = new Field("name",java.lang.String.class,"collection",Collection.class);
	...
	public CollectionModel(IField father){
		...
		this.NAME = new ComplexField(father,"name",java.lang.String.class,"collection",Collection.class);

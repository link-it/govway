...
import org.openspcoop2.core.controllo_congestione.dao.jdbc.JDBCLimitedServiceManager;
...
import org.openspcoop2.core.controllo_congestione.utils.ProjectInfo;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.core.controllo_congestione.ConfigurazionePolicy} 
 *
 * @author Poli Andrea (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
*/
public class JDBCConfigurazionePolicyServiceSearch implements IDBConfigurazionePolicyServiceSearch, IDBServiceUtilities<ConfigurazionePolicy> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<ConfigurazionePolicy, IdPolicy, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCConfigurazionePolicyServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCConfigurazionePolicyServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.core.controllo_congestione.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("configurazionePolicy");
	...
	@Override
	public void validate(ConfigurazionePolicy configurazionePolicy) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(configurazionePolicy, this.log, 
				org.openspcoop2.core.controllo_congestione.utils.XSDValidator.getXSDValidator(this.log));
	}
	...
	@Override
	public IdPolicy convertToId(ConfigurazionePolicy obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+ConfigurazionePolicy.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public ConfigurazionePolicy get(IdPolicy id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(id==null){
				throw new Exception("Parameter (type:"+IdPolicy.class.getName()+") 'id' is null");
			}
	...
	@Override
	public ConfigurazionePolicy get(IdPolicy id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdPolicy id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdPolicy> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<IdPolicy> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<ConfigurazionePolicy> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<ConfigurazionePolicy> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public ConfigurazionePolicy find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public ConfigurazionePolicy find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdPolicy id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdPolicy id, ConfigurazionePolicy obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, ConfigurazionePolicy obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
			
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdPolicy.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+ConfigurazionePolicy.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public ConfigurazionePolicy get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public ConfigurazionePolicy get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdPolicy findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdPolicy id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {

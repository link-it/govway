...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.core.controllo_congestione.AttivazionePolicy} 
 *
...
public class JDBCAttivazionePolicyServiceSearch implements IDBAttivazionePolicyServiceSearch, IDBServiceUtilities<AttivazionePolicy> {
	...
	public JDBCAttivazionePolicyServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.core.controllo_congestione.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("attivazionePolicy");

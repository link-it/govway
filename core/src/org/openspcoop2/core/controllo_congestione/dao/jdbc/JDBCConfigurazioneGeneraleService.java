...
import org.openspcoop2.core.controllo_congestione.dao.IDBConfigurazioneGeneraleService;
...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.openspcoop2.core.controllo_congestione.ConfigurazioneGenerale} 
 *
...
public class JDBCConfigurazioneGeneraleService extends JDBCConfigurazioneGeneraleServiceSearch  implements IDBConfigurazioneGeneraleService {
	...
	public JDBCConfigurazioneGeneraleService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.serviceCRUD = JDBCProperties.getInstance(org.openspcoop2.core.controllo_congestione.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceCRUD("configurazioneGenerale");

...
import org.openspcoop2.core.controllo_congestione.dao.IDBAttivazionePolicyService;
...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.openspcoop2.core.controllo_congestione.AttivazionePolicy} 
 *
...
public class JDBCAttivazionePolicyService extends JDBCAttivazionePolicyServiceSearch  implements IDBAttivazionePolicyService {
	...
	public JDBCAttivazionePolicyService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.serviceCRUD = JDBCProperties.getInstance(org.openspcoop2.core.controllo_congestione.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceCRUD("attivazionePolicy");

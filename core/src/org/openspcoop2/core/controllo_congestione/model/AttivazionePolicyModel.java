...
public class AttivazionePolicyModel extends AbstractModel<AttivazionePolicy> {
	...
	public AttivazionePolicyModel(){
		...
		this.FILTRO = new org.openspcoop2.core.controllo_congestione.model.AttivazionePolicyFiltroModel(new Field("filtro",org.openspcoop2.core.controllo_congestione.AttivazionePolicyFiltro.class,"attivazione-policy",AttivazionePolicy.class));
		this.GROUP_BY = new org.openspcoop2.core.controllo_congestione.model.AttivazionePolicyRaggruppamentoModel(new Field("group-by",org.openspcoop2.core.controllo_congestione.AttivazionePolicyRaggruppamento.class,"attivazione-policy",AttivazionePolicy.class));
	...
	public AttivazionePolicyModel(IField father){
		...
		this.FILTRO = new org.openspcoop2.core.controllo_congestione.model.AttivazionePolicyFiltroModel(new ComplexField(father,"filtro",org.openspcoop2.core.controllo_congestione.AttivazionePolicyFiltro.class,"attivazione-policy",AttivazionePolicy.class));
		this.GROUP_BY = new org.openspcoop2.core.controllo_congestione.model.AttivazionePolicyRaggruppamentoModel(new ComplexField(father,"group-by",org.openspcoop2.core.controllo_congestione.AttivazionePolicyRaggruppamento.class,"attivazione-policy",AttivazionePolicy.class));
	...
	public org.openspcoop2.core.controllo_congestione.model.AttivazionePolicyFiltroModel FILTRO = null;
	 
	public org.openspcoop2.core.controllo_congestione.model.AttivazionePolicyRaggruppamentoModel GROUP_BY = null;

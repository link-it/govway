...
/** <p>Java class for stato-servizi-pdd-porta-applicativa complex type.
 * 
...
@XmlType(name = "stato-servizi-pdd-porta-applicativa", 
  propOrder = {
  	"filtroAbilitazione",
...
@XmlRootElement(name = "stato-servizi-pdd-porta-applicativa")

public class StatoServiziPddPortaApplicativa extends org.openspcoop2.utils.beans.BaseBeanWithId implements Serializable , Cloneable {
  public StatoServiziPddPortaApplicativa() {
    super();
  }

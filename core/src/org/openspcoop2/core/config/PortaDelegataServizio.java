...
/** <p>Java class for porta-delegata-servizio complex type.
 * 
...
@XmlType(name = "porta-delegata-servizio")

@XmlRootElement(name = "porta-delegata-servizio")

public class PortaDelegataServizio extends org.openspcoop2.utils.beans.BaseBeanWithId implements Serializable , Cloneable {
  public PortaDelegataServizio() {
    super();
  }

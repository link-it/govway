...
/** <p>Java class for porta-delegata-autorizzazione-token complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="porta-delegata-autorizzazione-token"&gt;
 * 		&lt;sequence&gt;
 * 			&lt;element name="servizi-applicativi" type="{http://www.openspcoop2.org/core/config}porta-delegata-autorizzazione-servizi-applicativi" minOccurs="0" maxOccurs="1"/&gt;
...
@XmlType(name = "porta-delegata-autorizzazione-token", 
  propOrder = {
  	"serviziApplicativi",
  	"ruoli"
  }
...
@XmlRootElement(name = "porta-delegata-autorizzazione-token")

public class PortaDelegataAutorizzazioneToken extends org.openspcoop2.utils.beans.BaseBeanWithId implements Serializable , Cloneable {
  public PortaDelegataAutorizzazioneToken() {
    super();
  }

  public PortaDelegataAutorizzazioneServiziApplicativi getServiziApplicativi() {
    return this.serviziApplicativi;
  }

  public void setServiziApplicativi(PortaDelegataAutorizzazioneServiziApplicativi serviziApplicativi) {
  ...
  protected PortaDelegataAutorizzazioneServiziApplicativi serviziApplicativi;

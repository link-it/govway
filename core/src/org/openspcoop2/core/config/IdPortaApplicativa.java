...
public class IdPortaApplicativa extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  ...
  public IdPortaApplicativa(org.openspcoop2.core.id.IDPortaApplicativaByNome idPortaApplicativa){
  	if(idPortaApplicativa!=null){
  		this.nome = idPortaApplicativa.getNome();
  		if(idPortaApplicativa.getSoggetto()!=null){
  			this.idSoggetto = new IdSoggetto();
  			this.idSoggetto.setNome(idPortaApplicativa.getSoggetto().getNome());
  			this.idSoggetto.setTipo(idPortaApplicativa.getSoggetto().getTipo());
  		}
  	}
  }

  public org.openspcoop2.core.id.IDPortaApplicativaByNome toIDPortaApplicativa() throws org.openspcoop2.core.commons.CoreException{
  	if(this.nome==null){
  	...
  	org.openspcoop2.core.id.IDPortaApplicativaByNome idPA = new org.openspcoop2.core.id.IDPortaApplicativaByNome();
  	idPA.setNome(this.nome);
  	idPA.setSoggetto(this.idSoggetto.toIDSoggetto());
  	return idPA;
  }

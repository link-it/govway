 ...
 * @version $Rev$, $Date$
 */
@javax.xml.bind.annotation.XmlType(name = "InvocazioneServizioTipoAutenticazione")
@javax.xml.bind.annotation.XmlEnum(String.class)
public enum InvocazioneServizioTipoAutenticazione implements IEnumeration , Serializable , Cloneable {
	...
	InvocazioneServizioTipoAutenticazione(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof InvocazioneServizioTipoAutenticazione) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((InvocazioneServizioTipoAutenticazione)object));
	}

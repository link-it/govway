...
/**     
 * Enumeration dell'elemento FaseServiceHandler xsd (tipo:string) 
 *
...
public enum FaseServiceHandler implements IEnumeration , Serializable , Cloneable {
	...
	FaseServiceHandler(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(FaseServiceHandler object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof FaseServiceHandler) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((FaseServiceHandler)object));
	}
	...
	public static String[] toArray(){
		...
		int i=0;
		for (FaseServiceHandler tmp : values()) {
			res[i]=tmp.getValue();
			i++;
		}
		return res;
	...
	public static FaseServiceHandler toEnumConstant(String value){
		try{
	...
	public static FaseServiceHandler toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		FaseServiceHandler res = null;
		for (FaseServiceHandler tmp : values()) {

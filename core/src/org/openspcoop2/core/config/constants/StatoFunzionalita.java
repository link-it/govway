 ...
 * @version $Rev$, $Date$
 */
@javax.xml.bind.annotation.XmlType(name = "StatoFunzionalita")
@javax.xml.bind.annotation.XmlEnum(String.class)
public enum StatoFunzionalita implements IEnumeration , Serializable , Cloneable {
	...
	StatoFunzionalita(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(StatoFunzionalita object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof StatoFunzionalita) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((StatoFunzionalita)object));
	}

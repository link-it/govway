...
public enum ValidazioneContenutiApplicativiTipo implements IEnumeration , Serializable , Cloneable {
	...
	ValidazioneContenutiApplicativiTipo(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(ValidazioneContenutiApplicativiTipo object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof ValidazioneContenutiApplicativiTipo) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((ValidazioneContenutiApplicativiTipo)object));
	}

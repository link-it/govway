...
/**     
 * Enumeration dell'elemento FaseMessageHandler xsd (tipo:string) 
 *
...
public enum FaseMessageHandler implements IEnumeration , Serializable , Cloneable {
	...
	FaseMessageHandler(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof FaseMessageHandler) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((FaseMessageHandler)object));
	}
	...
	public static String[] toArray(){
		...
		int i=0;
		for (FaseMessageHandler tmp : values()) {
			res[i]=tmp.getValue();
			i++;
		}
		return res;
	...
	public static FaseMessageHandler toEnumConstant(String value){
		try{
	...
	public static FaseMessageHandler toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		FaseMessageHandler res = null;
		for (FaseMessageHandler tmp : values()) {

...
public enum PortaDelegataAzioneIdentificazione implements IEnumeration , Serializable , Cloneable {
	...
	PortaDelegataAzioneIdentificazione(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof PortaDelegataAzioneIdentificazione) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((PortaDelegataAzioneIdentificazione)object));
	}

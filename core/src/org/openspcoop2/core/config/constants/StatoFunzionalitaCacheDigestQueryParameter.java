 ...
 * @version $Rev$, $Date$
 */
@jakarta.xml.bind.annotation.XmlType(name = "StatoFunzionalitaCacheDigestQueryParameter")
@jakarta.xml.bind.annotation.XmlEnum(String.class)
public enum StatoFunzionalitaCacheDigestQueryParameter implements IEnumeration , Serializable , Cloneable {

	@jakarta.xml.bind.annotation.XmlEnumValue("abilitato")
	ABILITATO ("abilitato"),
	@jakarta.xml.bind.annotation.XmlEnumValue("selezionePuntuale")

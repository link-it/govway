 ...
 * @version $Rev$, $Date$
 */
@javax.xml.bind.annotation.XmlType(name = "RicercaTipologiaFruizione")
@javax.xml.bind.annotation.XmlEnum(String.class)
public enum RicercaTipologiaFruizione implements IEnumeration , Serializable , Cloneable {
	...
	RicercaTipologiaFruizione(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(RicercaTipologiaFruizione object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof RicercaTipologiaFruizione) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((RicercaTipologiaFruizione)object));
	}

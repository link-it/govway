 ...
 * @version $Rev$, $Date$
 */
@javax.xml.bind.annotation.XmlType(name = "StatoFunzionalitaConWarning")
@javax.xml.bind.annotation.XmlEnum(String.class)
public enum StatoFunzionalitaConWarning implements IEnumeration , Serializable , Cloneable {

	@javax.xml.bind.annotation.XmlEnumValue("abilitato")
	ABILITATO ("abilitato"),
	@javax.xml.bind.annotation.XmlEnumValue("disabilitato")
	DISABILITATO ("disabilitato"),
	@javax.xml.bind.annotation.XmlEnumValue("warningOnly")
	...
	StatoFunzionalitaConWarning(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(StatoFunzionalitaConWarning object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof StatoFunzionalitaConWarning) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((StatoFunzionalitaConWarning)object));
	}

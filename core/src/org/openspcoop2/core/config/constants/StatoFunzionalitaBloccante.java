...
/**     
 * Enumeration dell'elemento StatoFunzionalitaBloccante xsd (tipo:string) 
 *
 * @author Poli Andrea (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
@jakarta.xml.bind.annotation.XmlType(name = "StatoFunzionalitaBloccante")
@jakarta.xml.bind.annotation.XmlEnum(String.class)
public enum StatoFunzionalitaBloccante implements IEnumeration , Serializable , Cloneable {

	@jakarta.xml.bind.annotation.XmlEnumValue("abilitato")
	ABILITATO ("abilitato"),
	@jakarta.xml.bind.annotation.XmlEnumValue("nonBloccante")
	NON_BLOCCANTE ("nonBloccante"),
	...
	StatoFunzionalitaBloccante(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof StatoFunzionalitaBloccante) ){
	...
	public static String[] toArray(){
		...
		int i=0;
		for (StatoFunzionalitaBloccante tmp : values()) {
			res[i]=tmp.getValue();
			i++;
		}
		return res;
	...
	public static StatoFunzionalitaBloccante toEnumConstant(String value){
		try{
	...
	public static StatoFunzionalitaBloccante toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		StatoFunzionalitaBloccante res = null;
		for (StatoFunzionalitaBloccante tmp : values()) {

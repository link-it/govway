...
/**     
 * Enumeration dell'elemento StatoFunzionalitaConPersonalizzazione xsd (tipo:string) 
 *
 * @author Poli Andrea (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
@jakarta.xml.bind.annotation.XmlType(name = "StatoFunzionalitaConPersonalizzazione")
@jakarta.xml.bind.annotation.XmlEnum(String.class)
public enum StatoFunzionalitaConPersonalizzazione implements IEnumeration , Serializable , Cloneable {

	@jakarta.xml.bind.annotation.XmlEnumValue("abilitato")
	ABILITATO ("abilitato"),
	@jakarta.xml.bind.annotation.XmlEnumValue("disabilitato")
	DISABILITATO ("disabilitato"),
	@jakarta.xml.bind.annotation.XmlEnumValue("personalizzato")
	PERSONALIZZATO ("personalizzato"),
	@jakarta.xml.bind.annotation.XmlEnumValue("configurazioneEsterna")
	CONFIGURAZIONE_ESTERNA ("configurazioneEsterna");
	...
	StatoFunzionalitaConPersonalizzazione(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof StatoFunzionalitaConPersonalizzazione) ){
	...
	public static String[] toArray(){
		...
		int i=0;
		for (StatoFunzionalitaConPersonalizzazione tmp : values()) {
			res[i]=tmp.getValue();
			i++;
		}
		return res;
	...
	public static StatoFunzionalitaConPersonalizzazione toEnumConstant(String value){
		try{
	...
	public static StatoFunzionalitaConPersonalizzazione toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		StatoFunzionalitaConPersonalizzazione res = null;
		for (StatoFunzionalitaConPersonalizzazione tmp : values()) {

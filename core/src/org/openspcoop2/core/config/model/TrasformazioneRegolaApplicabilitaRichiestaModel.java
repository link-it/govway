...
public class TrasformazioneRegolaApplicabilitaRichiestaModel extends AbstractModel<TrasformazioneRegolaApplicabilitaRichiesta> {
	...
	public TrasformazioneRegolaApplicabilitaRichiestaModel(){
		...
		this.CONNETTORE = new Field("connettore",java.lang.String.class,"trasformazione-regola-applicabilita-richiesta",TrasformazioneRegolaApplicabilitaRichiesta.class);
	...
	public TrasformazioneRegolaApplicabilitaRichiestaModel(IField father){
		...
		this.CONNETTORE = new ComplexField(father,"connettore",java.lang.String.class,"trasformazione-regola-applicabilita-richiesta",TrasformazioneRegolaApplicabilitaRichiesta.class);

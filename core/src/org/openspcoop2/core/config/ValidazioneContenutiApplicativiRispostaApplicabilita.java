...
/** <p>Java class for validazione-contenuti-applicativi-risposta-applicabilita complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="validazione-contenuti-applicativi-risposta-applicabilita"&gt;
 * 		&lt;sequence&gt;
 ...
 * 		&lt;/sequence&gt;
 * 		&lt;attribute name="return-code-min" type="{http://www.w3.org/2001/XMLSchema}integer" use="optional"/&gt;
 * 		&lt;attribute name="return-code-max" type="{http://www.w3.org/2001/XMLSchema}integer" use="optional"/&gt;
 * 		&lt;attribute name="rest-problem-detail" type="{http://www.openspcoop2.org/core/config}StatoFunzionalita" use="optional"/&gt;
 * 		&lt;attribute name="rest-empty-response" type="{http://www.openspcoop2.org/core/config}StatoFunzionalita" use="optional"/&gt;
 * &lt;/complexType&gt;
 * </pre>
 * 
 * @version $Rev$, $Date$
...
@XmlType(name = "validazione-contenuti-applicativi-risposta-applicabilita", 
  propOrder = {
  	"azione",
  	"contentType",
  	"match"
...
@XmlRootElement(name = "validazione-contenuti-applicativi-risposta-applicabilita")

public class ValidazioneContenutiApplicativiRispostaApplicabilita extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  public ValidazioneContenutiApplicativiRispostaApplicabilita() {
  }
  ...
  public void set_value_restProblemDetail(String value) {
    this.restProblemDetail = (StatoFunzionalita) StatoFunzionalita.toEnumConstantFromString(value);
  }

  public String get_value_restProblemDetail() {
    if(this.restProblemDetail == null){
    	return null;
    }else{
    	return this.restProblemDetail.toString();
    }
  }

  public org.openspcoop2.core.config.constants.StatoFunzionalita getRestProblemDetail() {
    return this.restProblemDetail;
  }

  public void setRestProblemDetail(org.openspcoop2.core.config.constants.StatoFunzionalita restProblemDetail) {
    this.restProblemDetail = restProblemDetail;
  }

  public void set_value_restEmptyResponse(String value) {
    this.restEmptyResponse = (StatoFunzionalita) StatoFunzionalita.toEnumConstantFromString(value);
  }

  public String get_value_restEmptyResponse() {
    if(this.restEmptyResponse == null){
    	return null;
    }else{
    	return this.restEmptyResponse.toString();
    }
  }

  public org.openspcoop2.core.config.constants.StatoFunzionalita getRestEmptyResponse() {
    return this.restEmptyResponse;
  }

  public void setRestEmptyResponse(org.openspcoop2.core.config.constants.StatoFunzionalita restEmptyResponse) {
    this.restEmptyResponse = restEmptyResponse;
  }
  ...
  */
  ...
  protected java.lang.String _value_restProblemDetail;

  @XmlAttribute(name="rest-problem-detail",required=false)
  protected StatoFunzionalita restProblemDetail;

  @javax.xml.bind.annotation.XmlTransient
  protected java.lang.String _value_restEmptyResponse;

  @XmlAttribute(name="rest-empty-response",required=false)
  protected StatoFunzionalita restEmptyResponse;

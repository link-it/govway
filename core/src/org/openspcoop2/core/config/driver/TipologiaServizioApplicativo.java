 ...
 * @version $Rev$, $Date$
 */
public class TipologiaServizioApplicativo {

	private TipologiaFruizione tipologiaFruizione;
	private TipologiaErogazione tipologiaErogazione;
	private IDServizioApplicativo idServizioApplicativo;
	
	
	public TipologiaFruizione getTipologiaFruizione() {
		return this.tipologiaFruizione;
	}
	public void setTipologiaFruizione(TipologiaFruizione tipologiaFruizione) {
		this.tipologiaFruizione = tipologiaFruizione;
	}
	public TipologiaErogazione getTipologiaErogazione() {
		return this.tipologiaErogazione;
	}
	public void setTipologiaErogazione(TipologiaErogazione tipologiaErogazione) {

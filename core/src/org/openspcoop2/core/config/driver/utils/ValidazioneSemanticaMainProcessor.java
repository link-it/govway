...
public class ValidazioneSemanticaMainProcessor {
	...
	public static void main(String[] args) throws Exception  {
		...
		if (args.length  < 4) {
			String errorMsg = "ERROR, Usage:  java ValidazioneSemanticaMainProcessor commonProperties tipoConfigurazione proprietaConfigurazione validazioneConfigurazione";

...
@XmlType(name = "porta-applicativa-servizio")

@XmlRootElement(name = "porta-applicativa-servizio")

public class PortaApplicativaServizio extends org.openspcoop2.utils.beans.BaseBeanWithId implements Serializable , Cloneable {
  public PortaApplicativaServizio() {
    super();
  }

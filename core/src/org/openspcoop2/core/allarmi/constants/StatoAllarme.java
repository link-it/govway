...
/**     
 * Enumeration dell'elemento stato-allarme xsd (tipo:string) 
 *
 * @author Poli Andrea (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
@jakarta.xml.bind.annotation.XmlType(name = "stato-allarme")
@jakarta.xml.bind.annotation.XmlEnum(String.class)
public enum StatoAllarme implements IEnumeration , Serializable , Cloneable {

	@jakarta.xml.bind.annotation.XmlEnumValue("ok")
	OK ("ok"),
	@jakarta.xml.bind.annotation.XmlEnumValue("warning")
	WARNING ("warning"),
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof StatoAllarme) ){
	...
	public static StatoAllarme toEnumConstant(String value){
		try{
	...
	public static StatoAllarme toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		StatoAllarme res = null;
		for (StatoAllarme tmp : values()) {

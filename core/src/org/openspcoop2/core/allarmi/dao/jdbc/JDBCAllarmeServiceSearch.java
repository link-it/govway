...
public class JDBCAllarmeServiceSearch implements IDBAllarmeServiceSearch, IDBServiceUtilities<Allarme> {
	...
	public JDBCAllarmeServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCAllarmeServiceSearch.class.getName()+ " initialized");
	...
	public IdAllarme convertToId(Allarme obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+Allarme.class.getName()+") 'obj' is null");
			}
	...
	public void mappingTableIds(long tableId, Allarme obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdAllarme.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+Allarme.class.getName()+") 'obj' is null");
			}

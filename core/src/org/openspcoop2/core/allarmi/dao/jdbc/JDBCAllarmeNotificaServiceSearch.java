...
import org.openspcoop2.core.allarmi.dao.IDBAllarmeNotificaServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.core.allarmi.AllarmeNotifica} 
 *
 * @author Poli Andrea (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
*/
public class JDBCAllarmeNotificaServiceSearch implements IDBAllarmeNotificaServiceSearch, IDBServiceUtilities<AllarmeNotifica> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithoutId<AllarmeNotifica, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCAllarmeNotificaServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCAllarmeNotificaServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.core.allarmi.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("allarmeNotifica");
	...
	@Override
	public void validate(AllarmeNotifica allarmeNotifica) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(allarmeNotifica, this.log, 
	...
	@Override
	public List<AllarmeNotifica> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<AllarmeNotifica> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public AllarmeNotifica find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public AllarmeNotifica find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public AllarmeNotifica get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public AllarmeNotifica get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {

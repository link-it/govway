...
public class Costanti {
	...
	public static final String PROPRIETA_SOGGETTO_EROGATORE = "PROPRIETA_SOGGETTO_EROGATORE";
	public static final String PROPRIETA_SOGGETTO_FRUITORE = "PROPRIETA_SOGGETTO_FRUITORE";
	public static final String PROPRIETA_APPLICATIVO = "PROPRIETA_APPLICATIVO";
	...
	public final static String CONSEGNA_MULTIPLA_CONNETTORI_BY_SA = "CONSEGNA_MULTIPLA_CONNETTORI_BY_SA";
	
	public final static String CONSEGNA_MULTIPLA_NOME_CONNETTORE = "CONSEGNA_MULTIPLA_NOME_CONNETTORE";

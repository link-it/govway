...
public enum PolicyGroupByActiveThreadsType {
	...
	public String toLabel() {
		switch (this) {
		case LOCAL:
			return Costanti.LABEL_MODALITA_SINCRONIZZAZIONE_LOCALE;
		case LOCAL_DIVIDED_BY_NODES:
			return Costanti.LABEL_MODALITA_SINCRONIZZAZIONE_LOCALE_SUDDIVISA_TRA_NODI;
		case DATABASE:
			return Costanti.LABEL_MODALITA_SINCRONIZZAZIONE_DISTRIBUITA+" - "+Costanti.LABEL_MODALITA_IMPLEMENTAZIONE_DATABASE;
		case HAZELCAST_MAP:
			return Costanti.LABEL_MODALITA_SINCRONIZZAZIONE_DISTRIBUITA+" - "+Costanti.LABEL_MODALITA_IMPLEMENTAZIONE_HAZELCAST +
					" ("+Costanti.LABEL_MODALITA_TIPOLOGIA_HAZELCAST_FULL_SYNC+")";
		case HAZELCAST_NEAR_CACHE:
			return Costanti.LABEL_MODALITA_SINCRONIZZAZIONE_DISTRIBUITA+" - "+Costanti.LABEL_MODALITA_IMPLEMENTAZIONE_HAZELCAST +
					" ("+Costanti.LABEL_MODALITA_TIPOLOGIA_HAZELCAST_NEAR_CACHE+")";
		case HAZELCAST_LOCAL_CACHE:
			return Costanti.LABEL_MODALITA_SINCRONIZZAZIONE_DISTRIBUITA+" - "+Costanti.LABEL_MODALITA_IMPLEMENTAZIONE_HAZELCAST +
					" ("+Costanti.LABEL_MODALITA_TIPOLOGIA_HAZELCAST_LOCAL_CACHE+")";
		case HAZELCAST_NEAR_CACHE_UNSAFE_SYNC_MAP:
			return Costanti.LABEL_MODALITA_SINCRONIZZAZIONE_DISTRIBUITA+" - "+Costanti.LABEL_MODALITA_IMPLEMENTAZIONE_HAZELCAST +
					" ("+Costanti.LABEL_MODALITA_TIPOLOGIA_HAZELCAST_REMOTE_SYNC+")";
		case HAZELCAST_NEAR_CACHE_UNSAFE_ASYNC_MAP:
			return Costanti.LABEL_MODALITA_SINCRONIZZAZIONE_DISTRIBUITA+" - "+Costanti.LABEL_MODALITA_IMPLEMENTAZIONE_HAZELCAST +
					" ("+Costanti.LABEL_MODALITA_TIPOLOGIA_HAZELCAST_REMOTE_ASYNC+")";
		case HAZELCAST_PNCOUNTER:
			return Costanti.LABEL_MODALITA_SINCRONIZZAZIONE_DISTRIBUITA+" - "+Costanti.LABEL_MODALITA_IMPLEMENTAZIONE_HAZELCAST +
					" ("+Costanti.LABEL_MODALITA_TIPOLOGIA_HAZELCAST_CONTATORI_PNCOUNTER+")";
		case HAZELCAST_ATOMIC_LONG:
				return Costanti.LABEL_MODALITA_SINCRONIZZAZIONE_DISTRIBUITA+" - "+Costanti.LABEL_MODALITA_IMPLEMENTAZIONE_HAZELCAST +
						" ("+Costanti.LABEL_MODALITA_TIPOLOGIA_HAZELCAST_CONTATORI_ATOMIC_LONG+")";
		case HAZELCAST_ATOMIC_LONG_ASYNC:
			return Costanti.LABEL_MODALITA_SINCRONIZZAZIONE_DISTRIBUITA+" - "+Costanti.LABEL_MODALITA_IMPLEMENTAZIONE_HAZELCAST +
					" ("+Costanti.LABEL_MODALITA_TIPOLOGIA_HAZELCAST_CONTATORI_ATOMIC_LONG_ASYNC+")";
		case HAZELCAST_REPLICATED_MAP:
			return Costanti.LABEL_MODALITA_SINCRONIZZAZIONE_DISTRIBUITA+" - "+Costanti.LABEL_MODALITA_IMPLEMENTAZIONE_HAZELCAST +
					" ("+Costanti.LABEL_MODALITA_TIPOLOGIA_HAZELCAST_REPLICATED_MAP+")";
		case REDISSON_ATOMIC_LONG:
			return Costanti.LABEL_MODALITA_SINCRONIZZAZIONE_DISTRIBUITA+" - "+Costanti.LABEL_MODALITA_IMPLEMENTAZIONE_REDIS  +
					" ("+Costanti.LABEL_MODALITA_TIPOLOGIA_REDIS_CONTATORI_ATOMIC_LONG+")";
		case REDISSON_LONGADDER:
			return Costanti.LABEL_MODALITA_SINCRONIZZAZIONE_DISTRIBUITA+" - "+Costanti.LABEL_MODALITA_IMPLEMENTAZIONE_REDIS +
				" ("+Costanti.LABEL_MODALITA_TIPOLOGIA_REDIS_CONTATORI_LONGADDER+")"; 
		case REDISSON_MAP:
			return Costanti.LABEL_MODALITA_SINCRONIZZAZIONE_DISTRIBUITA+" - "+Costanti.LABEL_MODALITA_IMPLEMENTAZIONE_REDIS +
					" ("+Costanti.LABEL_MODALITA_TIPOLOGIA_REDIS_REDDISSON+")";
		}
		return null;
	}

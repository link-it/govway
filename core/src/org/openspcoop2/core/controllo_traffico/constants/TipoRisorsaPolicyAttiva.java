...
public enum TipoRisorsaPolicyAttiva implements IEnumeration , Serializable , Cloneable {
	...
	NUMERO_TOKEN_INPUT (TipoRisorsa.NUMERO_TOKEN_INPUT.getValue()),
	NUMERO_TOKEN_OUTPUT (TipoRisorsa.NUMERO_TOKEN_OUTPUT.getValue()),
	NUMERO_TOKEN_COMPLESSIVI (TipoRisorsa.NUMERO_TOKEN_COMPLESSIVI.getValue()),
	COSTO (TipoRisorsa.COSTO.getValue());

...
/**     
 * Enumeration dell'elemento tipo-finestra xsd (tipo:string) 
 *
...
public enum TipoFinestra implements IEnumeration , Serializable , Cloneable {
	...
	public boolean equals(TipoFinestra object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof TipoFinestra) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((TipoFinestra)object));
	}
	...
	public static TipoFinestra toEnumConstant(String value){
		try{
	...
	public static TipoFinestra toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		TipoFinestra res = null;
		for (TipoFinestra tmp : values()) {

...
/**     
 * Enumeration dell'elemento tipo-periodo-realtime xsd (tipo:string) 
 *
...
public enum TipoPeriodoRealtime implements IEnumeration , Serializable , Cloneable {
	...
	TipoPeriodoRealtime(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof TipoPeriodoRealtime) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((TipoPeriodoRealtime)object));
	}
	...
	public static String[] toArray(){
		...
		int i=0;
		for (TipoPeriodoRealtime tmp : values()) {
			res[i]=tmp.getValue();
			i++;
		}
		return res;
	...
	public static TipoPeriodoRealtime toEnumConstant(String value){
		try{
	...
	public static TipoPeriodoRealtime toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		TipoPeriodoRealtime res = null;
		for (TipoPeriodoRealtime tmp : values()) {

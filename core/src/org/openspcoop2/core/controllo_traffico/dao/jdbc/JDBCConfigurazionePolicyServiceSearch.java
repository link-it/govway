...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.core.controllo_traffico.ConfigurazionePolicy} 
 *
...
public class JDBCConfigurazionePolicyServiceSearch implements IDBConfigurazionePolicyServiceSearch, IDBServiceUtilities<ConfigurazionePolicy> {
	...
	public JDBCConfigurazionePolicyServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCConfigurazionePolicyServiceSearch.class.getName()+ " initialized";
		this.log.debug(msgInit);
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.core.controllo_traffico.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("configurazionePolicy");
	...
	private ServiceException newServiceExceptionParameterObjIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+ConfigurazionePolicy.class.getName()+") 'obj' is null");
	}
	private ServiceException newServiceExceptionParameterIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdPolicy.class.getName()+") 'id' is null");
	}
	...
	private ServiceException newServiceExceptionParameterWithTypeTableIdLessEqualsZero(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdPolicy.class.getName()+") 'tableId' is lessEquals 0");
	}

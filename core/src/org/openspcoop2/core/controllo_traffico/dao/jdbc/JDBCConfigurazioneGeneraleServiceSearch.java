...
/**     
 * Service can be used to search for the backend objects of type {@link org.openspcoop2.core.controllo_traffico.ConfigurazioneGenerale} 
 *
 * @author Poli Andrea (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
*/
public class JDBCConfigurazioneGeneraleServiceSearch implements IDBConfigurazioneGeneraleServiceSearch, IDBServiceUtilities<ConfigurazioneGenerale> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchSingleObject<ConfigurazioneGenerale, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCConfigurazioneGeneraleServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCConfigurazioneGeneraleServiceSearch.class.getName()+ " initialized";
		this.log.debug(msgInit);
		this.serviceSearch = JDBCProperties.getInstance(org.openspcoop2.core.controllo_traffico.dao.jdbc.JDBCServiceManager.class.getPackage(),ProjectInfo.getInstance()).getServiceSearch("configurazioneGenerale");
	...
	private ServiceException newServiceExceptionParameterObjIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+ConfigurazioneGenerale.class.getName()+") 'obj' is null");
	}
	...
	@Override
	public void validate(ConfigurazioneGenerale configurazioneGenerale) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(configurazioneGenerale, this.log, 
	...
	@Override
	public ConfigurazioneGenerale get() throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public ConfigurazioneGenerale get(org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(ConfigurazioneGenerale obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
			...
			this.serviceSearch.mappingTableIds(this.jdbcProperties,this.log,connection,sqlQueryObject,obj);
			...
			this.logError(e); throw new ServiceException("mappingIds not completed: "+e.getMessage(),e);
		}finally{
			if(connection!=null){
				this.jdbcServiceManager.closeConnection(connection);
			}
	...
	@Override
	public ConfigurazioneGenerale get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public ConfigurazioneGenerale get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {

...
public class JDBCAttivazionePolicyServiceSearch implements IDBAttivazionePolicyServiceSearch, IDBServiceUtilities<AttivazionePolicy> {
	...
	public JDBCAttivazionePolicyServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCAttivazionePolicyServiceSearch.class.getName()+ " initialized");
	...
	public IdActivePolicy convertToId(AttivazionePolicy obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+AttivazionePolicy.class.getName()+") 'obj' is null");
			}
	...
	public AttivazionePolicy get(IdActivePolicy id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(id==null){
				throw new Exception("Parameter (type:"+IdActivePolicy.class.getName()+") 'id' is null");
			}
	...
	public void mappingTableIds(long tableId, AttivazionePolicy obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdActivePolicy.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+AttivazionePolicy.class.getName()+") 'obj' is null");
			}

 ...
 * 			&lt;element name="soggetto" type="{http://www.openspcoop2.org/core/eccezione/details}dominio-soggetto" minOccurs="1" maxOccurs="1"/>
 * 		&lt;/sequence>
 * 		&lt;attribute name="funzione" type="{http://www.openspcoop2.org/core/eccezione/details}TipoPdD" use="optional"/>
...
public class Dominio extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  ...
  public org.openspcoop2.core.eccezione.details.constants.TipoPdD getFunzione() {
    return this.funzione;
  }

  public void setFunzione(org.openspcoop2.core.eccezione.details.constants.TipoPdD funzione) {

...
public class DominioModel extends AbstractModel<Dominio> {
	...
	public DominioModel(){
		...
		this.ORGANIZATION = new org.openspcoop2.core.eccezione.errore_applicativo.model.DominioSoggettoModel(new Field("organization",org.openspcoop2.core.eccezione.errore_applicativo.DominioSoggetto.class,"dominio",Dominio.class));
	...
	public DominioModel(IField father){
		...
		this.ORGANIZATION = new org.openspcoop2.core.eccezione.errore_applicativo.model.DominioSoggettoModel(new ComplexField(father,"organization",org.openspcoop2.core.eccezione.errore_applicativo.DominioSoggetto.class,"dominio",Dominio.class));
	...
	public org.openspcoop2.core.eccezione.errore_applicativo.model.DominioSoggettoModel ORGANIZATION = null;

...
public class DominioModel extends AbstractModel<Dominio> {
	...
	public DominioModel(){
		...
		this.SOGGETTO = new org.openspcoop2.core.eccezione.errore_applicativo.model.DominioSoggettoModel(new Field("soggetto",org.openspcoop2.core.eccezione.errore_applicativo.DominioSoggetto.class,"dominio",Dominio.class));
	...
	public DominioModel(IField father){
		...
		this.SOGGETTO = new org.openspcoop2.core.eccezione.errore_applicativo.model.DominioSoggettoModel(new ComplexField(father,"soggetto",org.openspcoop2.core.eccezione.errore_applicativo.DominioSoggetto.class,"dominio",Dominio.class));
	...
	public org.openspcoop2.core.eccezione.errore_applicativo.model.DominioSoggettoModel SOGGETTO = null;

...
package org.openspcoop2.pdd_test.response_caching;
...
public class TestResponseCaching {
	...
	private static final String ID_TEST = "ResponseCaching";
	
	@Test(groups={Costanti.GRUPPO_PDD,Costanti.GRUPPO_PDD+"."+ID_TEST})
	public void testResponseCaching() throws Exception{
		
		TestLogger.info("Run test '"+ID_TEST+"' ...");
		org.openspcoop2.pdd.core.response_caching.test.ResponseCachingTest.test();

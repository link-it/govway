...
(
	...
	pdd_codice VARCHAR(256) NOT NULL,
	pdd_tipo_soggetto VARCHAR(256) NOT NULL,
	pdd_nome_soggetto VARCHAR(256) NOT NULL,
	pdd_ruolo VARCHAR(256) NOT NULL,
	tipo_messaggio VARCHAR(256) NOT NULL,
	esito_elaborazione VARCHAR(256) NOT NULL,
	dettaglio_esito_elaborazione TEXT,
	mittente VARCHAR(256),
	tipo_mittente VARCHAR(256),
	idporta_mittente VARCHAR(256),
	indirizzo_mittente VARCHAR(256),
	destinatario VARCHAR(256),
	tipo_destinatario VARCHAR(256),
	idporta_destinatario VARCHAR(256),
	indirizzo_destinatario VARCHAR(256),
	profilo_collaborazione VARCHAR(256),
	profilo_collaborazione_meta VARCHAR(256),
	servizio_correlato VARCHAR(256),
	tipo_servizio_correlato VARCHAR(256),
	versione_servizio_correlato INT,
	collaborazione VARCHAR(256),
	versione_servizio INT,
	servizio VARCHAR(256),
	tipo_servizio VARCHAR(256),
	azione VARCHAR(256),
	id_messaggio VARCHAR(256),
	-- Precisione ai millisecondi supportata dalla versione 5.6.4, se si utilizza una versione precedente non usare il suffisso '(3)'
	ora_registrazione TIMESTAMP(3) DEFAULT 0,
	tipo_ora_reg VARCHAR(256),
	tipo_ora_reg_meta VARCHAR(256),
	rif_messaggio VARCHAR(256),
	-- Precisione ai millisecondi supportata dalla versione 5.6.4, se si utilizza una versione precedente non usare il suffisso '(3)'
	scadenza TIMESTAMP(3) DEFAULT 0,
	inoltro VARCHAR(256),
	inoltro_meta VARCHAR(256),
	conferma_ricezione INT,
	sequenza INT,
	-- Dati di integrazione
	location VARCHAR(256),
	correlazione_applicativa VARCHAR(256),
	correlazione_risposta VARCHAR(256),
	sa_fruitore VARCHAR(256),
	sa_erogatore VARCHAR(256),
	-- Protocollo
	protocollo VARCHAR(256) NOT NULL,
	-- Testsuite

...
(
	...
	tipo_soggetto_erogatore VARCHAR(256) NOT NULL,
	nome_soggetto_erogatore VARCHAR(256) NOT NULL,
	-- * Servizio *
	-- tipo/nome/versione per le modalita static
	-- id utilizzato in caso di registryInput
	id_servizio BIGINT,
	tipo_servizio VARCHAR(256) NOT NULL,
	...
	-- id utilizzato in caso di registryInput
	id_azione BIGINT,
	nome_azione VARCHAR(256),
	mode_azione VARCHAR(256),
	pattern_azione VARCHAR(256),
	nome_porta_delegante_azione VARCHAR(256),
	-- abilitato/disabilitato
	force_interface_based_azione VARCHAR(256),
	-- Controllo Accessi
	autenticazione VARCHAR(256),
	-- abilitato/disabilitato
	autenticazione_opzionale VARCHAR(256),
	-- Gestione Token
	token_policy VARCHAR(256),
	token_opzionale VARCHAR(256),
	token_validazione VARCHAR(256),
	token_introspection VARCHAR(256),
	token_user_info VARCHAR(256),
	token_forward VARCHAR(256),
	token_options VARCHAR(4000),
	token_authn_issuer VARCHAR(256),
	token_authn_client_id VARCHAR(256),
	token_authn_subject VARCHAR(256),
	token_authn_username VARCHAR(256),
	token_authn_email VARCHAR(256),
	-- Autorizzazione
	autorizzazione VARCHAR(256),
	autorizzazione_xacml MEDIUMTEXT,
	autorizzazione_contenuto VARCHAR(256),
	-- disable/packaging/unpackaging/verify
	mtom_request_mode VARCHAR(256),
	-- disable/packaging/unpackaging/verify
	mtom_response_mode VARCHAR(256),
	...
	-- abilitato/disabilitato
	security_mtom_req VARCHAR(256),
	-- abilitato/disabilitato
	security_mtom_res VARCHAR(256),
	security_request_mode VARCHAR(256),
	security_response_mode VARCHAR(256),
	-- abilitato/disabilitato
	ricevuta_asincrona_sim VARCHAR(256),
	-- abilitato/disabilitato
	ricevuta_asincrona_asim VARCHAR(256),
	-- abilitato/disabilitato/warningOnly
	validazione_contenuti_stato VARCHAR(256),
	-- wsdl/interface/xsd
	validazione_contenuti_tipo VARCHAR(256),
	-- abilitato/disabilitato
	validazione_contenuti_mtom VARCHAR(256),
	-- lista di tipi separati dalla virgola
	integrazione VARCHAR(4000),
	-- scadenza correlazione applicativa
	scadenza_correlazione_appl VARCHAR(256),
	-- abilitato/disabilitato
	allega_body VARCHAR(256),
	-- abilitato/disabilitato
	scarta_body VARCHAR(256),
	-- abilitato/disabilitato
	gestione_manifest VARCHAR(256),
	-- abilitato/disabilitato
	stateless VARCHAR(256),
	-- abilitato/disabilitato
	local_forward VARCHAR(256),
	-- Nome della PortaApplicativa
	local_forward_pa VARCHAR(256),
	-- all/any
	ruoli_match VARCHAR(256),
	token_sa_stato VARCHAR(256),
	token_ruoli_stato VARCHAR(256),
	-- all/any
	token_ruoli_match VARCHAR(256),
	token_ruoli_tipologia VARCHAR(256),
	scope_stato VARCHAR(256),
	-- all/any
	scope_match VARCHAR(256),
	-- abilitato/disabilitato
	ricerca_porta_azione_delegata VARCHAR(256),
	-- Livello Log Messaggi Diagnostici
	msg_diag_severita VARCHAR(256),
	-- Tracciamento delle transazioni
	tracciamento_stato VARCHAR(256),
	tracciamento_esiti VARCHAR(256),
	transazioni_tempi VARCHAR(256),
	transazioni_token VARCHAR(256),
	-- Gestione CORS
	cors_stato VARCHAR(256),
	cors_tipo VARCHAR(256),
	cors_all_allow_origins VARCHAR(256),
	cors_all_allow_methods VARCHAR(256),
	cors_all_allow_headers VARCHAR(256),
	cors_allow_credentials VARCHAR(256),
	...
	-- Response caching
	response_cache_stato VARCHAR(256),
	response_cache_seconds INT,
	response_cache_max_msg_size BIGINT,
	response_cache_hash_url VARCHAR(256),
	response_cache_hash_query VARCHAR(256),
	response_cache_hash_query_list TEXT,
	response_cache_hash_headers VARCHAR(256),
	response_cache_hash_hdr_list TEXT,
	response_cache_hash_payload VARCHAR(256),

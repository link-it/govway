...
(
	...
	cadenza_inoltro VARCHAR(256) NOT NULL,
	-- Validazione Buste
	validazione_stato VARCHAR(256),
	validazione_controllo VARCHAR(256),
	validazione_profilo VARCHAR(256),
	validazione_manifest VARCHAR(256),
	...
	msg_diag_severita VARCHAR(256) NOT NULL,
	msg_diag_severita_log4j VARCHAR(256) NOT NULL,
	-- Tracciamento Buste
	tracciamento_buste VARCHAR(256),
	tracciamento_esiti_pd VARCHAR(256),
	tracciamento_esiti VARCHAR(256),
	-- Transazione
	transazioni_tempi_pd VARCHAR(256),
	transazioni_tempi VARCHAR(256),
	transazioni_token_pd VARCHAR(256),
	transazioni_token VARCHAR(256),
	-- Dump
	dump VARCHAR(256),
	dump_bin_pd VARCHAR(256),
	dump_bin_pa VARCHAR(256),
	-- Autenticazione IntegrationManager
	auth_integration_manager VARCHAR(256),
	-- Cache per l'accesso ai registri
	statocache VARCHAR(256),
	dimensionecache VARCHAR(256),
	algoritmocache VARCHAR(256),
	idlecache VARCHAR(256),
	lifecache VARCHAR(256),
	-- Cache per l'accesso alla configurazione
	config_statocache VARCHAR(256),
	config_dimensionecache VARCHAR(256),
	config_algoritmocache VARCHAR(256),
	config_idlecache VARCHAR(256),
	config_lifecache VARCHAR(256),
	-- Cache per l'accesso ai dati di autorizzazione
	auth_statocache VARCHAR(256),
	auth_dimensionecache VARCHAR(256),
	auth_algoritmocache VARCHAR(256),
	auth_idlecache VARCHAR(256),
	auth_lifecache VARCHAR(256),
	-- Cache per l'accesso ai dati di autenticazione
	authn_statocache VARCHAR(256),
	authn_dimensionecache VARCHAR(256),
	authn_algoritmocache VARCHAR(256),
	authn_idlecache VARCHAR(256),
	authn_lifecache VARCHAR(256),
	-- Cache per la gestione dei token
	token_statocache VARCHAR(256),
	token_dimensionecache VARCHAR(256),
	token_algoritmocache VARCHAR(256),
	token_idlecache VARCHAR(256),
	token_lifecache VARCHAR(256),
	-- Cache per la gestione dei dati ottenuti da attribute authority
	aa_statocache VARCHAR(256),
	aa_dimensionecache VARCHAR(256),
	aa_algoritmocache VARCHAR(256),
	aa_idlecache VARCHAR(256),
	aa_lifecache VARCHAR(256),
	-- Cache per la gestione dei keystore
	keystore_statocache VARCHAR(256),
	keystore_dimensionecache VARCHAR(256),
	keystore_algoritmocache VARCHAR(256),
	keystore_idlecache VARCHAR(256),
	keystore_lifecache VARCHAR(256),
	keystore_crl_lifecache VARCHAR(256),
	-- connessione su cui vengono inviate le risposte
	-- reply: connessione esistente (es. http reply)
	-- new: nuova connessione
	mod_risposta VARCHAR(256),
	-- Gestione dell'indirizzo
	indirizzo_telematico VARCHAR(256),
	-- Gestione Manifest
	gestione_manifest VARCHAR(256),
	-- Routing Table
	routing_enabled VARCHAR(256) NOT NULL,
	...
	multitenant_stato VARCHAR(256),
	multitenant_fruizioni VARCHAR(256),
	multitenant_erogazioni VARCHAR(256),
	-- Gestione CORS
	...
	response_cache_statocache VARCHAR(256),
	response_cache_dimensionecache VARCHAR(256),
	response_cache_algoritmocache VARCHAR(256),
	response_cache_idlecache VARCHAR(256),
	response_cache_lifecache VARCHAR(256),
	-- Cache per la consegna agli applicativi
	consegna_statocache VARCHAR(256),
	consegna_dimensionecache VARCHAR(256),
	consegna_algoritmocache VARCHAR(256),
	consegna_idlecache VARCHAR(256),
	consegna_lifecache VARCHAR(256),
	-- Gestione CORS
	canali_stato VARCHAR(256),
	-- Cache per la gestione delle richieste
	dati_richieste_statocache VARCHAR(256),
	dati_richieste_dimensionecache VARCHAR(256),
	dati_richieste_algoritmocache VARCHAR(256),
	dati_richieste_idlecache VARCHAR(256),
	dati_richieste_lifecache VARCHAR(256),
	-- fk/pk columns
	id BIGINT AUTO_INCREMENT,
	-- fk/pk keys constraints

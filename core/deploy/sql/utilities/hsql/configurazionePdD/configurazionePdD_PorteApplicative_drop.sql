...
DROP TABLE pa_token_ruoli_init_seq;
DROP TABLE pa_token_ruoli;
DROP TABLE pa_token_sa_init_seq;
DROP TABLE pa_token_sa;
DROP TABLE pa_aa_init_seq;
DROP TABLE pa_aa;
DROP TABLE pa_handlers_init_seq;
...
DROP TABLE pa_ct_properties_init_seq;

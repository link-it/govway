...
-- DROP INDEX idx_cong_att_policy_2;
-- DROP INDEX idx_rt_prop_policy_2;
DROP TABLE ct_active_policy_init_seq;
DROP TABLE ct_active_policy;
DROP TABLE ct_config_policy_init_seq;
DROP TABLE ct_config_policy;
DROP TABLE ct_rt_props_init_seq;
DROP TABLE ct_rt_props;
DROP TABLE ct_config_init_seq;

...
-- DROP INDEX INDEX_TR_TOKEN_ID;
-- DROP INDEX INDEX_TR_PURPOSE_ID;
...
DROP TABLE transazioni_info_init_seq;
DROP TABLE transazioni_info;
DROP TABLE transazioni_llm_init_seq;
...
DROP SEQUENCE seq_transazioni_llm;

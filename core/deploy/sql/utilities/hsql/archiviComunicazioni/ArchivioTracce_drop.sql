...
-- DROP INDEX TRACCE_EXT_SEARCH;
-- DROP INDEX TRACCE_EXT_INFO;
-- DROP INDEX TRACCE_ALLEGATI_INDEX;
-- DROP INDEX TRACCE_ECC;
-- DROP INDEX TRACCE_TR;
-- DROP INDEX TRACCE_RIS;
-- DROP INDEX TRACCE_SEARCH_GDO;
-- DROP INDEX TRACCE_SEARCH_ID_APPL_RISP;
-- DROP INDEX TRACCE_SEARCH_ID_APPL;
...
DROP TABLE tracce_eccezioni_init_seq;
DROP TABLE tracce_eccezioni;
DROP TABLE tracce_trasmissioni_init_seq;
DROP TABLE tracce_trasmissioni;
DROP TABLE tracce_riscontri_init_seq;
DROP TABLE tracce_riscontri;
DROP TABLE tracce_init_seq;
DROP TABLE tracce;

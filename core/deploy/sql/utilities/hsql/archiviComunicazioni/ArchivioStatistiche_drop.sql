...
-- DROP INDEX INDEX_STAT_DAY_LLM_FULL;
-- DROP INDEX INDEX_STAT_DAY_LLM_COVER;
...
-- DROP INDEX INDEX_STAT_HOUR_LLM_FULL;
-- DROP INDEX INDEX_STAT_HOUR_LLM_COVER;
-- DROP INDEX idx_stat_c_orarie_1;
-- DROP INDEX INDEX_STAT_HOUR;
-- DROP INDEX INDEX_STAT_HOUR_FULL;
-- DROP INDEX INDEX_STAT_HOUR_ENTRY;
DROP TABLE statistiche_pdnd_tracing_init_seq;
DROP TABLE statistiche_pdnd_tracing;
DROP TABLE stat_mensili_contenuti_init_seq;
DROP TABLE stat_mensili_contenuti;
DROP TABLE statistiche_mensili_init_seq;
DROP TABLE statistiche_mensili;
DROP TABLE stat_settimane_contenuti_init_seq;
DROP TABLE stat_settimane_contenuti;
DROP TABLE statistiche_settimanali_init_seq;
DROP TABLE statistiche_settimanali;
DROP TABLE stat_giorni_llm_init_seq;
DROP TABLE stat_giorni_llm;
DROP TABLE stat_giorni_contenuti_init_seq;
DROP TABLE stat_giorni_contenuti;
DROP TABLE statistiche_giornaliere_init_seq;
DROP TABLE statistiche_giornaliere;
DROP TABLE stat_orarie_llm_init_seq;
DROP TABLE stat_orarie_llm;
DROP TABLE stat_orarie_contenuti_init_seq;
DROP TABLE stat_orarie_contenuti;
DROP TABLE statistiche_orarie_init_seq;
DROP TABLE statistiche_orarie;
DROP TABLE statistiche_init_seq;

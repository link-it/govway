...
DROP TRIGGER trg_statistiche_settimanali;
DROP TRIGGER trg_stat_giorni_llm;
DROP TRIGGER trg_stat_giorni_contenuti;
DROP TRIGGER trg_statistiche_giornaliere;
DROP TRIGGER trg_stat_orarie_llm;

...
ALTER TABLE statistiche_orarie MODIFY COLUMN cluster_id VARCHAR(100) NOT NULL;

ALTER TABLE statistiche_orarie ADD COLUMN stato_record INT ;
UPDATE statistiche_orarie set stato_record=1;
ALTER TABLE statistiche_orarie MODIFY COLUMN stato_record INT NOT NULL;
...
ALTER TABLE statistiche_giornaliere MODIFY COLUMN cluster_id VARCHAR(100) NOT NULL;

ALTER TABLE statistiche_giornaliere ADD COLUMN stato_record INT ;
UPDATE statistiche_giornaliere set stato_record=1;
ALTER TABLE statistiche_giornaliere MODIFY COLUMN stato_record INT NOT NULL;
...
ALTER TABLE statistiche_settimanali MODIFY COLUMN cluster_id VARCHAR(100) NOT NULL;

ALTER TABLE statistiche_settimanali ADD COLUMN stato_record INT ;
UPDATE statistiche_settimanali set stato_record=1;
ALTER TABLE statistiche_settimanali MODIFY COLUMN stato_record INT NOT NULL;
...
ALTER TABLE statistiche_mensili MODIFY COLUMN cluster_id VARCHAR(100) NOT NULL;

ALTER TABLE statistiche_mensili ADD COLUMN stato_record INT ;
UPDATE statistiche_mensili set stato_record=1;
ALTER TABLE statistiche_mensili MODIFY COLUMN stato_record INT NOT NULL;

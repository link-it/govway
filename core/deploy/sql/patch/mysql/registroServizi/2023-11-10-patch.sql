...
ALTER TABLE servizi MODIFY COLUMN descrizione MEDIUMTEXT;
...
ALTER TABLE servizi_fruitori ADD COLUMN descrizione MEDIUMTEXT;
...
ALTER TABLE scope MODIFY COLUMN descrizione MEDIUMTEXT;
...
ALTER TABLE ruoli MODIFY COLUMN descrizione MEDIUMTEXT;
...
ALTER TABLE gruppi MODIFY COLUMN descrizione MEDIUMTEXT;

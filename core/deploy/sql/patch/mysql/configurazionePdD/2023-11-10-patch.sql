ALTER TABLE porte_applicative MODIFY COLUMN descrizione VARCHAR(4000);
...
ALTER TABLE porte_applicative_sa ADD COLUMN data_creazione TIMESTAMP(3) DEFAULT 0;
ALTER TABLE porte_applicative_sa ADD COLUMN utente_ultima_modifica VARCHAR(255);
ALTER TABLE porte_applicative_sa ADD COLUMN data_ultima_modifica TIMESTAMP(3) DEFAULT 0;
...
ALTER TABLE porte_delegate MODIFY COLUMN descrizione VARCHAR(4000);
...
ALTER TABLE servizi_applicativi MODIFY COLUMN descrizione VARCHAR(4000);
ALTER TABLE servizi_applicativi ADD COLUMN utente_richiedente VARCHAR(255);
ALTER TABLE servizi_applicativi ADD COLUMN data_creazione TIMESTAMP(3) DEFAULT 0;
ALTER TABLE servizi_applicativi ADD COLUMN utente_ultima_modifica VARCHAR(255);
ALTER TABLE servizi_applicativi ADD COLUMN data_ultima_modifica TIMESTAMP(3) DEFAULT 0;
...
ALTER TABLE generic_properties MODIFY COLUMN descrizione VARCHAR(4000);
ALTER TABLE generic_properties ADD COLUMN utente_richiedente VARCHAR(255);
ALTER TABLE generic_properties ADD COLUMN data_creazione TIMESTAMP(3) DEFAULT 0;
ALTER TABLE generic_properties ADD COLUMN utente_ultima_modifica VARCHAR(255);
ALTER TABLE generic_properties ADD COLUMN data_ultima_modifica TIMESTAMP(3) DEFAULT 0;

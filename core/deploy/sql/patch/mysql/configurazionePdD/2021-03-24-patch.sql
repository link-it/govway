...
ALTER TABLE dump_config_regola MODIFY COLUMN payload VARCHAR(255) NOT NULL;
...
ALTER TABLE dump_config_regola MODIFY COLUMN payload_parsing VARCHAR(255) NOT NULL;

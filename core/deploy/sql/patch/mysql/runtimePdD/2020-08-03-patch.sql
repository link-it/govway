...
ALTER TABLE MSG_SERVIZI_APPLICATIVI MODIFY COLUMN TIPO_CONSEGNA VARCHAR(40);

UPDATE MSG_SERVIZI_APPLICATIVI SET ATTESA_ESITO=0 WHERE ATTESA_ESITO IS NULL;
ALTER TABLE MSG_SERVIZI_APPLICATIVI MODIFY COLUMN ATTESA_ESITO INT NOT NULL DEFAULT 0;

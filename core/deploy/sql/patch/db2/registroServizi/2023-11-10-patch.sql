ALTER TABLE accordi ALTER COLUMN descrizione SET DATA TYPE VARCHAR(4000);
...
ALTER TABLE servizi ALTER COLUMN descrizione SET DATA TYPE VARCHAR(4000);
...
ALTER TABLE scope ALTER COLUMN descrizione SET DATA TYPE VARCHAR(4000);
...
ALTER TABLE ruoli ALTER COLUMN descrizione SET DATA TYPE VARCHAR(4000);
...
ALTER TABLE gruppi ALTER COLUMN descrizione SET DATA TYPE VARCHAR(4000);

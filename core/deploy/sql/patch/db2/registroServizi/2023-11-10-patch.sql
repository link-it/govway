...
-- ALTER TABLE servizi ALTER COLUMN descrizione SET DATA TYPE CLOB;
...
CALL SYSPROC.ADMIN_CMD ('REORG TABLE servizi') ;
...
-- ALTER TABLE scope ALTER COLUMN descrizione SET DATA TYPE CLOB;
...
CALL SYSPROC.ADMIN_CMD ('REORG TABLE scope') ;
...
-- ALTER TABLE ruoli ALTER COLUMN descrizione SET DATA TYPE CLOB;
...
CALL SYSPROC.ADMIN_CMD ('REORG TABLE ruoli') ;
...
-- ALTER TABLE gruppi ALTER COLUMN descrizione SET DATA TYPE CLOB;
...
CALL SYSPROC.ADMIN_CMD ('REORG TABLE gruppi') ;

ALTER TABLE porte_applicative ADD validazione_contenuti_soapa VARCHAR(255);
ALTER TABLE porte_applicative ADD validazione_contenuti_json VARCHAR(255);
ALTER TABLE porte_applicative ADD validazione_contenuti_pat_and VARCHAR(255);
ALTER TABLE porte_applicative ADD validazione_contenuti_pat_not VARCHAR(255);

ALTER TABLE porte_delegate ADD validazione_contenuti_soapa VARCHAR(255);
ALTER TABLE porte_delegate ADD validazione_contenuti_json VARCHAR(255);
ALTER TABLE porte_delegate ADD validazione_contenuti_pat_and VARCHAR(255);
ALTER TABLE porte_delegate ADD validazione_contenuti_pat_not VARCHAR(255);

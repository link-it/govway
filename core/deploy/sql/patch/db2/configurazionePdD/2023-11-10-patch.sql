ALTER TABLE porte_applicative ALTER COLUMN descrizione SET DATA TYPE VARCHAR(4000);
...
ALTER TABLE porte_delegate ALTER COLUMN descrizione SET DATA TYPE VARCHAR(4000);
...
ALTER TABLE servizi_applicativi ALTER COLUMN descrizione SET DATA TYPE VARCHAR(4000);
...
ALTER TABLE generic_properties ALTER COLUMN descrizione SET DATA TYPE VARCHAR(4000);
...
ALTER TABLE generic_properties ADD data_ultima_modifica TIMESTAMP;

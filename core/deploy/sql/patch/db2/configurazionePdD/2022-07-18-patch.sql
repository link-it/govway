ALTER TABLE servizi_applicativi ADD token_policy VARCHAR(255);

ALTER TABLE porte_applicative ADD token_sa_stato VARCHAR(255);
ALTER TABLE porte_applicative ADD token_ruoli_stato VARCHAR(255);
ALTER TABLE porte_applicative ADD token_ruoli_match VARCHAR(255);
ALTER TABLE porte_applicative ADD token_ruoli_tipologia VARCHAR(255);

ALTER TABLE porte_delegate ADD token_sa_stato VARCHAR(255);
ALTER TABLE porte_delegate ADD token_ruoli_stato VARCHAR(255);
ALTER TABLE porte_delegate ADD token_ruoli_match VARCHAR(255);
ALTER TABLE porte_delegate ADD token_ruoli_tipologia VARCHAR(255);

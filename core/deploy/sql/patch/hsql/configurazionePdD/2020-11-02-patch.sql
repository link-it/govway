...
CREATE SEQUENCE seq_pa_val_pattern AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) NO CYCLE;
...
CREATE TABLE pa_val_pattern_init_seq (id BIGINT);
INSERT INTO pa_val_pattern_init_seq VALUES (NEXT VALUE FOR seq_pa_val_pattern);



CREATE SEQUENCE seq_pa_val_richiesta AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) NO CYCLE;
...
CREATE TABLE pa_val_richiesta_init_seq (id BIGINT);
INSERT INTO pa_val_richiesta_init_seq VALUES (NEXT VALUE FOR seq_pa_val_richiesta);



CREATE SEQUENCE seq_pa_val_risposta AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) NO CYCLE;
...
CREATE TABLE pa_val_risposta_init_seq (id BIGINT);
INSERT INTO pa_val_risposta_init_seq VALUES (NEXT VALUE FOR seq_pa_val_risposta);



CREATE SEQUENCE seq_pd_val_pattern AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) NO CYCLE;
...
CREATE TABLE pd_val_pattern_init_seq (id BIGINT);
INSERT INTO pd_val_pattern_init_seq VALUES (NEXT VALUE FOR seq_pd_val_pattern);



CREATE SEQUENCE seq_pd_val_richiesta AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) NO CYCLE;
...
CREATE TABLE pd_val_richiesta_init_seq (id BIGINT);
INSERT INTO pd_val_richiesta_init_seq VALUES (NEXT VALUE FOR seq_pd_val_richiesta);



CREATE SEQUENCE seq_pd_val_risposta AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) NO CYCLE;
...
CREATE TABLE pd_val_risposta_init_seq (id BIGINT);
INSERT INTO pd_val_risposta_init_seq VALUES (NEXT VALUE FOR seq_pd_val_risposta);

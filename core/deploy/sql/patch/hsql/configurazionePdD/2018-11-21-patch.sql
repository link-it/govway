...
ALTER TABLE porte_delegate ADD COLUMN cors_allow_origins VARCHAR(65535);
ALTER TABLE porte_delegate ADD COLUMN cors_allow_headers VARCHAR(65535);
ALTER TABLE porte_delegate ADD COLUMN cors_allow_methods VARCHAR(65535);
ALTER TABLE porte_delegate ADD COLUMN cors_allow_expose_headers VARCHAR(65535);
...
ALTER TABLE porte_applicative ADD COLUMN cors_allow_origins VARCHAR(65535);
ALTER TABLE porte_applicative ADD COLUMN cors_allow_headers VARCHAR(65535);
ALTER TABLE porte_applicative ADD COLUMN cors_allow_methods VARCHAR(65535);
ALTER TABLE porte_applicative ADD COLUMN cors_allow_expose_headers VARCHAR(65535);
...
ALTER TABLE configurazione ADD COLUMN cors_allow_origins VARCHAR(65535);
ALTER TABLE configurazione ADD COLUMN cors_allow_headers VARCHAR(65535);
ALTER TABLE configurazione ADD COLUMN cors_allow_methods VARCHAR(65535);
ALTER TABLE configurazione ADD COLUMN cors_allow_expose_headers VARCHAR(65535);

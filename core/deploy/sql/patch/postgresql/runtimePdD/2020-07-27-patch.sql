ALTER TABLE MSG_SERVIZI_APPLICATIVI ADD COLUMN ORA_REGISTRAZIONE TIMESTAMP;
...
ALTER TABLE DEFINIZIONE_MESSAGGI ADD COLUMN ORA_REGISTRAZIONE TIMESTAMP;
...
ALTER TABLE REPOSITORY_BUSTE ADD COLUMN DATA_REGISTRAZIONE TIMESTAMP;
...
ALTER TABLE LISTA_RISCONTRI ADD COLUMN DATA_REGISTRAZIONE TIMESTAMP;
...
ALTER TABLE LISTA_TRASMISSIONI ADD COLUMN DATA_REGISTRAZIONE TIMESTAMP;
...
ALTER TABLE LISTA_ECCEZIONI ADD COLUMN DATA_REGISTRAZIONE TIMESTAMP;
...
ALTER TABLE LISTA_EXT_PROTOCOL_INFO ADD COLUMN DATA_REGISTRAZIONE TIMESTAMP;
...
ALTER TABLE SEQUENZA_DA_INVIARE ADD COLUMN DATA_REGISTRAZIONE TIMESTAMP;
...
ALTER TABLE SEQUENZA_DA_RICEVERE ADD COLUMN DATA_REGISTRAZIONE TIMESTAMP;

...
ALTER TABLE servizi ALTER COLUMN descrizione TYPE TEXT;
...
ALTER TABLE servizi_fruitori ALTER COLUMN descrizione TYPE TEXT;
...
ALTER TABLE scope ALTER COLUMN descrizione TYPE TEXT;
...
ALTER TABLE ruoli ALTER COLUMN descrizione TYPE TEXT;
...
ALTER TABLE gruppi ALTER COLUMN descrizione TYPE TEXT;

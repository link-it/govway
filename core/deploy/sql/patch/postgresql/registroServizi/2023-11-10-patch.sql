ALTER TABLE accordi ALTER COLUMN descrizione TYPE VARCHAR(4000);
...
ALTER TABLE servizi ALTER COLUMN descrizione TYPE VARCHAR(4000);
...
ALTER TABLE servizi_fruitori ALTER COLUMN descrizione TYPE VARCHAR(4000);
...
ALTER TABLE scope ALTER COLUMN descrizione TYPE VARCHAR(4000);
...
ALTER TABLE ruoli ALTER COLUMN descrizione TYPE VARCHAR(4000);
...
ALTER TABLE gruppi ALTER COLUMN descrizione TYPE VARCHAR(4000);

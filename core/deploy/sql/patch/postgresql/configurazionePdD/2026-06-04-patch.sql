CREATE SEQUENCE seq_connettori_llm_binding start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 NO CYCLE;
...
(
	...
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_connettori_llm_binding') NOT NULL,
	-- unique constraints
...
CREATE SEQUENCE seq_connettori_llm start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 NO CYCLE;
...
(
	...
	id_connettore BIGINT NOT NULL,
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_connettori_llm') NOT NULL,
	-- unique constraints

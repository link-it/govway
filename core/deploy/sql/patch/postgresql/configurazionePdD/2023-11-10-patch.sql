ALTER TABLE porte_applicative ALTER COLUMN descrizione TYPE VARCHAR(4000);
...
ALTER TABLE porte_delegate ALTER COLUMN descrizione TYPE VARCHAR(4000);
...
ALTER TABLE servizi_applicativi ALTER COLUMN descrizione TYPE VARCHAR(4000);
...
ALTER TABLE generic_properties ALTER COLUMN descrizione TYPE VARCHAR(4000);
ALTER TABLE generic_properties ADD COLUMN utente_richiedente VARCHAR(255);
ALTER TABLE generic_properties ADD COLUMN data_creazione TIMESTAMP;
ALTER TABLE generic_properties ADD COLUMN utente_ultima_modifica VARCHAR(255);
ALTER TABLE generic_properties ADD COLUMN data_ultima_modifica TIMESTAMP;

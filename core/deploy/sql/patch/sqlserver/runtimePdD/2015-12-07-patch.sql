...
ALTER TABLE ID_MESSAGGIO DROP CONSTRAINT pk_ID_MESSAGGIO;
...
ALTER TABLE ID_MESSAGGIO_PRG DROP CONSTRAINT pk_ID_MESSAGGIO_PRG;
ALTER TABLE ID_MESSAGGIO_PRG ADD CONSTRAINT pk_ID_MESSAGGIO_PRG PRIMARY KEY (PROTOCOLLO);

ALTER TABLE ID_MESSAGGIO_RELATIVO_PRG DROP CONSTRAINT pk_ID_MESSAGGIO_RELATIVO_PRG;

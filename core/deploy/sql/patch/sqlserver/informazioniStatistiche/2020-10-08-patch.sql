...
ALTER TABLE statistiche_orarie ALTER COLUMN uri_api VARCHAR2(20) NOT NULL;
...
ALTER TABLE statistiche_giornaliere ALTER COLUMN uri_api VARCHAR2(20) NOT NULL;
...
ALTER TABLE statistiche_settimanali ALTER COLUMN uri_api VARCHAR2(20) NOT NULL;
...
ALTER TABLE statistiche_mensili ALTER COLUMN uri_api VARCHAR2(20) NOT NULL;

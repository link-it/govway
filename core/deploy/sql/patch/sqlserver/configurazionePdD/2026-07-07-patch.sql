...
ALTER TABLE configurazione ADD llm_cache_statocache VARCHAR(255);
ALTER TABLE configurazione ADD llm_cache_dimensionecache VARCHAR(255);
ALTER TABLE configurazione ADD llm_cache_algoritmocache VARCHAR(255);
ALTER TABLE configurazione ADD llm_cache_idlecache VARCHAR(255);

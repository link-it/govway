...
ALTER TABLE dump_config_regola ALTER COLUMN payload VARCHAR(255) NOT NULL;
...
ALTER TABLE dump_config_regola ALTER COLUMN payload_parsing VARCHAR(255) NOT NULL;

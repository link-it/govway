...
ALTER TABLE porte_delegate ADD cors_allow_origins VARCHAR(max);
ALTER TABLE porte_delegate ADD cors_allow_headers VARCHAR(max);
ALTER TABLE porte_delegate ADD cors_allow_methods VARCHAR(max);
ALTER TABLE porte_delegate ADD cors_allow_expose_headers VARCHAR(max);
...
ALTER TABLE porte_applicative ADD cors_allow_origins VARCHAR(max);
ALTER TABLE porte_applicative ADD cors_allow_headers VARCHAR(max);
ALTER TABLE porte_applicative ADD cors_allow_methods VARCHAR(max);
ALTER TABLE porte_applicative ADD cors_allow_expose_headers VARCHAR(max);
...
ALTER TABLE configurazione ADD cors_allow_origins VARCHAR(max);
ALTER TABLE configurazione ADD cors_allow_headers VARCHAR(max);
ALTER TABLE configurazione ADD cors_allow_methods VARCHAR(max);
ALTER TABLE configurazione ADD cors_allow_expose_headers VARCHAR(max);

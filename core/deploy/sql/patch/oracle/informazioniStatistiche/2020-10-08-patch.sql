...
ALTER TABLE statistiche_orarie MODIFY uri_api NOT NULL;
...
ALTER TABLE statistiche_giornaliere MODIFY uri_api NOT NULL;
...
ALTER TABLE statistiche_settimanali MODIFY uri_api NOT NULL;
...
ALTER TABLE statistiche_mensili MODIFY uri_api NOT NULL;

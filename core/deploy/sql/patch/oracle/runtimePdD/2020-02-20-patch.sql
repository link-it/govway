...
ALTER TABLE MSG_SERVIZI_APPLICATIVI ADD CLUSTER_ID VARCHAR2(255);
ALTER TABLE MSG_SERVIZI_APPLICATIVI ADD ATTESA_ESITO NUMBER;
ALTER TABLE MSG_SERVIZI_APPLICATIVI ADD ERRORE_PROCESSAMENTO_COMPACT VARCHAR2(255);

...
ALTER TABLE configurazione ADD llm_cache_statocache VARCHAR2(255);
ALTER TABLE configurazione ADD llm_cache_dimensionecache VARCHAR2(255);
ALTER TABLE configurazione ADD llm_cache_algoritmocache VARCHAR2(255);
ALTER TABLE configurazione ADD llm_cache_idlecache VARCHAR2(255);

...
CREATE SEQUENCE seq_congestion_config AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) NO CYCLE;
...
ALTER TABLE congestion_config ALTER COLUMN max_threads_enabled SET DEFAULT true;
ALTER TABLE congestion_config ALTER COLUMN max_threads_warning_only SET DEFAULT false;
ALTER TABLE congestion_config ALTER COLUMN max_threads_tipo_errore SET DEFAULT 'fault';
ALTER TABLE congestion_config ALTER COLUMN max_threads_includi_errore SET DEFAULT true;
ALTER TABLE congestion_config ALTER COLUMN cc_enabled SET DEFAULT false;
ALTER TABLE congestion_config ALTER COLUMN rt_tipo_errore SET DEFAULT 'fault';
ALTER TABLE congestion_config ALTER COLUMN rt_includi_errore SET DEFAULT true;
ALTER TABLE congestion_config ALTER COLUMN cache SET DEFAULT true;

CREATE TABLE congestion_config_init_seq (id BIGINT);
INSERT INTO congestion_config_init_seq VALUES (NEXT VALUE FOR seq_congestion_config);



CREATE SEQUENCE seq_congestion_config_policy AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) NO CYCLE;
...
ALTER TABLE congestion_config_policy ALTER COLUMN rt_simultanee SET DEFAULT false;
ALTER TABLE congestion_config_policy ALTER COLUMN rt_applicabilita SET DEFAULT 'sempre';
ALTER TABLE congestion_config_policy ALTER COLUMN rt_applicabilita_con_cc SET DEFAULT false;
ALTER TABLE congestion_config_policy ALTER COLUMN rt_applicabilita_degrado SET DEFAULT false;
ALTER TABLE congestion_config_policy ALTER COLUMN rt_applicabilita_allarme SET DEFAULT false;
ALTER TABLE congestion_config_policy ALTER COLUMN allarme_not_stato SET DEFAULT false;

CREATE TABLE congestion_config_policy_init_seq (id BIGINT);
INSERT INTO congestion_config_policy_init_seq VALUES (NEXT VALUE FOR seq_congestion_config_policy);



CREATE SEQUENCE seq_congestion_active_policy AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) NO CYCLE;
...
ALTER TABLE congestion_active_policy ALTER COLUMN policy_warning SET DEFAULT false;
ALTER TABLE congestion_active_policy ALTER COLUMN filtro_enabled SET DEFAULT false;
ALTER TABLE congestion_active_policy ALTER COLUMN filtro_key_enabled SET DEFAULT false;
ALTER TABLE congestion_active_policy ALTER COLUMN group_enabled SET DEFAULT false;
ALTER TABLE congestion_active_policy ALTER COLUMN group_ruolo SET DEFAULT false;
ALTER TABLE congestion_active_policy ALTER COLUMN group_protocollo SET DEFAULT false;
ALTER TABLE congestion_active_policy ALTER COLUMN group_fruitore SET DEFAULT false;
ALTER TABLE congestion_active_policy ALTER COLUMN group_sa_fruitore SET DEFAULT false;
ALTER TABLE congestion_active_policy ALTER COLUMN group_erogatore SET DEFAULT false;
ALTER TABLE congestion_active_policy ALTER COLUMN group_sa_erogatore SET DEFAULT false;
ALTER TABLE congestion_active_policy ALTER COLUMN group_servizio SET DEFAULT false;
ALTER TABLE congestion_active_policy ALTER COLUMN group_azione SET DEFAULT false;
ALTER TABLE congestion_active_policy ALTER COLUMN group_key_enabled SET DEFAULT false;

CREATE TABLE congestion_active_policy_init_seq (id BIGINT);
INSERT INTO congestion_active_policy_init_seq VALUES (NEXT VALUE FOR seq_congestion_active_policy);

...
CREATE SEQUENCE seq_api_resources_details AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) NO CYCLE;
...
CREATE TABLE api_resources_details_init_seq (id BIGINT);
INSERT INTO api_resources_details_init_seq VALUES (NEXT VALUE FOR seq_api_resources_details);

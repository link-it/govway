...
CREATE SEQUENCE seq_statistiche_orarie AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) CYCLE;
...
CREATE SEQUENCE seq_stat_orarie_contenuti AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) CYCLE;

CREATE TABLE stat_orarie_contenuti
(
	data TIMESTAMP NOT NULL,
	-- Risorsa Aggregata
	risorsa_nome VARCHAR(65535) NOT NULL,
...
CREATE TABLE stat_orarie_contenuti_init_seq (id BIGINT);
INSERT INTO stat_orarie_contenuti_init_seq VALUES (NEXT VALUE FOR seq_stat_orarie_contenuti);
...
CREATE SEQUENCE seq_statistiche_giornaliere AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) CYCLE;
...
CREATE SEQUENCE seq_stat_giorni_contenuti AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) CYCLE;
...
CREATE TABLE stat_giorni_contenuti_init_seq (id BIGINT);
INSERT INTO stat_giorni_contenuti_init_seq VALUES (NEXT VALUE FOR seq_stat_giorni_contenuti);
...
CREATE SEQUENCE seq_statistiche_settimanali AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) CYCLE;
...
CREATE SEQUENCE seq_stat_settimane_contenuti AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) CYCLE;
...
CREATE TABLE stat_settimane_contenuti_init_seq (id BIGINT);
INSERT INTO stat_settimane_contenuti_init_seq VALUES (NEXT VALUE FOR seq_stat_settimane_contenuti);



-- STATISTICHE MENSILI

CREATE SEQUENCE seq_statistiche_mensili AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) CYCLE;
...
CREATE SEQUENCE seq_stat_mensili_contenuti AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) CYCLE;
...
CREATE TABLE stat_mensili_contenuti_init_seq (id BIGINT);
INSERT INTO stat_mensili_contenuti_init_seq VALUES (NEXT VALUE FOR seq_stat_mensili_contenuti);

...
(
	...
	error_log VARCHAR(65535),
	warning_log VARCHAR(65535),
...
CREATE SEQUENCE seq_transazioni_llm AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) CYCLE;
...
CREATE TABLE transazioni_llm_init_seq (id BIGINT);
INSERT INTO transazioni_llm_init_seq VALUES (NEXT VALUE FOR seq_transazioni_llm);
...
CREATE SEQUENCE seq_transazioni_esiti AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) CYCLE;
...
CREATE SEQUENCE seq_transazioni_classe_esiti AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) CYCLE;
...
(
	...
	post_processed INT,
	multipart_header_ext LONGVARCHAR,
	header_ext LONGVARCHAR,
	-- fk/pk columns
	id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	-- check constraints

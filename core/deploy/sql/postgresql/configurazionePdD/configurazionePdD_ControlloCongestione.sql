...
CREATE SEQUENCE seq_congestion_config start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 NO CYCLE;
...
(
	...
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_congestion_config') NOT NULL,
	-- check constraints
...
CREATE SEQUENCE seq_congestion_config_policy start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 NO CYCLE;
...
(
	...
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_congestion_config_policy') NOT NULL,
	-- check constraints
...
CREATE SEQUENCE seq_congestion_active_policy start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 NO CYCLE;
...
(
	...
	group_key_name TEXT,
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_congestion_active_policy') NOT NULL,
	-- check constraints

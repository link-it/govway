...
CREATE SEQUENCE seq_statistiche_orarie start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 CYCLE;
...
(
	...
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_statistiche_orarie') NOT NULL,
	-- check constraints
...
CREATE SEQUENCE seq_stat_orarie_contenuti start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 CYCLE;
...
(
	...
	latenza_servizio BIGINT,
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_stat_orarie_contenuti') NOT NULL,
...
CREATE SEQUENCE seq_stat_orarie_llm start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 CYCLE;
...
(
	...
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_stat_orarie_llm') NOT NULL,
	id_stat BIGINT NOT NULL,
	-- fk/pk keys constraints
...
CREATE SEQUENCE seq_statistiche_giornaliere start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 CYCLE;
...
(
	...
	latenza_servizio BIGINT,
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_statistiche_giornaliere') NOT NULL,
	-- check constraints
...
CREATE SEQUENCE seq_stat_giorni_contenuti start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 CYCLE;
...
(
	...
	latenza_servizio BIGINT,
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_stat_giorni_contenuti') NOT NULL,
	id_stat BIGINT NOT NULL,
	-- fk/pk keys constraints
...
CREATE SEQUENCE seq_stat_giorni_llm start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 CYCLE;
...
(
	...
	cost_estimated DOUBLE PRECISION,
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_stat_giorni_llm') NOT NULL,
	id_stat BIGINT NOT NULL,
	-- fk/pk keys constraints
...
CREATE SEQUENCE seq_statistiche_settimanali start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 CYCLE;
...
(
	...
	latenza_servizio BIGINT,
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_statistiche_settimanali') NOT NULL,
	-- check constraints
...
CREATE SEQUENCE seq_stat_settimane_contenuti start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 CYCLE;
...
(
	...
	latenza_servizio BIGINT,
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_stat_settimane_contenuti') NOT NULL,
	id_stat BIGINT NOT NULL,
	-- fk/pk keys constraints
...
CREATE SEQUENCE seq_statistiche_mensili start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 CYCLE;
...
(
	...
	latenza_servizio BIGINT,
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_statistiche_mensili') NOT NULL,
	-- check constraints
...
CREATE SEQUENCE seq_stat_mensili_contenuti start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 CYCLE;
...
(
	...
	latenza_servizio BIGINT,
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_stat_mensili_contenuti') NOT NULL,
	id_stat BIGINT NOT NULL,
	-- fk/pk keys constraints

function get_traccia_trasmissione(id_transazione, tipo_messaggio) {
    ...
    dbquery = "select * from tracce_trasmissioni where idtraccia=(select id from tracce where id_transazione='"+id_transazione+"' and tipo_messaggio='"+tipo_messaggio+"')"

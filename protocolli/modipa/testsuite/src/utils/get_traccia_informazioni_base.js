function get_traccia_informazioni_base(id_transazione, tipo_messaggio) {
    ...
    dbquery = "select * from tracce where id_transazione='"+id_transazione+"' and tipo_messaggio='"+tipo_messaggio+"'"

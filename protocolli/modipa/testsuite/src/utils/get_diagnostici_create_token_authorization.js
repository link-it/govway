function get_diagnostici_create_token_audit(id_transazione) {
    ...
    dbquery = "select * from msgdiagnostici where id_transazione='"+id_transazione+"' and messaggio LIKE 'Creazione security token ModI %ID_AUTH% della richiesta effettuata con successo%'"

...
/**
* BloccanteRestSicurezzaMessaggioFixKarateRichiestaVuotaTest
*
...
public class BloccanteRestSicurezzaMessaggioFixKarateRichiestaVuotaTest extends ConfigLoader {
    ...
    public static void beforeClass() {       
        File file = ResourceUtils.getFileRelativeTo(BloccanteRestSicurezzaMessaggioFixKarateRichiestaVuotaTest.class, "mock.feature");
        server = MockServer
                .feature(file)
        ...
        file = ResourceUtils.getFileRelativeTo(BloccanteRestSicurezzaMessaggioFixKarateRichiestaVuotaTest.class, "proxy.feature");
        proxy = MockServer
    			.feature(file)
    			.args(new HashMap<String,Object>((Map) prop))

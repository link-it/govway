...
public class BloccanteRestSicurezzaMessaggioFixKarateRichiestaVuotaTest extends ConfigLoader {
    ...
    public static void beforeClass() {       
        File file = FileUtils.getFileRelativeTo(BloccanteRestSicurezzaMessaggioFixKarateRichiestaVuotaTest.class, "mock.feature");
        server = FeatureServer.start(file, Integer.valueOf(prop.getProperty("http_mock_port")), false, new HashMap<String,Object>((Map) prop));

        file = FileUtils.getFileRelativeTo(BloccanteRestSicurezzaMessaggioFixKarateRichiestaVuotaTest.class, "proxy.feature");

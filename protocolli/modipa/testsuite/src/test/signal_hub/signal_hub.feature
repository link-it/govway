...
Scenario: Informazioni crittografiche non disponibili per servizio senza digest richiesta; viene verificato che la richiesta arrivi al backend
...
Scenario: push del segnale di erogazione senza pseudoanonimizzazione (verifica sul mock) con serviceId multipli e con descriptorId noDigest2 
...
Scenario: push del segnale di erogazione con pseudoanonimizzazione (verifica sul mock) con serviceId multipli e con descriptorId yesDigest1 

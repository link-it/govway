...
Given url govway_base_path + "/rest/out/DemoSoggettoFruitore/DemoSoggettoErogatore/TestRecuperoInformazioniPDNDAuth/v3"
And path 'test'
...
And header simulazionepdnd-audience = 'TestRecuperoInformazioniPDNDAuth/v3'
When method post
Then status 200
...
Given url govway_base_path + "/rest/out/DemoSoggettoFruitore/DemoSoggettoErogatore/TestRecuperoInformazioniPDNDIntegrity/v3"
And path 'test'
And request read('request.json')
...
And header simulazionepdnd-audience = 'TestRecuperoInformazioniPDNDIntegrity/v3'

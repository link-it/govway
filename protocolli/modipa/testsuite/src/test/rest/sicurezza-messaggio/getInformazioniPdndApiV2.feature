...
* def expectedOrgName = 'Comune di Esempio '+formattedDate+' ApplicativoBlockingIDA01'
* def pdndOrganizationName = get_credenziale_by_refid_and_value('pdnd_org_name',clientIdID,expectedOrgName)
* match pdndOrganizationName == expectedOrgName

* def pdndOrganizationJson = get_credenziale_by_refid_and_value('pdnd_org_json',clientIdID,'"c_c000_'+formattedDate+'_0002"')
* match pdndOrganizationJson contains '"kind":"PA"'
* match pdndOrganizationJson contains '"subUnitType":"AOO"'
* match pdndOrganizationJson contains '"externalId":'
...
* def expectedOrgName = 'Comune di Esempio '+formattedDate+' ApplicativoBlockingJWK'
* def pdndOrganizationName = get_credenziale_by_refid_and_value('pdnd_org_name',clientIdID,expectedOrgName)
* match pdndOrganizationName == expectedOrgName

* def pdndOrganizationJson = get_credenziale_by_refid_and_value('pdnd_org_json',clientIdID,'"c_c000_'+formattedDate+'_0003"')
* match pdndOrganizationJson contains '"kind":"PA"'
* match pdndOrganizationJson contains '"subUnitType":"AOO"'
* match pdndOrganizationJson contains '"externalId":'

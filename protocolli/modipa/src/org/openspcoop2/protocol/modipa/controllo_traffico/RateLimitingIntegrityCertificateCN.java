...
/**
 * RateLimitingIntegrityCertificateCN
 *
 * @author Andrea Poli (poli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public class RateLimitingIntegrityCertificateCN extends AbstractModIRateLimiting {
	...
	protected String estraiValore(Logger log, SecurityToken securityToken, Dati datiRichiesta) throws PluginsException {
		...
		String cn = subject.getCN();
		if(cn == null || CertificatePrincipal.CN_EMPTY.equals(cn)) {
			throw new PluginsException("CN non presente nel certificato di firma ModI");
		}
		return cn;
	}

	...
	public ConsoleConfiguration getDynamicConfigServizioApplicativo(ConsoleOperationType consoleOperationType, IConsoleHelper consoleHelper, IRegistryReader registryReader,
		...
		if(isClient) {
			if(!esterno) {
				...
				BaseConsoleItem subTitoloMODI_AUTH = ProtocolPropertiesFactory.newSubTitleItem(
				...
				configuration.addConsoleItem(subTitoloMODI_AUTH);
			}
			...
			if(booleanModeItemValue!=null && booleanModeItemValue.getValue()!=null && booleanModeItemValue.getValue()) {
				...
				*/			
				...
				if(subTitoloMODI_AUTH!=null) {
					subTitoloMODI_AUTH.setType(ConsoleItemType.SUBTITLE);
				}
...
//								}
				...
				if(profiloSicurezzaMessaggioRestJtiAsIdMessaggioItem!=null) {
					if(profiloSicurezzaMessaggioRestJtiItemValue!=null && ModIConsoleCostanti.MODIPA_API_IMPL_PROFILO_SICUREZZA_MESSAGGIO_DOPPI_HEADER_JTI_VALUE_DIFFERENT.equals(profiloSicurezzaMessaggioRestJtiItemValue.getValue())) {
						...
						if(profiloSicurezzaMessaggioRestJtiAsIdMessaggioItemValue!=null) {
							if(profiloSicurezzaMessaggioRestJtiAsIdMessaggioItemValue.getValue()==null) {
	...
	private void addTrustStoreSSLConfig_choice(ConsoleConfiguration configuration, boolean x5u) throws ProtocolException {
		_addTrustStoreConfig_choice(configuration, true, false, false, false, x5u);
	}
	private void addTrustStoreCertificatiConfig_choice(ConsoleConfiguration configuration, boolean x5u) throws ProtocolException {
		_addTrustStoreConfig_choice(configuration, false, true, false, false, x5u);
	}
	private void addTrustStoreKeystoreErogazioneConfig_choice(ConsoleConfiguration configuration) throws ProtocolException {
		_addTrustStoreConfig_choice(configuration, false, false, true, false, false);
	}
	private void addTrustStoreKeystoreFruizioneConfig_choice(ConsoleConfiguration configuration) throws ProtocolException {
		_addTrustStoreConfig_choice(configuration, false, false, false, true, false);
	}
	private void _addTrustStoreConfig_choice(ConsoleConfiguration configuration, boolean ssl, boolean truststore, boolean keystoreErogazione, boolean keystoreFruizione, boolean x5u) throws ProtocolException {
	...
	private void updateTrustConfig(ConsoleConfiguration consoleConfiguration, ProtocolProperties properties, boolean ssl, boolean x5u, boolean requiredValue) throws ProtocolException {
		...
		boolean ocsp = (ridefinisci && ocspProvider.isOcspEnabled());

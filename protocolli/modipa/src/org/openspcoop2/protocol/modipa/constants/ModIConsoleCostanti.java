...
public class ModIConsoleCostanti {
    ...
    public static final String MODIPA_LABEL_UNDEFINED = CostantiLabel.MODIPA_LABEL_UNDEFINED;
	...
	public static final String MODIPA_KEYSTORE_FRUIZIONE_TOKEN_POLICY = ModICostanti.MODIPA_KEYSTORE_FRUIZIONE_TOKEN_POLICY;

	// DPoP Keystore - Applicativo
	public static final String MODIPA_DPOP_SUBTITLE_LABEL = ModICostanti.MODIPA_DPOP_SUBTITLE_LABEL;
	public static final String MODIPA_DPOP_SUBTITLE_ID = "modipaDPoPSubtitleId";

	public static final String MODIPA_DPOP_STATO_LABEL = ModICostanti.MODIPA_DPOP_STATO_LABEL;
	public static final String MODIPA_DPOP_STATO_ID = ModICostanti.MODIPA_DPOP_STATO;

	public static final String MODIPA_DPOP_KEYSTORE_MODE_LABEL = MODIPA_KEYSTORE_MODE_LABEL;
	public static final String MODIPA_DPOP_KEYSTORE_MODE_ID = ModICostanti.MODIPA_DPOP_KEYSTORE_MODE;
	public static final String MODIPA_DPOP_KEYSTORE_MODE_VALUE_ARCHIVE = MODIPA_KEYSTORE_MODE_VALUE_ARCHIVE;
	public static final String MODIPA_DPOP_KEYSTORE_MODE_LABEL_ARCHIVE = MODIPA_KEYSTORE_MODE_LABEL_ARCHIVE;
	public static final String MODIPA_DPOP_KEYSTORE_MODE_VALUE_PATH = MODIPA_KEYSTORE_MODE_VALUE_PATH;
	public static final String MODIPA_DPOP_KEYSTORE_MODE_LABEL_PATH = MODIPA_KEYSTORE_MODE_LABEL_PATH;
	public static final String MODIPA_DPOP_KEYSTORE_MODE_VALUE_HSM = MODIPA_KEYSTORE_MODE_VALUE_HSM;
	public static final String MODIPA_DPOP_KEYSTORE_MODE_LABEL_HSM = MODIPA_KEYSTORE_MODE_LABEL_HSM;
	public static final String MODIPA_DPOP_KEYSTORE_MODE_DEFAULT_VALUE = MODIPA_KEYSTORE_MODE_VALUE_PATH;

	public static final String MODIPA_DPOP_KEYSTORE_ARCHIVE_LABEL = MODIPA_KEYSTORE_ARCHIVE_LABEL;
	public static final String MODIPA_DPOP_KEYSTORE_ARCHIVE_ID = ModICostanti.MODIPA_DPOP_KEYSTORE_ARCHIVE;

	public static final String MODIPA_DPOP_KEYSTORE_PATH_LABEL = MODIPA_KEYSTORE_PATH_LABEL;
	public static final String MODIPA_DPOP_KEYSTORE_PATH_ID = ModICostanti.MODIPA_DPOP_KEYSTORE_PATH;

	public static final String MODIPA_DPOP_KEYSTORE_TYPE_LABEL = MODIPA_KEYSTORE_TYPE_LABEL;
	public static final String MODIPA_DPOP_KEYSTORE_TYPE_ID = ModICostanti.MODIPA_DPOP_KEYSTORE_TYPE;
	public static final String MODIPA_DPOP_KEYSTORE_TYPE_DEFAULT_VALUE = MODIPA_KEYSTORE_TYPE_DEFAULT_VALUE;

	public static final String MODIPA_DPOP_KEYSTORE_PATH_PUBLIC_KEY_LABEL = MODIPA_KEYSTORE_PATH_PUBLIC_KEY_LABEL;
	public static final String MODIPA_DPOP_KEYSTORE_PATH_PUBLIC_KEY_ID = ModICostanti.MODIPA_DPOP_KEYSTORE_PATH_PUBLIC_KEY;

	public static final String MODIPA_DPOP_KEYSTORE_KEY_ALGORITHM_LABEL = MODIPA_KEYSTORE_KEY_ALGORITHM_LABEL;
	public static final String MODIPA_DPOP_KEYSTORE_KEY_ALGORITHM_ID = ModICostanti.MODIPA_DPOP_KEYSTORE_KEY_ALGORITHM;
	public static final String MODIPA_DPOP_KEYSTORE_KEY_ALGORITHM_DEFAULT_VALUE = MODIPA_KEYSTORE_KEY_ALGORITHM_DEFAULT_VALUE;

	public static final String MODIPA_DPOP_KEYSTORE_PASSWORD_LABEL = MODIPA_KEYSTORE_PASSWORD_LABEL;
	public static final String MODIPA_DPOP_KEYSTORE_PASSWORD_ID = ModICostanti.MODIPA_DPOP_KEYSTORE_PASSWORD;

	public static final String MODIPA_DPOP_KEYSTORE_BYOK_POLICY_LABEL = MODIPA_KEYSTORE_BYOK_POLICY_LABEL;
	public static final String MODIPA_DPOP_KEYSTORE_BYOK_POLICY_ID = ModICostanti.MODIPA_DPOP_KEYSTORE_BYOK_POLICY;

	public static final String MODIPA_DPOP_KEY_ALIAS_LABEL = MODIPA_KEY_ALIAS_LABEL;
	public static final String MODIPA_DPOP_KEY_ALIAS_ID = ModICostanti.MODIPA_DPOP_KEY_ALIAS;

	public static final String MODIPA_DPOP_KEY_PASSWORD_LABEL = MODIPA_KEY_PASSWORD_LABEL;
	public static final String MODIPA_DPOP_KEY_PASSWORD_ID = ModICostanti.MODIPA_DPOP_KEY_PASSWORD;

	// DPoP Keystore - Fruizione
	public static final String MODIPA_DPOP_FRUIZIONE_KEYSTORE_SUBTITLE_LABEL = ModICostanti.MODIPA_DPOP_SUBTITLE_LABEL;
	public static final String MODIPA_DPOP_FRUIZIONE_KEYSTORE_SUBTITLE_ID = "modipaDPoPFruizioneSubtitleId";

	public static final String MODIPA_DPOP_FRUIZIONE_KEYSTORE_MODE_LABEL = ModICostanti.MODIPA_DPOP_FRUIZIONE_KEYSTORE_MODE_LABEL;
	public static final String MODIPA_DPOP_FRUIZIONE_KEYSTORE_MODE_ID = ModICostanti.MODIPA_DPOP_FRUIZIONE_KEYSTORE_MODE;
	public static final String MODIPA_DPOP_FRUIZIONE_KEYSTORE_MODE_VALUE_UNDEFINED = MODIPA_PROFILO_MODE_VALUE_UNDEFINED;
	public static final String MODIPA_DPOP_FRUIZIONE_KEYSTORE_MODE_LABEL_UNDEFINED = ModICostanti.MODIPA_DPOP_FRUIZIONE_KEYSTORE_MODE_LABEL_UNDEFINED;
	public static final String MODIPA_DPOP_FRUIZIONE_KEYSTORE_MODE_VALUE_DEFAULT = MODIPA_PROFILO_MODE_VALUE_DEFAULT;
	public static final String MODIPA_DPOP_FRUIZIONE_KEYSTORE_MODE_LABEL_DEFAULT = ModICostanti.MODIPA_DPOP_FRUIZIONE_KEYSTORE_MODE_LABEL_DEFAULT;
	public static final String MODIPA_DPOP_FRUIZIONE_KEYSTORE_MODE_VALUE_RIDEFINITO = MODIPA_PROFILO_MODE_VALUE_RIDEFINISCI;
	public static final String MODIPA_DPOP_FRUIZIONE_KEYSTORE_MODE_LABEL_RIDEFINITO = ModICostanti.MODIPA_DPOP_FRUIZIONE_KEYSTORE_MODE_LABEL_RIDEFINISCI;
	public static final String MODIPA_DPOP_FRUIZIONE_KEYSTORE_MODE_DEFAULT_VALUE = MODIPA_DPOP_FRUIZIONE_KEYSTORE_MODE_VALUE_UNDEFINED;

	// DPoP Fruizione - Title sezione autonoma
	public static final String MODIPA_API_IMPL_DPOP_TITLE_LABEL = MODIPA_TITLE_LABEL+" - DPoP";
	public static final String MODIPA_API_IMPL_DPOP_TITLE_ID = "modipaAPIImplDPoPTitleId";
    ...
    // DPoP a livello API
    public static final String MODIPA_PROFILO_SICUREZZA_MESSAGGIO_DPOP_ID = ModICostanti.MODIPA_PROFILO_SICUREZZA_MESSAGGIO_DPOP;
    public static final String MODIPA_PROFILO_SICUREZZA_MESSAGGIO_DPOP_LABEL = CostantiLabel.MODIPA_PROFILO_SICUREZZA_MESSAGGIO_DPOP_LABEL;
    public static final String MODIPA_PROFILO_SICUREZZA_MESSAGGIO_DPOP_LABEL_RIGHT = "Proof-of-Possession (REST_JWS_2021_POP)";
    public static final boolean MODIPA_PROFILO_SICUREZZA_MESSAGGIO_DPOP_DEFAULT_VALUE = false;
    ...
    public static final String MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_NOTE = "Attenzione: la gestione dell'integrità (Digest e signed_header) è demandata all'applicazione";
    ...
    public static final String MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_LABEL = CostantiLabel.MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_LABEL;
    public static final String MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_ACCESSIBLE_LABEL = CostantiLabel.MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_ACCESSIBLE_LABEL;
    public static final String MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_ID = ModICostanti.MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE;
    public static final String MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_VALUE_PAYLOAD_HTTP = ModICostanti.MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_VALUE_PAYLOAD_HTTP;
    public static final String MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_LABEL_PAYLOAD_HTTP = CostantiLabel.MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_LABEL_PAYLOAD_HTTP;
    public static final String MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_VALUE_ALWAYS = ModICostanti.MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_VALUE_ALWAYS;
    public static final String MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_LABEL_ALWAYS = CostantiLabel.MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_LABEL_ALWAYS;
    public static final String MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_VALUE_RICHIESTE_CON_PAYLOAD_HTTP_QUALSIASI_RISPOSTA = ModICostanti.MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_VALUE_RICHIESTE_CON_PAYLOAD_HTTP_QUALSIASI_RISPOSTA;
    public static final String MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_LABEL_RICHIESTE_CON_PAYLOAD_HTTP_QUALSIASI_RISPOSTA = CostantiLabel.MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_LABEL_RICHIESTE_CON_PAYLOAD_HTTP_QUALSIASI_RISPOSTA;
    public static final String MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_VALUE_RISPOSTE_CON_PAYLOAD_HTTP_QUALSIASI_RICHIESTA = ModICostanti.MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_VALUE_RISPOSTE_CON_PAYLOAD_HTTP_QUALSIASI_RICHIESTA;
    public static final String MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_LABEL_RISPOSTE_CON_PAYLOAD_HTTP_QUALSIASI_RICHIESTA = CostantiLabel.MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_LABEL_RISPOSTE_CON_PAYLOAD_HTTP_QUALSIASI_RICHIESTA;
    public static final String MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_DEFAULT_VALUE = MODIPA_PROFILO_SICUREZZA_MESSAGGIO_HEADER_CUSTOM_MODE_VALUE_PAYLOAD_HTTP;
	...
	// I campi audience sono single-line (validazione), ma resi come textarea multi-riga di larghezza standard vista la complessità del valore (es. array '["a","b"]')
	public static final int MODIPA_API_IMPL_PROFILO_SICUREZZA_MESSAGGIO_AUDIENCE_ROWS = 2;
	public static final int MODIPA_API_IMPL_PROFILO_SICUREZZA_MESSAGGIO_AUDIENCE_COLUMNS = CostantiLabel.TEXT_AREA_SINGLE_LINE_COLUMNS;
	...
	public static final int MODIPA_API_IMPL_PROFILO_SICUREZZA_MESSAGGIO_TRUSTSTORE_CRLS_ROWS = 2;
	public static final int MODIPA_API_IMPL_PROFILO_SICUREZZA_MESSAGGIO_TRUSTSTORE_CRLS_COLUMNS = CostantiLabel.TEXT_AREA_SINGLE_LINE_COLUMNS;
    ...
    public static final String MODIPA_API_IMPL_PROFILO_SICUREZZA_MESSAGGIO_FRUIZIONE_KEYSTORE_MODE_LABEL_TOKEN_POLICY = CostantiLabel.MODIPA_API_IMPL_PROFILO_SICUREZZA_MESSAGGIO_FRUIZIONE_KEYSTORE_MODE_LABEL_TOKEN_POLICY;

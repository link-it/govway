...
/**     
 * Enumeration dell'elemento completionMode.mode xsd (tipo:string) 
 *
...
public enum Mode implements IEnumeration , Serializable , Cloneable {
	...
	public boolean equals(Mode object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		...
		return this.equals(((Mode)object));
	}
	...
	public static Mode toEnumConstant(String value){
		try{
	...
	public static Mode toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		Mode res = null;
		for (Mode tmp : values()) {

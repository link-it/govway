...
/**
 * GestioneUtentiWrappedDocumentLiteralSoapBindingStub.java
 *
...
public class GestioneUtentiWrappedDocumentLiteralSoapBindingStub extends org.apache.axis.client.Stub implements org.openspcoop2.ValidazioneContenutiWS.Service.GestioneUtentiWrappedDocumentLiteral {
    ...
    static {
        GestioneUtentiWrappedDocumentLiteralSoapBindingStub._operations = new org.apache.axis.description.OperationDesc[2];
        GestioneUtentiWrappedDocumentLiteralSoapBindingStub._initOperationDesc1();
    }
    ...
    private static void _initOperationDesc1(){
        ...
        GestioneUtentiWrappedDocumentLiteralSoapBindingStub._operations[0] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("eliminazioneUtenteWDL");
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://openspcoop2.org/ValidazioneContenutiWS/Service/types/esempio1", "eliminazioneUtenteWDLResponseType"));
        oper.setReturnClass(org.openspcoop2.ValidazioneContenutiWS.Service.types.esempio1.EliminazioneUtenteWDLResponseType.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://openspcoop2.org/ValidazioneContenutiWS/Service/types", "eliminazioneUtenteWDLResponse"));
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        GestioneUtentiWrappedDocumentLiteralSoapBindingStub._operations[1] = oper;

    }

    public GestioneUtentiWrappedDocumentLiteralSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public GestioneUtentiWrappedDocumentLiteralSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public GestioneUtentiWrappedDocumentLiteralSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://openspcoop2.org/ValidazioneContenutiWS/Service/types/esempio1", "eliminazioneUtenteWDLRequestType");
            this.cachedSerQNames.add(qName);
            cls = org.openspcoop2.ValidazioneContenutiWS.Service.types.esempio1.EliminazioneUtenteWDLRequestType.class;
            this.cachedSerClasses.add(cls);
            this.cachedSerFactories.add(beansf);
            this.cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://openspcoop2.org/ValidazioneContenutiWS/Service/types/esempio1", "eliminazioneUtenteWDLResponseType");
            this.cachedSerQNames.add(qName);
            cls = org.openspcoop2.ValidazioneContenutiWS.Service.types.esempio1.EliminazioneUtenteWDLResponseType.class;
            this.cachedSerClasses.add(cls);
            this.cachedSerFactories.add(beansf);
            this.cachedDeserFactories.add(beandf);
	...
	public org.openspcoop2.ValidazioneContenutiWS.Service.types.esempio1.RegistrazioneUtenteWDLResponseType registrazioneUtenteWDL(org.openspcoop2.ValidazioneContenutiWS.Service.types.esempio1.RegistrazioneUtenteWDLRequestType argomentoWrapped) throws java.rmi.RemoteException {
        ...
        _call.setOperation(GestioneUtentiWrappedDocumentLiteralSoapBindingStub._operations[0]);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {argomentoWrapped});
  ...
  throw axisFaultException;
	...
	public org.openspcoop2.ValidazioneContenutiWS.Service.types.esempio1.EliminazioneUtenteWDLResponseType eliminazioneUtenteWDL(org.openspcoop2.ValidazioneContenutiWS.Service.types.esempio1.EliminazioneUtenteWDLRequestType argomentoWrapped) throws java.rmi.RemoteException {
        ...
        org.apache.axis.client.Call _call = createCall();
        _call.setOperation(GestioneUtentiWrappedDocumentLiteralSoapBindingStub._operations[1]);
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("eliminazioneUtenteWDL");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "eliminazioneUtenteWDL"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {argomentoWrapped});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (org.openspcoop2.ValidazioneContenutiWS.Service.types.esempio1.EliminazioneUtenteWDLResponseType) _resp;
            } catch (java.lang.Exception _exception) {
                return (org.openspcoop2.ValidazioneContenutiWS.Service.types.esempio1.EliminazioneUtenteWDLResponseType) org.apache.axis.utils.JavaUtils.convert(_resp, org.openspcoop2.ValidazioneContenutiWS.Service.types.esempio1.EliminazioneUtenteWDLResponseType.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;

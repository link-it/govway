...
/**
 * GestioneUtentiRPCEncodedSoapBindingStub.java
 *
...
public class GestioneUtentiRPCEncodedSoapBindingStub extends org.apache.axis.client.Stub implements org.openspcoop2.ValidazioneContenutiWS.Service.GestioneUtentiRPCEncoded {


    static org.apache.axis.description.OperationDesc [] _operations;

    static {
        GestioneUtentiRPCEncodedSoapBindingStub._operations = new org.apache.axis.description.OperationDesc[2];
        GestioneUtentiRPCEncodedSoapBindingStub._initOperationDesc1();
    }
    ...
    private static void _initOperationDesc1(){
        ...
        GestioneUtentiRPCEncodedSoapBindingStub._operations[0] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("eliminazioneUtenteRPCE");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://openspcoop2.org/ValidazioneContenutiWS/Service/types", "nominativo"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        oper.setReturnClass(java.lang.String.class);
        ...
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        GestioneUtentiRPCEncodedSoapBindingStub._operations[1] = oper;

    }

    public GestioneUtentiRPCEncodedSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public GestioneUtentiRPCEncodedSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public GestioneUtentiRPCEncodedSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
	...
	public java.lang.String registrazioneUtenteRPCE(java.lang.String nominativoUtente, java.lang.String indirizzoUtente, java.util.Date oraRegistrazioneUtente) throws java.rmi.RemoteException {
        ...
        _call.setOperation(GestioneUtentiRPCEncodedSoapBindingStub._operations[0]);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {nominativoUtente, indirizzoUtente, oraRegistrazioneUtente});
  ...
  throw axisFaultException;
	...
	public java.lang.String eliminazioneUtenteRPCE(java.lang.String nominativoUtente) throws java.rmi.RemoteException {
        ...
        org.apache.axis.client.Call _call = createCall();
        _call.setOperation(GestioneUtentiRPCEncodedSoapBindingStub._operations[1]);
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("eliminazioneUtenteRPCE");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://openspcoop2.org/ValidazioneContenutiWS/Service/types", "eliminazioneUtenteRPCE"));

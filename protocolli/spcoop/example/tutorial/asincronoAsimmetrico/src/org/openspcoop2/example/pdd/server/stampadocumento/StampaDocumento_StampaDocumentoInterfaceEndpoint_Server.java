 ...
 * @version $Rev$, $Date$
 */
public class StampaDocumento_StampaDocumentoInterfaceEndpoint_Server{

    protected StampaDocumento_StampaDocumentoInterfaceEndpoint_Server(String endpoint) throws Exception {
        System.out.println("Starting Server");
        Object implementor = new StampaDocumentoImpl();
    ...
    public static void main(String args[]) throws Exception { 
        ...
        new StampaDocumento_StampaDocumentoInterfaceEndpoint_Server(endpoint);

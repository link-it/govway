...
public class BusteEGov11LineeGuida11 {
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".OWENG", ID_GRUPPO+".SENG",
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".VerificaReturnCodeOneway"})
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".VerificaReturnCodeOneway"},dataProvider="testVerificaReturnCodeOneway",dependsOnMethods="VerificaReturnCodeOneway")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".OWENG"},
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".OWENG"},
		...
		try{
			...
			Assert.assertTrue(data.getVerificatoreTracciaRichiesta().isTracedOraRegistrazione(id,SPCoopCostanti.TIPO_TEMPO_SPC,TipoOraRegistrazione.SINCRONIZZATO));
			Reporter.log("Controllo valore Servizio Busta con id: " +id);
			Assert.assertTrue(data.getVerificatoreTracciaRichiesta().isTracedServizio(id, this.busteEGov.getDatiServizioRichiesta(index)));
			Reporter.log("Controllo valore Azione Busta con id: " +id);
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".SENG"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".OWEAG"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".SEAG"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".OWEAG_FC"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".OWEAG_FC_CDATA"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".TMDSPC"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".TMDSPC"},
		...
		try{
			...
			Reporter.log("Controllo valore Mittente Busta con id: " +id);
			Assert.assertTrue(data.getVerificatoreTracciaRisposta().isTracedMittente(id,this.busteEGov.getDestinatarioRisposta(index), this.busteEGov.getIndirizzoTelematicoDestinatario(index)));
			Reporter.log("Controllo valore Destinatario Busta con id: " +id);
			Assert.assertTrue(data.getVerificatoreTracciaRisposta().isTracedDestinatario(id,this.busteEGov.getMittenteRisposta(index),this.busteEGov.getIndirizzoTelematicoMittente(index)));
			Reporter.log("Controllo valore OraRegistrazione con id: " +id);
			...
			Reporter.log("Controllo valore Servizio Busta con id: " +id);
			Assert.assertTrue(data.getVerificatoreTracciaRisposta().isTracedServizio(id, this.busteEGov.getDatiServizioRisposta(index)));
			Reporter.log("Controllo valore Azione Busta con id: " +id);
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".ITM"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".ITM"},
		...
		try{
			...
			Assert.assertTrue(data.getVerificatoreTracciaRisposta().isTracedMittente(id,this.busteEGov.getDestinatarioRisposta(index), this.busteEGov.getIndirizzoTelematicoDestinatario(index)));
			Reporter.log("Controllo valore Destinatario Busta con id: " +id);
			Assert.assertTrue(data.getVerificatoreTracciaRisposta().isTracedDestinatario(id,this.busteEGov.getMittenteRisposta(index),null));
			Reporter.log("Controllo valore OraRegistrazione con id: " +id);
			Assert.assertTrue(data.getVerificatoreTracciaRisposta().isTracedOraRegistrazione(id,SPCoopCostanti.TIPO_TEMPO_SPC,TipoOraRegistrazione.SINCRONIZZATO));
			Reporter.log("Controllo valore Servizio Busta con id: " +id);
			Assert.assertTrue(data.getVerificatoreTracciaRisposta().isTracedServizio(id, this.busteEGov.getDatiServizioRisposta(index)));
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".DTDSPC"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".ITD"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".ITD"},
		...
		try{
			...
			Reporter.log("Controllo valore Mittente Busta con id: " +id);
			Assert.assertTrue(data.getVerificatoreTracciaRisposta().isTracedMittente(id,this.busteEGov.getDestinatarioRisposta(index), null));
			Reporter.log("Controllo valore Destinatario Busta con id: " +id);
			Assert.assertTrue(data.getVerificatoreTracciaRisposta().isTracedDestinatario(id,this.busteEGov.getMittenteRisposta(index),this.busteEGov.getIndirizzoTelematicoMittente(index)));
			Reporter.log("Controllo valore OraRegistrazione con id: " +id);
			Assert.assertTrue(data.getVerificatoreTracciaRisposta().isTracedOraRegistrazione(id,SPCoopCostanti.TIPO_TEMPO_SPC,TipoOraRegistrazione.SINCRONIZZATO));
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".BOWSTS"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".ROWSS"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".TServDSPC"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".BOWSAz"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO, ID_GRUPPO+".IDD"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".BSPC"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".BTSC"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".BSC"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".BTESC"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".Collaborazione"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".BCASCC"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".CBASSC"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".TORDSPC"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".CR"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".SFD"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".BSCR"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".BSSFD"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".SEQ"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".SEQs"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".TR"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".TR"},
		...
		try{
			...
			Assert.assertTrue(data.getVerificatoreTracciaRichiesta().isTracedProfiloTrasmissione(id, this.busteEGov.getProfiloTrasmissioneConfermaRicezione(index),
					this.busteEGov.getProfiloTrasmissioneInoltro(index),this.busteEGov.getProfiloTrasmissioneInoltroSdk(index)));
			Reporter.log("Controllo lista trasmissione con id: " +id);
			Assert.assertTrue(data.getVerificatoreTracciaRichiesta().isTracedTrasmissione(id, this.busteEGov.getMittenteRichiesta(index),this.busteEGov.getIndirizzoTelematicoMittente(index),
					this.busteEGov.getDestinatarioRichiesta(index),this.busteEGov.getIndirizzoTelematicoDestinatario(index),
					true,SPCoopCostanti.TIPO_TEMPO_SPC,TipoOraRegistrazione.SINCRONIZZATO));			
			Reporter.log("-------------- RISPOSTA --------------------");
			...
			Assert.assertTrue(data.getVerificatoreTracciaRisposta().isTracedProfiloTrasmissione(id, this.busteEGov.getProfiloTrasmissioneConfermaRicezione(index),
					this.busteEGov.getProfiloTrasmissioneInoltro(index),this.busteEGov.getProfiloTrasmissioneInoltroSdk(index)));
			Reporter.log("Controllo lista trasmissione con id: " +id);
			Assert.assertTrue(data.getVerificatoreTracciaRisposta().isTracedTrasmissione(id, this.busteEGov.getDestinatarioRisposta(index), this.busteEGov.getIndirizzoTelematicoDestinatario(index),
					this.busteEGov.getMittenteRisposta(index),this.busteEGov.getIndirizzoTelematicoMittente(index),
					true,SPCoopCostanti.TIPO_TEMPO_SPC,TipoOraRegistrazione.SINCRONIZZATO));
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".BLTTMDSPC"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".BLTTDDSPC"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".BLTORDSPC"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".BLTITM"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".BLTITD"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".BRiscontro"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO,ID_GRUPPO+".RTDSPC"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiProfiliLineeGuida.ID_GRUPPO_PROFILI,ID_GRUPPO, ID_GRUPPO+".SPT"},
			dependsOnMethods="init")

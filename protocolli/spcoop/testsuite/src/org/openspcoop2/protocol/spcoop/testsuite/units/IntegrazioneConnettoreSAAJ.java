...
public class IntegrazioneConnettoreSAAJ {
	...
	@Test(groups={IntegrazioneConnettoreSAAJ.ID_GRUPPO,IntegrazioneConnettoreSAAJ.ID_GRUPPO+".ONEWAY_SAAJ"},dataProvider="OneWaySAAJ",dependsOnMethods={"oneWaySAAJ"})
	...
	@Test(groups={IntegrazioneConnettoreSAAJ.ID_GRUPPO,IntegrazioneConnettoreSAAJ.ID_GRUPPO+".ONEWAY_WSADDRESSING_SAAJ"},dataProvider="OneWayWithWSASAAJ",dependsOnMethods={"oneWayWithWSASAAJ"})
	...
	@Test(groups={IntegrazioneConnettoreSAAJ.ID_GRUPPO,IntegrazioneConnettoreSAAJ.ID_GRUPPO+".SINCRONO_SAAJ"},dataProvider="SincronoSAAJ",dependsOnMethods={"sincronoSAAJ"})
	...
	@Test(groups={IntegrazioneConnettoreSAAJ.ID_GRUPPO,IntegrazioneConnettoreSAAJ.ID_GRUPPO+".SINCRONO_WSADDRESSING_SAAJ"},dataProvider="SincronoWithWSASAAJ",dependsOnMethods={"sincronoWithWSASAAJ"})
	...
	@Test(groups={IntegrazioneConnettoreSAAJ.ID_GRUPPO,IntegrazioneConnettoreSAAJ.ID_GRUPPO+".SINCRONO_WSADDRESSING_VERIFICA_CLIENT_SINCRONO_SAAJ"},
	...
	@Test(groups={IntegrazioneConnettoreSAAJ.ID_GRUPPO,IntegrazioneConnettoreSAAJ.ID_GRUPPO+".ONEWAY_ATTACHMENTS_SAAJ"},dataProvider="OneWayWithAttachmentsSAAJ",dependsOnMethods={"oneWayWithAttachmentsSAAJ"})
	...
	@Test(groups={IntegrazioneConnettoreSAAJ.ID_GRUPPO,IntegrazioneConnettoreSAAJ.ID_GRUPPO+".SINCRONO_ATTACHMENTS_SAAJ"},dataProvider="SincronoWithAttachmentsSAAJ",dependsOnMethods={"sincronoWithAttachmentsSAAJ"})
	...
	@Test(groups={IntegrazioneConnettoreSAAJ.ID_GRUPPO,IntegrazioneConnettoreSAAJ.ID_GRUPPO+".SINCRONO_ATTACHMENTS_WSADDRESSING_SAAJ"},

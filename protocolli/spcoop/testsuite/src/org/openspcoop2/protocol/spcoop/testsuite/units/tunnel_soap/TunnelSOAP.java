...
public class TunnelSOAP {
	...
	private boolean isEqualsRichiestaRisposta(String xmlRichiestaString,String xmlRispostaString) throws Exception{
		...
		Element xmlRichiesta = org.openspcoop2.message.xml.XMLUtils.DEFAULT.newElement(tmpRichiesta.getBytes());
		...
		Element xmlRisposta = org.openspcoop2.message.xml.XMLUtils.DEFAULT.newElement(tmpRisposta.getBytes());

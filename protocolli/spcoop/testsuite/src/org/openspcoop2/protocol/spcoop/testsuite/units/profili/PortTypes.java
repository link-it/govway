...
public class PortTypes {
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ONEWAY"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ONEWAY"},dataProvider="OneWay",dependsOnMethods={"oneWay"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".SINCRONO"},description="Test di tipo sincrono, Viene controllato se i body sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".SINCRONO"},dataProvider="Sincrono",dependsOnMethods={"sincrono"})
	...
	ServerRicezioneRispostaAsincronaSimmetrica serverRicezioneRispostaAsincronaSimmetrica_modalitaAsincrona = 
		new ServerRicezioneRispostaAsincronaSimmetrica(Utilities.testSuiteProperties.getWorkerNumber(),
				Utilities.testSuiteProperties.getSocketAsincronoSimmetrico_modalitaAsincrona_portTypes(),
				this.repositoryConsegnaRisposteAsincroneSimmetriche_modalitaAsincrona);
	@Test (groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr"})
	...
	@Test (groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr"},description="Test di tipo asincrono simmetrico con modalita asincrona",dependsOnMethods="startServerRicezioneRispostaAsincronaSimmetrica_modalitaAsincrona")
	public void asincronoSimmetrico_ModalitaAsincrona() throws Exception{
		this.collaborazioneSPCoopBase.asincronoSimmetrico_modalitaAsincrona(
				...
				"profiloAsincrono_richiestaAsincrona_portTypes","123456",
				this.repositoryConsegnaRisposteAsincroneSimmetriche_modalitaAsincrona, 
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr"},dataProvider="AsincronoSimmetrico_ModalitaAsincrona",dependsOnMethods={"asincronoSimmetrico_ModalitaAsincrona"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr"},dataProvider="RispostaAsincronoSimmetrico_ModalitaAsincrona",dependsOnMethods={"testAsincronoSimmetrico_ModalitaAsincrona"})
	...
	@Test (groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr"},dependsOnMethods={"testRispostaAsincronoSimmetrico_ModalitaAsincrona"})
	...
	ServerRicezioneRispostaAsincronaSimmetrica serverRicezioneRispostaAsincronaSimmetrica_modalitaSincrona = 
		new ServerRicezioneRispostaAsincronaSimmetrica(Utilities.testSuiteProperties.getWorkerNumber(),
				Utilities.testSuiteProperties.getSocketAsincronoSimmetrico_modalitaSincrona_portTypes(),
				this.repositoryConsegnaRisposteAsincroneSimmetriche_modalitaSincrona);
	@Test (groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr"})
	...
	@Test (groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr"},description="Test di tipo asincrono simmetrico con modalita asincrona",dependsOnMethods="startServerRicezioneRispostaAsincronaSimmetrica_modalitaSincrona")
	public void asincronoSimmetrico_ModalitaSincrona() throws Exception{		
		this.collaborazioneSPCoopBase.asincronoSimmetrico_modalitaSincrona(
				...
				"profiloAsincrono_richiestaSincrona_portTypes","123456",
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr"},dataProvider="AsincronoSimmetrico_ModalitaSincrona",dependsOnMethods={"asincronoSimmetrico_ModalitaSincrona"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr"},dataProvider="RispostaAsincronoSimmetrico_ModalitaSincrona",dependsOnMethods={"testAsincronoSimmetrico_ModalitaSincrona"})
	...
	@Test (groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr"},dependsOnMethods={"testRispostaAsincronoSimmetrico_ModalitaSincrona"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asincr"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asincr"},dataProvider="AsincronoAsimmetrico_ModalitaAsincrona",dependsOnMethods={"asincronoAsimmetrico_ModalitaAsincrona"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asincr"},dataProvider="RispostaAsincronoAsimmetrico_ModalitaAsincrona",dependsOnMethods={"testAsincronoAsimmetrico_ModalitaAsincrona"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sincr"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sincr"},dataProvider="AsincronoAsimmetrico_modalitaSincrona",dependsOnMethods={"asincronoAsimmetrico_modalitaSincrona"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sincr"},dataProvider="RispostaAsincronoAsimmetrico_modalitaSincrona",dependsOnMethods={"testAsincronoAsimmetrico_modalitaSincrona"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ONEWAY_LOOPBACK"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ONEWAY_LOOPBACK"},dataProvider="OneWayLoopback",dependsOnMethods={"oneWayLoopback"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asin_azCorrelata"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asin_azCorrelata"},dataProvider="AsincronoAsimmetrico_AzioneCorrelata_ModalitaAsincrona",dependsOnMethods={"asincronoAsimmetrico_AzioneCorrelata_ModalitaAsincrona"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asin_azCorrelata"},dataProvider="RispostaAsincronoAsimmetrico_AzioneCorrelata_ModalitaAsincrona",dependsOnMethods={"testAsincronoAsimmetrico_AzioneCorrelata_ModalitaAsincrona"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sin_azCorrelata"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sin_azCorrelata"},dataProvider="AsincronoAsimmetrico_AzioneCorrelata_modalitaSincrona",dependsOnMethods={"asincronoAsimmetrico_AzioneCorrelata_modalitaSincrona"})
	...
	@Test(groups={CostantiProfili.ID_GRUPPO_PROFILI,PortTypes.ID_GRUPPO,PortTypes.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sin_azCorrelata"},dataProvider="RispostaAsincronoAsimmetrico_AzioneCorrelata_modalitaSincrona",dependsOnMethods={"testAsincronoAsimmetrico_AzioneCorrelata_modalitaSincrona"})

...
public class SOAPWithAttachments {
	...
	private CooperazioneBase collaborazioneSPCoopBase = 
		new CooperazioneBase(true,MessageType.SOAP_11,  this.info, 
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ONEWAY"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ONEWAY"},dataProvider="OneWay",dependsOnMethods={"oneWay"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ONEWAY_STATELESS"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".SINCRONO"},description="Test di tipo sincrono, Viene controllato se i body sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".SINCRONO"},dataProvider="Sincrono",dependsOnMethods={"sincrono"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".SINCRONO_STATEFUL"},description="Test di tipo sincrono, Viene controllato se i body sono uguali e se gli attachment sono uguali")
	...
	@Test (groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr"})
	...
	@Test (groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr"},description="Test di tipo asincrono simmetrico con modalita asincrona",dependsOnMethods="startServerRicezioneRispostaAsincronaSimmetrica_modalitaAsincrona")
	...
	@Test (groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr"},dependsOnMethods={"testRispostaAsincronoSimmetrico_ModalitaAsincrona"})
	...
	@Test (groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr_stateful"})
	...
	@Test (groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr_stateful"},description="Test di tipo asincrono simmetrico con modalita asincrona",
	...
	@Test (groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr_stateful"},dependsOnMethods={"testRispostaAsincronoSimmetrico_ModalitaAsincrona_Stateful"})
	...
	@Test (groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr"})
	...
	@Test (groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr"},description="Test di tipo asincrono simmetrico con modalita asincrona",dependsOnMethods="startServerRicezioneRispostaAsincronaSimmetrica_modalitaSincrona")
	...
	@Test (groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr"},dependsOnMethods={"testRispostaAsincronoSimmetrico_ModalitaSincrona"})
	...
	@Test (groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr_stateful"})
	...
	@Test (groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr_stateful"},description="Test di tipo asincrono simmetrico con modalita asincrona",
	...
	@Test (groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr_stateful"},dependsOnMethods={"testRispostaAsincronoSimmetrico_ModalitaSincrona_Stateful"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asincr"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asincr"},dataProvider="AsincronoAsimmetrico_ModalitaAsincrona",dependsOnMethods={"asincronoAsimmetrico_ModalitaAsincrona"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asincr"},dataProvider="RispostaAsincronoAsimmetrico_ModalitaAsincrona",dependsOnMethods={"testAsincronoAsimmetrico_ModalitaAsincrona"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asincr_stateful"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asincr_stateful"},dataProvider="AsincronoAsimmetrico_ModalitaAsincrona_Stateful",
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asincr_stateful"},dataProvider="RispostaAsincronoAsimmetrico_ModalitaAsincrona_Stateful",
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sincr"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sincr"},dataProvider="AsincronoAsimmetrico_modalitaSincrona",dependsOnMethods={"asincronoAsimmetrico_modalitaSincrona"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sincr"},dataProvider="RispostaAsincronoAsimmetrico_modalitaSincrona",dependsOnMethods={"testAsincronoAsimmetrico_modalitaSincrona"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sincr_stateful"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sincr_stateful"},dataProvider="AsincronoAsimmetrico_modalitaSincrona_Stateful",
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sincr_stateful"},dataProvider="RispostaAsincronoAsimmetrico_modalitaSincrona_Stateful",
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ONEWAY_LOOPBACK"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ONEWAY_LOOPBACK"},dataProvider="OneWayLoopback",dependsOnMethods={"oneWayLoopback"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_azCorrelata_asincr"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_azCorrelata_asincr"},dataProvider="AsincronoAsimmetrico_AzioneCorrelata_ModalitaAsincrona",dependsOnMethods={"asincronoAsimmetrico_AzioneCorrelata_ModalitaAsincrona"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_azCorrelata_asincr"},dataProvider="RispostaAsincronoAsimmetrico_AzioneCorrelata_ModalitaAsincrona",dependsOnMethods={"testAsincronoAsimmetrico_AzioneCorrelata_ModalitaAsincrona"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_azCorrelata_sincr"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_azCorrelata_sincr"},dataProvider="AsincronoAsimmetrico_AzioneCorrelata_modalitaSincrona",dependsOnMethods={"asincronoAsimmetrico_AzioneCorrelata_modalitaSincrona"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_azCorrelata_sincr"},dataProvider="RispostaAsincronoAsimmetrico_AzioneCorrelata_modalitaSincrona",dependsOnMethods={"testAsincronoAsimmetrico_AzioneCorrelata_modalitaSincrona"})
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".SINCRONO_CONTENT_TYPE_NON_STANDARD"},description="Test di tipo sincrono, Viene controllato se i body sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".SINCRONO_CONTENT_TYPE_NON_STANDARD"},dataProvider="SincronoContentTypeNonStandard",
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".BODY_CON_PIU_CHILD"},
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".BODY_CON_PIU_CHILD"},dataProvider="SincronoBodyConPiuChildElement",
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".BODY_VUOTO"},
			description="Test di tipo sincrono, Viene controllato se i body sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPWithAttachments.ID_GRUPPO,SOAPWithAttachments.ID_GRUPPO+".BODY_VUOTO"},dataProvider="SincronoBodyVuoto",

...
public class ProfiliDiCollaborazioneLineeGuida11 {
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ONEWAY"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ONEWAY"},dataProvider="OneWay",dependsOnMethods={"oneWay"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ONEWAY_STATELESS"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".SINCRONO"},description="Test di tipo sincrono, Viene controllato se i body sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".SINCRONO"},dataProvider="Sincrono",dependsOnMethods={"sincrono"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".SINCRONO_STATEFUL"},
	...
	@Test (groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr"})
	...
	@Test (groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr"},description="Test di tipo asincrono simmetrico con modalita asincrona",dependsOnMethods="startServerRicezioneRispostaAsincronaSimmetrica_modalitaAsincrona")
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr"},dataProvider="AsincronoSimmetrico_ModalitaAsincrona",dependsOnMethods={"asincronoSimmetrico_ModalitaAsincrona"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr"},dataProvider="RispostaAsincronoSimmetrico_ModalitaAsincrona",dependsOnMethods={"testAsincronoSimmetrico_ModalitaAsincrona"})
	...
	@Test (groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr"},dependsOnMethods={"testRispostaAsincronoSimmetrico_ModalitaAsincrona"})
	...
	@Test (groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_SIMMETRICO_asincr_stateful"})
	...
	@Test (groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr"})
	...
	@Test (groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr"},description="Test di tipo asincrono simmetrico con modalita asincrona",dependsOnMethods="startServerRicezioneRispostaAsincronaSimmetrica_modalitaSincrona")
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr"},dataProvider="AsincronoSimmetrico_ModalitaSincrona",dependsOnMethods={"asincronoSimmetrico_ModalitaSincrona"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr"},dataProvider="RispostaAsincronoSimmetrico_ModalitaSincrona",dependsOnMethods={"testAsincronoSimmetrico_ModalitaSincrona"})
	...
	@Test (groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr"},dependsOnMethods={"testRispostaAsincronoSimmetrico_ModalitaSincrona"})
	...
	@Test (groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_SIMMETRICO_sincr_stateful"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asincr"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asincr"},dataProvider="AsincronoAsimmetrico_ModalitaAsincrona",dependsOnMethods={"asincronoAsimmetrico_ModalitaAsincrona"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asincr"},dataProvider="RispostaAsincronoAsimmetrico_ModalitaAsincrona",dependsOnMethods={"testAsincronoAsimmetrico_ModalitaAsincrona"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asincr_stateful"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sincr"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sincr"},dataProvider="AsincronoAsimmetrico_modalitaSincrona",dependsOnMethods={"asincronoAsimmetrico_modalitaSincrona"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sincr"},dataProvider="RispostaAsincronoAsimmetrico_modalitaSincrona",dependsOnMethods={"testAsincronoAsimmetrico_modalitaSincrona"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sincr_stateful"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ONEWAY_LOOPBACK"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ONEWAY_LOOPBACK"},dataProvider="OneWayLoopback",dependsOnMethods={"oneWayLoopback"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asin_azCorrelata"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asin_azCorrelata"},dataProvider="AsincronoAsimmetrico_AzioneCorrelata_ModalitaAsincrona",dependsOnMethods={"asincronoAsimmetrico_AzioneCorrelata_ModalitaAsincrona"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_asin_azCorrelata"},dataProvider="RispostaAsincronoAsimmetrico_AzioneCorrelata_ModalitaAsincrona",dependsOnMethods={"testAsincronoAsimmetrico_AzioneCorrelata_ModalitaAsincrona"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sin_azCorrelata"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sin_azCorrelata"},dataProvider="AsincronoAsimmetrico_AzioneCorrelata_modalitaSincrona",dependsOnMethods={"asincronoAsimmetrico_AzioneCorrelata_modalitaSincrona"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".ASINCRONO_ASIMMETRICO_sin_azCorrelata"},dataProvider="RispostaAsincronoAsimmetrico_AzioneCorrelata_modalitaSincrona",dependsOnMethods={"testAsincronoAsimmetrico_AzioneCorrelata_modalitaSincrona"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".RiscontroDeprecato"})
	...
	@Test(groups={ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO,ProfiliDiCollaborazioneLineeGuida11.ID_GRUPPO+".RiscontroDeprecato"},dataProvider="ConsegnaAffidabile",dependsOnMethods="ConsegnaAffidabile")
	...
	public void sincronoTESTCollaborazioneDeprecata() throws FatalTestSuiteException, IOException, SOAPException{

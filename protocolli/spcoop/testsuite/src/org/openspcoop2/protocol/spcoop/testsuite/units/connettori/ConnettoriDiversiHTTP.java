...
public class ConnettoriDiversiHTTP {
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".SAAJ_ONEWAY"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".SAAJ_ONEWAY"},dataProvider="saajOneway",dependsOnMethods={"saajOneway"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".SAAJ_SINCRONO"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".SAAJ_SINCRONO"},dataProvider="saajSincrono",dependsOnMethods={"saajSincrono"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".HTTPCORE_ONEWAY"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".HTTPCORE_ONEWAY"},dataProvider="httpCoreOneway",dependsOnMethods={"httpCoreOneway"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".HTTPCORE_SINCRONO"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".HTTPCORE_SINCRONO"},dataProvider="httpCoreSincrono",dependsOnMethods={"httpCoreSincrono"})
	...
	/***
	 * Test Connettore HTTPCORE5 Oneway
	 */
	Repository repositoryHTTPCORE5Oneway=new Repository();
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".HTTPCORE5_ONEWAY"})
	public void HTTPCORE5Oneway() throws TestSuiteException, Exception{
		
		// Invocazione SPCoop
		this.collaborazioneSPCoopBase.oneWay(this.repositoryHTTPCORE5Oneway,CostantiTestSuite.PORTA_DELEGATA_HTTPCORE5_ONEWAY,addIDUnivoco);
		
	}
	@DataProvider (name="HTTPCORE5Oneway")
	public Object[][]testHTTPCORE5OnewayTest() throws Exception{
		String id=this.repositoryHTTPCORE5Oneway.getNext();
		if(Utilities.testSuiteProperties.attendiTerminazioneMessaggi_verificaDatabase()==false){
			try {
				Thread.sleep(Utilities.testSuiteProperties.timeToSleep_verificaDatabase());
			} catch (InterruptedException e) {
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".HTTPCORE5_ONEWAY"},dataProvider="HTTPCORE5Oneway",dependsOnMethods={"HTTPCORE5Oneway"})
	public void testHTTPCORE5OnewayTest(DatabaseComponent data,String id) throws Exception{
		try{
			this.collaborazioneSPCoopBase.testOneWay(data,id, CostantiTestSuite.SPCOOP_TIPO_SERVIZIO_ONEWAY,
					CostantiTestSuite.SPCOOP_NOME_SERVIZIO_ONEWAY,
					CostantiTestSuite.SPCOOP_SERVIZIO_ONEWAY_HTTPCORE5, false,null);
		}catch(Exception e){
			throw e;
		}finally{
			data.close();
	...
	/***
	 * Test Connettore HTTPCORE5 Sincrono
	 */
	Repository repositoryHTTPCORE5Sincrono=new Repository();
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".HTTPCORE5_SINCRONO"})
	public void HTTPCORE5Sincrono() throws TestSuiteException, Exception{
		
		// Invocazione SPCoop
		this.collaborazioneSPCoopBase.sincrono(this.repositoryHTTPCORE5Sincrono,CostantiTestSuite.PORTA_DELEGATA_HTTPCORE5_SINCRONO,addIDUnivoco);
		
	}
	@DataProvider (name="HTTPCORE5Sincrono")
	public Object[][]testHTTPCORE5SincronoTest() throws Exception{
		String id=this.repositoryHTTPCORE5Sincrono.getNext();
		if(Utilities.testSuiteProperties.attendiTerminazioneMessaggi_verificaDatabase()==false){
			try {
				Thread.sleep(Utilities.testSuiteProperties.timeToSleep_verificaDatabase());
			} catch (InterruptedException e) {
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".HTTPCORE5_SINCRONO"},dataProvider="HTTPCORE5Sincrono",dependsOnMethods={"HTTPCORE5Sincrono"})
	public void testHTTPCORE5SincronoTest(DatabaseComponent data,String id) throws Exception{
		try{
			this.collaborazioneSPCoopBase.testSincrono(data,id, CostantiTestSuite.SPCOOP_TIPO_SERVIZIO_SINCRONO,
					CostantiTestSuite.SPCOOP_NOME_SERVIZIO_SINCRONO,
					CostantiTestSuite.SPCOOP_SERVIZIO_SINCRONO_HTTPCORE5, false,null);
		}catch(Exception e){
			throw e;
		}finally{
			data.close();
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".FILE_serializeFile"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".FILE_serializeFile"},dataProvider="FILE_serializeFile",dependsOnMethods={"FILE_serializeFile"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".FILE_serializeFileAndHeaders"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".FILE_serializeFileAndHeaders"},dataProvider="FILE_serializeFileAndHeaders",dependsOnMethods={"FILE_serializeFileAndHeaders"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".FILE_serializeDynamicFile"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".FILE_serializeDynamicFile"},dataProvider="FILE_serializeDynamicFile",dependsOnMethods={"FILE_serializeDynamicFile"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".FILE_serializeFile_sbustamentoSOAP"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".FILE_serializeFile_sbustamentoSOAP"},dataProvider="FILE_serializeFile_sbustamentoSOAP",dependsOnMethods={"FILE_serializeFile_sbustamentoSOAP"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".FILE_serializeAndReturnFile"},description="Test di tipo FILE_serializeAndReturnFile, Viene controllato se i body sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".FILE_serializeAndReturnFile"},dataProvider="FILE_serializeAndReturnFile",dependsOnMethods={"FILE_serializeAndReturnFile"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".FILE_serializeAndReturnFileAndHeaders"},description="Test di tipo FILE_serializeAndReturnFileAndHeaders, Viene controllato se i body sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".FILE_serializeAndReturnFileAndHeaders"},dataProvider="FILE_serializeAndReturnFileAndHeaders",dependsOnMethods={"FILE_serializeAndReturnFileAndHeaders"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".FILE_serializeAndReturnDynamicFile"},description="Test di tipo FILE_serializeAndReturnDynamicFile, Viene controllato se i body sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".FILE_serializeAndReturnDynamicFile"},dataProvider="FILE_serializeAndReturnDynamicFile",dependsOnMethods={"FILE_serializeAndReturnDynamicFile"})
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".FILE_serializeAndReturnFile_sbustamentoSOAP"},description="Test di tipo FILE_serializeAndReturnFile_sbustamentoSOAP, Viene controllato se i body sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiConnettori.ID_GRUPPO_CONNETTORI,ConnettoriDiversiHTTP.ID_GRUPPO,ConnettoriDiversiHTTP.ID_GRUPPO+".FILE_serializeAndReturnFile_sbustamentoSOAP"},dataProvider="FILE_serializeAndReturnFile_sbustamentoSOAP",dependsOnMethods={"FILE_serializeAndReturnFile_sbustamentoSOAP"})

...
public class RiconoscimentoProfiloGestione {
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, ID_GRUPPO,ID_GRUPPO+".FRTEST1",ID_GRUPPO+".FRTEST2",ID_GRUPPO+".FRTEST3"})
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, ID_GRUPPO,ID_GRUPPO+".ERTEST1"})
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, ID_GRUPPO,ID_GRUPPO+".ERTEST1"},dataProvider="AsincronoAsimmetrico_AzioneCorrelata_ModalitaSincronaTEST1",
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, ID_GRUPPO,ID_GRUPPO+".ERTEST1"},dataProvider="RispostaAsincronoAsimmetrico_AzioneCorrelata_ModalitaSincronaTEST1",
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, ID_GRUPPO,ID_GRUPPO+".ERTEST2"})
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, ID_GRUPPO,ID_GRUPPO+".ERTEST2"},dataProvider="AsincronoAsimmetrico_AzioneCorrelata_ModalitaSincronaTEST2",
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, ID_GRUPPO,ID_GRUPPO+".ERTEST2"},dataProvider="RispostaAsincronoAsimmetrico_AzioneCorrelata_ModalitaSincronaTEST2",
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, ID_GRUPPO,ID_GRUPPO+".ERTEST3"})
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, ID_GRUPPO,ID_GRUPPO+".ERTEST3"},dataProvider="AsincronoAsimmetrico_AzioneCorrelata_ModalitaSincronaTEST3",
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, ID_GRUPPO,ID_GRUPPO+".ERTEST3"},dataProvider="RispostaAsincronoAsimmetrico_AzioneCorrelata_ModalitaSincronaTEST3",
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, ID_GRUPPO,ID_GRUPPO+".FRTEST1"},
		...
		try{
			...
			if(Utilities.testSuiteProperties.isNewConnectionForResponse()==false){
				...
				Assert.assertTrue(data.getVerificatoreTracciaRisposta().isTracedProfiloTrasmissione(id, this.busteEGov.getProfiloTrasmissioneConfermaRicezione(index),
						this.busteEGov.getProfiloTrasmissioneInoltro(index), this.busteEGov.getProfiloTrasmissioneInoltroSdk(index)));
				String tipoServizioCorrelato = this.busteEGov.getDatiServizioRisposta(index).getTipoServizio();
				String servizioCorrelato = this.busteEGov.getDatiServizioRisposta(index).getNomeServizio();
				Reporter.log("Controllo valore tipo["+tipoServizioCorrelato+"] e servizio correlato["+servizioCorrelato+"]");
				Assert.assertTrue(data.getVerificatoreTracciaRisposta().isTracedServizioCorrelato(id, this.busteEGov.getDatiServizioRisposta(index)));
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, ID_GRUPPO,ID_GRUPPO+".FRTEST2"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, ID_GRUPPO,ID_GRUPPO+".FRTEST3"},
			dependsOnMethods="init")

...
public class SOAPBodyEmpty {
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPBodyEmpty.ID_GRUPPO,SOAPBodyEmpty.ID_GRUPPO+".SINCRONO_SOAP_BODY_VUOTO"},description="Test di tipo sincrono, Viene controllato se i body sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPBodyEmpty.ID_GRUPPO,SOAPBodyEmpty.ID_GRUPPO+".SINCRONO_SOAP_BODY_VUOTO"},
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPBodyEmpty.ID_GRUPPO,SOAPBodyEmpty.ID_GRUPPO+".SINCRONO_STATEFUL_SOAP_BODY_VUOTO"},description="Test di tipo sincrono, Viene controllato se i body sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPBodyEmpty.ID_GRUPPO,SOAPBodyEmpty.ID_GRUPPO+".SINCRONO_STATEFUL_SOAP_BODY_VUOTO"},
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPBodyEmpty.ID_GRUPPO,SOAPBodyEmpty.ID_GRUPPO+".SINCRONO_SOAP_WITH_ATTACHMENTS_BODY_VUOTO"},description="Test di tipo sincrono, Viene controllato se i body sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPBodyEmpty.ID_GRUPPO,SOAPBodyEmpty.ID_GRUPPO+".SINCRONO_SOAP_WITH_ATTACHMENTS_BODY_VUOTO"},
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPBodyEmpty.ID_GRUPPO,SOAPBodyEmpty.ID_GRUPPO+".SINCRONO_STATEFUL_SOAP_WITH_ATTACHMENTS_BODY_VUOTO"},description="Test di tipo sincrono, Viene controllato se i body sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPBodyEmpty.ID_GRUPPO,SOAPBodyEmpty.ID_GRUPPO+".SINCRONO_STATEFUL_SOAP_WITH_ATTACHMENTS_BODY_VUOTO"},

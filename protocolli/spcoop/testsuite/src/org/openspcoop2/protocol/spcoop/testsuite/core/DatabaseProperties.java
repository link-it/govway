				...
				try{
					...
					if(dbP.databasePdD_is_DatabaseTracciamento()){
						if(dbP.isDatasourceVersion()){
							return new DatabaseComponent(dbP.getDataSourceErogatore(),dbP.getJNDIContext_DataSourceErogatore(),CostantiTestSuite.PROTOCOL_NAME);
						}else{
							return new DatabaseComponent(dbP.getDriverJDBC(),dbP.getConnectionUrlTracciamentoErogatore(),
									dbP.getUsernameTracciamentoErogatore(),dbP.getPasswordTracciamentoErogatore(),CostantiTestSuite.PROTOCOL_NAME);
						}
					}else  {
						if(dbP.isDatasourceVersion()){
							return new DatabaseComponent(dbP.getDataSourceErogatore(),dbP.getJNDIContext_DataSourceErogatore(),
									dbP.getDataSourcePdDErogatore(),dbP.getJNDIContext_DataSourcePdDErogatore(),CostantiTestSuite.PROTOCOL_NAME);
						}else{
							return new DatabaseComponent(dbP.getDriverJDBC(),
									...
									dbP.getUsernameOpenspcoopErogatore(),dbP.getPasswordOpenspcoopErogatore(),CostantiTestSuite.PROTOCOL_NAME);
						}
					}
				}catch(Exception e){
					e.printStackTrace();
		...
		if(databaseFruitore==null){
			synchronized(DatabaseProperties.getInstance()){
				try{
					...
					if(dbP.databasePdD_is_DatabaseTracciamento()){
						if(dbP.isDatasourceVersion()){
							return new DatabaseComponent(dbP.getDataSourceFruitore(),dbP.getJNDIContext_DataSourceFruitore(),CostantiTestSuite.PROTOCOL_NAME);
						}else{
							return new DatabaseComponent(dbP.getDriverJDBC(),dbP.getConnectionUrlTracciamentoFruitore(),
									dbP.getUsernameTracciamentoFruitore(),dbP.getPasswordTracciamentoFruitore(),CostantiTestSuite.PROTOCOL_NAME);
						}
					}else  {
						if(dbP.isDatasourceVersion()){
							return new DatabaseComponent(dbP.getDataSourceFruitore(),dbP.getJNDIContext_DataSourceFruitore(),
									dbP.getDataSourcePdDFruitore(),dbP.getJNDIContext_DataSourcePdDFruitore(),CostantiTestSuite.PROTOCOL_NAME);
						}else{
							return new DatabaseComponent(dbP.getDriverJDBC(),
									...
									dbP.getUsernameOpenspcoopFruitore(),dbP.getPasswordOpenspcoopFruitore(),CostantiTestSuite.PROTOCOL_NAME);
						}
					}
				}catch(Exception e){
					e.printStackTrace();
			...
			synchronized(DatabaseProperties.getInstance()){
				try{
					...
					if(dbP.databaseDiagnostica_is_DatabaseTracciamento()){
						if(dbP.isDatasourceVersion()){
							return new DatabaseMsgDiagnosticiComponent(dbP.getDataSourceErogatore(),dbP.getJNDIContext_DataSourceErogatore(),CostantiTestSuite.PROTOCOL_NAME);
						}else{
						...
						if(dbP.isDatasourceVersion()){
							return new DatabaseMsgDiagnosticiComponent(dbP.getDataSourceDiagnosticaPdDErogatore(),dbP.getJNDIContext_DataSourceDiagnosticaPdDErogatore(),CostantiTestSuite.PROTOCOL_NAME);
						}else{
							return new DatabaseMsgDiagnosticiComponent(dbP.getDriverJDBC(),dbP.getConnectionUrlDiagnosticaErogatore(),
									dbP.getUsernameDiagnosticaErogatore(),dbP.getPasswordDiagnosticaErogatore(),CostantiTestSuite.PROTOCOL_NAME);
						}
					}
				}catch(Exception e){
					e.printStackTrace();
		...
		if(databaseDiagnosticaFruitore==null){
			synchronized(DatabaseProperties.getInstance()){
				try{
					...
					if(dbP.databaseDiagnostica_is_DatabaseTracciamento()){
						if(dbP.isDatasourceVersion()){
							return new DatabaseMsgDiagnosticiComponent(dbP.getDataSourceFruitore(),dbP.getJNDIContext_DataSourceFruitore(),CostantiTestSuite.PROTOCOL_NAME);
						}else{
						...
						if(dbP.isDatasourceVersion()){
							return new DatabaseMsgDiagnosticiComponent(dbP.getDataSourceDiagnosticaPdDFruitore(),dbP.getJNDIContext_DataSourceDiagnosticaPdDFruitore(),CostantiTestSuite.PROTOCOL_NAME);
						}else{
							return new DatabaseMsgDiagnosticiComponent(dbP.getDriverJDBC(),dbP.getConnectionUrlDiagnosticaFruitore(),
									dbP.getUsernameDiagnosticaFruitore(),dbP.getPasswordDiagnosticaFruitore(),CostantiTestSuite.PROTOCOL_NAME);
						}
					}
				}catch(Exception e){
					e.printStackTrace();

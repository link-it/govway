...
public class WSSecuritySoapBox {
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_ENCRYPT_SIGNATURE"},
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_ENCRYPT_SIGNATURE"},dataProvider="SincronoWSSSoapBoxEncryptSignature",dependsOnMethods={"sincronoWSSSoapBoxEncryptSignature"})
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_SIGNATURE_ENCRYPT"},
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_SIGNATURE_ENCRYPT"},dataProvider="SincronoWSSSoapBoxSignatureEncrypt",dependsOnMethods={"sincronoWSSSoapBoxSignatureEncrypt"})
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_ENCRYPT"},
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_ENCRYPT"},dataProvider="SincronoWSSSoapBoxEncrypt",dependsOnMethods={"sincronoWSSSoapBoxEncrypt"})
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_SIGNATURE"},
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_SIGNATURE"},dataProvider="SincronoWSSSoapBoxSignature",dependsOnMethods={"sincronoWSSSoapBoxSignature"})
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_ENCRYPT_SIGNATURE_ATTACHMENTS"},
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_ENCRYPT_SIGNATURE_ATTACHMENTS"},dataProvider="SincronoWSSSoapBoxEncryptSignatureAttachments",dependsOnMethods={"sincronoWSSSoapBoxEncryptSignatureAttachments"})
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_SIGNATURE_ENCRYPT_ATTACHMENTS"},
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_SIGNATURE_ENCRYPT_ATTACHMENTS"},dataProvider="SincronoWSSSoapBoxSignatureEncryptAttachments",dependsOnMethods={"sincronoWSSSoapBoxSignatureEncryptAttachments"})
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_ENCRYPT_ATTACHMENTS"},
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_ENCRYPT_ATTACHMENTS"},dataProvider="SincronoWSSSoapBoxEncryptAttachments",dependsOnMethods={"sincronoWSSSoapBoxEncryptAttachments"})
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_SIGNATURE_ATTACHMENTS"},
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_SIGNATURE_ATTACHMENTS"},dataProvider="SincronoWSSSoapBoxSignatureAttachments",dependsOnMethods={"sincronoWSSSoapBoxSignatureAttachments"})
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_SIGNATURE_ATTACHMENTS_ENGINE_SUN"},
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_SIGNATURE_ATTACHMENTS_ENGINE_SUN"},dataProvider="SincronoWSSSoapBoxSignatureAttachments_engineSun",dependsOnMethods={"sincronoWSSSoapBoxSignatureAttachments_engineSun"})
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_SIGNATURE_ATTACHMENTS_ENGINE_XMLSEC"},
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,WSSecuritySoapBox.ID_GRUPPO,WSSecuritySoapBox.ID_GRUPPO+".SOAPBOX_SINCRONO_SIGNATURE_ATTACHMENTS_ENGINE_XMLSEC"},dataProvider="SincronoWSSSoapBoxSignatureAttachments_engineXmlSec",dependsOnMethods={"sincronoWSSSoapBoxSignatureAttachments_engineXmlSec"})

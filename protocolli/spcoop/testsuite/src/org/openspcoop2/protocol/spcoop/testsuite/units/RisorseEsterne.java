...
public class RisorseEsterne {
	...
	public Object[][]testDatabaseOpenSPCoop()throws Exception{
		...
		return new Object[][]{
				{DatabaseProperties.getDatabaseComponentFruitore()},
				{DatabaseProperties.getDatabaseComponentErogatore()}
		};
	}
	...
	public Object[][]testDatabaseMsgDiagnostici()throws Exception{
		...
		return new Object[][]{
				{DatabaseProperties.getDatabaseComponentDiagnosticaFruitore()},
				{DatabaseProperties.getDatabaseComponentDiagnosticaErogatore()}
		};
	}
	...
	public void testRisorseJMX() throws Exception{
		try{
			...
			if("jboss7".equals(version_jbossas) || 
				...
				JMXServiceURL serviceURL = new JMXServiceURL(testsuiteProperties.getJMXServiceURL(as));       
				JMXConnector jmxConnector = JMXConnectorFactory.connect(serviceURL, null);       
				jmxconn = jmxConnector.getMBeanServerConnection();	
			}else{
				Hashtable<String, Object> env = new Hashtable<String, Object>();
				env.put(Context.INITIAL_CONTEXT_FACTORY, testsuiteProperties.getJMXFactory());
				env.put(Context.PROVIDER_URL, testsuiteProperties.getJMXServer());
				
				Context ctx = new InitialContext(env);
				jmxconn = (MBeanServerConnection) ctx.lookup("jmx/invoker/RMIAdaptor");
				SecurityAssociation.setPrincipal(new SimplePrincipal(testsuiteProperties.getJMXUsername()));
				SecurityAssociation.setCredential(testsuiteProperties.getJMXPassword());
			}			

...
public class VersionamentoAccordiServizio {
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, VersionamentoAccordiServizio.ID_GRUPPO,VersionamentoAccordiServizio.ID_GRUPPO+".ONEWAY"})
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, VersionamentoAccordiServizio.ID_GRUPPO,VersionamentoAccordiServizio.ID_GRUPPO+".ONEWAY"},dataProvider="OneWay",dependsOnMethods={"oneWay"})
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, VersionamentoAccordiServizio.ID_GRUPPO,VersionamentoAccordiServizio.ID_GRUPPO+".SINCRONO_SOGGREFERENTE_NOME_VERSIONE"})
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, VersionamentoAccordiServizio.ID_GRUPPO,VersionamentoAccordiServizio.ID_GRUPPO+".SINCRONO_SOGGREFERENTE_NOME"})
...
//	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, VersionamentoAccordiServizio.ID_GRUPPO,VersionamentoAccordiServizio.ID_GRUPPO+".SINCRONO_NOME_VERSIONE"})

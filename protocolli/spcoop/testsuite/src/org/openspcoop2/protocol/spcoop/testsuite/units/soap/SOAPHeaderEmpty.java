...
public class SOAPHeaderEmpty {
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPHeaderEmpty.ID_GRUPPO,SOAPHeaderEmpty.ID_GRUPPO+".SINCRONO_SOAP_HEADER_VUOTO"},description="Test di tipo sincrono, Viene controllato se i Header sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPHeaderEmpty.ID_GRUPPO,SOAPHeaderEmpty.ID_GRUPPO+".SINCRONO_SOAP_HEADER_VUOTO"},
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPHeaderEmpty.ID_GRUPPO,SOAPHeaderEmpty.ID_GRUPPO+".SINCRONO_STATEFUL_SOAP_HEADER_VUOTO"},description="Test di tipo sincrono, Viene controllato se i Header sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPHeaderEmpty.ID_GRUPPO,SOAPHeaderEmpty.ID_GRUPPO+".SINCRONO_STATEFUL_SOAP_HEADER_VUOTO"},
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPHeaderEmpty.ID_GRUPPO,SOAPHeaderEmpty.ID_GRUPPO+".SINCRONO_SOAP_HEADER_NON_PRESENTE"},description="Test di tipo sincrono, Viene controllato se i Header sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPHeaderEmpty.ID_GRUPPO,SOAPHeaderEmpty.ID_GRUPPO+".SINCRONO_SOAP_HEADER_NON_PRESENTE"},
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPHeaderEmpty.ID_GRUPPO,SOAPHeaderEmpty.ID_GRUPPO+".SINCRONO_STATEFUL_SOAP_HEADER_NON_PRESENTE"},description="Test di tipo sincrono, Viene controllato se i Header sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPHeaderEmpty.ID_GRUPPO,SOAPHeaderEmpty.ID_GRUPPO+".SINCRONO_STATEFUL_SOAP_HEADER_NON_PRESENTE"},
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPHeaderEmpty.ID_GRUPPO,SOAPHeaderEmpty.ID_GRUPPO+".SINCRONO_SOAP_WITH_ATTACHMENTS_HEADER_VUOTO"},description="Test di tipo sincrono, Viene controllato se i Header sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPHeaderEmpty.ID_GRUPPO,SOAPHeaderEmpty.ID_GRUPPO+".SINCRONO_SOAP_WITH_ATTACHMENTS_HEADER_VUOTO"},
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPHeaderEmpty.ID_GRUPPO,SOAPHeaderEmpty.ID_GRUPPO+".SINCRONO_STATEFUL_SOAP_WITH_ATTACHMENTS_HEADER_VUOTO"},description="Test di tipo sincrono, Viene controllato se i Header sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPHeaderEmpty.ID_GRUPPO,SOAPHeaderEmpty.ID_GRUPPO+".SINCRONO_STATEFUL_SOAP_WITH_ATTACHMENTS_HEADER_VUOTO"},
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPHeaderEmpty.ID_GRUPPO,SOAPHeaderEmpty.ID_GRUPPO+".SINCRONO_SOAP_WITH_ATTACHMENTS_HEADER_NON_PRESENTE"},description="Test di tipo sincrono, Viene controllato se i Header sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPHeaderEmpty.ID_GRUPPO,SOAPHeaderEmpty.ID_GRUPPO+".SINCRONO_SOAP_WITH_ATTACHMENTS_HEADER_NON_PRESENTE"},
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPHeaderEmpty.ID_GRUPPO,SOAPHeaderEmpty.ID_GRUPPO+".SINCRONO_STATEFUL_SOAP_HEADER_HEADER_NON_PRESENTE"},description="Test di tipo sincrono, Viene controllato se i Header sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSOAP.ID_GRUPPO_SOAP,SOAPHeaderEmpty.ID_GRUPPO,SOAPHeaderEmpty.ID_GRUPPO+".SINCRONO_STATEFUL_SOAP_HEADER_HEADER_NON_PRESENTE"},

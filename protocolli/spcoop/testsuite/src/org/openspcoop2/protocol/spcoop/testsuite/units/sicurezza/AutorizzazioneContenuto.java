...
public class AutorizzazioneContenuto extends GestioneViaJmx {
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,AutorizzazioneContenuto.ID_GRUPPO,AutorizzazioneContenuto.ID_GRUPPO+".SINCRONO_PD_OK"},description="Test di tipo sincronoPD_OK, Viene controllato se i body sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,AutorizzazioneContenuto.ID_GRUPPO,AutorizzazioneContenuto.ID_GRUPPO+".SINCRONO_PD_OK"},dataProvider="sincronoPD_OK",dependsOnMethods={"sincronoPD_OK"})
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,AutorizzazioneContenuto.ID_GRUPPO,AutorizzazioneContenuto.ID_GRUPPO+".SINCRONO_PA_OK"},description="Test di tipo sincronoPA_OK, Viene controllato se i body sono uguali e se gli attachment sono uguali")
	...
	@Test(groups={CostantiSicurezza.ID_GRUPPO_SICUREZZA,AutorizzazioneContenuto.ID_GRUPPO,AutorizzazioneContenuto.ID_GRUPPO+".SINCRONO_PA_KO"})

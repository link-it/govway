...
public class Handlers extends GestioneViaJmx {
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, Handlers.ID_GRUPPO,Handlers.ID_GRUPPO+".ONEWAY_STATEFUL"},dataProvider="TipologieTests")
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, Handlers.ID_GRUPPO,Handlers.ID_GRUPPO+".ONEWAY_STATEFUL"},dataProvider="OneWay",dependsOnMethods={"oneWay"})
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, Handlers.ID_GRUPPO,Handlers.ID_GRUPPO+".ONEWAY_STATELESS"},dataProvider="TipologieTests")
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, Handlers.ID_GRUPPO,Handlers.ID_GRUPPO+".ONEWAY_STATELESS"},dataProvider="OneWay_Stateless",dependsOnMethods={"oneWay_Stateless"})
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, Handlers.ID_GRUPPO,Handlers.ID_GRUPPO+".ONEWAY_RISPOSTA_VUOTA"},dataProvider="TipologieTests")
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, Handlers.ID_GRUPPO,Handlers.ID_GRUPPO+".ONEWAY_RISPOSTA_VUOTA"},dataProvider="OneWay_RispostaCompletamenteVuota",dependsOnMethods={"oneWay_RispostaCompletamenteVuota"})
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, Handlers.ID_GRUPPO,Handlers.ID_GRUPPO+".SINCRONO_STATEFUL"},dataProvider="TipologieTests")
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, Handlers.ID_GRUPPO,Handlers.ID_GRUPPO+".SINCRONO_STATEFUL"},dataProvider="Sincrono_Stateful",dependsOnMethods={"sincrono_Stateful"})
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, Handlers.ID_GRUPPO,Handlers.ID_GRUPPO+".SINCRONO_STATELESS"},dataProvider="TipologieTests")
	...
	@Test(groups={CostantiOthers.ID_GRUPPO_OTHERS, Handlers.ID_GRUPPO,Handlers.ID_GRUPPO+".SINCRONO_STATELESS"},dataProvider="Sincrono_Stateless",dependsOnMethods={"sincrono_Stateless"})

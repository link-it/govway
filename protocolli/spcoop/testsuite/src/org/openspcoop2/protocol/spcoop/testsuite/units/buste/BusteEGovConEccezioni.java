...
public class BusteEGovConEccezioni {
	...
	@Test(groups={CostantiBuste.ID_GRUPPO_BUSTE,ID_GRUPPO,ID_GRUPPO+".OWENG",ID_GRUPPO+".SENG",ID_GRUPPO+".OWEAG",ID_GRUPPO+".SEAG",ID_GRUPPO+".OWEAG_FC",ID_GRUPPO+".OWEAG_FC_CDATA",ID_GRUPPO+".OWEAG_FSS",ID_GRUPPO+".OWEAG_FCS"})
	...
	@Test(groups={CostantiBuste.ID_GRUPPO_BUSTE,ID_GRUPPO,ID_GRUPPO+".OWEAG_FSS"},
			dependsOnMethods="init")
	...
	@Test(groups={CostantiBuste.ID_GRUPPO_BUSTE,ID_GRUPPO,ID_GRUPPO+".OWEAG_FCS"},
			dependsOnMethods="init")

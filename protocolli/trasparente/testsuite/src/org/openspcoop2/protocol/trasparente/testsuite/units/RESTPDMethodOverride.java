...
public class RESTPDMethodOverride {
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDMethodOverride.ID_GRUPPO,RESTPDMethodOverride.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaJSON"},dataProvider="contentTypeJSONConSenza")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDMethodOverride.ID_GRUPPO,RESTPDMethodOverride.ID_GRUPPO+".ConContenutoRichiesta_SenzaContenutoRispostaJSON"},dataProvider="contentTypeJSONConSenza")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDMethodOverride.ID_GRUPPO,RESTPDMethodOverride.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDMethodOverride.ID_GRUPPO,RESTPDMethodOverride.ID_GRUPPO+".ConContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDMethodOverride.ID_GRUPPO,RESTPDMethodOverride.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaXML"},dataProvider="contentTypeXMLConSenza")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDMethodOverride.ID_GRUPPO,RESTPDMethodOverride.ID_GRUPPO+".ConContenutoRichiesta_SenzaContenutoRispostaXML"},dataProvider="contentTypeXMLConSenza")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDMethodOverride.ID_GRUPPO,RESTPDMethodOverride.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDMethodOverride.ID_GRUPPO,RESTPDMethodOverride.ID_GRUPPO+".ConContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDMethodOverride.ID_GRUPPO,RESTPDMethodOverride.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaMulti"},dataProvider="responseCodeConSenza")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDMethodOverride.ID_GRUPPO,RESTPDMethodOverride.ID_GRUPPO+".ConContenutoRichiesta_SenzaContenutoRispostaMulti"},dataProvider="responseCodeConSenza")

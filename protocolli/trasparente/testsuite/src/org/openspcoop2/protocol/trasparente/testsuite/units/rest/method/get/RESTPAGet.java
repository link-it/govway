...
package org.openspcoop2.protocol.trasparente.testsuite.units.rest.method.get;
...
public class RESTPAGet {
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPAGet.ID_GRUPPO,RESTPAGet.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPAGet.ID_GRUPPO,RESTPAGet.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPAGet.ID_GRUPPO,RESTPAGet.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPAGet.ID_GRUPPO,RESTPAGet.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPAGet.ID_GRUPPO,RESTPAGet.ID_GRUPPO+".REDIRECT"},dataProvider="redirect")

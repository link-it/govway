...
public class RESTPDDelete {
	...
	@Test(groups={RESTCore.REST_CORE,RESTPDDelete.ID_GRUPPO,RESTPDDelete.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPDDelete.ID_GRUPPO,RESTPDDelete.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPDDelete.ID_GRUPPO,RESTPDDelete.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPDDelete.ID_GRUPPO,RESTPDDelete.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPDDelete.ID_GRUPPO,RESTPDDelete.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPDDelete.ID_GRUPPO,RESTPDDelete.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaMulti"},dataProvider="responseCodeConCon")

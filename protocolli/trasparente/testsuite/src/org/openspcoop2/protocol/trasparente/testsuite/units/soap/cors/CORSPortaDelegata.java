...
public class CORSPortaDelegata {
	...
	public static final String ID_GRUPPO = "CORSPortaDelegata.SOAP";
	...
	public void testDoFilterActualPOST() throws TestSuiteException, Exception{
		...
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_DELEGATA_SOAP_CORS);
	 ...
	 */
	@Test(groups={CostantiTestSuite.ID_GRUPPO_TEST_CORS, CostantiTestSuite.ID_GRUPPO_TEST_CORS_PORTA_DELEGATA, CORSPortaDelegata.ID_GRUPPO,CORSPortaDelegata.ID_GRUPPO+".actualAnyOriginAndSupportsCredentials"})
	public void testDoFilterActualAnyOriginAndSupportsCredentials() throws TestSuiteException, Exception{
		Repository repository=new Repository();
		RESTCore restCore = new RESTCore(HttpRequestMethod.POST, RUOLO.PORTA_DELEGATA);
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_DELEGATA_SOAP_CORS_ALLORIGINS_CREDENTIALS);
	 ...
	 */
	@Test(groups={CostantiTestSuite.ID_GRUPPO_TEST_CORS, CostantiTestSuite.ID_GRUPPO_TEST_CORS_PORTA_DELEGATA, CORSPortaDelegata.ID_GRUPPO,CORSPortaDelegata.ID_GRUPPO+".actualAnyOriginAndSupportsCredentialsDisabled"})
	public void testDoFilterActualAnyOriginAndSupportsCredentialsDisabled() throws TestSuiteException, Exception{
		Repository repository=new Repository();
		RESTCore restCore = new RESTCore(HttpRequestMethod.POST, RUOLO.PORTA_DELEGATA);
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_DELEGATA_SOAP_CORS_ALLORIGINS);
	 ...
	 */
	@Test(groups={CostantiTestSuite.ID_GRUPPO_TEST_CORS, CostantiTestSuite.ID_GRUPPO_TEST_CORS_PORTA_DELEGATA, CORSPortaDelegata.ID_GRUPPO,CORSPortaDelegata.ID_GRUPPO+".actualRequestWithExposedHeaders"})
	public void testDoFilterActualWithExposedHeaders() throws TestSuiteException, Exception{
		Repository repository=new Repository();
		RESTCore restCore = new RESTCore(HttpRequestMethod.POST, RUOLO.PORTA_DELEGATA);
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_DELEGATA_SOAP_CORS_EXPOSE);
	...
	public void testDoFilterPreflightNegativeMaxAge() throws TestSuiteException, Exception{
		Repository repository=new Repository();
		RESTCore restCore = new RESTCore(HttpRequestMethod.OPTIONS, RUOLO.PORTA_DELEGATA);
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_DELEGATA_SOAP_CORS_MAXAGE_DISABLED);
	...
	public void testDoFilterPreflightMaxAge() throws TestSuiteException, Exception{
		Repository repository=new Repository();
		RESTCore restCore = new RESTCore(HttpRequestMethod.OPTIONS, RUOLO.PORTA_DELEGATA);
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_DELEGATA_SOAP_CORS_MAXAGE);
	 ...
	 * 
	 */
	@Test(groups={CostantiTestSuite.ID_GRUPPO_TEST_CORS, CostantiTestSuite.ID_GRUPPO_TEST_CORS_PORTA_DELEGATA, CORSPortaDelegata.ID_GRUPPO,CORSPortaDelegata.ID_GRUPPO+".actualRequestTrasparente"})
	public void testDoFilterActualRequestTrasparente() throws TestSuiteException, Exception{
		Repository repository=new Repository();
		RESTCore restCore = new RESTCore(HttpRequestMethod.POST, RUOLO.PORTA_DELEGATA);
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_DELEGATA_SOAP_CORS_TRASPARENTE);

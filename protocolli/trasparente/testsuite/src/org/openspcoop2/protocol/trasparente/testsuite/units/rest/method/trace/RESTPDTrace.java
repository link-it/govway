...
package org.openspcoop2.protocol.trasparente.testsuite.units.rest.method.trace;
 ...
 * @version $Rev$, $Date$
 */
public class RESTPDTrace {

	private static final String ID_GRUPPO = "REST.PD.TRACE";
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDTrace.ID_GRUPPO,RESTPDTrace.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDTrace.ID_GRUPPO,RESTPDTrace.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDTrace.ID_GRUPPO,RESTPDTrace.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDTrace.ID_GRUPPO,RESTPDTrace.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDTrace.ID_GRUPPO,RESTPDTrace.ID_GRUPPO+".REDIRECT"},dataProvider="redirect")

 ...
 * @version $Rev$, $Date$
 */
public class RESTPADelete {

	private static final String ID_GRUPPO = "REST.PA.DELETE";
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".REDIRECT"},dataProvider="redirect")

...
public class PortaApplicativaNonAutenticato extends PortaImpl {
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ONEWAY",PortaApplicativa.ID_GRUPPO+".SOAP11",PortaApplicativa.ID_GRUPPO+".ONEWAY.SOAP11.STATEFUL"})
	public void oneWay_paSOAP11Stateful() throws FatalTestSuiteException, Exception{
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ONEWAY",PortaApplicativa.ID_GRUPPO+".SOAP11",PortaApplicativa.ID_GRUPPO+".ONEWAY.SOAP11.STATEFUL"},dataProvider=PortaApplicativa.ID_GRUPPO+"OneWaySOAP11Stateful",dependsOnMethods={"oneWay_paSOAP11Stateful"})
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ONEWAY",PortaApplicativa.ID_GRUPPO+".SOAP11",PortaApplicativa.ID_GRUPPO+".ONEWAY.SOAP11.STATELESS"})
	public void oneWay_paSOAP11Stateless() throws FatalTestSuiteException, Exception{
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ONEWAY",PortaApplicativa.ID_GRUPPO+".SOAP11",PortaApplicativa.ID_GRUPPO+".ONEWAY.SOAP11.STATELESS"},dataProvider=PortaApplicativa.ID_GRUPPO+"OneWaySOAP11Stateless",dependsOnMethods={"oneWay_paSOAP11Stateless"})
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ONEWAY",PortaApplicativa.ID_GRUPPO+".SOAP12",PortaApplicativa.ID_GRUPPO+".ONEWAY.SOAP12.STATEFUL"})
	public void oneWay_paSOAP12Stateful() throws FatalTestSuiteException, Exception{
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ONEWAY",PortaApplicativa.ID_GRUPPO+".SOAP12",PortaApplicativa.ID_GRUPPO+".ONEWAY.SOAP12.STATEFUL"},dataProvider=PortaApplicativa.ID_GRUPPO+"OneWaySOAP12Stateful",dependsOnMethods={"oneWay_paSOAP12Stateful"})
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ONEWAY",PortaApplicativa.ID_GRUPPO+".SOAP12",PortaApplicativa.ID_GRUPPO+".ONEWAY.SOAP12.STATELESS"})
	public void oneWay_paSOAP12Stateless() throws FatalTestSuiteException, Exception{
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ONEWAY",PortaApplicativa.ID_GRUPPO+".SOAP12",PortaApplicativa.ID_GRUPPO+".ONEWAY.SOAP12.STATELESS"},dataProvider=PortaApplicativa.ID_GRUPPO+"OneWaySOAP12Stateless",dependsOnMethods={"oneWay_paSOAP12Stateless"})
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ATTACHMENTS",PortaApplicativa.ID_GRUPPO+".ONEWAY",PortaApplicativa.ID_GRUPPO+".SOAP11",PortaApplicativa.ID_GRUPPO+".ONEWAY.SOAP11.STATEFUL.ATTACHMENTS"})
	public void oneWay_paSOAP11WithAttachmentsStateful() throws FatalTestSuiteException, Exception{
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ATTACHMENTS",PortaApplicativa.ID_GRUPPO+".ONEWAY",PortaApplicativa.ID_GRUPPO+".SOAP11",PortaApplicativa.ID_GRUPPO+".ONEWAY.SOAP11.STATELESS.ATTACHMENTS"})
	public void oneWay_paSOAP11WithAttachmentsStateless() throws FatalTestSuiteException, Exception{
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ATTACHMENTS",PortaApplicativa.ID_GRUPPO+".ONEWAY",PortaApplicativa.ID_GRUPPO+".SOAP12",PortaApplicativa.ID_GRUPPO+".ONEWAY.SOAP12.STATEFUL.ATTACHMENTS"})
	public void oneWay_paSOAP12WithAttachmentsStateful() throws FatalTestSuiteException, Exception{
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ATTACHMENTS",PortaApplicativa.ID_GRUPPO+".ONEWAY",PortaApplicativa.ID_GRUPPO+".SOAP12",PortaApplicativa.ID_GRUPPO+".ONEWAY.SOAP12.STATELESS.ATTACHMENTS"})
	public void oneWay_paSOAP12WithAttachmentsStateless() throws FatalTestSuiteException, Exception{
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".SINCRONO",PortaApplicativa.ID_GRUPPO+".SOAP11",PortaApplicativa.ID_GRUPPO+".SINCRONO.SOAP11.STATEFUL"})
	public void sincrono_paSOAP11Stateful() throws FatalTestSuiteException, Exception{
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".SINCRONO",PortaApplicativa.ID_GRUPPO+".SOAP11",PortaApplicativa.ID_GRUPPO+".SINCRONO.SOAP11.STATEFUL"},dataProvider=PortaApplicativa.ID_GRUPPO+"SincronoSOAP11Stateful",dependsOnMethods={"sincrono_paSOAP11Stateful"})
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".SINCRONO",PortaApplicativa.ID_GRUPPO+".SOAP11",PortaApplicativa.ID_GRUPPO+".SINCRONO.SOAP11.STATELESS"})
	public void sincrono_paSOAP11Stateless() throws FatalTestSuiteException, Exception{
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".SINCRONO",PortaApplicativa.ID_GRUPPO+".SOAP11",PortaApplicativa.ID_GRUPPO+".SINCRONO.SOAP11.STATELESS"},dataProvider=PortaApplicativa.ID_GRUPPO+"SincronoSOAP11Stateless",dependsOnMethods={"sincrono_paSOAP11Stateless"})
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".SINCRONO",PortaApplicativa.ID_GRUPPO+".SOAP12",PortaApplicativa.ID_GRUPPO+".SINCRONO.SOAP12.STATEFUL"})
	public void sincrono_paSOAP12Stateful() throws FatalTestSuiteException, Exception{
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".SINCRONO",PortaApplicativa.ID_GRUPPO+".SOAP12",PortaApplicativa.ID_GRUPPO+".SINCRONO.SOAP12.STATEFUL"},dataProvider=PortaApplicativa.ID_GRUPPO+"SincronoSOAP12Stateful",dependsOnMethods={"sincrono_paSOAP12Stateful"})
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".SINCRONO",PortaApplicativa.ID_GRUPPO+".SOAP12",PortaApplicativa.ID_GRUPPO+".SINCRONO.SOAP12.STATELESS"})
	public void sincrono_paSOAP12Stateless() throws FatalTestSuiteException, Exception{
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".SINCRONO",PortaApplicativa.ID_GRUPPO+".SOAP12",PortaApplicativa.ID_GRUPPO+".SINCRONO.SOAP12.STATELESS"},dataProvider=PortaApplicativa.ID_GRUPPO+"SincronoSOAP12Stateless",dependsOnMethods={"sincrono_paSOAP12Stateless"})
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ATTACHMENTS",PortaApplicativa.ID_GRUPPO+".SINCRONO",PortaApplicativa.ID_GRUPPO+".SOAP11",PortaApplicativa.ID_GRUPPO+".SINCRONO.SOAP11.STATEFUL.ATTACHMENTS"})
	public void sincrono_paSOAP11WithAttachmentsStateful() throws FatalTestSuiteException, Exception{
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ATTACHMENTS",PortaApplicativa.ID_GRUPPO+".SINCRONO",PortaApplicativa.ID_GRUPPO+".SOAP11",PortaApplicativa.ID_GRUPPO+".SINCRONO.SOAP11.STATEFUL.ATTACHMENTS"},dataProvider=PortaApplicativa.ID_GRUPPO+"SincronoSOAP11WithAttachmentsStateful",dependsOnMethods={"sincrono_paSOAP11WithAttachmentsStateful"})
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ATTACHMENTS",PortaApplicativa.ID_GRUPPO+".SINCRONO",PortaApplicativa.ID_GRUPPO+".SOAP11",PortaApplicativa.ID_GRUPPO+".SINCRONO.SOAP11.STATELESS.ATTACHMENTS"})
	public void sincrono_paSOAP11WithAttachmentsStateless() throws FatalTestSuiteException, Exception{
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ATTACHMENTS",PortaApplicativa.ID_GRUPPO+".SINCRONO",PortaApplicativa.ID_GRUPPO+".SOAP12",PortaApplicativa.ID_GRUPPO+".SINCRONO.SOAP12.STATEFUL.ATTACHMENTS"})
	public void sincrono_paSOAP12WithAttachmentsStateful() throws FatalTestSuiteException, Exception{
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ATTACHMENTS",PortaApplicativa.ID_GRUPPO+".SINCRONO",PortaApplicativa.ID_GRUPPO+".SOAP12",PortaApplicativa.ID_GRUPPO+".SINCRONO.SOAP12.STATEFUL.ATTACHMENTS"},dataProvider=PortaApplicativa.ID_GRUPPO+"SincronoSOAP12WithAttachmentsStateful",dependsOnMethods={"sincrono_paSOAP12WithAttachmentsStateful"})
	...
	@Test(groups={PortaApplicativa.ID_GRUPPO,PortaApplicativa.ID_GRUPPO+".ATTACHMENTS",PortaApplicativa.ID_GRUPPO+".SINCRONO",PortaApplicativa.ID_GRUPPO+".SOAP12",PortaApplicativa.ID_GRUPPO+".SINCRONO.SOAP12.STATELESS.ATTACHMENTS"})
	public void sincrono_paSOAP12WithAttachmentsStateless() throws FatalTestSuiteException, Exception{

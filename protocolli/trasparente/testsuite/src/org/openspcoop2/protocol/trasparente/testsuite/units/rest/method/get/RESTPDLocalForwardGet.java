 ...
 * @version $Rev$, $Date$
 */
public class RESTPDLocalForwardGet {

	private final static String ID_GRUPPO = "REST.PD.LOCAL_FORWARD.GET";
	private HttpRequestMethod method = HttpRequestMethod.GET;

	private RESTCore restCore;
	
	public RESTPDLocalForwardGet() {
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD_LOCAL_FORWARD,RESTPDLocalForwardGet.ID_GRUPPO,RESTPDLocalForwardGet.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD_LOCAL_FORWARD,RESTPDLocalForwardGet.ID_GRUPPO,RESTPDLocalForwardGet.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD_LOCAL_FORWARD,RESTPDLocalForwardGet.ID_GRUPPO,RESTPDLocalForwardGet.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD_LOCAL_FORWARD,RESTPDLocalForwardGet.ID_GRUPPO,RESTPDLocalForwardGet.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD_LOCAL_FORWARD,RESTPDLocalForwardGet.ID_GRUPPO,RESTPDLocalForwardGet.ID_GRUPPO+".REDIRECT"},dataProvider="redirect")

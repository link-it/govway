...
public class ResponseCachingPortaDelegata {
	 ...
	 * 
	 */
	@Test(groups={CostantiTestSuite.ID_GRUPPO_TEST_RESPONSE_CACHING, CostantiTestSuite.ID_GRUPPO_TEST_RESPONSE_CACHING_PORTA_DELEGATA, ResponseCachingPortaDelegata.ID_GRUPPO,ResponseCachingPortaDelegata.ID_GRUPPO+".digestQueryParameters"})
	public void testResponseCachingDigestQueryParameters() throws TestSuiteException, Exception{
		...
		Repository repository=new Repository();
		RESTCore restCore = new RESTCore(HttpRequestMethod.GET, RUOLO.PORTA_DELEGATA);
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_DELEGATA_RESPONSE_CACHING_DIGEST_CON_QUERY_PARAMETERS);

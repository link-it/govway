...
public class RESTPADelete {
	...
	@Test(groups={RESTCore.REST_CORE,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTCore.REST_PA,RESTPADelete.ID_GRUPPO,RESTPADelete.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaMulti"},dataProvider="responseCodeConCon")

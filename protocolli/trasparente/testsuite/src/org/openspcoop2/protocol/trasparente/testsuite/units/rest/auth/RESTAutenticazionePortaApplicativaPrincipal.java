 ...
 * @version $Rev$, $Date$
 */
public class RESTAutenticazionePortaApplicativaPrincipal {

	/** Identificativo del gruppo */
	public static final String ID_GRUPPO_PRINCIPAL = "RESTAutenticazionePortaApplicativaPrincipal";
	

	
	private Date dataAvvioGruppoTest = null;
	@BeforeGroups (alwaysRun=true , groups= {RESTAutenticazionePortaApplicativa.ID_GRUPPO, RESTAutenticazionePortaApplicativaPrincipal.ID_GRUPPO_PRINCIPAL})
	public void testOpenspcoopCoreLog_raccoltaTempoAvvioTest() throws Exception{
		this.dataAvvioGruppoTest = DateManager.getDate();
	} 	
	private List<ErroreAttesoOpenSPCoopLogCore> erroriAttesiOpenSPCoopCore = new java.util.ArrayList<>();
	@AfterGroups (alwaysRun=true , groups={RESTAutenticazionePortaApplicativa.ID_GRUPPO, RESTAutenticazionePortaApplicativaPrincipal.ID_GRUPPO_PRINCIPAL})
...
//	Si attende un 401 ritornato da GovWay e un corretto WWW-Authenticate header.
	...
	@Test(groups={RESTAutenticazionePortaApplicativa.ID_GRUPPO,RESTAutenticazionePortaApplicativaPrincipal.ID_GRUPPO_PRINCIPAL,RESTAutenticazionePortaApplicativa.ID_GRUPPO+".AuthPrincipal_WWWAuthenticate_credenzialiNonFornite"},dataProvider="principalWWWAuthenticateProvider")

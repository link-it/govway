...
public class RESTPDHead {
	...
	@Test(groups={RESTCore.REST_CORE,RESTPDHead.ID_GRUPPO,RESTPDHead.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPDHead.ID_GRUPPO,RESTPDHead.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")

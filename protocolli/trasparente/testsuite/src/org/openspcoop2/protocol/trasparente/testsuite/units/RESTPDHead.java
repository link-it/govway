...
public class RESTPDHead {
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDHead.ID_GRUPPO,RESTPDHead.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDHead.ID_GRUPPO,RESTPDHead.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDHead.ID_GRUPPO,RESTPDHead.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDHead.ID_GRUPPO,RESTPDHead.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDHead.ID_GRUPPO,RESTPDHead.ID_GRUPPO+".REDIRECT"},dataProvider="redirect")

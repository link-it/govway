...
public class RESTPATrace {
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPATrace.ID_GRUPPO,RESTPATrace.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPATrace.ID_GRUPPO,RESTPATrace.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPATrace.ID_GRUPPO,RESTPATrace.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPATrace.ID_GRUPPO,RESTPATrace.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPATrace.ID_GRUPPO,RESTPATrace.ID_GRUPPO+".REDIRECT"},dataProvider="redirect")

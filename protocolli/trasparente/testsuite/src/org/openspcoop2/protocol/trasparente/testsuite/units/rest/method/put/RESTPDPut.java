 ...
 * @version $Rev$, $Date$
 */
public class RESTPDPut {

	private final static String ID_GRUPPO = "REST.PD.PUT";
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDPut.ID_GRUPPO,RESTPDPut.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaJSON"},dataProvider="contentTypeJSONConSenza")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDPut.ID_GRUPPO,RESTPDPut.ID_GRUPPO+".ConContenutoRichiesta_SenzaContenutoRispostaJSON"},dataProvider="contentTypeJSONConSenza")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDPut.ID_GRUPPO,RESTPDPut.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDPut.ID_GRUPPO,RESTPDPut.ID_GRUPPO+".ConContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDPut.ID_GRUPPO,RESTPDPut.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaBinary"},dataProvider="contentTypeBinaryConSenza")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDPut.ID_GRUPPO,RESTPDPut.ID_GRUPPO+".ConContenutoRichiesta_SenzaContenutoRispostaBinary"},dataProvider="contentTypeBinaryConSenza")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDPut.ID_GRUPPO,RESTPDPut.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDPut.ID_GRUPPO,RESTPDPut.ID_GRUPPO+".ConContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDPut.ID_GRUPPO,RESTPDPut.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaXML"},dataProvider="contentTypeXMLConSenza")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDPut.ID_GRUPPO,RESTPDPut.ID_GRUPPO+".ConContenutoRichiesta_SenzaContenutoRispostaXML"},dataProvider="contentTypeXMLConSenza")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDPut.ID_GRUPPO,RESTPDPut.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDPut.ID_GRUPPO,RESTPDPut.ID_GRUPPO+".ConContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDPut.ID_GRUPPO,RESTPDPut.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaMulti"},dataProvider="responseCodeConSenza")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDPut.ID_GRUPPO,RESTPDPut.ID_GRUPPO+".ConContenutoRichiesta_SenzaContenutoRispostaMulti"},dataProvider="responseCodeConSenza")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDPut.ID_GRUPPO,RESTPDPut.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")

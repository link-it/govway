 ...
 * @version $Rev$, $Date$
 */
public class RESTPDLocalForwardOptions {

	private final static String ID_GRUPPO = "REST.PD.LOCAL_FORWARD.OPTIONS";
	private HttpRequestMethod method = HttpRequestMethod.OPTIONS;

	private RESTCore restCore;
	
	public RESTPDLocalForwardOptions() {
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD_LOCAL_FORWARD,RESTPDLocalForwardOptions.ID_GRUPPO,RESTPDLocalForwardOptions.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD_LOCAL_FORWARD,RESTPDLocalForwardOptions.ID_GRUPPO,RESTPDLocalForwardOptions.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD_LOCAL_FORWARD,RESTPDLocalForwardOptions.ID_GRUPPO,RESTPDLocalForwardOptions.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD_LOCAL_FORWARD,RESTPDLocalForwardOptions.ID_GRUPPO,RESTPDLocalForwardOptions.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD_LOCAL_FORWARD,RESTPDLocalForwardOptions.ID_GRUPPO,RESTPDLocalForwardOptions.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD_LOCAL_FORWARD,RESTPDLocalForwardOptions.ID_GRUPPO,RESTPDLocalForwardOptions.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD_LOCAL_FORWARD,RESTPDLocalForwardOptions.ID_GRUPPO,RESTPDLocalForwardOptions.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD_LOCAL_FORWARD,RESTPDLocalForwardOptions.ID_GRUPPO,RESTPDLocalForwardOptions.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD_LOCAL_FORWARD,RESTPDLocalForwardOptions.ID_GRUPPO,RESTPDLocalForwardOptions.ID_GRUPPO+".REDIRECT"},dataProvider="redirect")

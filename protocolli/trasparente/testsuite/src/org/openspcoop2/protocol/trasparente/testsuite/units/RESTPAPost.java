...
public class RESTPAPost {
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".ConContenutoRichiesta_ConContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaJSON"},dataProvider="contentTypeJSONConSenza")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".ConContenutoRichiesta_SenzaContenutoRispostaJSON"},dataProvider="contentTypeJSONConSenza")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".ConContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaBinary"},dataProvider="contentTypeBinaryConSenza")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".ConContenutoRichiesta_SenzaContenutoRispostaBinary"},dataProvider="contentTypeBinaryConSenza")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".ConContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaXML"},dataProvider="contentTypeXMLConSenza")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".ConContenutoRichiesta_SenzaContenutoRispostaXML"},dataProvider="contentTypeXMLConSenza")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".ConContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaMulti"},dataProvider="responseCodeConSenza")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".ConContenutoRichiesta_SenzaContenutoRispostaMulti"},dataProvider="responseCodeConSenza")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")

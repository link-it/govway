...
public class RESTPAPost {
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".ConContenutoRichiesta_ConContenutoRispostaPDF"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".ConContenutoRichiesta_SenzaContenutoRispostaPDF"},dataProvider="contentTypeBinaryConSenza")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaPDF"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".ConContenutoRichiesta_ConContenutoRispostaZIP"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".ConContenutoRichiesta_SenzaContenutoRispostaZIP"},dataProvider="contentTypeBinaryConSenza")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaZIP"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".ConContenutoRichiesta_ConContenutoRispostaDOC"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".ConContenutoRichiesta_SenzaContenutoRispostaDOC"},dataProvider="contentTypeBinaryConSenza")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAPost.ID_GRUPPO,RESTPAPost.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaDOC"},dataProvider="contentTypeBinaryConCon")

 ...
 * @version $Rev$, $Date$
 */
public class SOAPIntegrazionePortaDelegata {

	/** Identificativo del gruppo */
	public static final String ID_GRUPPO = "SOAPIntegrazionePortaDelegata";
	

	
	private Date dataAvvioGruppoTest = null;
	@BeforeGroups (alwaysRun=true , groups=SOAPIntegrazionePortaDelegata.ID_GRUPPO)
	...
	@Test(groups={CostantiTestSuite.ID_GRUPPO_INTEGRAZIONE, SOAPIntegrazionePortaDelegata.ID_GRUPPO,SOAPIntegrazionePortaDelegata.ID_GRUPPO+".ContentTypesOk"},dataProvider="contentTypesOk")
	public void testContentTypeOk(String contentType) throws TestSuiteException, Exception{
		...
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_DELEGATA_AUTH_BASIC_NO_INTEGRAZIONE_SOAP);
	...
	@Test(groups={CostantiTestSuite.ID_GRUPPO_INTEGRAZIONE, SOAPIntegrazionePortaDelegata.ID_GRUPPO,SOAPIntegrazionePortaDelegata.ID_GRUPPO+".ContentTypesKo"},dataProvider="contentTypesKo")
	...
	@Test(groups={CostantiTestSuite.ID_GRUPPO_INTEGRAZIONE, SOAPIntegrazionePortaDelegata.ID_GRUPPO,SOAPIntegrazionePortaDelegata.ID_GRUPPO+".AlternativeSoap12ContentTypes"},dataProvider="alternativeSoap12ContentTypesSupported")
	...
	@Test(groups={CostantiTestSuite.ID_GRUPPO_INTEGRAZIONE, SOAPIntegrazionePortaDelegata.ID_GRUPPO,SOAPIntegrazionePortaDelegata.ID_GRUPPO+".AlternativeSoap12ContentTypesUnsupported"},dataProvider="alternativeSoap12ContentTypesUnsupported")

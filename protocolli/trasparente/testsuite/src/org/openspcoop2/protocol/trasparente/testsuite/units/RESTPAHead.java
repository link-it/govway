...
public class RESTPAHead {
	...
	@Test(groups={RESTCore.REST_CORE,RESTCore.REST_PA,RESTPAHead.ID_GRUPPO,RESTPAHead.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTCore.REST_PA,RESTPAHead.ID_GRUPPO,RESTPAHead.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTCore.REST_PA,RESTPAHead.ID_GRUPPO,RESTPAHead.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTCore.REST_PA,RESTPAHead.ID_GRUPPO,RESTPAHead.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")

...
public class RESTPAHead {
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAHead.ID_GRUPPO,RESTPAHead.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPAHead.ID_GRUPPO,RESTPAHead.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")

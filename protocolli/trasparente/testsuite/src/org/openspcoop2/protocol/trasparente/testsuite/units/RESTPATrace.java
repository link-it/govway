...
public class RESTPATrace {
	...
	@Test(groups={RESTCore.REST_CORE,RESTPATrace.ID_GRUPPO,RESTPATrace.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPATrace.ID_GRUPPO,RESTPATrace.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")

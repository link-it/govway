...
package org.openspcoop2.protocol.trasparente.testsuite.units.rest.method.options;
 ...
 * @version $Rev$, $Date$
 */
public class RESTPDOptions {

	private static final String ID_GRUPPO = "REST.PD.OPTIONS";
	private HttpRequestMethod method = HttpRequestMethod.OPTIONS;

	private RESTCore restCore;
	
	public RESTPDOptions() {
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDOptions.ID_GRUPPO,RESTPDOptions.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDOptions.ID_GRUPPO,RESTPDOptions.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDOptions.ID_GRUPPO,RESTPDOptions.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDOptions.ID_GRUPPO,RESTPDOptions.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDOptions.ID_GRUPPO,RESTPDOptions.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDOptions.ID_GRUPPO,RESTPDOptions.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDOptions.ID_GRUPPO,RESTPDOptions.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDOptions.ID_GRUPPO,RESTPDOptions.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PD,RESTPDOptions.ID_GRUPPO,RESTPDOptions.ID_GRUPPO+".REDIRECT"},dataProvider="redirect")

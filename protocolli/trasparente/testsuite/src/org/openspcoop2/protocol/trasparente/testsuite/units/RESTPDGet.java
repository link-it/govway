...
public class RESTPDGet {
	...
	@Test(groups={RESTCore.REST_CORE,RESTPDGet.ID_GRUPPO,RESTPDGet.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTPDGet.ID_GRUPPO,RESTPDGet.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")

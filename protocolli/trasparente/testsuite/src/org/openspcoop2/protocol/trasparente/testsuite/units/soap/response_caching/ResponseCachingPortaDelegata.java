...
public class ResponseCachingPortaDelegata {
	...
	public static final String ID_GRUPPO = "ResponseCachingPortaDelegata.SOAP";
	 ...
	 * 
	 */
	@DataProvider(name=ResponseCachingPortaDelegata.ID_GRUPPO+".soapFault")
	public Object[][] soapFaultProvider(){
		return new Object[][]{
			{500, CostantiTestSuite.PORTA_DELEGATA_RESPONSE_CACHING_INCLUDE_SOAP_FAULT_11, 
				CostantiTestSuite.PROXY_SERVIZIO_SINCRONO_AZIONE_SOAPFAULT_11_500, true , "soap11"},
			
			{500, CostantiTestSuite.PORTA_DELEGATA_RESPONSE_CACHING_EXCLUDE_SOAP_FAULT_11, 
				CostantiTestSuite.PROXY_SERVIZIO_SINCRONO_AZIONE_SOAPFAULT_11_500, false , "soap11"},
			
			{500, CostantiTestSuite.PORTA_DELEGATA_RESPONSE_CACHING_INCLUDE_SOAP_FAULT_12, 
				CostantiTestSuite.PROXY_SERVIZIO_SINCRONO_AZIONE_SOAPFAULT_12_500, true , "soap12"},
			
			{500, CostantiTestSuite.PORTA_DELEGATA_RESPONSE_CACHING_EXCLUDE_SOAP_FAULT_12, 
				CostantiTestSuite.PROXY_SERVIZIO_SINCRONO_AZIONE_SOAPFAULT_12_500, false , "soap12"},
		};
	}
	@Test(groups={CostantiTestSuite.ID_GRUPPO_TEST_RESPONSE_CACHING, CostantiTestSuite.ID_GRUPPO_TEST_RESPONSE_CACHING_PORTA_DELEGATA, ResponseCachingPortaDelegata.ID_GRUPPO,ResponseCachingPortaDelegata.ID_GRUPPO+".soapFault"},
			dataProvider=ResponseCachingPortaDelegata.ID_GRUPPO+".soapFault")

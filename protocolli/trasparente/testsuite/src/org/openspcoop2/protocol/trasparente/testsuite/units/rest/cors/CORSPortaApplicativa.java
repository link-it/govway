...
public class CORSPortaApplicativa {
	...
	public static final String ID_GRUPPO = "CORSPortaApplicativa.REST";
	 ...
	 * 
	 */
	@Test(groups={CostantiTestSuite.ID_GRUPPO_TEST_CORS, CostantiTestSuite.ID_GRUPPO_TEST_CORS_PORTA_APPLICATIVA, CORSPortaApplicativa.ID_GRUPPO,CORSPortaApplicativa.ID_GRUPPO+".simpleRequestGET"})
	public void testDoFilterSimpleGET() throws TestSuiteException, Exception{
		...
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_APPLICATIVA_REST_CORS);
	...
	/**
	 * Tests if a POST request is treated as actual request (contentType).
	 */	
	...
	/**
	 * Tests if a POST request is treated as actual request (contentType non presente).
	 */	
	@Test(groups={CostantiTestSuite.ID_GRUPPO_TEST_CORS, CostantiTestSuite.ID_GRUPPO_TEST_CORS_PORTA_APPLICATIVA, CORSPortaApplicativa.ID_GRUPPO,CORSPortaApplicativa.ID_GRUPPO+".actualRequestPOSTWithoutContentType"})
	 ...
	 */	
	@Test(groups={CostantiTestSuite.ID_GRUPPO_TEST_CORS, CostantiTestSuite.ID_GRUPPO_TEST_CORS_PORTA_APPLICATIVA, CORSPortaApplicativa.ID_GRUPPO,CORSPortaApplicativa.ID_GRUPPO+".simpleRequestHEAD"})
	public void testDoFilterSimpleHEAD() throws TestSuiteException, Exception{
		Repository repository=new Repository();
		RESTCore restCore = new RESTCore(HttpRequestMethod.HEAD, RUOLO.PORTA_APPLICATIVA);
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_APPLICATIVA_REST_CORS);
	 ...
	 */	
	@Test(groups={CostantiTestSuite.ID_GRUPPO_TEST_CORS, CostantiTestSuite.ID_GRUPPO_TEST_CORS_PORTA_APPLICATIVA, CORSPortaApplicativa.ID_GRUPPO,CORSPortaApplicativa.ID_GRUPPO+".actualPUT"})
	public void testDoFilterActualPUT() throws TestSuiteException, Exception{
		Repository repository=new Repository();
		RESTCore restCore = new RESTCore(HttpRequestMethod.PUT, RUOLO.PORTA_APPLICATIVA); // put non e' più simple
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_APPLICATIVA_REST_CORS);
	 ...
	 */
	@Test(groups={CostantiTestSuite.ID_GRUPPO_TEST_CORS, CostantiTestSuite.ID_GRUPPO_TEST_CORS_PORTA_APPLICATIVA, CORSPortaApplicativa.ID_GRUPPO,CORSPortaApplicativa.ID_GRUPPO+".simpleAnyOriginAndSupportsCredentials"})
	public void testDoFilterSimpleAnyOriginAndSupportsCredentials() throws TestSuiteException, Exception{
		Repository repository=new Repository();
		RESTCore restCore = new RESTCore(HttpRequestMethod.POST, RUOLO.PORTA_APPLICATIVA);
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_APPLICATIVA_REST_CORS_ALLORIGINS_CREDENTIALS);
	 ...
	 */
	@Test(groups={CostantiTestSuite.ID_GRUPPO_TEST_CORS, CostantiTestSuite.ID_GRUPPO_TEST_CORS_PORTA_APPLICATIVA, CORSPortaApplicativa.ID_GRUPPO,CORSPortaApplicativa.ID_GRUPPO+".simpleAnyOriginAndSupportsCredentialsDisabled"})
	public void testDoFilterSimpleAnyOriginAndSupportsCredentialsDisabled() throws TestSuiteException, Exception{
		Repository repository=new Repository();
		RESTCore restCore = new RESTCore(HttpRequestMethod.POST, RUOLO.PORTA_APPLICATIVA);
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_APPLICATIVA_REST_CORS_ALLORIGINS);
	 ...
	 */
	@Test(groups={CostantiTestSuite.ID_GRUPPO_TEST_CORS, CostantiTestSuite.ID_GRUPPO_TEST_CORS_PORTA_APPLICATIVA, CORSPortaApplicativa.ID_GRUPPO,CORSPortaApplicativa.ID_GRUPPO+".simpleRequestWithExposedHeaders"})
	public void testDoFilterSimpleWithExposedHeaders() throws TestSuiteException, Exception{
		Repository repository=new Repository();
		RESTCore restCore = new RESTCore(HttpRequestMethod.POST, RUOLO.PORTA_APPLICATIVA);
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_APPLICATIVA_REST_CORS_EXPOSE);
	...
	public void testDoFilterPreflightNegativeMaxAge() throws TestSuiteException, Exception{
		Repository repository=new Repository();
		RESTCore restCore = new RESTCore(HttpRequestMethod.OPTIONS, RUOLO.PORTA_APPLICATIVA);
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_APPLICATIVA_REST_CORS_MAXAGE_DISABLED);
	...
	public void testDoFilterPreflightMaxAge() throws TestSuiteException, Exception{
		Repository repository=new Repository();
		RESTCore restCore = new RESTCore(HttpRequestMethod.OPTIONS, RUOLO.PORTA_APPLICATIVA);
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_APPLICATIVA_REST_CORS_MAXAGE);
	 ...
	 * 
	 */
	@Test(groups={CostantiTestSuite.ID_GRUPPO_TEST_CORS, CostantiTestSuite.ID_GRUPPO_TEST_CORS_PORTA_APPLICATIVA, CORSPortaApplicativa.ID_GRUPPO,CORSPortaApplicativa.ID_GRUPPO+".simpleRequestTrasparente"})
	public void testDoFilterSimpleRequestTrasparente() throws TestSuiteException, Exception{
		...
		Repository repository=new Repository();
		RESTCore restCore = new RESTCore(HttpRequestMethod.GET, RUOLO.PORTA_APPLICATIVA);
		restCore.setPortaApplicativaDelegata(CostantiTestSuite.PORTA_APPLICATIVA_REST_CORS_TRASPARENTE);

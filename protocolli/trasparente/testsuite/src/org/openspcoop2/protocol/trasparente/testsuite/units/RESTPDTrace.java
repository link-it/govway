...
public class RESTPDTrace {
	...
	@Test(groups={RESTCore.REST_CORE,RESTCore.REST_PD,RESTPDTrace.ID_GRUPPO,RESTPDTrace.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTCore.REST_PD,RESTPDTrace.ID_GRUPPO,RESTPDTrace.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTCore.REST_PD,RESTPDTrace.ID_GRUPPO,RESTPDTrace.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST_CORE,RESTCore.REST_PD,RESTPDTrace.ID_GRUPPO,RESTPDTrace.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")

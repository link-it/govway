...
public class PortaDelegataLocalForward extends PortaImpl {
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP11",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD.SOAP11.STATEFUL"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP11",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD.SOAP11.STATEFUL"},dataProvider=PortaDelegata.ID_GRUPPO+"OneWayLocalForwardSOAP11Stateful",dependsOnMethods={"oneWayLocalForward_pdSOAP11Stateful"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP11",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD.SOAP11.STATELESS"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP11",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD.SOAP11.STATELESS"},dataProvider=PortaDelegata.ID_GRUPPO+"OneWayLocalForwardSOAP11Stateless",dependsOnMethods={"oneWayLocalForward_pdSOAP11Stateless"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP12",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD.SOAP12.STATEFUL"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP12",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD.SOAP12.STATEFUL"},dataProvider=PortaDelegata.ID_GRUPPO+"OneWayLocalForwardSOAP12Stateful",dependsOnMethods={"oneWayLocalForward_pdSOAP12Stateful"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP12",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD.SOAP12.STATELESS"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP12",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD.SOAP12.STATELESS"},dataProvider=PortaDelegata.ID_GRUPPO+"OneWayLocalForwardSOAP12Stateless",dependsOnMethods={"oneWayLocalForward_pdSOAP12Stateless"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ATTACHMENTS",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP11",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD.SOAP11.STATEFUL.ATTACHMENTS"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ATTACHMENTS",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP11",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD.SOAP11.STATEFUL.ATTACHMENTS"},dataProvider=PortaDelegata.ID_GRUPPO+"OneWayLocalForwardSOAP11WithAttachmentsStateful",dependsOnMethods={"oneWayLocalForward_pdSOAP11WithAttachmentsStateful"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ATTACHMENTS",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP11",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD.SOAP11.STATELESS.ATTACHMENTS"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ATTACHMENTS",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP11",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD.SOAP11.STATELESS.ATTACHMENTS"},dataProvider=PortaDelegata.ID_GRUPPO+"OneWayLocalForwardSOAP11WithAttachmentsStateless",dependsOnMethods={"oneWayLocalForward_pdSOAP11WithAttachmentsStateless"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ATTACHMENTS",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP12",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD.SOAP12.STATEFUL.ATTACHMENTS"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ATTACHMENTS",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP12",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD.SOAP12.STATEFUL.ATTACHMENTS"},dataProvider=PortaDelegata.ID_GRUPPO+"OneWayLocalForwardSOAP12WithAttachmentsStateful",dependsOnMethods={"oneWayLocalForward_pdSOAP12WithAttachmentsStateful"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ATTACHMENTS",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP12",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD.SOAP12.STATELESS.ATTACHMENTS"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ATTACHMENTS",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP12",PortaDelegata.ID_GRUPPO+".ONEWAY_LOCAL_FORWARD.SOAP12.STATELESS.ATTACHMENTS"},dataProvider=PortaDelegata.ID_GRUPPO+"OneWayLocalForwardSOAP12WithAttachmentsStateless",dependsOnMethods={"oneWayLocalForward_pdSOAP12WithAttachmentsStateless"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".SINCRONO_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP11",PortaDelegata.ID_GRUPPO+".SINCRONO_LOCAL_FORWARD.SOAP11.STATELESS"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".SINCRONO_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP11",PortaDelegata.ID_GRUPPO+".SINCRONO_LOCAL_FORWARD.SOAP11.STATELESS"},dataProvider=PortaDelegata.ID_GRUPPO+"SincronoLocalForwardSOAP11Stateless",dependsOnMethods={"sincronoLocalForward_pdSOAP11Stateless"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".SINCRONO_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP12",PortaDelegata.ID_GRUPPO+".SINCRONO_LOCAL_FORWARD.SOAP12.STATELESS"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".SINCRONO_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP12",PortaDelegata.ID_GRUPPO+".SINCRONO_LOCAL_FORWARD.SOAP12.STATELESS"},dataProvider=PortaDelegata.ID_GRUPPO+"SincronoLocalForwardSOAP12Stateless",dependsOnMethods={"sincronoLocalForward_pdSOAP12Stateless"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ATTACHMENTS",PortaDelegata.ID_GRUPPO+".SINCRONO_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP11",PortaDelegata.ID_GRUPPO+".SINCRONO_LOCAL_FORWARD.SOAP11.STATELESS.ATTACHMENTS"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ATTACHMENTS",PortaDelegata.ID_GRUPPO+".SINCRONO_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP11",PortaDelegata.ID_GRUPPO+".SINCRONO_LOCAL_FORWARD.SOAP11.STATELESS.ATTACHMENTS"},dataProvider=PortaDelegata.ID_GRUPPO+"SincronoLocalForwardSOAP11WithAttachmentsStateless",dependsOnMethods={"sincronoLocalForward_pdSOAP11WithAttachmentsStateless"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ATTACHMENTS",PortaDelegata.ID_GRUPPO+".SINCRONO_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP12",PortaDelegata.ID_GRUPPO+".SINCRONO_LOCAL_FORWARD.SOAP12.STATELESS.ATTACHMENTS"})
	...
	@Test(groups={PortaDelegata.ID_GRUPPO,PortaDelegata.ID_GRUPPO+".ATTACHMENTS",PortaDelegata.ID_GRUPPO+".SINCRONO_LOCAL_FORWARD",PortaDelegata.ID_GRUPPO+".SOAP12",PortaDelegata.ID_GRUPPO+".SINCRONO_LOCAL_FORWARD.SOAP12.STATELESS.ATTACHMENTS"},dataProvider=PortaDelegata.ID_GRUPPO+"SincronoLocalForwardSOAP12WithAttachmentsStateless",dependsOnMethods={"sincronoLocalForward_pdSOAP12WithAttachmentsStateless"})

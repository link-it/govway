...
public class RESTPAOptions {
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPAOptions.ID_GRUPPO,RESTPAOptions.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPAOptions.ID_GRUPPO,RESTPAOptions.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPAOptions.ID_GRUPPO,RESTPAOptions.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPAOptions.ID_GRUPPO,RESTPAOptions.ID_GRUPPO+".SenzaContenutoRichiesta_ConContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPAOptions.ID_GRUPPO,RESTPAOptions.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaJSON"},dataProvider="contentTypeJSONConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPAOptions.ID_GRUPPO,RESTPAOptions.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaBinary"},dataProvider="contentTypeBinaryConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPAOptions.ID_GRUPPO,RESTPAOptions.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaXML"},dataProvider="contentTypeXMLConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPAOptions.ID_GRUPPO,RESTPAOptions.ID_GRUPPO+".SenzaContenutoRichiesta_SenzaContenutoRispostaMulti"},dataProvider="responseCodeConCon")
	...
	@Test(groups={RESTCore.REST,RESTCore.REST_PA,RESTPAOptions.ID_GRUPPO,RESTPAOptions.ID_GRUPPO+".REDIRECT"},dataProvider="redirect")

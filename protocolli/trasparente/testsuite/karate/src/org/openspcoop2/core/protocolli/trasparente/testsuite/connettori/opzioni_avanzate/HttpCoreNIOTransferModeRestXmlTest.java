...
/**
* HttpCoreNIOTransferModeRestXmlTest
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class HttpCoreNIOTransferModeRestXmlTest extends TransferModeRestXmlTestEngine {
	public HttpCoreNIOTransferModeRestXmlTest() {

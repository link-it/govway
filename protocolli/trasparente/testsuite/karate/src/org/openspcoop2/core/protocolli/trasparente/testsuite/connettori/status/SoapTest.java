...
public class SoapTest extends ConfigLoader {
	...
	public void testOkResponses() throws UtilsException {
		Object[][] provider = new Object[][] {
			{false, "/statusModI", TipoServizio.EROGAZIONE, ConnettoreStatusResponseType.MODI},
			{false, "/statusModI", TipoServizio.FRUIZIONE, ConnettoreStatusResponseType.MODI},
		};
	...
	public void testConnettivita() throws UtilsException, SQLQueryObjectException {
		Object[][] provider = new Object[][] {
			{false, TipoServizio.EROGAZIONE},
			{false, TipoServizio.FRUIZIONE}
		};

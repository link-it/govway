...
* @version $Rev$, $Date$
*/
public class UrlConnBIOSoapTest extends SoapTestEngine {
	public UrlConnBIOSoapTest() {
		this.setLibraryMode(new HttpLibraryMode(HttpLibrary.URLCONNECTION, false, false));
	}
}

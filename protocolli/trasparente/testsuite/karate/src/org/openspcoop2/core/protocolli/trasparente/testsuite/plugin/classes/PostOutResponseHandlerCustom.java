...
* @version $Rev$, $Date$
*/
public class PostOutResponseHandlerCustom implements org.openspcoop2.pdd.core.handlers.PostOutResponseHandler {
	...
	public void invoke(PostOutResponseContext context) throws HandlerException {
		...
		try {
			...
			String tipoTest = "post-out-response-handler";

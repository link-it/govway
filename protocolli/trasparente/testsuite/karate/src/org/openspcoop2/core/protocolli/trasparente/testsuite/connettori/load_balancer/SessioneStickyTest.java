...
public class SessioneStickyTest extends ConfigLoader {
	...
	public void healthCheck() {
		...
		for(var request : richiesteSonda) {
			HttpResponse response = org.openspcoop2.core.protocolli.trasparente.testsuite.Utils.makeRequest(request);
	...
	public static void velocityTemplate_Impl(String erogazione)  throws InterruptedException, ExecutionException {
		...
		var futureResp1 = org.openspcoop2.core.protocolli.trasparente.testsuite.Utils.makeBackgroundRequest(requestBlockingIdSessione1);
		org.openspcoop2.utils.Utilities.sleep(delayRichiesteBackground);

		var futureResp2 = org.openspcoop2.core.protocolli.trasparente.testsuite.Utils.makeBackgroundRequest(requestBlockingIdSessione2);
		org.openspcoop2.utils.Utilities.sleep(delayRichiesteBackground);

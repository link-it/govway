...
* @version $Rev$, $Date$
*/
public class SoapContentLengthTest extends ConfigLoader {
	...
	public void erogazione_globale_small() throws Exception {
		SoapUtilities.test(contentLengthMode, TipoServizio.EROGAZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(Bodies.SMALL_SIZE).getBytes(),
				"globale", "small", null,
				null, false, false);
	}
	@Test
	public void fruizione_globale_small() throws Exception {
		SoapUtilities.test(contentLengthMode, TipoServizio.FRUIZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(Bodies.SMALL_SIZE).getBytes(),
				"globale", "small", null,
				null, false, false);
	}
	@Test
	public void erogazione_globale_50kb() throws Exception {
		SoapUtilities.test(contentLengthMode, TipoServizio.EROGAZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(Bodies.SIZE_50K).getBytes(),
				"globale", "50kb", null,
				null, false, false);
	}
	@Test
	public void fruizione_globale_50kb() throws Exception {
		SoapUtilities.test(contentLengthMode, TipoServizio.FRUIZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(Bodies.SIZE_50K).getBytes(),
				"globale", "50kb", null,
				null, false, false);
	}
	@Test
	public void erogazione_globale_2mb() throws Exception {
		SoapUtilities.test(contentLengthMode, TipoServizio.EROGAZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(Bodies.BIG_SIZE).getBytes(),
				"globale", "2mb", null,
				null, false, false);
	}
	@Test
	public void fruizione_globale_2mb() throws Exception {
		SoapUtilities.test(contentLengthMode, TipoServizio.FRUIZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(Bodies.BIG_SIZE).getBytes(),
				"globale", "2mb", null,
				null, false, false);
	}
	@Test
	public void erogazione_globale_10mb() throws Exception {
		SoapUtilities.test(contentLengthMode, TipoServizio.EROGAZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(1024*1024*10).getBytes(),
				"globale", "2mb", "Request Content-Length exceeds the allowed limit",
				null, true, true);
	}
	@Test
	public void fruizione_globale_10mb() throws Exception {
		SoapUtilities.test(contentLengthMode, TipoServizio.FRUIZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(1024*1024*10).getBytes(),
				"globale", "2mb", "Request Content-Length exceeds the allowed limit",
				null, true, true);
	}
	@Test
	public void erogazione_globale_10mb_header() throws Exception {
		SoapUtilities.test(contentLengthMode, TipoServizio.EROGAZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(1024*1024*10,1024).getBytes(),
				"globale", "2mb", "Request Content-Length exceeds the allowed limit",
				null, true, true);
	}
	@Test
	public void fruizione_globale_10mb_header() throws Exception {
		SoapUtilities.test(contentLengthMode, TipoServizio.FRUIZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(1024*1024*10,1024).getBytes(),
				"globale", "2mb", "Request Content-Length exceeds the allowed limit",
				null, true, true);
	}
	...
	public void erogazione_registrazioneDisabilitata_50kb_requestPolicy_header() throws Exception {
		SoapUtilities.test(contentLengthMode, TipoServizio.EROGAZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(Bodies.SIZE_50K,1024).getBytes(),
				"sendRegistrazioneDisabilitata", "50kb", "Request Content-Length exceeds the allowed limit",
				"Richiesta", true, true);
	}
	@Test
	public void fruizione_registrazioneDisabilitata_50kb_requestPolicy_header() throws Exception {
		SoapUtilities.test(contentLengthMode, TipoServizio.FRUIZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(Bodies.SIZE_50K,1024).getBytes(),
				"sendRegistrazioneDisabilitata", "50kb", "Request Content-Length exceeds the allowed limit",
				"Richiesta", true, true);
	}
	@Test
	...
	public void erogazione_correlazioneApplicativa_small() throws Exception {
		...
		SoapUtilities.test(contentLengthMode, TipoServizio.EROGAZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(Bodies.SMALL_SIZE, idApplicativoClaim).getBytes(),
	...
	public void fruizione_correlazioneApplicativa_small() throws Exception {
		String idApplicativo = System.currentTimeMillis()+"-"+IDUtilities.getUniqueSerialNumber();
		String idApplicativoClaim = "<identificativoApplicativo>"+idApplicativo+"</identificativoApplicativo>";
		SoapUtilities.test(contentLengthMode, TipoServizio.FRUIZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(Bodies.SMALL_SIZE, idApplicativoClaim).getBytes(),
				"sendCorrelazioneApplicativa", "small", null,
				idApplicativo,
				null, false, false);
	}
	...
	public void erogazione_correlazioneApplicativa_50kb() throws Exception {
		String idApplicativo = System.currentTimeMillis()+"-"+IDUtilities.getUniqueSerialNumber();
		String idApplicativoClaim = "<identificativoApplicativo>"+idApplicativo+"</identificativoApplicativo>";
		SoapUtilities.test(contentLengthMode, TipoServizio.EROGAZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(Bodies.SIZE_50K, idApplicativoClaim).getBytes(),
	...
	public void fruizione_correlazioneApplicativa_50kb() throws Exception {
		...
		SoapUtilities.test(contentLengthMode, TipoServizio.FRUIZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(Bodies.SIZE_50K, idApplicativoClaim).getBytes(),
				"sendCorrelazioneApplicativa", "50kb", null,
				idApplicativo,
				null, false, false);
	}
	...
	public void erogazione_correlazioneApplicativa_2mb() throws Exception {
		String idApplicativo = System.currentTimeMillis()+"-"+IDUtilities.getUniqueSerialNumber();
		String idApplicativoClaim = "<identificativoApplicativo>"+idApplicativo+"</identificativoApplicativo>";
		SoapUtilities.test(contentLengthMode, TipoServizio.EROGAZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(Bodies.BIG_SIZE, idApplicativoClaim).getBytes(),
	...
	public void fruizione_correlazioneApplicativa_2mb() throws Exception {
		String idApplicativo = System.currentTimeMillis()+"-"+IDUtilities.getUniqueSerialNumber();
		String idApplicativoClaim = "\"identificativoApplicativo\":\""+idApplicativo+"\"";
		SoapUtilities.test(contentLengthMode, TipoServizio.FRUIZIONE, HttpConstants.CONTENT_TYPE_SOAP_1_1, Bodies.getSOAPEnvelope11(Bodies.BIG_SIZE, idApplicativoClaim).getBytes(),
				"sendCorrelazioneApplicativa", "2mb", "Request Content-Length exceeds the allowed limit",
				idApplicativo,
				null, true, true);
	}

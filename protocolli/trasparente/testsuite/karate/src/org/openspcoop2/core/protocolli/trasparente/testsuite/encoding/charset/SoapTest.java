...
public class SoapTest extends ConfigLoader {
	...
	public void erogazione_soap11_modify_content_con_dump() throws Exception {
		_test("modify_content_con_dump",this.charset, true, false);
	}
	@Test
	public void erogazione_soap12_modify_content_con_dump() throws Exception {
		_test("modify_content_con_dump",this.charset, false, false);
	}
	@Test
	public void erogazione_soap11withAttachments_modify_content_con_dump() throws Exception {
		_test("modify_content_con_dump",this.charset, true, true);
	}
	@Test
	public void erogazione_soap12withAttachments_modify_content_con_dump() throws Exception {
		_test("modify_content_con_dump",this.charset, false, true);
	}
	
	
	private static void _test(
			String operazione, Charset charset, boolean soap11, boolean attachments) throws Exception {
...
//		}
		...
		if(attachments) {
			...
			if(!operazione.startsWith("modify_content") || Charset.UTF_8.equals(charset)) {
				CharsetUtilities._test(logCore, api, operazione, 

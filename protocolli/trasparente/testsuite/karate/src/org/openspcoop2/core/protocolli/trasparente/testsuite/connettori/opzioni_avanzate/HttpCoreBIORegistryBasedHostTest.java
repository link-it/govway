...
/**
* HttpCoreBIORegistryBasedHostTest
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class HttpCoreBIORegistryBasedHostTest extends RegistryBasedHostTestEngine {
	public HttpCoreBIORegistryBasedHostTest() {

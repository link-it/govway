...
/**
* PreInRequestHandlerCustom
*
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class PreInRequestHandlerCustom implements org.openspcoop2.pdd.core.handlers.PreInRequestHandler {
	...
	public void invoke(PreInRequestContext context) throws HandlerException {
		...
		try {
			...
			String tipoTest = "pre-in-request-handler";

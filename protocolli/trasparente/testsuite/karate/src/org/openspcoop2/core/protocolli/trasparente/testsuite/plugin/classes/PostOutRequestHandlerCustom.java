...
/**
* PostOutRequestHandlerCustom
*
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class PostOutRequestHandlerCustom implements org.openspcoop2.pdd.core.handlers.PostOutRequestHandler {
	...
	public void invoke(PostOutRequestContext context) throws HandlerException {
		...
		try {
			...
			String tipoTest = "post-out-request-handler";

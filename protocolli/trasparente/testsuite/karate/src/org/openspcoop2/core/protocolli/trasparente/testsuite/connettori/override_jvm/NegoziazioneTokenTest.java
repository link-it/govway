...
/**
 * NegoziazioneTokenTest
 *
 * Override della configurazione HTTPS della JVM ({@code connettori.httpsEndpoint.jvmConfigOverride.*})
 * applicato al connettore INTERNO di NEGOZIAZIONE del token (analogo di {@link RestTest}, che verifica
 ...
 * @version $Rev$, $Date$
 */
public class NegoziazioneTokenTest extends ConfigLoader {

...
/**
 * Test di validazione REST per l'API {@code TestValidazioneRestOpenApi31}, profilo OpenAPI 3.1.
 * <p>
 ...
 * </ul>
 * Le risorse {@code /incompatible} hanno una libreria non compatibile con OpenAPI 3.1
...
public class OpenApi31Test extends ConfigLoader {
	...
	private static final String API = "TestValidazioneRestOpenApi31";

	/** Body Echo valido secondo lo schema OpenAPI 3.1 (richiede anche {@code kind: "echo"} const). */
	private static final byte[] VALID_BODY =
			"{\"code\":\"AB123\",\"name\":\"hello\",\"score\":42.5,\"kind\":\"echo\",\"tags\":[\"alpha\",\"beta\"]}"
					.getBytes();

	/** Body con {@code code} che viola il pattern {@code ^[A-Z]{2}\d{3}$}. */
	private static final byte[] INVALID_REQUEST_BODY =
			"{\"code\":\"xx\",\"name\":\"hello\",\"score\":42.5,\"kind\":\"echo\",\"tags\":[\"alpha\",\"beta\"]}"
					.getBytes();
	...
	/** Diagnostico emesso da GovWay quando la libreria configurata non supporta OpenAPI 3.1. */
	private static final String DIAG_INCOMPATIBILE = "la libreria non supporta OpenAPI 3.1";

	/* =========================== /default — libreria di default (kappa) =========================== */

	@Test public void defaultErogazioneOk()          throws Exception { okCase(TipoServizio.EROGAZIONE, "default"); }
	@Test public void defaultErogazioneKoRequest()   throws Exception { koRequestCase(TipoServizio.EROGAZIONE, "default", ValidazioneRestUtils.DETAIL_KAPPA); }
	@Test public void defaultErogazioneKoResponse()  throws Exception { koResponseCase(TipoServizio.EROGAZIONE, "default", ValidazioneRestUtils.DETAIL_KAPPA); }
	@Test public void defaultFruizioneOk()           throws Exception { okCase(TipoServizio.FRUIZIONE,  "default"); }
	@Test public void defaultFruizioneKoRequest()    throws Exception { koRequestCase(TipoServizio.FRUIZIONE,  "default", ValidazioneRestUtils.DETAIL_KAPPA); }
	@Test public void defaultFruizioneKoResponse()   throws Exception { koResponseCase(TipoServizio.FRUIZIONE,  "default", ValidazioneRestUtils.DETAIL_KAPPA); }

	/* ===================== /alternate — libreria alternativa compatibile (json_schema) ===================== */

	@Test public void alternateErogazioneOk()         throws Exception { okCase(TipoServizio.EROGAZIONE, "alternate"); }
	@Test public void alternateErogazioneKoRequest()  throws Exception { koRequestCase(TipoServizio.EROGAZIONE, "alternate", ValidazioneRestUtils.DETAIL_JSON_SCHEMA); }
	@Test public void alternateErogazioneKoResponse() throws Exception { koResponseCase(TipoServizio.EROGAZIONE, "alternate", ValidazioneRestUtils.DETAIL_JSON_SCHEMA); }
	@Test public void alternateFruizioneOk()          throws Exception { okCase(TipoServizio.FRUIZIONE,  "alternate"); }
	@Test public void alternateFruizioneKoRequest()   throws Exception { koRequestCase(TipoServizio.FRUIZIONE,  "alternate", ValidazioneRestUtils.DETAIL_JSON_SCHEMA); }
	@Test public void alternateFruizioneKoResponse()  throws Exception { koResponseCase(TipoServizio.FRUIZIONE,  "alternate", ValidazioneRestUtils.DETAIL_JSON_SCHEMA); }

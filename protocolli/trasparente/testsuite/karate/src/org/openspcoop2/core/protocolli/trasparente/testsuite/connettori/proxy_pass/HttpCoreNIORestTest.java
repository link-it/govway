...
* @version $Rev$, $Date$
*/
public class HttpCoreNIORestTest extends RestTestEngine {
	public HttpCoreNIORestTest() {
		this.setLibraryMode(new HttpLibraryMode(HttpLibrary.HTTPCORE, true, false));
	}
}

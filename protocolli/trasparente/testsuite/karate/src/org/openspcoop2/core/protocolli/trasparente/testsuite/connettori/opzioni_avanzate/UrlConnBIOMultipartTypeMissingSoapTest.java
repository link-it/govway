...
/**
* UrlConnBIOMultipartTypeMissingSoapTest
*
* @author Poli Andrea (apoli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class UrlConnBIOMultipartTypeMissingSoapTest extends MultipartTypeMissingSoapEngine {
	public UrlConnBIOMultipartTypeMissingSoapTest() {

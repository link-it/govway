...
/**
* UrlConnBIOTransferModeSoap11Test
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class UrlConnBIOTransferModeSoap11Test extends TransferModeSoap11TestEngine {
	public UrlConnBIOTransferModeSoap11Test() {

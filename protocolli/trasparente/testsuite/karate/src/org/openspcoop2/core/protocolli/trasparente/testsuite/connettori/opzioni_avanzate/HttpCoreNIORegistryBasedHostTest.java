...
/**
* HttpCoreNIORegistryBasedHostTest
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class HttpCoreNIORegistryBasedHostTest extends RegistryBasedHostTestEngine {
	public HttpCoreNIORegistryBasedHostTest() {
		super(new HttpLibraryMode(HttpLibrary.HTTPCORE, true, false));
	}
}

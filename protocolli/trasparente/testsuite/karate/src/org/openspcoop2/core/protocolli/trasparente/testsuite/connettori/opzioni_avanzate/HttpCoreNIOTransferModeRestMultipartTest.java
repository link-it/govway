...
/**
* HttpCoreNIOTransferModeRestMultipartTest
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class HttpCoreNIOTransferModeRestMultipartTest extends TransferModeRestMultipartTestEngine {
	public HttpCoreNIOTransferModeRestMultipartTest() {

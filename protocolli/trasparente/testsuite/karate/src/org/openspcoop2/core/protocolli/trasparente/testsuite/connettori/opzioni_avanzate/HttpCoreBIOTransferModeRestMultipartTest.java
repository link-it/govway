...
/**
* HttpCoreBIOTransferModeRestMultipartTest
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class HttpCoreBIOTransferModeRestMultipartTest extends TransferModeRestMultipartTestEngine {
	public HttpCoreBIOTransferModeRestMultipartTest() {

...
/**
* PreInResponseHandlerCustom
*
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class PreInResponseHandlerCustom implements org.openspcoop2.pdd.core.handlers.PreInResponseHandler {
	...
	public void invoke(PreInResponseContext context) throws HandlerException {
		...
		try {
			...
			String tipoTest = "pre-in-response-handler";

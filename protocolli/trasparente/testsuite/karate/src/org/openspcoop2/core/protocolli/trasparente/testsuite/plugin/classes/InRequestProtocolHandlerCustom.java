...
/**
* InRequestProtocolHandlerCustom
*
* @author Andrea Poli (poli@link.it)
* @author $Author$	
* @version $Rev$, $Date$
*/
public class InRequestProtocolHandlerCustom implements org.openspcoop2.pdd.core.handlers.InRequestProtocolHandler {
	...
	public void invoke(InRequestProtocolContext context) throws HandlerException {
		...
		try {
			...
			String tipoTest = "in-request-protocol-handler";

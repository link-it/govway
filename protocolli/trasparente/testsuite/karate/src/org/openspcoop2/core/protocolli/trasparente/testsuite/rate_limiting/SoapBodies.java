...
public class SoapBodies {
	...
	private static final String minuto(String payload) { 
	...
	private static final String minutoDefault(String payload) { 
		return "<soap:Envelope xmlns:soap=\"http://www.w3.org/2003/05/soap-envelope\">\n" +  
			"    <soap:Body>\n" + 
	...
	private static final String giornaliero(String payload) {
		return "<soap:Envelope xmlns:soap=\"http://www.w3.org/2003/05/soap-envelope\">\n" +  
			"    <soap:Body>\n" + 
	...
	private static final String orario(String payload) { 
		return "<soap:Envelope xmlns:soap=\"http://www.w3.org/2003/05/soap-envelope\">\n" +  
			"    <soap:Body>\n" + 
	...
	private static final String richiesteSimultanee(String payload) {
		return "<soap:Envelope xmlns:soap=\"http://www.w3.org/2003/05/soap-envelope\">\n" +  
			"    <soap:Body>\n" + 
	...
	private static final String noPolicy(String payload) {
			return "<soap:Envelope xmlns:soap=\"http://www.w3.org/2003/05/soap-envelope\">\n" +  
			"    <soap:Body>\n" + 
	...
	public static final String get(PolicyAlias alias) {
		return get(alias, "");
	}
	
	public static final String get(PolicyAlias alias, String payload) {
		if (alias == null)

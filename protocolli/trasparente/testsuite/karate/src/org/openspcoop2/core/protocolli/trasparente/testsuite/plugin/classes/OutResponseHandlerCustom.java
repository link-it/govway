...
/**
* OutResponseHandlerCustom
*
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class OutResponseHandlerCustom implements org.openspcoop2.pdd.core.handlers.OutResponseHandler {
	...
	public void invoke(OutResponseContext context) throws HandlerException {
		...
		try {
			...
			String tipoTest = "out-response-handler";

...
/**
* UrlConnBIOKeystoreSenzaPasswordTest
* @author Tommaso Burlon (tommas.burlon@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class UrlConnBIOKeystoreSenzaPasswordTest extends KeystoreSenzaPasswordTestEngine {
	public UrlConnBIOKeystoreSenzaPasswordTest() {
		super(new HttpLibraryMode(HttpLibrary.URLCONNECTION, false, true));
	}
}

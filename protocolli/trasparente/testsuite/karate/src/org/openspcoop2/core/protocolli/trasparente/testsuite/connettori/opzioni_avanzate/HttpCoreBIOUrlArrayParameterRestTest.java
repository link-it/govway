...
/**
* HttpCoreBIOHttpProxyRestTest
* @author Tommaso Burlon (tommaso.burlon@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class HttpCoreBIOUrlArrayParameterRestTest extends UrlArrayParameterRestTestEngine {
	public HttpCoreBIOUrlArrayParameterRestTest() {

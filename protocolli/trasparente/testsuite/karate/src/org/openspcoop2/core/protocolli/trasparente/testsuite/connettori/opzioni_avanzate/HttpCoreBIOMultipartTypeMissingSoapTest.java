...
/**
* HttpCoreBIOMultipartTypeMissingSoapTest
*
* @author Poli Andrea (apoli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class HttpCoreBIOMultipartTypeMissingSoapTest extends MultipartTypeMissingSoapEngine {
	public HttpCoreBIOMultipartTypeMissingSoapTest() {

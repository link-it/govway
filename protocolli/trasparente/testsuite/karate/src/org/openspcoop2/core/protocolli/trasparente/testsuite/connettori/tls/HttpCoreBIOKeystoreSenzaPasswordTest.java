...
/**
* HttpCoreBIOKeystoreSenzaPasswordTest
* @author Tommaso Burlon (tommas.burlon@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class HttpCoreBIOKeystoreSenzaPasswordTest extends KeystoreSenzaPasswordTestEngine {
	public HttpCoreBIOKeystoreSenzaPasswordTest() {

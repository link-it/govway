...
/**
* HttpCoreNIOKeystoreSenzaPasswordTest
* @author Tommaso Burlon (tommas.burlon@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class HttpCoreNIOKeystoreSenzaPasswordTest extends KeystoreSenzaPasswordTestEngine {
	public HttpCoreNIOKeystoreSenzaPasswordTest() {
		super(new HttpLibraryMode(HttpLibrary.HTTPCORE, true, true));
	}
}

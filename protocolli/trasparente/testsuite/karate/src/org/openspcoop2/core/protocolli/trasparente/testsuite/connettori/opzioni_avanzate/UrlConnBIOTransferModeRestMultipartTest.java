...
/**
* UrlConnBIOTransferModeRestMultipartTest
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class UrlConnBIOTransferModeRestMultipartTest extends TransferModeRestMultipartTestEngine {
	public UrlConnBIOTransferModeRestMultipartTest() {

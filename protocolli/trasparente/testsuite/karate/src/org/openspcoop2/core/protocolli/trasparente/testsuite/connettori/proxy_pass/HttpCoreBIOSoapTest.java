...
* @version $Rev$, $Date$
*/
public class HttpCoreBIOSoapTest extends SoapTestEngine {
	public HttpCoreBIOSoapTest() {
		this.setLibraryMode(new HttpLibraryMode(HttpLibrary.HTTPCORE, false, false));
	}
}

...
public class ConsegnaMultiplaTest  extends ConfigLoader {
	...
	private static final org.openspcoop2.utils.Semaphore semaphore = new org.openspcoop2.utils.Semaphore("ConsegnaMultiplaTest");
	
	@Test
	public void varieCombinazioniDiRegole2xx_4xx() {
		semaphore.acquireThrowRuntime("varieCombinazioniDiRegole2xx_4xx");
		try {
			varieCombinazioniDiRegole(CommonConsegnaMultipla.statusCode2xx4xxVsConnettori);
		}finally {
			semaphore.release("varieCombinazioniDiRegole2xx_4xx");
		}
	}
	@Test
	public void varieCombinazioniDiRegole5xx() {
		semaphore.acquireThrowRuntime("varieCombinazioniDiRegole5xx");
		try {
			varieCombinazioniDiRegole(CommonConsegnaMultipla.statusCode5xxVsConnettori);
		}finally {
			semaphore.release("varieCombinazioniDiRegole5xx");
		}
	}
	...
	public void schedulingAbilitatoDisabilitato() throws UtilsException, HttpUtilsException {
		semaphore.acquireThrowRuntime("schedulingAbilitatoDisabilitato");
		try {
			...
			semaphore.release("schedulingAbilitatoDisabilitato");
		}
	...
	public void consegnaMultiplaSemplice() throws IOException {
		...
		semaphore.acquireThrowRuntime("consegnaMultiplaSemplice");
		try {
			...
			semaphore.release("consegnaMultiplaSemplice");
		}
	}
	...
	public void consegnaMultiplaErrori() throws IOException {
		...
		try {
			...
			semaphore.release("consegnaMultiplaErrori");
		}
	}
	...
	public void  regoleSoapFault() {
		...
		semaphore.acquireThrowRuntime("regoleSoapFault");
		try {
			...
			semaphore.release("regoleSoapFault");
		}
	}
	...
	public void cadenzaRispedizione() {
		...
		semaphore.acquireThrowRuntime("cadenzaRispedizione");
		try {
			...
			semaphore.release("cadenzaRispedizione");
		}
	}
	...
	public void connettoreRotto() {
		...
		semaphore.acquireThrowRuntime("connettoreRotto");
		try {
			...
			semaphore.release("connettoreRotto");
		}
	}
	...
	public void integrationManager() throws MalformedURLException, IntegrationManagerException_Exception {
		...
		semaphore.acquireThrowRuntime("integrationManager");
		try {
			...
			semaphore.release("integrationManager");
		}
	}

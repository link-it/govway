...
/**
* HttpCoreBIOTransferModeSoap11Test
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class HttpCoreBIOTransferModeSoap11Test extends TransferModeSoap11TestEngine {
	public HttpCoreBIOTransferModeSoap11Test() {

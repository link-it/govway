...
* @version $Rev$, $Date$
*/
public class OpenAPI30_HeaderEnumParameterSerializationTest extends ConfigLoader {
	...
	private void _array_simple_explode_true(TipoServizio tipo) throws Exception {
		testHeader(tipo, "array_simple_explode_true", "Valore1,Valore2,Valore33", "Valore1,Valore2,Valore33");
	}
	...
	private void _array_simple_explode_false(TipoServizio tipo) throws Exception {
		testHeader(tipo, "array_simple_explode_false", "Valore1,Valore2,Valore33", "Valore1,Valore2,Valore33");
	}
	...
	static void testHeader(TipoServizio tipoServizio, String path, String requestValue, String responseValue) throws Exception {
		...
		final String url = tipoServizio == TipoServizio.EROGAZIONE
				? System.getProperty("govway_base_path") + "/SoggettoInternoTest/EnumParameterSerialization/v1/header/"+path
				: System.getProperty("govway_base_path") + "/out/SoggettoInternoTestFruitore/SoggettoInternoTest/EnumParameterSerialization/v1/header/"+path;

...
/**
* HttpCoreNIOMultipartTypeMissingSoapTest
*
* @author Poli Andrea (apoli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class HttpCoreNIOMultipartTypeMissingSoapTest extends MultipartTypeMissingSoapEngine {
	public HttpCoreNIOMultipartTypeMissingSoapTest() {

...
/**
* UrlConnBIOTransferModeRestBinaryTest
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class UrlConnBIOTransferModeRestBinaryTest extends TransferModeRestBinaryTestEngine {
	public UrlConnBIOTransferModeRestBinaryTest() {

...
* @version $Rev$, $Date$
*/
public class IntrospectionDynamicDiscoveryTest extends ConfigLoader {

	public static final String validazione = "TestValidazioneToken-IntrospectionDynamicDiscovery";
	...
	private void test(TipoServizio tipoServizio, String operazione) throws Exception {
		...
		File f = File.createTempFile("introspectionResponse", ".json");
		...
		try {
			...
			String tokenPolicy = "TestIntrospectionDynamicDiscovery";
			if("custom".equals(operazione)) {

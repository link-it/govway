...
/**
* InResponseHandlerCustom
*
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class InResponseHandlerCustom implements org.openspcoop2.pdd.core.handlers.InResponseHandler {
	...
	public void invoke(InResponseContext context) throws HandlerException {
		...
		try {
			...
			String tipoTest = "in-response-handler";

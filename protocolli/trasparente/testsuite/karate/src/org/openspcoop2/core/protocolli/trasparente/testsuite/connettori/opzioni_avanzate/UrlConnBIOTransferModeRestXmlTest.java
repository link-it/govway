...
/**
* UrlConnBIOTransferModeRestXmlTest
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class UrlConnBIOTransferModeRestXmlTest extends TransferModeRestXmlTestEngine {
	public UrlConnBIOTransferModeRestXmlTest() {

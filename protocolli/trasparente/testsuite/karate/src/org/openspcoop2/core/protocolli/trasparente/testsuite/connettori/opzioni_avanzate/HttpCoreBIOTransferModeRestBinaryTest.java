...
/**
* HttpCoreBIOTransferModeRestBinaryTest
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class HttpCoreBIOTransferModeRestBinaryTest extends TransferModeRestBinaryTestEngine {
	public HttpCoreBIOTransferModeRestBinaryTest() {

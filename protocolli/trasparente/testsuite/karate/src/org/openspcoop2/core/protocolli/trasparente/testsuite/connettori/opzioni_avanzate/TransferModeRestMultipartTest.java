...
/**
* TransferModeRestMultipartTest
*
* Modalita' di data transfer del connettore con messaggi di tipo MIME Multipart.
*
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class TransferModeRestMultipartTest extends ConfigLoader {
	...
	// Resta verificata dal test sul medesimo formato: TransferModeRestTest.
	...
	private static void test(String mode, String config, int size) throws Exception {
		TransferModeUtils.test(logCore, TransferModeUtils.API_REST, MessageType.MIME_MULTIPART,
				mode, config, size);
	}

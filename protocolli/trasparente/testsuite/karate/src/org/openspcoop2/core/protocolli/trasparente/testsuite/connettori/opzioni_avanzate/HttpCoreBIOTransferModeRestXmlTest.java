...
/**
* HttpCoreBIOTransferModeRestXmlTest
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class HttpCoreBIOTransferModeRestXmlTest extends TransferModeRestXmlTestEngine {
	public HttpCoreBIOTransferModeRestXmlTest() {

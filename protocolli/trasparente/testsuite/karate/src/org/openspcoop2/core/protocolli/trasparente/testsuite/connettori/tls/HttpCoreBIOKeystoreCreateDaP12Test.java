...
/**
* HttpCoreBIOHttpMethodsTest
* @author Tommaso Burlon (tommas.burlon@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class HttpCoreBIOKeystoreCreateDaP12Test extends KeystoreCreatoDaP12TestEngine {
	public HttpCoreBIOKeystoreCreateDaP12Test() {
		super(new HttpLibraryMode(HttpLibrary.HTTPCORE, false, true));
	}
}

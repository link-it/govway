...
/**
 * Esecuzione di {@link TracciamentoDateEngine} forzando il connettore in uscita a usare
 ...
 * @version $Rev$, $Date$
 */
public class HttpCoreBIOTracciamentoDateTest extends TracciamentoDateEngine {
	public HttpCoreBIOTracciamentoDateTest() {

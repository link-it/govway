...
/**
* HttpCoreNIOTransferModeRestBinaryTest
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class HttpCoreNIOTransferModeRestBinaryTest extends TransferModeRestBinaryTestEngine {
	public HttpCoreNIOTransferModeRestBinaryTest() {

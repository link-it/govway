...
/**
 * Test di validazione REST per l'API {@code TestValidazioneRestOpenApi30External}: spec OpenAPI 3.0
 * con uno schema referenziato via {@code $ref} cross-file (allegato).
 * <p>
 * La porta principale usa il default per OpenAPI 3.0 ({@code openapi4j}). Le due risorse:
 * <ul>
 ...
 *       avviene a runtime nel motore openapi4j.</li>
 * </ul>
 ...
 */
public class OpenApi30ExternalTest extends ConfigLoader {

	private static final String API = "TestValidazioneRestOpenApi30External";
	...
	private void koRequestCase(TipoServizio tipo, String resource) throws Exception {
		...
		ValidazioneRestUtils.verifyKoRequest(response, ValidazioneRestUtils.DETAIL_OPENAPI4J,
	...
	private void koResponseCase(TipoServizio tipo, String resource) throws Exception {
		...
		HttpResponse response = ValidazioneRestUtils.invokePost(url, VALID_BODY);
		ValidazioneRestUtils.verifyKoResponse(response, ValidazioneRestUtils.DETAIL_OPENAPI4J,

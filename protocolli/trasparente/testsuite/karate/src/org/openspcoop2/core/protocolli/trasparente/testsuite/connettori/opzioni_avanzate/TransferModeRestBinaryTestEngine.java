...
/**
* TransferModeRestBinaryTestEngine
*
* Modalita' di data transfer del connettore con messaggi di tipo binario.
*
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class TransferModeRestBinaryTestEngine extends ConfigLoader {
	...
	private void test(String mode, String config, int size) throws Exception {
		TransferModeUtils.test(logCore, TransferModeUtils.API_REST, MessageType.BINARY,

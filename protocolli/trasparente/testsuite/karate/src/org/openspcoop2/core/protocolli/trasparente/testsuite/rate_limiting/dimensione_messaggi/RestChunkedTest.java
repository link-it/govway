...
* @version $Rev$, $Date$
*/
public class RestChunkedTest extends ConfigLoader {
	...
	public void erogazione_globale_small() throws Exception {
		RestUtilities.test(chunkedMode, TipoServizio.EROGAZIONE, HttpConstants.CONTENT_TYPE_JSON, Bodies.getJson(Bodies.SMALL_SIZE).getBytes(),
				"globale", "small", null,
				null, false, false);
	}
	@Test
	public void fruizione_globale_small() throws Exception {
		RestUtilities.test(chunkedMode, TipoServizio.FRUIZIONE, HttpConstants.CONTENT_TYPE_JSON, Bodies.getJson(Bodies.SMALL_SIZE).getBytes(),
				"globale", "small", null,
				null, false, false);
	}
	@Test
	public void erogazione_globale_50kb() throws Exception {
		RestUtilities.test(chunkedMode, TipoServizio.EROGAZIONE, HttpConstants.CONTENT_TYPE_JSON, Bodies.getJson(Bodies.SIZE_50K).getBytes(),
				"globale", "50kb", null,
				null, false, false);
	}
	@Test
	public void fruizione_globale_50kb() throws Exception {
		RestUtilities.test(chunkedMode, TipoServizio.FRUIZIONE, HttpConstants.CONTENT_TYPE_JSON, Bodies.getJson(Bodies.SIZE_50K).getBytes(),
				"globale", "50kb", null,
				null, false, false);
	}
	@Test
	public void erogazione_globale_2mb() throws Exception {
		RestUtilities.test(chunkedMode, TipoServizio.EROGAZIONE, HttpConstants.CONTENT_TYPE_JSON, Bodies.getJson(Bodies.BIG_SIZE).getBytes(),
				"globale", "2mb", null,
				null, false, false);
	}
	@Test
	public void fruizione_globale_2mb() throws Exception {
		RestUtilities.test(chunkedMode, TipoServizio.FRUIZIONE, HttpConstants.CONTENT_TYPE_JSON, Bodies.getJson(Bodies.BIG_SIZE).getBytes(),
				"globale", "2mb", null,
				null, false, false);
	}
	@Test
	public void erogazione_globale_10mb() throws Exception {
		RestUtilities.test(chunkedMode, TipoServizio.EROGAZIONE, HttpConstants.CONTENT_TYPE_JSON, Bodies.getJson(1024*1024*10).getBytes(),
				"globale", "2mb", "Request Payload too large",
				null, true, true);
	}
	@Test
	public void fruizione_globale_10mb() throws Exception {
		RestUtilities.test(chunkedMode, TipoServizio.FRUIZIONE, HttpConstants.CONTENT_TYPE_JSON, Bodies.getJson(1024*1024*10).getBytes(),
				"globale", "2mb", "Request Payload too large",
				null, true, true);
	}
	...
	public void erogazione_correlazioneApplicativa_small() throws Exception {
		...
		RestUtilities.test(chunkedMode, TipoServizio.EROGAZIONE, HttpConstants.CONTENT_TYPE_JSON, Bodies.getJson(Bodies.SMALL_SIZE, idApplicativoClaim).getBytes(),
	...
	public void fruizione_correlazioneApplicativa_small() throws Exception {
		String idApplicativo = System.currentTimeMillis()+"-"+IDUtilities.getUniqueSerialNumber();
		String idApplicativoClaim = "\"identificativoApplicativo\":\""+idApplicativo+"\"";	
		RestUtilities.test(chunkedMode, TipoServizio.FRUIZIONE, HttpConstants.CONTENT_TYPE_JSON, Bodies.getJson(Bodies.SMALL_SIZE, idApplicativoClaim).getBytes(),
				"sendCorrelazioneApplicativa", "small", null,
				idApplicativo,
				null, false, false);
	}
	...
	public void erogazione_correlazioneApplicativa_50kb() throws Exception {
		String idApplicativo = System.currentTimeMillis()+"-"+IDUtilities.getUniqueSerialNumber();
		String idApplicativoClaim = "\"identificativoApplicativo\":\""+idApplicativo+"\"";	
		RestUtilities.test(chunkedMode, TipoServizio.EROGAZIONE, HttpConstants.CONTENT_TYPE_JSON, Bodies.getJson(Bodies.SIZE_50K, idApplicativoClaim).getBytes(),
	...
	public void fruizione_correlazioneApplicativa_50kb() throws Exception {
		String idApplicativo = System.currentTimeMillis()+"-"+IDUtilities.getUniqueSerialNumber();
		String idApplicativoClaim = "\"identificativoApplicativo\":\""+idApplicativo+"\"";
		RestUtilities.test(chunkedMode, TipoServizio.FRUIZIONE, HttpConstants.CONTENT_TYPE_JSON, Bodies.getJson(Bodies.SIZE_50K, idApplicativoClaim).getBytes(),
				"sendCorrelazioneApplicativa", "50kb", null,
				idApplicativo,
				null, false, false);
	}
	...
	public void erogazione_correlazioneApplicativa_2mb() throws Exception {
		String idApplicativo = System.currentTimeMillis()+"-"+IDUtilities.getUniqueSerialNumber();
		String idApplicativoClaim = "\"identificativoApplicativo\":\""+idApplicativo+"\"";	
		RestUtilities.test(chunkedMode, TipoServizio.EROGAZIONE, HttpConstants.CONTENT_TYPE_JSON, Bodies.getJson(Bodies.BIG_SIZE, idApplicativoClaim).getBytes(),
	...
	public void fruizione_correlazioneApplicativa_2mb() throws Exception {
		String idApplicativo = System.currentTimeMillis()+"-"+IDUtilities.getUniqueSerialNumber();
		String idApplicativoClaim = "\"identificativoApplicativo\":\""+idApplicativo+"\"";
		RestUtilities.test(chunkedMode, TipoServizio.FRUIZIONE, HttpConstants.CONTENT_TYPE_JSON, Bodies.getJson(Bodies.BIG_SIZE, idApplicativoClaim).getBytes(),
				"sendCorrelazioneApplicativa", "2mb", "Request Payload too large",
				idApplicativo,
				null, true, true);
	}

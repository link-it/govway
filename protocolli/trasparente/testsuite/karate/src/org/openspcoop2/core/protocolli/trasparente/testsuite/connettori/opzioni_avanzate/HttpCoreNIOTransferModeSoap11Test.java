...
/**
* HttpCoreNIOTransferModeSoap11Test
* @author Andrea Poli (poli@link.it)
* @author $Author$
* @version $Rev$, $Date$
*/
public class HttpCoreNIOTransferModeSoap11Test extends TransferModeSoap11TestEngine {
	public HttpCoreNIOTransferModeSoap11Test() {

...
/**
 * ComunicazioneVariazione_ComunicazioneVariazioneInterfaceEndpoint11_Client
 * 
 * @author Poli Andrea (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public final class ComunicazioneVariazione_ComunicazioneVariazioneInterfaceEndpoint11_Client {

    private static final QName SERVICE_NAME = new QName("http://openspcoop2.org/example/pdd/server/ComunicazioneVariazione", "ComunicazioneVariazioneSOAP11Service");

    private ComunicazioneVariazione_ComunicazioneVariazioneInterfaceEndpoint11_Client() {
    }
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        URL wsdlURL = ComunicazioneVariazioneService11.WSDL_LOCATION;
        if (args.length > 0) { 
        ...
        ComunicazioneVariazioneService11 ss = new ComunicazioneVariazioneService11(wsdlURL, SERVICE_NAME);

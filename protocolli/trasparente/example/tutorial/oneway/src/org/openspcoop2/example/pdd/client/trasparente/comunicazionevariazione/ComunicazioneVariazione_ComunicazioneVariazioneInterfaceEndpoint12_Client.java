...
import org.openspcoop2.example.pdd.server.trasparente.comunicazionevariazione.ComunicazioneVariazioneService12;
import org.openspcoop2.example.pdd.server.trasparente.comunicazionevariazione.ComunicazioneVariazione_Type;

/**
 * ComunicazioneVariazione_ComunicazioneVariazioneInterfaceEndpoint12_Client
 * 
 * @author Poli Andrea (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public final class ComunicazioneVariazione_ComunicazioneVariazioneInterfaceEndpoint12_Client {

    private static final QName SERVICE_NAME = new QName("http://openspcoop2.org/example/pdd/server/ComunicazioneVariazione", "ComunicazioneVariazioneSOAP12Service");

    private ComunicazioneVariazione_ComunicazioneVariazioneInterfaceEndpoint12_Client() {
    }
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        URL wsdlURL = ComunicazioneVariazioneService12.WSDL_LOCATION;
        if (args.length > 0) { 
        ...
        ComunicazioneVariazioneService12 ss = new ComunicazioneVariazioneService12(wsdlURL, SERVICE_NAME);
        ComunicazioneVariazione client = ss.getComunicazioneVariazioneInterfaceEndpoint12();  

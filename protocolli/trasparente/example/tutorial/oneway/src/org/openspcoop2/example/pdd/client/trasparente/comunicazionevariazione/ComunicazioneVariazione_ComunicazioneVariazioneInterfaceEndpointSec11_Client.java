...
/**
 * ComunicazioneVariazione_ComunicazioneVariazioneInterfaceEndpointSec11_Client
 * 
 * @author Poli Andrea (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public final class ComunicazioneVariazione_ComunicazioneVariazioneInterfaceEndpointSec11_Client {

    private static final QName SERVICE_NAME = new QName("http://openspcoop2.org/example/pdd/server/ComunicazioneVariazione", "ComunicazioneVariazioneSOAP11SecService");

    private ComunicazioneVariazione_ComunicazioneVariazioneInterfaceEndpointSec11_Client() {
    }
    ...
    public static void main(String args[]) throws java.lang.Exception {
		...
		if(isInvocazioneTramitePdD){
			...
			String PD = reader.getProperty("Contesto.soap11.security");
			if(PD == null){
			...
			String endpoint = reader.getProperty("endpoint.soap11.security");
			if(endpoint == null){
        ...
        URL wsdlURL = ComunicazioneVariazioneServiceSec11.WSDL_LOCATION;
        if (args.length > 0) { 
        ...
        ComunicazioneVariazioneServiceSec11 ss = new ComunicazioneVariazioneServiceSec11(wsdlURL, SERVICE_NAME);
        ComunicazioneVariazione client = ss.getComunicazioneVariazioneInterfaceEndpointSec();  

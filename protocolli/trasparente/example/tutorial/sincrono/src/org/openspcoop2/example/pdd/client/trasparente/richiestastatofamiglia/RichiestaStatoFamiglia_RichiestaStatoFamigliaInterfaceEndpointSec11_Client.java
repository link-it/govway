...
import org.openspcoop2.example.pdd.server.trasparente.richiestastatofamiglia.RichiestaStatoFamigliaServiceSec11;

/**
 * RichiestaStatoFamiglia_RichiestaStatoFamigliaInterfaceEndpointSec11_Client
 * 
 * @author Poli Andrea (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public final class RichiestaStatoFamiglia_RichiestaStatoFamigliaInterfaceEndpointSec11_Client {

    private static final QName SERVICE_NAME = new QName("http://openspcoop2.org/example/pdd/server/RichiestaStatoFamiglia", "RichiestaStatoFamigliaSOAP11SecService");

    private RichiestaStatoFamiglia_RichiestaStatoFamigliaInterfaceEndpointSec11_Client() {
    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        URL wsdlURL = RichiestaStatoFamigliaServiceSec11.WSDL_LOCATION;
        if (args.length > 0) { 
        ...
        RichiestaStatoFamigliaServiceSec11 ss = new RichiestaStatoFamigliaServiceSec11(wsdlURL, SERVICE_NAME);
        RichiestaStatoFamiglia port = ss.getRichiestaStatoFamigliaInterfaceEndpointSec();  

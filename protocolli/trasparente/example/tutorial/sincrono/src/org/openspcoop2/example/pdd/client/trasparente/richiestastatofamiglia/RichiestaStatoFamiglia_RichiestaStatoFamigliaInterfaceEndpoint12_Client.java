...
import org.openspcoop2.example.pdd.server.trasparente.richiestastatofamiglia.RichiestaStatoFamigliaService12;

/**
 * RichiestaStatoFamiglia_RichiestaStatoFamigliaInterfaceEndpoint12_Client
 * 
 * @author Poli Andrea (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public final class RichiestaStatoFamiglia_RichiestaStatoFamigliaInterfaceEndpoint12_Client {

    private static final QName SERVICE_NAME = new QName("http://openspcoop2.org/example/pdd/server/RichiestaStatoFamiglia", "RichiestaStatoFamigliaSOAP12Service");

    private RichiestaStatoFamiglia_RichiestaStatoFamigliaInterfaceEndpoint12_Client() {
    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        URL wsdlURL = RichiestaStatoFamigliaService12.WSDL_LOCATION;
        if (args.length > 0) { 
        ...
        RichiestaStatoFamigliaService12 ss = new RichiestaStatoFamigliaService12(wsdlURL, SERVICE_NAME);
        RichiestaStatoFamiglia port = ss.getRichiestaStatoFamigliaInterfaceEndpoint12();  

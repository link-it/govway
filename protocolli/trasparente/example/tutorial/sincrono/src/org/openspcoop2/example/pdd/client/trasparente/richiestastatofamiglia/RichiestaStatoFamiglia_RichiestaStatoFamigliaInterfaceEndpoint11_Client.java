...
import org.openspcoop2.example.pdd.server.trasparente.richiestastatofamiglia.RichiestaStatoFamigliaService11;

/**
 * RichiestaStatoFamiglia_RichiestaStatoFamigliaInterfaceEndpoint11_Client
 * 
 * @author Poli Andrea (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public final class RichiestaStatoFamiglia_RichiestaStatoFamigliaInterfaceEndpoint11_Client {

    private static final QName SERVICE_NAME = new QName("http://openspcoop2.org/example/pdd/server/RichiestaStatoFamiglia", "RichiestaStatoFamigliaSOAP11Service");

    private RichiestaStatoFamiglia_RichiestaStatoFamigliaInterfaceEndpoint11_Client() {
    }
    ...
    public static void main(String args[]) throws Exception {
		...
		if(isInvocazioneTramitePdD){
			...
			String PD = reader.getProperty("Contesto.soap11");
			if(PD == null){
			...
			String endpoint = reader.getProperty("endpoint.soap11");
			if(endpoint == null){
        ...
        URL wsdlURL = RichiestaStatoFamigliaService11.WSDL_LOCATION;
        if (args.length > 0) { 
        ...
        RichiestaStatoFamigliaService11 ss = new RichiestaStatoFamigliaService11(wsdlURL, SERVICE_NAME);

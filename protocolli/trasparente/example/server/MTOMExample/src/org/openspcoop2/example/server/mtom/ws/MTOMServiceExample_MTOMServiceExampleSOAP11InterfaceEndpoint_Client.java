...
/**
 * MTOMServiceExample_MTOMServiceExampleSOAP11InterfaceEndpoint_Client
 * 
 * @author Poli Andrea (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public final class MTOMServiceExample_MTOMServiceExampleSOAP11InterfaceEndpoint_Client {

    private static final QName SERVICE_NAME = new QName("http://www.openspcoop2.org/example/server/mtom/ws", "MTOMServiceExampleSOAP11Service");

    private MTOMServiceExample_MTOMServiceExampleSOAP11InterfaceEndpoint_Client() {
    }
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        URL wsdlURL = MTOMServiceExampleSOAP11Service.WSDL_LOCATION;
        ...
        MTOMServiceExampleSOAP11Service ss = new MTOMServiceExampleSOAP11Service(wsdlURL, MTOMServiceExample_MTOMServiceExampleSOAP11InterfaceEndpoint_Client.SERVICE_NAME);
        MTOMServiceExample port = ss.getMTOMServiceExampleSOAP11InterfaceEndpoint();  

 ...
 *
 */
package eu.domibus.configuration.utils;
...
public class PropertiesXSDValidator {
	...
	private static synchronized void initValidator(Class<?> validatorImpl,Logger log) throws ServiceException{
		if(validator==null){
			validator = new org.openspcoop2.generic_project.utils.XSDValidator(log,Configuration.class, 
				"/domibus-pmode-properties.xsd"
				// elencare in questa posizione altri schemi xsd che vengono inclusi/importati dallo schema /domibus-pmode.xsd
			);
		}
	}

...
public class NotificaScartoTypeModel extends AbstractModel<NotificaScartoType> {
	...
	public NotificaScartoTypeModel(){
		...
		this.IDENTIFICATIVO_SD_I = new Field("IdentificativoSdI",java.lang.String.class,"NotificaScarto_Type",NotificaScartoType.class);
	...
	public NotificaScartoTypeModel(IField father){
		...
		this.IDENTIFICATIVO_SD_I = new ComplexField(father,"IdentificativoSdI",java.lang.String.class,"NotificaScarto_Type",NotificaScartoType.class);

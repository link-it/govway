...
public class DatiGeneraliDocumentoTypeModel extends AbstractModel<DatiGeneraliDocumentoType> {
	...
	public DatiGeneraliDocumentoTypeModel(){
		...
		this.DATI_RITENUTA = new it.gov.fatturapa.sdi.fatturapa.v1_1.model.DatiRitenutaTypeModel(new Field("DatiRitenuta",it.gov.fatturapa.sdi.fatturapa.v1_1.DatiRitenutaType.class,"DatiGeneraliDocumentoType",DatiGeneraliDocumentoType.class));
	...
	public DatiGeneraliDocumentoTypeModel(IField father){
		...
		this.DATI_RITENUTA = new it.gov.fatturapa.sdi.fatturapa.v1_1.model.DatiRitenutaTypeModel(new ComplexField(father,"DatiRitenuta",it.gov.fatturapa.sdi.fatturapa.v1_1.DatiRitenutaType.class,"DatiGeneraliDocumentoType",DatiGeneraliDocumentoType.class));
	...
	public it.gov.fatturapa.sdi.fatturapa.v1_1.model.DatiRitenutaTypeModel DATI_RITENUTA = null;
	 
	public it.gov.fatturapa.sdi.fatturapa.v1_1.model.DatiBolloTypeModel DATI_BOLLO = null;
	 
	public it.gov.fatturapa.sdi.fatturapa.v1_1.model.DatiCassaPrevidenzialeTypeModel DATI_CASSA_PREVIDENZIALE = null;
	 
	public it.gov.fatturapa.sdi.fatturapa.v1_1.model.ScontoMaggiorazioneTypeModel SCONTO_MAGGIORAZIONE = null;

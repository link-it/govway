...
public class DatiTrasmissioneTypeModel extends AbstractModel<DatiTrasmissioneType> {
	...
	public DatiTrasmissioneTypeModel(){
		...
		this.ID_TRASMITTENTE = new it.gov.fatturapa.sdi.fatturapa.v1_1.model.IdFiscaleTypeModel(new Field("IdTrasmittente",it.gov.fatturapa.sdi.fatturapa.v1_1.IdFiscaleType.class,"DatiTrasmissioneType",DatiTrasmissioneType.class));
		...
		this.CONTATTI_TRASMITTENTE = new it.gov.fatturapa.sdi.fatturapa.v1_1.model.ContattiTrasmittenteTypeModel(new Field("ContattiTrasmittente",it.gov.fatturapa.sdi.fatturapa.v1_1.ContattiTrasmittenteType.class,"DatiTrasmissioneType",DatiTrasmissioneType.class));
	...
	public DatiTrasmissioneTypeModel(IField father){
		...
		this.ID_TRASMITTENTE = new it.gov.fatturapa.sdi.fatturapa.v1_1.model.IdFiscaleTypeModel(new ComplexField(father,"IdTrasmittente",it.gov.fatturapa.sdi.fatturapa.v1_1.IdFiscaleType.class,"DatiTrasmissioneType",DatiTrasmissioneType.class));
		...
		this.CONTATTI_TRASMITTENTE = new it.gov.fatturapa.sdi.fatturapa.v1_1.model.ContattiTrasmittenteTypeModel(new ComplexField(father,"ContattiTrasmittente",it.gov.fatturapa.sdi.fatturapa.v1_1.ContattiTrasmittenteType.class,"DatiTrasmissioneType",DatiTrasmissioneType.class));
	
	}
	
	

	public it.gov.fatturapa.sdi.fatturapa.v1_1.model.IdFiscaleTypeModel ID_TRASMITTENTE = null;
	...
	public it.gov.fatturapa.sdi.fatturapa.v1_1.model.ContattiTrasmittenteTypeModel CONTATTI_TRASMITTENTE = null;

 ...
 * generated in the it.gov.fatturapa.sdi.fatturapa.v1_0 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.gov.fatturapa.sdi.fatturapa.v1_0
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://www.fatturapa.gov.it/sdi/fatturapa/v1.0", name="FatturaElettronica")
    public JAXBElement<FatturaElettronicaType> createFatturaElettronica() {
        return new JAXBElement<FatturaElettronicaType>(_FatturaElettronica, FatturaElettronicaType.class, null, this.createFatturaElettronicaType());
    }
    public JAXBElement<FatturaElettronicaType> createFatturaElettronica(FatturaElettronicaType fatturaElettronica) {
        return new JAXBElement<FatturaElettronicaType>(_FatturaElettronica, FatturaElettronicaType.class, null, fatturaElettronica);
    }

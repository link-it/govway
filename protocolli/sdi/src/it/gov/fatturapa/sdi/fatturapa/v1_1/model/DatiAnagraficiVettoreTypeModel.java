...
public class DatiAnagraficiVettoreTypeModel extends AbstractModel<DatiAnagraficiVettoreType> {
	...
	public DatiAnagraficiVettoreTypeModel(){
		...
		this.ID_FISCALE_IVA = new it.gov.fatturapa.sdi.fatturapa.v1_1.model.IdFiscaleTypeModel(new Field("IdFiscaleIVA",it.gov.fatturapa.sdi.fatturapa.v1_1.IdFiscaleType.class,"DatiAnagraficiVettoreType",DatiAnagraficiVettoreType.class));
		...
		this.ANAGRAFICA = new it.gov.fatturapa.sdi.fatturapa.v1_1.model.AnagraficaTypeModel(new Field("Anagrafica",it.gov.fatturapa.sdi.fatturapa.v1_1.AnagraficaType.class,"DatiAnagraficiVettoreType",DatiAnagraficiVettoreType.class));
	...
	public DatiAnagraficiVettoreTypeModel(IField father){
		...
		this.ID_FISCALE_IVA = new it.gov.fatturapa.sdi.fatturapa.v1_1.model.IdFiscaleTypeModel(new ComplexField(father,"IdFiscaleIVA",it.gov.fatturapa.sdi.fatturapa.v1_1.IdFiscaleType.class,"DatiAnagraficiVettoreType",DatiAnagraficiVettoreType.class));
		...
		this.ANAGRAFICA = new it.gov.fatturapa.sdi.fatturapa.v1_1.model.AnagraficaTypeModel(new ComplexField(father,"Anagrafica",it.gov.fatturapa.sdi.fatturapa.v1_1.AnagraficaType.class,"DatiAnagraficiVettoreType",DatiAnagraficiVettoreType.class));

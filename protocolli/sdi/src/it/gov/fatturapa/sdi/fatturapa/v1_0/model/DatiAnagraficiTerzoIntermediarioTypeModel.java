...
public class DatiAnagraficiTerzoIntermediarioTypeModel extends AbstractModel<DatiAnagraficiTerzoIntermediarioType> {
	...
	public DatiAnagraficiTerzoIntermediarioTypeModel(){
		...
		this.ID_FISCALE_IVA = new it.gov.fatturapa.sdi.fatturapa.v1_0.model.IdFiscaleTypeModel(new Field("IdFiscaleIVA",it.gov.fatturapa.sdi.fatturapa.v1_0.IdFiscaleType.class,"DatiAnagraficiTerzoIntermediarioType",DatiAnagraficiTerzoIntermediarioType.class));
		...
		this.ANAGRAFICA = new it.gov.fatturapa.sdi.fatturapa.v1_0.model.AnagraficaTypeModel(new Field("Anagrafica",it.gov.fatturapa.sdi.fatturapa.v1_0.AnagraficaType.class,"DatiAnagraficiTerzoIntermediarioType",DatiAnagraficiTerzoIntermediarioType.class));
	...
	public DatiAnagraficiTerzoIntermediarioTypeModel(IField father){
		...
		this.ID_FISCALE_IVA = new it.gov.fatturapa.sdi.fatturapa.v1_0.model.IdFiscaleTypeModel(new ComplexField(father,"IdFiscaleIVA",it.gov.fatturapa.sdi.fatturapa.v1_0.IdFiscaleType.class,"DatiAnagraficiTerzoIntermediarioType",DatiAnagraficiTerzoIntermediarioType.class));
		...
		this.ANAGRAFICA = new it.gov.fatturapa.sdi.fatturapa.v1_0.model.AnagraficaTypeModel(new ComplexField(father,"Anagrafica",it.gov.fatturapa.sdi.fatturapa.v1_0.AnagraficaType.class,"DatiAnagraficiTerzoIntermediarioType",DatiAnagraficiTerzoIntermediarioType.class));

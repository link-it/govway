...
public class DatiTrasportoTypeModel extends AbstractModel<DatiTrasportoType> {
	...
	public DatiTrasportoTypeModel(){
		...
		this.DATI_ANAGRAFICI_VETTORE = new it.gov.fatturapa.sdi.fatturapa.v1_1.model.DatiAnagraficiVettoreTypeModel(new Field("DatiAnagraficiVettore",it.gov.fatturapa.sdi.fatturapa.v1_1.DatiAnagraficiVettoreType.class,"DatiTrasportoType",DatiTrasportoType.class));
		...
		this.INDIRIZZO_RESA = new it.gov.fatturapa.sdi.fatturapa.v1_1.model.IndirizzoTypeModel(new Field("IndirizzoResa",it.gov.fatturapa.sdi.fatturapa.v1_1.IndirizzoType.class,"DatiTrasportoType",DatiTrasportoType.class));
	...
	public DatiTrasportoTypeModel(IField father){
		...
		this.DATI_ANAGRAFICI_VETTORE = new it.gov.fatturapa.sdi.fatturapa.v1_1.model.DatiAnagraficiVettoreTypeModel(new ComplexField(father,"DatiAnagraficiVettore",it.gov.fatturapa.sdi.fatturapa.v1_1.DatiAnagraficiVettoreType.class,"DatiTrasportoType",DatiTrasportoType.class));
		...
		this.INDIRIZZO_RESA = new it.gov.fatturapa.sdi.fatturapa.v1_1.model.IndirizzoTypeModel(new ComplexField(father,"IndirizzoResa",it.gov.fatturapa.sdi.fatturapa.v1_1.IndirizzoType.class,"DatiTrasportoType",DatiTrasportoType.class));
	...
	public it.gov.fatturapa.sdi.fatturapa.v1_1.model.DatiAnagraficiVettoreTypeModel DATI_ANAGRAFICI_VETTORE = null;
	...
	public it.gov.fatturapa.sdi.fatturapa.v1_1.model.IndirizzoTypeModel INDIRIZZO_RESA = null;

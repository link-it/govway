 ...
 * @version $Rev$, $Date$
 */
@javax.xml.bind.annotation.XmlType(name = "BolloVirtualeType")
@javax.xml.bind.annotation.XmlEnum(String.class)
public enum BolloVirtualeType implements IEnumeration , Serializable , Cloneable {
	...
	BolloVirtualeType(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(BolloVirtualeType object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof BolloVirtualeType) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((BolloVirtualeType)object));
	}

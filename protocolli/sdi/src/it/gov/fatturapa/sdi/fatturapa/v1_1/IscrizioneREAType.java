...
import it.gov.fatturapa.sdi.fatturapa.v1_1.constants.SocioUnicoType;
import it.gov.fatturapa.sdi.fatturapa.v1_1.constants.StatoLiquidazioneType;
 ...
 * 		&lt;sequence>
 * 			&lt;element name="Ufficio" type="{http://www.fatturapa.gov.it/sdi/fatturapa/v1.1}string" minOccurs="1" maxOccurs="1"/>
 * 			&lt;element name="NumeroREA" type="{http://www.fatturapa.gov.it/sdi/fatturapa/v1.1}normalizedString" minOccurs="1" maxOccurs="1"/>
 * 			&lt;element name="CapitaleSociale" type="{http://www.fatturapa.gov.it/sdi/fatturapa/v1.1}decimal" minOccurs="0" maxOccurs="1"/>
 * 			&lt;element name="SocioUnico" type="{http://www.fatturapa.gov.it/sdi/fatturapa/v1.1}SocioUnicoType" minOccurs="0" maxOccurs="1"/>
 * 			&lt;element name="StatoLiquidazione" type="{http://www.fatturapa.gov.it/sdi/fatturapa/v1.1}StatoLiquidazioneType" minOccurs="1" maxOccurs="1"/>
 * 		&lt;/sequence>
 * &lt;/complexType>
 * </pre>
 * 
...
public class IscrizioneREAType extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  ...
  public it.gov.fatturapa.sdi.fatturapa.v1_1.constants.SocioUnicoType getSocioUnico() {
    return this.socioUnico;
  }

  public void setSocioUnico(it.gov.fatturapa.sdi.fatturapa.v1_1.constants.SocioUnicoType socioUnico) {
  ...
  public it.gov.fatturapa.sdi.fatturapa.v1_1.constants.StatoLiquidazioneType getStatoLiquidazione() {
    return this.statoLiquidazione;
  }

  public void setStatoLiquidazione(it.gov.fatturapa.sdi.fatturapa.v1_1.constants.StatoLiquidazioneType statoLiquidazione) {

...
public class DettaglioLineeTypeModel extends AbstractModel<DettaglioLineeType> {
	...
	public DettaglioLineeTypeModel(){
		...
		this.ALTRI_DATI_GESTIONALI = new it.gov.fatturapa.sdi.fatturapa.v1_1.model.AltriDatiGestionaliTypeModel(new Field("AltriDatiGestionali",it.gov.fatturapa.sdi.fatturapa.v1_1.AltriDatiGestionaliType.class,"DettaglioLineeType",DettaglioLineeType.class));
	...
	public DettaglioLineeTypeModel(IField father){
		...
		this.ALTRI_DATI_GESTIONALI = new it.gov.fatturapa.sdi.fatturapa.v1_1.model.AltriDatiGestionaliTypeModel(new ComplexField(father,"AltriDatiGestionali",it.gov.fatturapa.sdi.fatturapa.v1_1.AltriDatiGestionaliType.class,"DettaglioLineeType",DettaglioLineeType.class));
	...
	public it.gov.fatturapa.sdi.fatturapa.v1_1.model.CodiceArticoloTypeModel CODICE_ARTICOLO = null;
	...
	public it.gov.fatturapa.sdi.fatturapa.v1_1.model.AltriDatiGestionaliTypeModel ALTRI_DATI_GESTIONALI = null;

...
public class FileSdIType extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  ...
  private static it.gov.fatturapa.sdi.ws.ricezione.v1_0.types.model.FileSdITypeModel modelStaticInstance = null;
  private static synchronized void initModelStaticInstance(){
	  if(it.gov.fatturapa.sdi.ws.ricezione.v1_0.types.FileSdIType.modelStaticInstance==null){
  			it.gov.fatturapa.sdi.ws.ricezione.v1_0.types.FileSdIType.modelStaticInstance = new it.gov.fatturapa.sdi.ws.ricezione.v1_0.types.model.FileSdITypeModel();
	  }
  }
  public static it.gov.fatturapa.sdi.ws.ricezione.v1_0.types.model.FileSdITypeModel model(){
	  if(it.gov.fatturapa.sdi.ws.ricezione.v1_0.types.FileSdIType.modelStaticInstance==null){
	  		initModelStaticInstance();
	  }
	  return it.gov.fatturapa.sdi.ws.ricezione.v1_0.types.FileSdIType.modelStaticInstance;
  }

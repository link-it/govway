...
import it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_0.constants.SocioUnicoType;
import it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_0.constants.StatoLiquidazioneType;
 ...
 * 		&lt;sequence&gt;
 * 			&lt;element name="Ufficio" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.0}string" minOccurs="1" maxOccurs="1"/&gt;
 * 			&lt;element name="NumeroREA" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.0}normalizedString" minOccurs="1" maxOccurs="1"/&gt;
 * 			&lt;element name="CapitaleSociale" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.0}decimal" minOccurs="0" maxOccurs="1"/&gt;
 * 			&lt;element name="SocioUnico" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.0}SocioUnicoType" minOccurs="0" maxOccurs="1"/&gt;
 * 			&lt;element name="StatoLiquidazione" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.0}StatoLiquidazioneType" minOccurs="1" maxOccurs="1"/&gt;
 * 		&lt;/sequence&gt;
 * &lt;/complexType&gt;
 * </pre>
 * 
...
public class IscrizioneREAType extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  ...
  public it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_0.constants.SocioUnicoType getSocioUnico() {
    return this.socioUnico;
  }

  public void setSocioUnico(it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_0.constants.SocioUnicoType socioUnico) {
  ...
  public it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_0.constants.StatoLiquidazioneType getStatoLiquidazione() {
    return this.statoLiquidazione;
  }

  public void setStatoLiquidazione(it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_0.constants.StatoLiquidazioneType statoLiquidazione) {

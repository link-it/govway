 ...
 *
 */
package it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_0.utils;
	...
	private static synchronized void initValidator(Class<?> validatorImpl,Logger log) throws ServiceException{
		if(validator==null){
			validator = new org.openspcoop2.generic_project.utils.XSDValidator(log,FatturaElettronicaType.class, 
				"/FatturaSemplificata_v1.0.1.xsd"
				// elencare in questa posizione altri schemi xsd che vengono inclusi/importati dallo schema /FatturaSemplificata_v1.0.1.xsd
			);
		}
	}

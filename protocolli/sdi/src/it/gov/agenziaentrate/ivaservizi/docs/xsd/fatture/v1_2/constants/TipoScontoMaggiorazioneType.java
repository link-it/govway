 ...
 * @version $Rev$, $Date$
 */
@jakarta.xml.bind.annotation.XmlType(name = "TipoScontoMaggiorazioneType")
...
public enum TipoScontoMaggiorazioneType implements IEnumeration , Serializable , Cloneable {
	...
	SC ("SC"),
	@jakarta.xml.bind.annotation.XmlEnumValue("MG")
	MG ("MG");
	...
	public static TipoScontoMaggiorazioneType toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{

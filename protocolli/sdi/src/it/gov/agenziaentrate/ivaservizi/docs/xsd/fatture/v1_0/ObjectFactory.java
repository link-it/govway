...
public class ObjectFactory {
    ...
    private final static QName _FatturaElettronicaSemplificata = new QName("http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.0", "FatturaElettronicaSemplificata");

...
public class DatiAnagraficiCedenteTypeModel extends AbstractModel<DatiAnagraficiCedenteType> {
	...
	public DatiAnagraficiCedenteTypeModel(){
		...
		this.ID_FISCALE_IVA = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.IdFiscaleTypeModel(new Field("IdFiscaleIVA",it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.IdFiscaleType.class,"DatiAnagraficiCedenteType",DatiAnagraficiCedenteType.class));
		...
		this.ANAGRAFICA = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.AnagraficaTypeModel(new Field("Anagrafica",it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.AnagraficaType.class,"DatiAnagraficiCedenteType",DatiAnagraficiCedenteType.class));
	...
	public DatiAnagraficiCedenteTypeModel(IField father){
		...
		this.ID_FISCALE_IVA = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.IdFiscaleTypeModel(new ComplexField(father,"IdFiscaleIVA",it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.IdFiscaleType.class,"DatiAnagraficiCedenteType",DatiAnagraficiCedenteType.class));
		...
		this.ANAGRAFICA = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.AnagraficaTypeModel(new ComplexField(father,"Anagrafica",it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.AnagraficaType.class,"DatiAnagraficiCedenteType",DatiAnagraficiCedenteType.class));

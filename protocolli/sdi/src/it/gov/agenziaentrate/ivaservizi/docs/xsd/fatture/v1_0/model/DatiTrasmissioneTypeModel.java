...
public class DatiTrasmissioneTypeModel extends AbstractModel<DatiTrasmissioneType> {
	...
	public DatiTrasmissioneTypeModel(){
		...
		this.ID_TRASMITTENTE = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_0.model.IdFiscaleTypeModel(new Field("IdTrasmittente",it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_0.IdFiscaleType.class,"DatiTrasmissioneType",DatiTrasmissioneType.class));
	...
	public DatiTrasmissioneTypeModel(IField father){
		...
		this.ID_TRASMITTENTE = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_0.model.IdFiscaleTypeModel(new ComplexField(father,"IdTrasmittente",it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_0.IdFiscaleType.class,"DatiTrasmissioneType",DatiTrasmissioneType.class));
	...
	public it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_0.model.IdFiscaleTypeModel ID_TRASMITTENTE = null;

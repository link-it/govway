 ...
 * 			&lt;element name="Destinatario" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fattura/messaggi/v1.0}Destinatario_Type" minOccurs="1" maxOccurs="1"/&gt;
 ...
 * 		&lt;attribute name="FlussoSemplificato" type="{http://www.w3.org/2001/XMLSchema}string" use="optional"/&gt;
 * &lt;/complexType&gt;
 * </pre>
 * 
 * @version $Rev$, $Date$
...
public class RicevutaConsegnaType extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  ...
  public java.lang.String getFlussoSemplificato() {
    return this.flussoSemplificato;
  }

  public void setFlussoSemplificato(java.lang.String flussoSemplificato) {
    this.flussoSemplificato = flussoSemplificato;
  }

  private static final long serialVersionUID = 1L;

  private static it.gov.agenziaentrate.ivaservizi.docs.xsd.fattura.messaggi.v1_0.model.RicevutaConsegnaTypeModel modelStaticInstance = null;
  private static synchronized void initModelStaticInstance(){
	  if(it.gov.agenziaentrate.ivaservizi.docs.xsd.fattura.messaggi.v1_0.RicevutaConsegnaType.modelStaticInstance==null){
  			it.gov.agenziaentrate.ivaservizi.docs.xsd.fattura.messaggi.v1_0.RicevutaConsegnaType.modelStaticInstance = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fattura.messaggi.v1_0.model.RicevutaConsegnaTypeModel();
	  }
  }
  public static it.gov.agenziaentrate.ivaservizi.docs.xsd.fattura.messaggi.v1_0.model.RicevutaConsegnaTypeModel model(){
	  if(it.gov.agenziaentrate.ivaservizi.docs.xsd.fattura.messaggi.v1_0.RicevutaConsegnaType.modelStaticInstance==null){
	  		initModelStaticInstance();
	  }
	  return it.gov.agenziaentrate.ivaservizi.docs.xsd.fattura.messaggi.v1_0.RicevutaConsegnaType.modelStaticInstance;
  }
  ...
  @javax.xml.bind.annotation.XmlSchemaType(name="string")
  @XmlAttribute(name="FlussoSemplificato",required=false)
  protected java.lang.String flussoSemplificato;

...
/** <p>Java class for RicevutaScarto_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RicevutaScarto_Type"&gt;
 * 		&lt;sequence&gt;
 ...
 * 			&lt;element name="ListaErrori" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fattura/messaggi/v1.0}ListaErrori_Type" minOccurs="1" maxOccurs="1"/&gt;
...
@XmlType(name = "RicevutaScarto_Type", 
  propOrder = {
  	"identificativoSdI",
  	"nomeFile",
  	"hash",
...
@XmlRootElement(name = "RicevutaScarto_Type")
...
public class RicevutaScartoType extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  ...
  private static it.gov.agenziaentrate.ivaservizi.docs.xsd.fattura.messaggi.v1_0.model.RicevutaScartoTypeModel modelStaticInstance = null;
  private static synchronized void initModelStaticInstance(){
	  if(it.gov.agenziaentrate.ivaservizi.docs.xsd.fattura.messaggi.v1_0.RicevutaScartoType.modelStaticInstance==null){
  			it.gov.agenziaentrate.ivaservizi.docs.xsd.fattura.messaggi.v1_0.RicevutaScartoType.modelStaticInstance = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fattura.messaggi.v1_0.model.RicevutaScartoTypeModel();
	  }
  }
  public static it.gov.agenziaentrate.ivaservizi.docs.xsd.fattura.messaggi.v1_0.model.RicevutaScartoTypeModel model(){
	  if(it.gov.agenziaentrate.ivaservizi.docs.xsd.fattura.messaggi.v1_0.RicevutaScartoType.modelStaticInstance==null){
	  		initModelStaticInstance();
	  }
	  return it.gov.agenziaentrate.ivaservizi.docs.xsd.fattura.messaggi.v1_0.RicevutaScartoType.modelStaticInstance;
  }

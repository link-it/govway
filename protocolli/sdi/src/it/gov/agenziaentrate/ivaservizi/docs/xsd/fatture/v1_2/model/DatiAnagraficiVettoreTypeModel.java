...
public class DatiAnagraficiVettoreTypeModel extends AbstractModel<DatiAnagraficiVettoreType> {
	...
	public DatiAnagraficiVettoreTypeModel(){
		...
		this.ID_FISCALE_IVA = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.IdFiscaleTypeModel(new Field("IdFiscaleIVA",it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.IdFiscaleType.class,"DatiAnagraficiVettoreType",DatiAnagraficiVettoreType.class));
		...
		this.ANAGRAFICA = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.AnagraficaTypeModel(new Field("Anagrafica",it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.AnagraficaType.class,"DatiAnagraficiVettoreType",DatiAnagraficiVettoreType.class));
	...
	public DatiAnagraficiVettoreTypeModel(IField father){
		...
		this.ID_FISCALE_IVA = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.IdFiscaleTypeModel(new ComplexField(father,"IdFiscaleIVA",it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.IdFiscaleType.class,"DatiAnagraficiVettoreType",DatiAnagraficiVettoreType.class));
		...
		this.ANAGRAFICA = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.AnagraficaTypeModel(new ComplexField(father,"Anagrafica",it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.AnagraficaType.class,"DatiAnagraficiVettoreType",DatiAnagraficiVettoreType.class));

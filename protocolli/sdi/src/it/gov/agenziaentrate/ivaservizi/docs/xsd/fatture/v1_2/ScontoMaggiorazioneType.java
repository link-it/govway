...
import it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.constants.TipoScontoMaggiorazioneType;
 ...
 * 		&lt;sequence&gt;
 * 			&lt;element name="Tipo" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.2}TipoScontoMaggiorazioneType" minOccurs="1" maxOccurs="1"/&gt;
 * 			&lt;element name="Percentuale" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.2}decimal" minOccurs="0" maxOccurs="1"/&gt;
 * 			&lt;element name="Importo" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.2}decimal" minOccurs="0" maxOccurs="1"/&gt;
 * 		&lt;/sequence&gt;
 * &lt;/complexType&gt;
 * </pre>
 * 
...
public class ScontoMaggiorazioneType extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  ...
  public it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.constants.TipoScontoMaggiorazioneType getTipo() {
    return this.tipo;
  }

  public void setTipo(it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.constants.TipoScontoMaggiorazioneType tipo) {
    this.tipo = tipo;
  }

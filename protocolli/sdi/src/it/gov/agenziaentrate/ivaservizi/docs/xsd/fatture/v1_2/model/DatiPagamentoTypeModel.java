...
public class DatiPagamentoTypeModel extends AbstractModel<DatiPagamentoType> {
	...
	public DatiPagamentoTypeModel(){
		...
		this.DETTAGLIO_PAGAMENTO = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.DettaglioPagamentoTypeModel(new Field("DettaglioPagamento",it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.DettaglioPagamentoType.class,"DatiPagamentoType",DatiPagamentoType.class));
	...
	public DatiPagamentoTypeModel(IField father){
		...
		this.DETTAGLIO_PAGAMENTO = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.DettaglioPagamentoTypeModel(new ComplexField(father,"DettaglioPagamento",it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.DettaglioPagamentoType.class,"DatiPagamentoType",DatiPagamentoType.class));
	...
	public it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.DettaglioPagamentoTypeModel DETTAGLIO_PAGAMENTO = null;

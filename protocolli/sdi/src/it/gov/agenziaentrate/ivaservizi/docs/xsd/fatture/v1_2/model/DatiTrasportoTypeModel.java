...
public class DatiTrasportoTypeModel extends AbstractModel<DatiTrasportoType> {
	...
	public DatiTrasportoTypeModel(){
		...
		this.DATI_ANAGRAFICI_VETTORE = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.DatiAnagraficiVettoreTypeModel(new Field("DatiAnagraficiVettore",it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.DatiAnagraficiVettoreType.class,"DatiTrasportoType",DatiTrasportoType.class));
		...
		this.NUMERO_COLLI = new Field("NumeroColli",java.math.BigInteger.class,"DatiTrasportoType",DatiTrasportoType.class);
		...
		this.PESO_LORDO = new Field("PesoLordo",java.math.BigDecimal.class,"DatiTrasportoType",DatiTrasportoType.class);
		this.PESO_NETTO = new Field("PesoNetto",java.math.BigDecimal.class,"DatiTrasportoType",DatiTrasportoType.class);
		...
		this.INDIRIZZO_RESA = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.IndirizzoTypeModel(new Field("IndirizzoResa",it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.IndirizzoType.class,"DatiTrasportoType",DatiTrasportoType.class));
	...
	public DatiTrasportoTypeModel(IField father){
		...
		this.DATI_ANAGRAFICI_VETTORE = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.DatiAnagraficiVettoreTypeModel(new ComplexField(father,"DatiAnagraficiVettore",it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.DatiAnagraficiVettoreType.class,"DatiTrasportoType",DatiTrasportoType.class));
		...
		this.NUMERO_COLLI = new ComplexField(father,"NumeroColli",java.math.BigInteger.class,"DatiTrasportoType",DatiTrasportoType.class);
		...
		this.PESO_LORDO = new ComplexField(father,"PesoLordo",java.math.BigDecimal.class,"DatiTrasportoType",DatiTrasportoType.class);
		this.PESO_NETTO = new ComplexField(father,"PesoNetto",java.math.BigDecimal.class,"DatiTrasportoType",DatiTrasportoType.class);
		...
		this.INDIRIZZO_RESA = new it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.IndirizzoTypeModel(new ComplexField(father,"IndirizzoResa",it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.IndirizzoType.class,"DatiTrasportoType",DatiTrasportoType.class));
	...
	public it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.DatiAnagraficiVettoreTypeModel DATI_ANAGRAFICI_VETTORE = null;
	...
	public it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v1_2.model.IndirizzoTypeModel INDIRIZZO_RESA = null;

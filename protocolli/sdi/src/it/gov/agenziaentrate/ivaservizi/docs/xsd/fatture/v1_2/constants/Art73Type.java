 ...
 * @version $Rev$, $Date$
 */
@javax.xml.bind.annotation.XmlType(name = "Art73Type")
@javax.xml.bind.annotation.XmlEnum(String.class)
public enum Art73Type implements IEnumeration , Serializable , Cloneable {
	...
	public boolean equals(Art73Type object){
		if(object==null)
			return false;
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof Art73Type) ){
			throw new RuntimeException("Wrong type: "+object.getClass().getName());
		}
		return this.equals(((Art73Type)object));
	}

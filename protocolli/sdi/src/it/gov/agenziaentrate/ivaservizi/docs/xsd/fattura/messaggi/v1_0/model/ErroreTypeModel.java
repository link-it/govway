...
public class ErroreTypeModel extends AbstractModel<ErroreType> {
	...
	public ErroreTypeModel(){
		...
		this.SUGGERIMENTO = new Field("Suggerimento",java.lang.String.class,"Errore_Type",ErroreType.class);
	...
	public ErroreTypeModel(IField father){
		...
		this.SUGGERIMENTO = new ComplexField(father,"Suggerimento",java.lang.String.class,"Errore_Type",ErroreType.class);
	...
	public IField SUGGERIMENTO = null;

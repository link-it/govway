	...
	public boolean handleMessage(SOAPMessageContext context) {
    	...
    	if (outboundProperty.booleanValue()==false && this.headerFileName!=null) {
    		...
    		try {
	            ...
	            DynamicNamespaceContext dnc = org.openspcoop2.message.xml.MessageDynamicNamespaceContextFactory.getInstance(OpenSPCoop2MessageFactory.getDefaultMessageFactory()).getNamespaceContext(header);

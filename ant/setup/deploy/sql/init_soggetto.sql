...
INSERT INTO soggetti (nome_soggetto,tipo_soggetto,descrizione,identificativo_porta,is_default,is_router,id_connettore,superuser,server,privato,profilo,codice_ipa) VALUES
	    ('@NOME_SOGGETTO@','@TIPO_SOGGETTO@',null,'@IDPORTA_SOGGETTO@',1,0,

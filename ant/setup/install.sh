...
CLASSPATH=${CLASSPATH}:${ANTINSTALLER_LIBRARIES}/ant-1.7.0.jar
CLASSPATH=${CLASSPATH}:${ANTINSTALLER_LIBRARIES}/ant-launcher-1.7.0.jar
CLASSPATH=${CLASSPATH}:${ROOT_OPENSPCOOP}/ant/setup/deploy/resources

# minimal regular expression env
CLASSPATH=${CLASSPATH}:${ANTINSTALLER_LIBRARIES}/ant-apache-regexp-1.7.0.jar
CLASSPATH=${CLASSPATH}:${ANTINSTALLER_LIBRARIES}/jakarta-regexp-1.5.jar

# unix tasks
CLASSPATH=${CLASSPATH}:${ANTINSTALLER_LIBRARIES}/ant-nodeps-1.7.0.jar

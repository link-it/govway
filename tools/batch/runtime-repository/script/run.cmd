...
set BATCH_DIR=DIRGESTORE
set BATCH_CLASSPATH=%BATCH_DIR%\lib
set BATCH_CONFIG=%BATCH_DIR%\properties
set BATCH_JDBC=%BATCH_DIR%\jdbc
...
:nojava
echo "Il Batch richiede Java Runtime Environment (JRE) 21"

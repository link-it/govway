...
public class WADLValidatorException extends Exception {
	...
	public WADLValidatorException(String message, Throwable cause)
	{
		super(message, cause);
		// TODO Auto-generated constructor stub
	}
	public WADLValidatorException(Throwable cause)
	{
		super(cause);
		// TODO Auto-generated constructor stub
	}

	public WADLValidatorException() {
		super();
	}
	public WADLValidatorException(String msg) {
		super(msg);
	}

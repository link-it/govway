...
public class KeyGeneratorTest {
	...
	public static void main(String[] args) throws Exception{
		 ...
		 * Dalla versione 9.4 alle più recenti funziona
		...
		KeyGeneratorTest.log = LoggerWrapperFactory.getLogger(KeyGeneratorTest.class);
		
		DateManager.initializeDataManager(org.openspcoop2.utils.date.SystemDate.class.getName(), new Properties(), KeyGeneratorTest.log);
	    ...
	    try{
	    	...
	    	KeyGeneratorTest.info(KeyGeneratorTest.log,KeyGeneratorTest.systemOut,"Test effettuato correttamente (id generati: first["+id1+"] second["+id2+"])");

...
public class Problem  {
  ...
  **/
  ...
  @Schema(description = "An optional applicative error code generated by govway. ")
 /**
   * An optional applicative error code generated by govway.   
  **/
  private String govwayStatus = null;
  
  @Schema(description = "An optional applicative error code generated by govpay.")
 /**
   * An optional applicative error code generated by govpay.  
  **/
  private String govpayStatus = null;
 /**
   * An absolute URI that identifies the problem type.  When dereferenced, it SHOULD provide human-readable documentation for the problem type (e.g., using HTML). 
   * @return type
  **/
 ...
 /**
   ...
   * @return govpayStatus
  **/
  @JsonProperty("govpay_status")
  public String getGovpayStatus() {
    return this.govpayStatus;
  }

  public void setGovpayStatus(String govpayStatus) {
    this.govpayStatus = govpayStatus;
  }

  public Problem govpayStatus(String govpayStatus) {
    this.govpayStatus = govpayStatus;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("    govpayStatus: ").append(Problem.toIndentedString(this.govpayStatus)).append("\n");
    sb.append("}");
    return sb.toString();
  }

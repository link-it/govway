...
public class Costanti {
    ...
    /** Versione beta, es: "b1" */
    public static final String OPENSPCOOP2_BETA = ".1.rc1"; //".0.rc1";
    /** Versione di OpenSPCoop */
    public static final String OPENSPCOOP2_VERSION = "3.1"+Costanti.OPENSPCOOP2_BETA;
    /** Versione di OpenSPCoop */
    ...
    /** Copyright */
	public final static String OPENSPCOOP2_COPYRIGHT = "2005-2019 Link.it srl";
	 /** License */

...
public class LimitedInputStreamEngine extends FilterInputStream {
	...
	protected LimitedInputStreamEngine(InputStream inputStream, long limitBytes, String prefixError, Hashtable<String, Object> ctx, ILimitExceededNotifier notifier) throws IOException {
		super(inputStream);

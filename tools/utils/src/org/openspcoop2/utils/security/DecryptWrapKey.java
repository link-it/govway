...
public class DecryptWrapKey  {
	...
	protected byte[] process(byte[] data, 
		...
		try{			
            ...
            // I parametri OAEP vengono indicati esplicitamente, altrimenti il formato atteso dipenderebbe da quale
            ...
            if(this.certificate!=null) {
            	...
            	if(oaepParameterSpec!=null) {
            		cipher.init(Cipher.UNWRAP_MODE, this.certificate.getPublicKey(), oaepParameterSpec);
            	}
            }
            else {
            	if(oaepParameterSpec!=null) {
            		cipher.init(Cipher.UNWRAP_MODE, this.key, oaepParameterSpec);
            	}
            	else {

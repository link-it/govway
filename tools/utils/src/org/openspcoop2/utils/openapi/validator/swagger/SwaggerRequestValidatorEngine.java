...
public class SwaggerRequestValidatorEngine extends AbstractApiValidator implements IApiValidator {
	...
	public void init(Logger log, Api api, ApiValidatorConfig rawConfig) throws ProcessingException {
		...
		try {
			...
			String cacheKey = this.config.cacheKey(OpenAPILibrary.swagger_request_validator.name());
			...
			if (openapiApi.getValidationStructure(cacheKey) != null
					...
					&& openapiApi.getValidationStructure(cacheKey) instanceof SwaggerValidatorCache validationCache) {

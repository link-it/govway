 ...
 * @version $Rev$, $Date$
 */
public class PipedBytesStream extends InputStream {
	...
	public PipedBytesStream(Logger log, long sizeBuffer){
		this(log, sizeBuffer, 120000); // timeout di 120 secondi per default
	}
	public PipedBytesStream(Logger log, long sizeBuffer, int timeoutMs){
		this.log = log;

...
public class TransazioneEsito  {
  ...
  @Schema(requiredMode = io.swagger.v3.oas.annotations.media.Schema.RequiredMode.REQUIRED, description = "Codice che rappresenta l'esito dell'invocazione. Può essere un http status per i protocolli basati su HTTP, o un altra codifica (es. OK/KO)")
 /**

...
public class TransazioneContenutoMessaggioHeader  {
  ...
  @Schema(example = "Content-Type", requiredMode = io.swagger.v3.oas.annotations.media.Schema.RequiredMode.REQUIRED, description = "")
  private String nome = null;
  @XmlElement(name="valore", required = true)
  
  @Schema(example = "application/json", requiredMode = io.swagger.v3.oas.annotations.media.Schema.RequiredMode.REQUIRED, description = "")

...
@XmlAccessorType(XmlAccessType.FIELD)
 @XmlType(name = "TransazioneExtDettaglioMessaggio", propOrder =
    { "contenutiIngresso", "contenutiUscita", "duplicatiMessaggio", "traccia"
})

@XmlRootElement(name="TransazioneExtDettaglioMessaggio")
public class TransazioneExtDettaglioMessaggio  {
  ...
  **/
  ...
  public TransazioneExtDettaglioMessaggio contenutiIngresso(TransazioneExtContenutoMessaggio contenutiIngresso) {
    this.contenutiIngresso = contenutiIngresso;
    return this;
  }
  ...
  **/
  ...
  public TransazioneExtDettaglioMessaggio contenutiUscita(TransazioneExtContenutoMessaggio contenutiUscita) {
    this.contenutiUscita = contenutiUscita;
    return this;
  }
  ...
  **/
  ...
  public TransazioneExtDettaglioMessaggio duplicatiMessaggio(Integer duplicatiMessaggio) {
    this.duplicatiMessaggio = duplicatiMessaggio;
    return this;
  }
  ...
  **/
  ...
  public TransazioneExtDettaglioMessaggio traccia(String traccia) {
    this.traccia = traccia;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class TransazioneExtDettaglioMessaggio {\n");
    
    sb.append("    contenutiIngresso: ").append(TransazioneExtDettaglioMessaggio.toIndentedString(this.contenutiIngresso)).append("\n");
    sb.append("    contenutiUscita: ").append(TransazioneExtDettaglioMessaggio.toIndentedString(this.contenutiUscita)).append("\n");
    sb.append("    duplicatiMessaggio: ").append(TransazioneExtDettaglioMessaggio.toIndentedString(this.duplicatiMessaggio)).append("\n");
    sb.append("    traccia: ").append(TransazioneExtDettaglioMessaggio.toIndentedString(this.traccia)).append("\n");
    sb.append("}");
    return sb.toString();
  }

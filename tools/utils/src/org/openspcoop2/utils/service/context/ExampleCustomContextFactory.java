...
/**
 * ExampleCustomContextFactory
 * 
 * @author Andrea Poli (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public class ExampleCustomContextFactory extends ContextFactory implements IContextFactory {
...
class CustomContext extends ApplicationContext{

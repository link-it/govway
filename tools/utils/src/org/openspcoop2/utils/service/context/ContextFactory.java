...
public class ContextFactory implements IContextFactory {
	...
	private boolean loggerPrefixEnabled = false;
	...
	public Context newContext() throws UtilsException {
		...
		return new Context(logger,this.loggerPrefixEnabled);
		
	}

	public boolean isLoggerPrefixEnabled() {
		return this.loggerPrefixEnabled;
	}

	public void setLoggerPrefixEnabled(boolean loggerPrefixEnabled) {

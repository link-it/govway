...
public abstract class BaseBD<T,K> {
	...
	public abstract <S extends BaseSearchForm> int count(S form)throws Exception;

	public abstract <S extends BaseSearchForm> List<T> findAll(S form, Integer start, Integer limit)throws Exception;

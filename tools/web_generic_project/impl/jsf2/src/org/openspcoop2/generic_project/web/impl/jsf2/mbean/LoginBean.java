...
import org.openspcoop2.generic_project.web.impl.jsf2.form.LanguageForm;
	...
	public String login(){
		...
		try{
			if(this.loginDao.login(this.username,this.password)){
				...
				MessageUtils.addErrorMsg("Errore: username non valido.");
			}
		}catch(ServiceException e){
			MessageUtils.addErrorMsg("Si e' verificato un errore durante l'esecuzione del Login: impossibile accedere all'applicazione.");
		}

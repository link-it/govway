...
public interface ReportisticaApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "503", description = "Service Unavailable", content = @Content(schema = @Schema(implementation = Problem.class))),
        @ApiResponse(responseCode = "200", description = "Unexpected error", content = @Content(schema = @Schema(implementation = Problem.class))) })
    public byte[] getReportDistribuzioneApiBySimpleSearch(@QueryParam("data_inizio") @NotNull DateTime dataInizio, @QueryParam("data_fine") @NotNull DateTime dataFine, @QueryParam("tipo") @NotNull TransazioneRuoloEnum tipo, @QueryParam("formato_report") @NotNull FormatoReportEnum formatoReport, @QueryParam("profilo") ProfiloEnum profilo, @QueryParam("soggetto") String soggetto, @QueryParam("soggetto_remoto") String soggettoRemoto, @QueryParam("esito") EsitoTransazioneSimpleSearchEnum esito, @QueryParam("unita_tempo") UnitaTempoReportEnum unitaTempo, @QueryParam("tipo_report") TipoReportEnum tipoReport, @QueryParam("tipo_informazione_report") TipoInformazioneReportEnum tipoInformazioneReport, @QueryParam("orientamento_etichette") OrientamentoEtichetteReportEnum orientamentoEtichette, @QueryParam("larghezza_grafico") Integer larghezzaGrafico);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "503", description = "Service Unavailable", content = @Content(schema = @Schema(implementation = Problem.class))),
        @ApiResponse(responseCode = "200", description = "Unexpected error", content = @Content(schema = @Schema(implementation = Problem.class))) })
    public byte[] getReportDistribuzioneApplicativoBySimpleSearch(@QueryParam("data_inizio") @NotNull DateTime dataInizio, @QueryParam("data_fine") @NotNull DateTime dataFine, @QueryParam("tipo") @NotNull TransazioneRuoloEnum tipo, @QueryParam("formato_report") @NotNull FormatoReportEnum formatoReport, @QueryParam("profilo") ProfiloEnum profilo, @QueryParam("soggetto") String soggetto, @QueryParam("soggetto_remoto") String soggettoRemoto, @QueryParam("nome_servizio") String nomeServizio, @QueryParam("tipo_servizio") String tipoServizio, @QueryParam("versione_servizio") Integer versioneServizio, @QueryParam("azione") String azione, @QueryParam("esito") EsitoTransazioneSimpleSearchEnum esito, @QueryParam("unita_tempo") UnitaTempoReportEnum unitaTempo, @QueryParam("tipo_report") TipoReportEnum tipoReport, @QueryParam("tipo_informazione_report") TipoInformazioneReportEnum tipoInformazioneReport, @QueryParam("orientamento_etichette") OrientamentoEtichetteReportEnum orientamentoEtichette, @QueryParam("larghezza_grafico") Integer larghezzaGrafico);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "503", description = "Service Unavailable", content = @Content(schema = @Schema(implementation = Problem.class))),
        @ApiResponse(responseCode = "200", description = "Unexpected error", content = @Content(schema = @Schema(implementation = Problem.class))) })
    public byte[] getReportDistribuzioneAzioneBySimpleSearch(@QueryParam("data_inizio") @NotNull DateTime dataInizio, @QueryParam("data_fine") @NotNull DateTime dataFine, @QueryParam("tipo") @NotNull TransazioneRuoloEnum tipo, @QueryParam("formato_report") @NotNull FormatoReportEnum formatoReport, @QueryParam("profilo") ProfiloEnum profilo, @QueryParam("soggetto") String soggetto, @QueryParam("soggetto_remoto") String soggettoRemoto, @QueryParam("nome_servizio") String nomeServizio, @QueryParam("tipo_servizio") String tipoServizio, @QueryParam("versione_servizio") Integer versioneServizio, @QueryParam("esito") EsitoTransazioneSimpleSearchEnum esito, @QueryParam("unita_tempo") UnitaTempoReportEnum unitaTempo, @QueryParam("tipo_report") TipoReportEnum tipoReport, @QueryParam("tipo_informazione_report") TipoInformazioneReportEnum tipoInformazioneReport, @QueryParam("orientamento_etichette") OrientamentoEtichetteReportEnum orientamentoEtichette, @QueryParam("larghezza_grafico") Integer larghezzaGrafico);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "503", description = "Service Unavailable", content = @Content(schema = @Schema(implementation = Problem.class))),
        @ApiResponse(responseCode = "200", description = "Unexpected error", content = @Content(schema = @Schema(implementation = Problem.class))) })
    public byte[] getReportDistribuzioneEsitiBySimpleSearch(@QueryParam("data_inizio") @NotNull DateTime dataInizio, @QueryParam("data_fine") @NotNull DateTime dataFine, @QueryParam("tipo") @NotNull TransazioneRuoloEnum tipo, @QueryParam("formato_report") @NotNull FormatoReportEnum formatoReport, @QueryParam("profilo") ProfiloEnum profilo, @QueryParam("soggetto") String soggetto, @QueryParam("soggetto_remoto") String soggettoRemoto, @QueryParam("nome_servizio") String nomeServizio, @QueryParam("tipo_servizio") String tipoServizio, @QueryParam("versione_servizio") Integer versioneServizio, @QueryParam("azione") String azione, @QueryParam("unita_tempo") UnitaTempoReportEnum unitaTempo, @QueryParam("tipo_report") TipoReportEnum tipoReport, @QueryParam("tipo_informazione_report") TipoInformazioneReportEnum tipoInformazioneReport, @QueryParam("orientamento_etichette") OrientamentoEtichetteReportEnum orientamentoEtichette, @QueryParam("larghezza_grafico") Integer larghezzaGrafico);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "503", description = "Service Unavailable", content = @Content(schema = @Schema(implementation = Problem.class))),
        @ApiResponse(responseCode = "200", description = "Unexpected error", content = @Content(schema = @Schema(implementation = Problem.class))) })
    public byte[] getReportDistribuzioneIdAutenticatoByFullSearch(@Valid Object body, @QueryParam("profilo") ProfiloEnum profilo, @QueryParam("soggetto") String soggetto);

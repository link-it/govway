...
public class StatoConfigurazioneApi  {
  ...
  @Schema(requiredMode = io.swagger.v3.oas.annotations.media.Schema.RequiredMode.REQUIRED, description = "Indica se l'erogazione o fruizione debba essere abilitata (true) o disabilitata (false)")
 /**

...
public class RicercaStatisticaDistribuzioneSoggettoLocale extends RicercaBaseStatisticaSoggetti {
  ...
  private OneOfRicercaStatisticaDistribuzioneSoggettoLocaleMittente mittente = null;
  ...
  **/
  ...
  public RicercaStatisticaDistribuzioneSoggettoLocale report(OpzioniGenerazioneReportDimensioni report) {
    this.report = report;
    return this;
  }
  ...
  **/
  ...
  @Valid
  public OneOfRicercaStatisticaDistribuzioneSoggettoLocaleMittente getMittente() {
    return this.mittente;
  }

  public void setMittente(OneOfRicercaStatisticaDistribuzioneSoggettoLocaleMittente mittente) {
    this.mittente = mittente;
  }

  public RicercaStatisticaDistribuzioneSoggettoLocale mittente(OneOfRicercaStatisticaDistribuzioneSoggettoLocaleMittente mittente) {
    this.mittente = mittente;
    return this;
  }
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("    ").append(RicercaStatisticaDistribuzioneSoggettoLocale.toIndentedString(super.toString())).append("\n");
    sb.append("    report: ").append(RicercaStatisticaDistribuzioneSoggettoLocale.toIndentedString(this.report)).append("\n");
    sb.append("    azione: ").append(RicercaStatisticaDistribuzioneSoggettoLocale.toIndentedString(this.azione)).append("\n");
    sb.append("    mittente: ").append(RicercaStatisticaDistribuzioneSoggettoLocale.toIndentedString(this.mittente)).append("\n");
    sb.append("    esito: ").append(RicercaStatisticaDistribuzioneSoggettoLocale.toIndentedString(this.esito)).append("\n");
    sb.append("}");
    return sb.toString();
  }

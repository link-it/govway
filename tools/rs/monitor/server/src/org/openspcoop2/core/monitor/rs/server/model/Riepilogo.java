...
public class Riepilogo  {
  ...
  @Schema(example = "2", requiredMode = io.swagger.v3.oas.annotations.media.Schema.RequiredMode.REQUIRED, description = "Il numero di api per cui il soggetto è referente")
 /**
  ...
  **/
  ...
  @Schema(example = "2", requiredMode = io.swagger.v3.oas.annotations.media.Schema.RequiredMode.REQUIRED, description = "Il numero di erogazioni del soggetto")
 /**
   * Il numero di erogazioni del soggetto  
  **/
  private Integer erogazioni = null;
  
  @Schema(example = "2", requiredMode = io.swagger.v3.oas.annotations.media.Schema.RequiredMode.REQUIRED, description = "Il numero di fruizioni del soggetto")
 /**

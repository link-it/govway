...
* def check_response_dimensioni = <filtro-report-formato>.contains('xml') ? check_response : <dimensioni-report>.contains('2d') ? check_response : <dimensioni-report>.contains('3dcustom') ? <info-custom-label> : <filtro-report-formato>.contains('json') ? dataOggi : "Data"
...
* def check_response_dimensioni = <dimensioni-report>.contains('2d') ? check_response : <dimensioni-report>.contains('3dcustom') ? <info-custom-label> : <filtro-report-formato>.contains('json') ? dataOggi : "Data"
	...
	When def result_check_response_dimensioni = excelUtils.existsString(responseBytes, check_response_dimensioni)
    	Then assert result_check_response_dimensioni == true
	* def response_qualsiasi = response
...
* def check_response_dimensioni = <dimensioni-report>.contains('2d') ? check_response : <dimensioni-report>.contains('3dcustom') ? <info-custom-label> : <filtro-report-formato>.contains('json') ? dataOggi : "Data"
	...
	When def result_check_response = pdfUtils.existsString(responseBytes, check_response)
    	Then assert result_check_response == true
	When def result_check_response_dimensioni = pdfUtils.existsString(responseBytes, check_response_dimensioni)
    	Then assert result_check_response_dimensioni == true
	* def response_qualsiasi = response
...
Examples:
| nome-statistica | path-distribuzione | filtro-esito | filtro-claim | filtro-tipo-qualsiasi | filtro-tipo-fruizione | filtro-tipo-erogazione | filtro-report-formato | filtro-report-tipo | filtro-report-informazione | stringa-verifica | dimensioni-report | info-custom | info-custom-label |
| 'distribuzione-errori-pdf (verifica 2d)' | 'distribuzione-errori' | null | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '2d' | null | null |
| 'distribuzione-errori-pdf' | 'distribuzione-errori' | null | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3d' | null | null |
| 'distribuzione-soggetto-remoto-pdf' | 'distribuzione-soggetto-remoto' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3d' | null | null |
| 'distribuzione-soggetto-locale-pdf' | 'distribuzione-soggetto-locale' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3d' | null | null |
| 'distribuzione-api-pdf' | 'distribuzione-api' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3d' | null | null |
| 'distribuzione-azione-pdf' | 'distribuzione-azione' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3d' | null | null |
| 'distribuzione-applicativo-trasporto-pdf' | 'distribuzione-applicativo' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3d' | null | null |
| 'distribuzione-applicativo-token-pdf' | 'distribuzione-applicativo' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3d' | null | null |
| 'distribuzione-id-autenticato-pdf' | 'distribuzione-id-autenticato' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3d' | null | null |
| 'distribuzione-token-info-subject-pdf' | 'distribuzione-token-info' | { "tipo": "ok" } | "subject" | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3d' | null | null |
| 'distribuzione-token-info-client-id-pdnd-pdf' | 'distribuzione-token-info' | { "tipo": "ok" } | "client_id_pdnd_informazioni" | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3d' | null | null |
| 'distribuzione-indirizzo-ip-pdf' | 'distribuzione-indirizzo-ip' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3d' | null | null |
| 'distribuzione-errori-pdf' | 'distribuzione-errori' | null | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3dcustom' | 'tag' | 'Tag' |
| 'distribuzione-soggetto-remoto-pdf' | 'distribuzione-soggetto-remoto' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3dcustom' | 'tag' | 'Tag' |
| 'distribuzione-soggetto-locale-pdf' | 'distribuzione-soggetto-locale' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3dcustom' | 'tag' | 'Tag' |
| 'distribuzione-api-pdf' | 'distribuzione-api' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3dcustom' | 'ip_address' | 'Indirizzo IP' |
| 'distribuzione-azione-pdf' | 'distribuzione-azione' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3dcustom' | 'tag' | 'Tag' |
| 'distribuzione-applicativo-trasporto-pdf' | 'distribuzione-applicativo' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3dcustom' | 'tag' | 'Tag' |
| 'distribuzione-applicativo-token-pdf' | 'distribuzione-applicativo' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3dcustom' | 'tag' | 'Tag' |
| 'distribuzione-id-autenticato-pdf' | 'distribuzione-id-autenticato' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3dcustom' | 'tag' | 'Tag' |
| 'distribuzione-token-info-subject-pdf' | 'distribuzione-token-info' | { "tipo": "ok" } | "subject" | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3dcustom' | 'tag' | 'Tag' |
| 'distribuzione-token-info-client-id-pdnd-pdf' | 'distribuzione-token-info' | { "tipo": "ok" } | "client_id_pdnd_informazioni" | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3dcustom' | 'tag' | 'Tag' |
| 'distribuzione-indirizzo-ip-pdf' | 'distribuzione-indirizzo-ip' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'numero_transazioni' | "Numero Transazioni" | '3dcustom' | 'tag' | 'Tag' |
...
* def check_response_dimensioni = <filtro-report-formato>.contains('xml') ? check_response : <dimensioni-report>.contains('2d') ? check_response : <filtro-report-formato>.contains('json') ? dataOggi : "Data"
...
* def check_response_dimensioni = <dimensioni-report>.contains('2d') ? check_response : <filtro-report-formato>.contains('json') ? dataOggi : "Data"
...
Examples:
| nome-statistica | path-distribuzione | filtro-esito | filtro-claim | filtro-tipo-qualsiasi | filtro-tipo-fruizione | filtro-tipo-erogazione | filtro-report-formato | filtro-report-tipo | filtro-report-informazione | stringa-verifica | dimensioni-report |
| 'occupazione-banda-distribuzione-errori-pdf (verifica 2d)' | 'distribuzione-errori' | null | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'occupazione_banda' | "Occupazione Banda" | '2d' |
| 'occupazione-banda-distribuzione-errori-pdf' | 'distribuzione-errori' | null | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'occupazione_banda' | "Occupazione Banda" | '3d' |
| 'occupazione-banda-distribuzione-soggetto-remoto-pdf' | 'distribuzione-soggetto-remoto' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'occupazione_banda' | "Occupazione Banda" | '3d' |
| 'occupazione-banda-distribuzione-soggetto-locale-pdf' | 'distribuzione-soggetto-locale' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'occupazione_banda' | "Occupazione Banda" | '3d' |
| 'occupazione-banda-distribuzione-api-pdf' | 'distribuzione-api' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'occupazione_banda' | "Occupazione Banda" | '3d' |
| 'occupazione-banda-distribuzione-azione-pdf' | 'distribuzione-azione' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'occupazione_banda' | "Occupazione Banda" | '3d' |
| 'occupazione-banda-distribuzione-applicativo-trasporto-pdf' | 'distribuzione-applicativo' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'occupazione_banda' | "Occupazione Banda" | '3d' |
| 'occupazione-banda-distribuzione-applicativo-token-pdf' | 'distribuzione-applicativo' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'occupazione_banda' | "Occupazione Banda" | '3d' |
| 'occupazione-banda-distribuzione-id-autenticato-pdf' | 'distribuzione-id-autenticato' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'occupazione_banda' | "Occupazione Banda" | '3d' |
| 'occupazione-banda-distribuzione-token-info-subject-pdf' | 'distribuzione-token-info' | { "tipo": "ok" } | "subject" | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'occupazione_banda' | "Occupazione Banda" | '3d' |
| 'occupazione-banda-distribuzione-token-info-client-id-pdnd-pdf' | 'distribuzione-token-info' | { "tipo": "ok" } | "client_id_pdnd_informazioni" | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'occupazione_banda' | "Occupazione Banda" | '3d' |
| 'occupazione-banda-distribuzione-indirizzo-ip-pdf' | 'distribuzione-indirizzo-ip' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'occupazione_banda' | "Occupazione Banda" | '3d' |
...
Examples:
| nome-statistica | path-distribuzione | filtro-esito | filtro-claim | filtro-tipo-qualsiasi | filtro-tipo-fruizione | filtro-tipo-erogazione | filtro-report-formato | filtro-report-tipo | filtro-report-informazione | stringa-verifica | dimensioni-report |
| 'tempo-medio-risposta-distribuzione-errori-pdf (verifica 2d)' | 'distribuzione-errori' | { "tipo": "qualsiasi", "escludi_scartate": false } | null | 'qualsiasi' | 'erogazione' | 'erogazione' | 'pdf' | 'table' | 'tempo_medio_risposta' | "Latenza Media" | '2d' |
| 'tempo-medio-risposta-distribuzione-errori-pdf' | 'distribuzione-errori' | { "tipo": "qualsiasi", "escludi_scartate": false } | null | 'qualsiasi' | 'erogazione' | 'erogazione' | 'pdf' | 'table' | 'tempo_medio_risposta' | "Latenza Media" | '3d' |
| 'tempo-medio-risposta-distribuzione-soggetto-remoto-pdf' | 'distribuzione-soggetto-remoto' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'tempo_medio_risposta' | "Latenza Media" | '3d' |
| 'tempo-medio-risposta-distribuzione-soggetto-locale-pdf' | 'distribuzione-soggetto-locale' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'tempo_medio_risposta' | "Latenza Media" | '3d' |
| 'tempo-medio-risposta-distribuzione-api-pdf' | 'distribuzione-api' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'tempo_medio_risposta' | "Latenza Media" | '3d' |
| 'tempo-medio-risposta-distribuzione-azione-pdf' | 'distribuzione-azione' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'tempo_medio_risposta' | "Latenza Media" | '3d' |
| 'tempo-medio-risposta-distribuzione-applicativo-trasporto-pdf' | 'distribuzione-applicativo' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'tempo_medio_risposta' | "Latenza Media" | '3d' |
| 'tempo-medio-risposta-distribuzione-applicativo-token-pdf' | 'distribuzione-applicativo' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'tempo_medio_risposta' | "Latenza Media" | '3d' |
| 'tempo-medio-risposta-distribuzione-id-autenticato-pdf' | 'distribuzione-id-autenticato' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'tempo_medio_risposta' | "Latenza Media" | '3d' |
| 'tempo-medio-risposta-distribuzione-token-info-subject-pdf' | 'distribuzione-token-info' | { "tipo": "ok" } | "subject" | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'tempo_medio_risposta' | "Latenza Media" | '3d' |
| 'tempo-medio-risposta-distribuzione-token-info-client-id-pdnd-pdf' | 'distribuzione-token-info' | { "tipo": "ok" } | "client_id_pdnd_informazioni" | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'tempo_medio_risposta' | "Latenza Media" | '3d' |
| 'tempo-medio-risposta-distribuzione-indirizzo-ip-pdf' | 'distribuzione-indirizzo-ip' | { "tipo": "ok" } | null | 'qualsiasi' | 'fruizione' | 'erogazione' | 'pdf' | 'table' | 'tempo_medio_risposta' | "Latenza Media" | '3d' |

...
public class ConnettoreConfigurazioneTimeout  {
  ...
  @Schema(example = "10000", requiredMode = io.swagger.v3.oas.annotations.media.Schema.RequiredMode.REQUIRED, description = "tempo massimo (in millisecondi) per instaurare una connessione")
 /**
   * tempo massimo (in millisecondi) per instaurare una connessione  
  **/
  private Integer connectionTimeout = null;
  
  @Schema(example = "150000", requiredMode = io.swagger.v3.oas.annotations.media.Schema.RequiredMode.REQUIRED, description = "tempo massimo (in millisecondi) per ricevere una risposta")
 /**
   * tempo massimo (in millisecondi) per ricevere una risposta  
  **/
  private Integer connectionReadTimeout = null;
  
  @Schema(example = "10000", requiredMode = io.swagger.v3.oas.annotations.media.Schema.RequiredMode.REQUIRED, description = "tempo medio (in millisecondi) atteso per ricevere una risposta")
 /**

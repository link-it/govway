...
@JsonProperty("modalita")
  ...
  public ModITrustStoreRidefinito modalita(StatoDefaultRidefinitoEnum modalita) {
    this.modalita = modalita;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class ModITrustStoreRidefinito {\n");
    sb.append("    ").append(ModITrustStoreRidefinito.toIndentedString(super.toString())).append("\n");
    sb.append("    modalita: ").append(ModITrustStoreRidefinito.toIndentedString(this.modalita)).append("\n");
    sb.append("}");
    return sb.toString();
  }

...
@JsonProperty("modalita_accesso")
  ...
  public AuthenticationToken modalitaAccesso(ModalitaAccessoEnum modalitaAccesso) {
    this.modalitaAccesso = modalitaAccesso;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("    ").append(AuthenticationToken.toIndentedString(super.toString())).append("\n");
    sb.append("    modalitaAccesso: ").append(AuthenticationToken.toIndentedString(this.modalitaAccesso)).append("\n");
    sb.append("}");
    return sb.toString();
  }

...
public class ApiAllegatoSpecificaSemiformale extends ApiAllegatoGenerico implements OneOfApiAllegatoAllegato {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("    ").append(ApiAllegatoSpecificaSemiformale.toIndentedString(super.toString())).append("\n");
    sb.append("    tipoSpecifica: ").append(ApiAllegatoSpecificaSemiformale.toIndentedString(this.tipoSpecifica)).append("\n");
    sb.append("}");
    return sb.toString();
  }

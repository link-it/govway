Feature: Configurazione Validazione Fruizioni
...
Scenario: Configurazione Validazione
    ...
    * def conf = call read('classpath:servizi-configurazione/validazione.feature') ({servizio_path: fruizione_petstore_path })

...
Scenario Outline: Allegati SpecificaSemiformale Erogazioni Create 204
...
Scenario Outline: Allegati SpecificaLivelloServizio Erogazioni Create 204
...
Scenario Outline: Allegati SpecificaSicurezza Erogazioni Create 204

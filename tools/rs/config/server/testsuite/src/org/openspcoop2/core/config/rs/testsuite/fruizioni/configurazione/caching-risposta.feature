Feature: Configurazione Fruizioni Caching Risposta
...
@Stato
Scenario: Configurazione Fruizioni Caching Risposta

    * call create ({ resourcePath: 'api', body: api_petstore })
    * call create ({ resourcePath: 'soggetti', body: erogatore })
    * call create ({ resourcePath: 'fruizioni', body: fruizione_petstore })

    * def conf = call read('classpath:servizi-configurazione/caching-risposta.feature') ({servizio_path: fruizione_petstore_path })

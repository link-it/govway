Feature: Configurazione Validazione Erogazioni
...
Scenario: Configurazione Validazione
    ...
    * def conf = call read('classpath:servizi-configurazione/validazione.feature') ({servizio_path: erogazione_petstore_path })

Feature: Configurazione Stato Erogazioni
...
@Stato
Scenario: Gestione Token

    * call create ({ resourcePath: 'api', body: api_petstore })
    * call create ({ resourcePath: 'erogazioni', body: erogazione_petstore })

    * def conf = call read('classpath:servizi-configurazione/stato.feature') ({servizio_path: erogazione_petstore_path })

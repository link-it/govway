...
Scenario: Allegati Erogazioni Get 200 OK
    ...
    * call create ({ resourcePath: 'erogazioni', body: erogazione_petstore })
    ...
    Given url configUrl
    And path erogazione_petstore_path + '/allegati'
    ...
    * match response.items[0].allegato.documento == '#notpresent'
    ...
    Given url configUrl
    And path erogazione_petstore_path + '/allegati' , allegato.allegato.nome
    And header Authorization = govwayConfAuth
    And params query_params
    When method get
    Then status 200
...
Scenario Outline: SpecificaSemiformale Erogazioni Get 200 OK
    ...
    * match response.items[0].allegato.documento == '#notpresent'
    ...
    Given url configUrl
    And path erogazione_petstore_path + '/allegati' , allegato_specificasemiformale.allegato.nome
    And header Authorization = govwayConfAuth
    And params query_params
    When method get
    Then status 200
...
Scenario Outline: SpecificaLivelloServizio Erogazioni Get 200 OK
    ...
    * match response.items[0].allegato.documento == '#notpresent'
    ...
    Given url configUrl
    And path erogazione_petstore_path + '/allegati' , allegato_specificalivelloservizio.allegato.nome
    And header Authorization = govwayConfAuth
    And params query_params
    When method get
    Then status 200
...
Scenario Outline: SpecificaSicurezza Erogazioni Get 200 OK
    ...
    * match response.items[0].allegato.documento == '#notpresent'
    ...
    Given url configUrl
    And path erogazione_petstore_path + '/allegati' , allegato_specificasicurezza.allegato.nome
    And header Authorization = govwayConfAuth
    And params query_params
    When method get
    Then status 200
...
Scenario Outline: Erogazioni Download SpecificaSemiformale
    ...
    * call create ({ resourcePath: 'api', body: api_petstore })
    * call create ({ resourcePath: 'erogazioni', body: erogazione_petstore })
    * call create ({ resourcePath: erogazione_petstore_path + '/allegati', body: allegato_specificasemiformale })

    * def allegatoDecodificato = call decodeBase64 allegato_specificasemiformale.allegato.documento

    Given url configUrl
    And path erogazione_petstore_path, "allegati", allegato_specificasemiformale.allegato.nome, 'download'
    And header Authorization = govwayConfAuth
    When method get
    Then status 200
...
Scenario Outline: Erogazioni Download SpecificaLivelloServizio
    ...
    * call create ({ resourcePath: 'api', body: api_petstore })
    * call create ({ resourcePath: 'erogazioni', body: erogazione_petstore })
    * call create ({ resourcePath: erogazione_petstore_path + '/allegati', body: allegato_specificalivelloservizio })

    * def allegatoDecodificato = call decodeBase64 allegato_specificalivelloservizio.allegato.documento

    Given url configUrl
    And path erogazione_petstore_path, "allegati", allegato_specificalivelloservizio.allegato.nome, 'download'
    And header Authorization = govwayConfAuth
    When method get
    Then status 200
    And match responseHeaders contains { 'Content-Type': ['<content_type>'] }
...
Scenario Outline: Erogazioni Download SpecificaSicurezza
    ...
    * call create ({ resourcePath: 'api', body: api_petstore })
    * call create ({ resourcePath: 'erogazioni', body: erogazione_petstore })
    * call create ({ resourcePath: erogazione_petstore_path + '/allegati', body: allegato_specificasicurezza })

    * def allegatoDecodificato = call decodeBase64 allegato_specificasicurezza.allegato.documento

    Given url configUrl
    And path erogazione_petstore_path, "allegati", allegato_specificasicurezza.allegato.nome, 'download'
    And header Authorization = govwayConfAuth
    When method get
    Then status 200
    And match responseHeaders contains { 'Content-Type': ['<content_type>'] }

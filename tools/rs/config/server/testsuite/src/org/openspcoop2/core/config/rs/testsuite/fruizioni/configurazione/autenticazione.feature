Feature: Configurazione Autenticazione Fruizioni
...
@Autenticazione
Scenario: Configurazione Autenticazione Fruizioni

    * call create ({ resourcePath: 'api', body: api_petstore })
    * call create ({ resourcePath: 'soggetti', body: erogatore })
    * call create ({ resourcePath: 'fruizioni', body: fruizione_petstore })

    * def conf = call read('classpath:servizi-configurazione/autenticazione.feature') ({servizio_path: fruizione_petstore_path })

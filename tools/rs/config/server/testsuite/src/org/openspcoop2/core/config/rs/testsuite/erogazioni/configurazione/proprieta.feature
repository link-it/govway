Feature: Configurazione Erogazioni Proprieta
...
Scenario: Configurazione Proprieta
    ...
    * def conf = call read('classpath:servizi-configurazione/proprieta.feature') ({servizio_path: erogazione_petstore_path })

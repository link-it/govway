Feature: Configurazione Erogazioni Caching Risposta
...
@Validazione
Scenario: Configurazione Erogazioni Caching Risposta

    * call create ({ resourcePath: 'api', body: api_petstore })
    * call create ({ resourcePath: 'erogazioni', body: erogazione_petstore })

    * def conf = call read('classpath:servizi-configurazione/caching-risposta.feature') ({servizio_path: erogazione_petstore_path })

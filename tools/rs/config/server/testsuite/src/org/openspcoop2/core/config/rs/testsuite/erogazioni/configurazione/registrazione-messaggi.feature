Feature: Configurazione Registrazione Messaggi Erogazioni
...
@GestioneToken
Scenario: Configurazione Registrazione Messaggi Erogazioni

    * call create ({ resourcePath: 'api', body: api_petstore })
    * call create ({ resourcePath: 'erogazioni', body: erogazione_petstore })

    * def conf = call read('classpath:servizi-configurazione/registrazione-messaggi.feature') ({servizio_path: erogazione_petstore_path })

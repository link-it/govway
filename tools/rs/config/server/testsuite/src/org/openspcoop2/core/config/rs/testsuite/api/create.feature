...
* def api_openapi3_1 = read('api_openapi3_1.json')
* eval randomize(api_openapi3_1, ["nome"])
...
@CreateOpenAPI3_1_201
Scenario: Api OpenAPI 3.1 Create 201
    * call create_201 ( { resourcePath: 'api', body: api_openapi3_1, key: api_openapi3_1.nome + '/' + api_openapi3_1.versione } )

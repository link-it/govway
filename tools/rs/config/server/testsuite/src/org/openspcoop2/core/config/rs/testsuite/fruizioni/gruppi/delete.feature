Feature: Delete Gruppi Fruizioni
...
@Delete204
Scenario: Delete Gruppi Fruizioni 204
    
    * call create ({ resourcePath: 'api', body: api_petstore })
    * call create ({ resourcePath: 'soggetti', body: erogatore })
    * call create ({ resourcePath: 'fruizioni', body: fruizione_petstore })
    
    * call delete_204 ( { resourcePath: fruizione_petstore_path + '/gruppi', body: gruppo_petstore, key: gruppo_petstore.nome } )
...
@Delete404
Scenario: Delete Gruppi Fruizioni 404

    * call create ({ resourcePath: 'api', body: api_petstore })
    * call create ({ resourcePath: 'soggetti', body: erogatore })
    * call create ({ resourcePath: 'fruizioni', body: fruizione_petstore })

    * call delete_404 ( { resourcePath: fruizione_petstore_path + '/gruppi' , key: gruppo_petstore.nome } )

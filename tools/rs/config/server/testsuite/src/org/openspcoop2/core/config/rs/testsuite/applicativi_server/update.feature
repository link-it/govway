...
|connettore_applicativo_server_status_empty.json|
|connettore_applicativo_server_status_verifica_statistica.json|
|connettore_applicativo_server_status_verifica_statistica_custom_lifetime.json|

Feature: Configurazione Registrazione Diagnostici Erogazioni
...
@GestioneDiagnostici
Scenario: Configurazione Registrazione Diagnostici Erogazioni

    * call create ({ resourcePath: 'api', body: api_petstore })
    * call create ({ resourcePath: 'erogazioni', body: erogazione_petstore })

    * def conf = call read('classpath:servizi-configurazione/diagnostica.feature') ({servizio_path: erogazione_petstore_path })

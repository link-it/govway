Feature: Delete Gruppi Erogazioni
...
@Delete204
Scenario: Delete Gruppi Erogazioni 204
    
    * call create ({ resourcePath: 'api', body: api_petstore })
    * call create ({ resourcePath: 'erogazioni', body: erogazione_petstore })
    
    * call delete_204 ( { resourcePath: erogazione_petstore_path + '/gruppi', body: gruppo_petstore, key: gruppo_petstore.nome } )
    
    * call delete ({ resourcePath: erogazione_petstore_path })
    * call delete ({ resourcePath: api_petstore_path })

@Delete404
Scenario: Delete Gruppi Erogazioni 404
    
    * call create ({ resourcePath: 'api', body: api_petstore })
    * call create ({ resourcePath: 'erogazioni', body: erogazione_petstore })
    
    * call delete_404 ( { resourcePath: erogazione_petstore_path + '/gruppi' , key: gruppo_petstore.nome } )

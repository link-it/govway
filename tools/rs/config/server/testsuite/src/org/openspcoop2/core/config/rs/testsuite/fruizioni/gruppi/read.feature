Feature: Lettura Gruppi Fruizioni
...
@FindAll200
Scenario: Gruppi Fruizioni FindAll 200 OK

    * call create ({ resourcePath: 'api', body: api_petstore })
    * call create ({ resourcePath: 'soggetti', body: erogatore })
    * call create ({ resourcePath: 'fruizioni', body: fruizione_petstore })
    
    * call findall_200 ( { resourcePath: fruizione_petstore_path + '/gruppi', body: gruppo_petstore, key: gruppo_petstore.nome})
...
@Get200
Scenario: Gruppi Fruizioni Get 200 OK
    ...
    * call get_200 ( { resourcePath: fruizione_petstore_path + '/gruppi', body: gruppo_petstore, key: gruppo_petstore.nome})
...
@Get404
Scenario: Gruppi Fruizioni Get 404

    * call get_404 ({ resourcePath: fruizione_petstore_path + '/gruppi/' + gruppo_petstore.nome })

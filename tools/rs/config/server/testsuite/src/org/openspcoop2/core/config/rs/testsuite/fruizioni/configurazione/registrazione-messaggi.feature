Feature: Configurazione Registrazione Messaggi Fruizioni
...
@TestGestioneToken
Scenario: Configurazione Registrazione Messaggi Fruizioni

    * call create ({ resourcePath: 'api', body: api_petstore })
    * call create ({ resourcePath: 'soggetti', body: erogatore })
    * call create ({ resourcePath: 'fruizioni', body: fruizione_petstore })

    * def conf = call read('classpath:servizi-configurazione/registrazione-messaggi.feature') ({servizio_path: fruizione_petstore_path })

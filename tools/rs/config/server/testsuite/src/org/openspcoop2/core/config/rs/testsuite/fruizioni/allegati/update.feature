...
Scenario Outline: SpecificaSemiformale Update 204
    ...
    * call update_204 ( { resourcePath: fruizione_petstore_path + '/allegati', body: allegato_specificasemiformale_src, body_update: allegato_specificasemiformale, key: allegato_specificasemiformale_src.allegato.nome, delete_key: allegato_specificasemiformale.allegato.nome } )
...
Scenario Outline: SpecificaLivelloServizio Update 204
    ...
    * call update_204 ( { resourcePath: fruizione_petstore_path + '/allegati', body: allegato_specificalivelloservizio_src, body_update: allegato_specificalivelloservizio, key: allegato_specificalivelloservizio_src.allegato.nome, delete_key: allegato_specificalivelloservizio.allegato.nome } )
...
Scenario Outline: SpecificaSicurezza Update 204
    ...
    * call update_204 ( { resourcePath: fruizione_petstore_path + '/allegati', body: allegato_specificasicurezza_src, body_update: allegato_specificasicurezza, key: allegato_specificasicurezza_src.allegato.nome, delete_key: allegato_specificasicurezza.allegato.nome } )

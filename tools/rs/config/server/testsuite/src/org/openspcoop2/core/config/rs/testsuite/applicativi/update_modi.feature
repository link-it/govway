...
Scenario Outline: Applicativi modi esterno Creazione 204 OK
    ...
    * call put ({ resourcePath: 'applicativi/'+applicativo_https_certificate.nome, body_update: applicativo_update, query_params: query_param_applicativi})
...
Scenario Outline: Applicativi modi interno Creazione 204 OK
    ...
    * call put ({ resourcePath: 'applicativi/'+applicativo_interno.nome, body_update: applicativo_update, query_params: query_param_applicativi})
    * call get ({ resourcePath: 'applicativi', key: applicativo_interno.nome , query_params: query_param_applicativi})
    * match response.modi == getExpectedInterno(applicativo_update)

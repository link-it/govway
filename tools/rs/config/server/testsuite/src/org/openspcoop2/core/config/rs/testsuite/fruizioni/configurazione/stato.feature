Feature: Configurazione Stato Fruizioni
...
@Stato
Scenario: Gestione CORS

    * call create ({ resourcePath: 'api', body: api_petstore })
    * call create ({ resourcePath: 'soggetti', body: erogatore })
    * call create ({ resourcePath: 'fruizioni', body: fruizione_petstore })

    * def conf = call read('classpath:servizi-configurazione/stato.feature') ({servizio_path: fruizione_petstore_path })

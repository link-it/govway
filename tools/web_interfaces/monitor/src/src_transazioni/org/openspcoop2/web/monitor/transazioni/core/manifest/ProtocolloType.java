 ...
 *       &lt;sequence>
 *         &lt;element name="fruitore" type="{http://www.link.it/pdd/monitor/web/pddmonitor/transazioni/core/manifest}soggetto_type" minOccurs="0"/>
 *         &lt;element name="erogatore" type="{http://www.link.it/pdd/monitor/web/pddmonitor/transazioni/core/manifest}soggetto_type" minOccurs="0"/>
...
@XmlType(name = "protocollo_type", namespace = "http://www.link.it/pdd/monitor/web/pddmonitor/transazioni/core/manifest", propOrder = {
    "fruitore",
    "erogatore",
    "servizio",
    "azione",
...
public class ProtocolloType {
    ...
    @XmlElement(name = "id-messaggio-richiesta", namespace = "http://www.link.it/pdd/monitor/web/pddmonitor/transazioni/core/manifest")
    protected String idMessaggioRichiesta;
    @XmlElement(name = "id-messaggio-risposta", namespace = "http://www.link.it/pdd/monitor/web/pddmonitor/transazioni/core/manifest")
    protected String idMessaggioRisposta;
    @XmlElement(name = "data-id-msg-richiesta", namespace = "http://www.link.it/pdd/monitor/web/pddmonitor/transazioni/core/manifest")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar dataIdMsgRichiesta;
    @XmlElement(name = "data-id-msg-risposta", namespace = "http://www.link.it/pdd/monitor/web/pddmonitor/transazioni/core/manifest")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar dataIdMsgRisposta;
    @XmlElement(namespace = "http://www.link.it/pdd/monitor/web/pddmonitor/transazioni/core/manifest")
    protected ProtocolloType.Profilo profilo;
    @XmlElement(name = "id-collaborazione", namespace = "http://www.link.it/pdd/monitor/web/pddmonitor/transazioni/core/manifest")
    protected String idCollaborazione;
    @XmlElement(name = "uri-accordo-servizio", namespace = "http://www.link.it/pdd/monitor/web/pddmonitor/transazioni/core/manifest")
    protected String uriAccordoServizio;
    @XmlElement(name = "profilo-asincrono", namespace = "http://www.link.it/pdd/monitor/web/pddmonitor/transazioni/core/manifest")
    ...
    public static class ProfiloAsincrono {
        ...
        @XmlElement(name = "servizio-correlato", namespace = "http://www.link.it/pdd/monitor/web/pddmonitor/transazioni/core/manifest")

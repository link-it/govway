...
public class CostantiExport {
	...
	public static final String KEY_COL_DATA_INGRESSO_RICHIESTA_STREAM = "colDataIngRichStream";
	public static final String KEY_COL_DATA_USCITA_RICHIESTA = "colDataUscitaRich";
	public static final String KEY_COL_DATA_USCITA_RICHIESTA_STREAM = "colDataUscitaRichStream";
	...
	public static final String KEY_COL_DATA_INGRESSO_RISPOSTA_STREAM = "colDataInRispostaStream";
	public static final String KEY_COL_DATA_USCITA_RISPOSTA = "colDataOutRisposta";
	public static final String KEY_COL_DATA_USCITA_RISPOSTA_STREAM = "colDataOutRispostaStream";
	...
	public static final String LABEL_COL_DATA_INGRESSO_RICHIESTA = "Data Ingresso Richiesta in Ricezione";
	public static final String LABEL_COL_DATA_INGRESSO_RICHIESTA_STREAM = "Data Ingresso Richiesta Acquisita";
	public static final String LABEL_COL_DATA_USCITA_RICHIESTA = "Data Uscita Richiesta in Spedizione";
	public static final String LABEL_COL_DATA_USCITA_RICHIESTA_STREAM = "Data Uscita Richiesta Consegnata";
	public static final String LABEL_COL_DATA_ACCETTAZIONE_RISPOSTA = "Data Accettazione Risposta";
	public static final String LABEL_COL_DATA_INGRESSO_RISPOSTA = "Data Ingresso Risposta in Ricezione";
	public static final String LABEL_COL_DATA_INGRESSO_RISPOSTA_STREAM = "Data Ingresso Risposta Acquisita";
	public static final String LABEL_COL_DATA_USCITA_RISPOSTA = "Data Uscita Risposta Consegnata"; // volutamente invertiti
	public static final String LABEL_COL_DATA_USCITA_RISPOSTA_STREAM = "Data Uscita Risposta in Spedizione";
	...
	public static final String LABEL_COL_LATENZA_SERVIZIO = "Tempo Risposta Servizio";

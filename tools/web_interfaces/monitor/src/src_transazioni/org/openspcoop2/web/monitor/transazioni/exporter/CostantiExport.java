...
public class CostantiExport {
	...
	public static final String LABEL_COL_PDD_CODICE = "PdD (ID)";
	public static final String LABEL_COL_PDD_SOGGETTO = "PdD (Soggetto)";
	...
	public static final String LABEL_COL_ID_PORTA_SOGGETTO_FRUITORE = "Fruitore (ID PdD)";
	...
	public static final String LABEL_COL_ID_PORTA_SOGGETTO_EROGATORE = "Erogatore (ID PdD)";
	...
	public static final String LABEL_COL_LATENZA_PORTA = "Latenza Porta";

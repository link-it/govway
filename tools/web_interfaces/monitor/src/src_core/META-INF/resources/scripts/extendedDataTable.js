...
// Disabilita il limite massimo di larghezza colonna durante il drag-resize
// dell'ExtendedDataTable (comportamento richiesto dal monitor: nessun cap).
if (typeof ExtendedDataTable !== "undefined"
    && ExtendedDataTable.DataTable
    && ExtendedDataTable.DataTable.header) {
    ExtendedDataTable.DataTable.header.prototype.disableMaxDelta = true;
}

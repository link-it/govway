 ...
 *
 */
public class DynamicUtilsServiceCacheJmxDatiConfigurazione extends AbstractCacheJmx {

	@Override
	public AbstractCacheWrapper getCacheWrapper() {
		return AbstractConsoleStartupListener.dynamicUtilsServiceCache_datiConfigurazione;
	}

	@Override
	public String getJmxDescription() {
		return "Configurazioni di supporto alle maschere di ricerca";
	}

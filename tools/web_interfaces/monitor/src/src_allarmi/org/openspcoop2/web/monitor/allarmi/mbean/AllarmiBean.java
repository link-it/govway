...
//			this.criteriAckDialogInfo.setContenuto(this.getModificaCriteriAck());
			StringBuilder sb = new StringBuilder();
			sb.append("<p><span>Il file fornito deve rispettare la sintassi del template engine 'Freemarker'.<br>È possiile accedere ai seguenti oggetti resi disponibili a runtime dal Gateway:</span><br></p><ul><li><b>header</b>: headers http (java.util.Map&lt;String, String&gt;)</li><li><b>query</b>: parametri della url (java.util.Map&lt;String, String&gt;)</li><li><b>form</b>: parametri della form (java.util.Map&lt;String, String&gt;)</li><li><b>xPath</b>: fornisce metodi per verificare la presenza o estrarre informazioni da messaggi XML tramite espressioni XPath (org.openspcoop2.pdd.core.dynamic.PatternExtractor)</li><li><b>jsonPath</b>: fornisce metodi per verificare la presenza o estrarre informazioni da messaggi JSON tramite espressioni JSONPath (org.openspcoop2.pdd.core.dynamic.PatternExtractor)</li><li><b>urlRegExp</b>: fornisce metodi per verificare la presenza o estrarre informazioni dalla url tramite espressioni regolari (org.openspcoop2.pdd.core.dynamic.URLRegExpExtractor)</li><li><b>transactionId</b>: identificativo UUID della transazione (java.lang.String)</li><li><b>date</b>: data di elaborazione del messaggio (java.util.Date)</li><li><b>busta</b>: informazioni generiche del profilo (org.openspcoop2.protocol.sdk.Busta)</li><li><b>property</b>: permette di riferire informazioni specifiche del profilo presenti nella traccia (java.util.Map&lt;String, String&gt;)</li><li><b>context</b>: permette di accedere al contesto della richiesta (java.util.Map&lt;String, Object&gt;)</li><li><b>tokenInfo</b>: permette di accedere ai claims di un token (org.openspcoop2.pdd.core.token.InformazioniToken)</li><li><b>aa</b>: permette di accedere agli attributi recuperati tramite Attribute Authority (org.openspcoop2.pdd.core.token.attribute_authority.InformazioniAttributi)</li><li><b>transportContext</b>: permette di accedere ai dati della richiesta http (org.openspcoop2.utils.transport.http.HttpServletTransportRequestContext)</li><li><b>config</b>: permette di accedere alle proprietà configurate per l'API (java.util.Map&lt;String, String&gt;)</li><li><b>clientApplicationConfig</b>: permette di accedere alle proprietà configurate nell'applicativo client (java.util.Map&lt;String, String&gt;)</li><li><b>clientOrganizationConfig</b>: permette di accedere alle proprietà configurate nel soggetto fruitore(java.util.Map&lt;String, String&gt;)</li><li><b>providerOrganizationConfig</b>: permette di accedere alle proprietà configurate nel soggetto erogatore (java.util.Map&lt;String, String&gt;)</li><li><b>request</b>: permette di accedere al contenuto della richiesta (org.openspcoop2.pdd.core.dynamic.ContentExtractor)</li><li><b>errorHandler</b>: permette di generare risposte personalizzate che segnalano l'impossibilità di proseguire la trasformazione (org.openspcoop2.pdd.core.dynamic.ErrorHandler)</li><li><b>headerValues</b>: headers http (java.util.Map&lt;String, List&lt;String&gt;&gt;)</li><li><b>queryValues</b>: parametri della url (java.util.Map&lt;String, List&lt;String&gt;&gt;)</li><li><b>formValues</b>: parametri della form (java.util.Map&lt;String, List&lt;String&gt;&gt;)</li><li><b>system</b>: permette di accedere alle proprietà di sistema indicate nella configurazione generale (org.openspcoop2.pdd.core.dynamic.PropertiesReader)</li><li><b>env</b>: permette di accedere alle variabili di sistema (org.openspcoop2.pdd.core.dynamic.PropertiesReader)</li><li><b>java</b>: permette di accedere alle variabili della jvm (org.openspcoop2.pdd.core.dynamic.PropertiesReader)</li><li><b>class</b>: permette di definire classi (es. class[\"org.apache.commons.lang.StringUtils\"] ).</li><li><b>new</b>: permette di istanziare una classe (es. new(\"java.lang.StringBuilder\",\"Commento Iniziale\") ).</li></ul><p></p>");
//			sb.append("<p><span>Espressione da applicare sul messaggio di richiesta; se si ha un match la regola di trasformazione verrà utilizzata.<br>I tipi di espressione utilizzabili sono:</span><br></p><ul><li><b>XPath</b>: utilizzabile con messaggi XML</li><li><b>JSONPath</b>: utilizzabile con messaggi JSON</li></ul><p></p>");
			this.criteriAckDialogInfo.setBody(sb.toString());
		}

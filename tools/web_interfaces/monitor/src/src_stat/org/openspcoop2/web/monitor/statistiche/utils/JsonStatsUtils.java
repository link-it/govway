...
//			long altri_sum_serie1=0;
	...
	private static String buildKeyAsseYJsonHeatmapChartDistribuzione(ResDistribuzione res) {
		if(res instanceof ResDistribuzione3D resD3D) {
			Date data = resD3D.getData();
			return data!=null ? Long.toString(data.getTime()) : "";
		}
		else if(res instanceof ResDistribuzione3DCustom resD3DCustom) {
			String datoCustom = resD3DCustom.getDatoCustom();

...
BaseStatsMBean<T, Integer, IService<ResBase, Integer>> {
	...
	public void newSearch(ActionEvent ae) {
		...
		DistribuzionePerErroriBean<ResDistribuzione> ab = new DistribuzionePerErroriBean<>();
	...
	private String esportaCsvEngine(HttpServletResponse responseParam, boolean useFaceContext) throws ServiceException, NotFoundException {
		...
		try {	
			...
			ReportDataSource report = ExportUtils.creaReportDistribuzione(list, titoloReport, log, tipoVisualizzazione, 

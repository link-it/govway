...
public enum DimensioneCustom implements IEnumeration , Serializable , Cloneable{
	...
	TOKEN_USERNAME ("tokenUsername"), TOKEN_EMAIL ("tokenEMail"), 
	TOKEN_PDND_ORGANIZATION ("tokenPdndOrganization"), TOKEN_PDND_ORGANIZATION_EXTERNAL_ID ("tokenPdndOrganizationExternalId"), TOKEN_PDND_ORGANIZATION_CONSUMER_ID ("tokenPdndOrganizationConsumerId"),
	PRINCIPAL ("principal"),

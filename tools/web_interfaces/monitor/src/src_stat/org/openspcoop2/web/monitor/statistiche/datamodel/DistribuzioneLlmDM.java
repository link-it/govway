 ...
 *
 */
public class DistribuzioneLlmDM extends BaseDataModel<String, ResDistribuzione, IStatisticheGiornaliere> {
	...
	public int getRowCount() {
		try {
			...
			int count = this.getDataProvider().countAllDistribuzioneLlm();
			if(count > 0)
				this.visualizzaComandiExport = true;
			return count;
		} catch (ServiceException e) {
			DistribuzioneLlmDM.log.error(e.getMessage(), e);
			return 0;
		}
	}

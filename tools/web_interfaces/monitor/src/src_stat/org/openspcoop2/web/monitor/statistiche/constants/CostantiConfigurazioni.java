...
public class CostantiConfigurazioni {
	...
	public static final String LABEL_STATUS_RESPONSE_TYPE = "Tipo Risposta";
	public static final String LABEL_STATUS_PERIOD = "Verifica Statistica";
	public static final String LABEL_STATUS_PERIOD_VALUE = "Intervallo Osservazione";
	public static final String LABEL_STATUS_TEST_CONNECTIVITY = "Verifica Connettività";
	public static final String LABEL_STATUS_STAT_LIFETIME = "Cache Life Time";
	...
	public static final String LABEL_AUTORIZZAZIONE_TRASPORTO_RUOLI_STATO = "Autorizzazione Trasporto (Ruoli)";
	public static final String LABEL_AUTORIZZAZIONE_TRASPORTO_RUOLI_RICHIESTI = "Autorizzazione Trasporto (Ruoli Richiesti)";
	public static final String LABEL_AUTORIZZAZIONE_TRASPORTO_RUOLI_AUTORIZZATI = "Autorizzazione Trasporto (Ruoli Autorizzati)";
	public static final String LABEL_AUTORIZZAZIONE_TOKEN_RUOLI_STATO = "Autorizzazione Token (Ruoli)";
	public static final String LABEL_AUTORIZZAZIONE_TOKEN_RUOLI_RICHIESTI = "Autorizzazione Token (Ruoli Richiesti)";
	public static final String LABEL_AUTORIZZAZIONE_TOKEN_RUOLI_AUTORIZZATI = "Autorizzazione Token (Ruoli Autorizzati)";
	public static final String LABEL_AUTORIZZAZIONE_TOKEN_CLAIMS = "Autorizzazione Token (Claims)";
	public static final String LABEL_AUTORIZZAZIONE_TRASPORTO_RICHIEDENTI_AUTORIZZATI_STATO = "Autorizzazione Trasporto (Richiedenti)";
	public static final String LABEL_AUTORIZZAZIONE_TRASPORTO_RICHIEDENTI_APPLICATIVI_AUTORIZZATI = "Autorizzazione Trasporto (Applicativi Autorizzati)";
	public static final String LABEL_AUTORIZZAZIONE_TRASPORTO_RICHIEDENTI_SOGGETTI_AUTORIZZATI = "Autorizzazione Trasporto (Soggetti Autorizzati)";
	public static final String LABEL_AUTORIZZAZIONE_TOKEN_RICHIEDENTI_AUTORIZZATI_STATO = "Autorizzazione Token (Richiedenti)";
	public static final String LABEL_AUTORIZZAZIONE_TOKEN_RICHIEDENTI_APPLICATIVI_AUTORIZZATI = "Autorizzazione Token (Applicativi Autorizzati)";
	public static final String LABEL_RUOLI_RICHIESTI = "Ruoli Richiesti";
	public static final String LABEL_AUTORIZZAZIONE_SCOPE_STATO = "Autorizzazione Token (Scope)";
	...
	public static final String LABEL_CONNETTORE_API_KEY = "Connettore (API Key)";
	public static final String LABEL_CONNETTORE_APP_ID = "Connettore (App Id)";

...
public class CostantiConfigurazioni {
	...
	public static final String LABEL_AUTORIZZAZIONE_TRASPORTO_RICHIEDENTI_AUTORIZZATI_STATO = "Autorizzazione Trasporto (Richiedenti Autorizzati)";
	public static final String LABEL_AUTORIZZAZIONE_TOKEN_RICHIEDENTI_AUTORIZZATI_STATO = "Autorizzazione Token (Richiedenti Autorizzati)";

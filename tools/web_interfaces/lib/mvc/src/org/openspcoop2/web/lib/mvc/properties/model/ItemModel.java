...
public class ItemModel extends AbstractModel<Item> {
	...
	public ItemModel(){
		...
		this.CONDITIONS = new org.openspcoop2.web.lib.mvc.properties.model.ConditionsModel(new Field("conditions",org.openspcoop2.web.lib.mvc.properties.Conditions.class,"item",Item.class));
		this.VALUES = new org.openspcoop2.web.lib.mvc.properties.model.ItemValuesModel(new Field("values",org.openspcoop2.web.lib.mvc.properties.ItemValues.class,"item",Item.class));
		this.PROPERTY = new org.openspcoop2.web.lib.mvc.properties.model.PropertyModel(new Field("property",org.openspcoop2.web.lib.mvc.properties.Property.class,"item",Item.class));
	...
	public ItemModel(IField father){
		...
		this.CONDITIONS = new org.openspcoop2.web.lib.mvc.properties.model.ConditionsModel(new ComplexField(father,"conditions",org.openspcoop2.web.lib.mvc.properties.Conditions.class,"item",Item.class));
		this.VALUES = new org.openspcoop2.web.lib.mvc.properties.model.ItemValuesModel(new ComplexField(father,"values",org.openspcoop2.web.lib.mvc.properties.ItemValues.class,"item",Item.class));
		this.PROPERTY = new org.openspcoop2.web.lib.mvc.properties.model.PropertyModel(new ComplexField(father,"property",org.openspcoop2.web.lib.mvc.properties.Property.class,"item",Item.class));
	...
	public org.openspcoop2.web.lib.mvc.properties.model.ConditionsModel CONDITIONS = null;
	 
	public org.openspcoop2.web.lib.mvc.properties.model.ItemValuesModel VALUES = null;
	 
	public org.openspcoop2.web.lib.mvc.properties.model.PropertyModel PROPERTY = null;

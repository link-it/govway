 ...
 * 		&lt;sequence>
 * 			&lt;element name="properties" type="{http://www.openspcoop2.org/web/lib/mvc/properties}properties" minOccurs="0" maxOccurs="1"/>
 * 			&lt;element name="section" type="{http://www.openspcoop2.org/web/lib/mvc/properties}section" minOccurs="1" maxOccurs="unbounded"/>
 * 		&lt;/sequence>
...
public class Config extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  ...
  private static org.openspcoop2.web.lib.mvc.properties.model.ConfigModel modelStaticInstance = null;
  private static synchronized void initModelStaticInstance(){
	  if(org.openspcoop2.web.lib.mvc.properties.Config.modelStaticInstance==null){
  			org.openspcoop2.web.lib.mvc.properties.Config.modelStaticInstance = new org.openspcoop2.web.lib.mvc.properties.model.ConfigModel();
	  }
  }
  public static org.openspcoop2.web.lib.mvc.properties.model.ConfigModel model(){
	  if(org.openspcoop2.web.lib.mvc.properties.Config.modelStaticInstance==null){
	  		initModelStaticInstance();
	  }
	  return org.openspcoop2.web.lib.mvc.properties.Config.modelStaticInstance;
  }

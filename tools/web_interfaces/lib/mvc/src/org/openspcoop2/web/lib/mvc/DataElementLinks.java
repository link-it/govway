...
public class DataElementLinks implements Serializable {
	...
	public String getBodyHtml() {
		...
		if(StringUtils.isNotEmpty(this.headerBody)) {
			sb.append("<p><span>").append(StringEscapeUtils.escapeHtml4(this.headerBody)).append("</span></p>");
		}
		...
		for (DataElementLink link : this.links) {
			...
			sb.append(">").append(StringEscapeUtils.escapeHtml4(link.getLabel())).append("</a></li>");
		}
		sb.append("</ul>");

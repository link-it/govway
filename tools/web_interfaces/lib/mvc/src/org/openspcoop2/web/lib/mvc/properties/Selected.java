...
/** <p>Java class for selected complex type.
 * 
...
@XmlType(name = "selected")

@XmlRootElement(name = "selected")

public class Selected extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  public Selected() {
  }

...
public class Item extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  ...
  public org.openspcoop2.web.lib.mvc.properties.constants.ItemType getType() {
    return this.type;
  }

  public void setType(org.openspcoop2.web.lib.mvc.properties.constants.ItemType type) {
    this.type = type;
  }

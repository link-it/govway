...
public class AuditCostanti {
	...
	public static final List<String> SERVLET_AUDIT  = new ArrayList<>();
	static{
	...
	public static final List<String> SERVLET_AUDIT_FILTRI = new ArrayList<>();
	static{
	...
	public static final List<String> SERVLET_AUDITING  = new ArrayList<>();
	static{
	...
	public static final List<String> SERVLET_AUDITING_DETTAGLIO  = new ArrayList<>();
	static{
	...
	public static final String DEFAULT_VALUE_PARAMETRO_AUDIT_APPENDER_PROPERTY_FILE_CONFIGURAZIONE_NAME_LOADER_INSTANCE = "nomeFileLoaderInstance";
	public static final String DEFAULT_VALUE_PARAMETRO_AUDIT_APPENDER_PROPERTY_FILE_CONFIGURAZIONE_VALUE_LOADER_INSTANCE = "audit_local.log4j2.properties";
	public static final String DEFAULT_VALUE_PARAMETRO_AUDIT_APPENDER_PROPERTY_FILE_CONFIGURAZIONE_NAME_LOG_PROPERTIES = "nomeProprietaLoaderInstance";
	public static final String DEFAULT_VALUE_PARAMETRO_AUDIT_APPENDER_PROPERTY_FILE_CONFIGURAZIONE_VALUE_LOG_PROPERTIES = "OPENSPCOOP2_AUDIT_LOG_PROPERTIES";

...
INSERT INTO audit_appender_prop (name,value,id_audit_appender) VALUES ('datasource','org.govway.datasource.audit',(select id from audit_appender where name='dbAppender'));

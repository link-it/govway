...
INSERT INTO audit_appender_prop (name,value,id_audit_appender) VALUES ('fileConfigurazione','audit.log4j.properties',(select id from audit_appender where name='log4jAppender'));
INSERT INTO audit_appender_prop (name,value,id_audit_appender) VALUES ('nomeFileLoaderInstance','audit_local.log4j.properties',(select id from audit_appender where name='log4jAppender'));

...
/**
 * AccordiCooperazioneAddStrutsBean
 * 
 ...
 * 
 */
public class AccordiCooperazioneAddStrutsBean {

	protected String nome, descr, referente, versione;
	protected boolean privato;// showPrivato;
	protected String statoPackage;

	protected String editMode = null;

	protected String tipoProtocollo = null;
	// Protocol Properties

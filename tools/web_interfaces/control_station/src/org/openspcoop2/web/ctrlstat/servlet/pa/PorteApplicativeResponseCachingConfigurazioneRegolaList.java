...
/**
 * PorteApplicativeResponseCachingConfigurazioneRegolaList
 * 
 ...
 * 
 */
public final class PorteApplicativeResponseCachingConfigurazioneRegolaList extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			return ServletUtils.getStrutsForwardError(ControlStationCore.getLog(), e, pd, request, session, gd, mapping, 
					PorteApplicativeCostanti.OBJECT_NAME_PORTE_APPLICATIVE_RESPONSE_CACHING_CONFIGURAZIONE_REGOLA, ForwardParams.LIST());
		}
	}
}

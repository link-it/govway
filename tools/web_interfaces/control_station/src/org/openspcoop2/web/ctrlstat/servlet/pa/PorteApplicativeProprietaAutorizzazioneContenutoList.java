...
/**
 * PorteApplicativeProprietaAutorizzazioneContenutoList
 * 
 ...
 * 
 */
public final class PorteApplicativeProprietaAutorizzazioneContenutoList extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			List<Proprieta> lista = porteApplicativeCore.porteApplicativeAutorizzazioneContenutoCustomPropList(Integer.parseInt(idPorta), ricerca);

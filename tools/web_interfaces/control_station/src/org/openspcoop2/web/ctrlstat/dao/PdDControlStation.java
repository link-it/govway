...
public class PdDControlStation extends PortaDominio implements Serializable {
						...
						if (fields[i].getType().getName().startsWith(this.getClass().getPackage().getName())) {
							...
							if ("[B".equals(fields[i].getType().getName())) {
								...
								if ("java.util.Date".equals(fields[i].getType().getName())) {
									...
									checkUguaglianza = (calendarThis.get(java.util.Calendar.YEAR) == calendarObject.get(java.util.Calendar.YEAR)) && (calendarThis.get(java.util.Calendar.MONTH) == calendarObject.get(java.util.Calendar.MONTH)) && (calendarThis.get(java.util.Calendar.DAY_OF_MONTH) == calendarObject.get(java.util.Calendar.DAY_OF_MONTH)) && (calendarThis.get(java.util.Calendar.HOUR_OF_DAY) == calendarObject.get(java.util.Calendar.HOUR_OF_DAY)) && (calendarThis.get(java.util.Calendar.MINUTE) == calendarObject.get(java.util.Calendar.MINUTE)) && (calendarThis.get(java.util.Calendar.SECOND) == calendarObject.get(java.util.Calendar.SECOND));
								} else {
	...
	public Object clone() {
		...
		try {
			 ...
			 * l'interfaccia cloneable allora eseguo il metodo clone di quel
			 * field
			 */
			...
			if (fields != null && fields.length > 0) {
				for (int i = 0; i < fields.length; i++) {
					...
					for (int j = 0; j < interfacce.length; j++) {
						// se il field che sto controllando implementa
						// l'interfaccia cloneable e il field che voglio clonare
						// non e' null
						// richiamo il clone

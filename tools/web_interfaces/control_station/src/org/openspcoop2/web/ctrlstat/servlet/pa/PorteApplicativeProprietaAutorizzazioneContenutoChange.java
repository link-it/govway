 ...
 * 
 */
public final class PorteApplicativeProprietaAutorizzazioneContenutoChange extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			if (porteApplicativeHelper.isEditModeInProgress()) {
				...
				if(valore==null){
					for (int i = 0; i < pa.sizeProprietaAutorizzazioneContenutoList(); i++) {
						Proprieta ssp = pa.getProprietaAutorizzazioneContenuto(i);
			...
			boolean isOk = porteApplicativeHelper.proprietaAutorizzazioneContenutoCheckData(TipoOperazione.CHANGE, idPorta, nome, valore);
			if (!isOk) {
			...
			for (int i = 0; i < pa.sizeProprietaAutorizzazioneContenutoList(); i++) {
				Proprieta ssp = pa.getProprietaAutorizzazioneContenuto(i);
				if (nome.equals(ssp.getNome())) {
					pa.removeProprietaAutorizzazioneContenuto(i);
					break;
				}
			}

...
public class ConsoleProperties {	
	 ...
	 * leggendo le properties con prefisso {@link #SPEC_VALIDATOR_PREFIX}.
	 */
	 ...
	 * con fallback su {@link #SPEC_VALIDATOR_PREFIX}.
	 */
	...
	private ConsoleProperties(String confDir, String confPropertyName, String confLocalPathPrefix,Logger log) throws UtilsException {
		...
		while (specKeys.hasMoreElements()) {
			...
			if (key.startsWith(SPEC_VALIDATOR_PREFIX) || key.startsWith(SPEC_VALIDATOR_PREFIX_31)) {
				try {
		...
		this.specValidatorLibrary = parseLibrary(rawSpecProps.get(SPEC_VALIDATOR_PREFIX + "library"),
	...
	private static String resolveSpecValidatorProperty(Map<String, String> rawProps, OpenAPILibrary library, String suffix, boolean openApi31) {
		...
		return lookupSpecValidatorProperty(rawProps, SPEC_VALIDATOR_PREFIX, library, suffix);
	}
	 ...
	 *         I valori provengono dalle properties {@code api.openApi.specValidator.*}
	 ...
	 *         con fallback sulle properties 3.0 ({@code api.openApi.specValidator.*}).
	 */

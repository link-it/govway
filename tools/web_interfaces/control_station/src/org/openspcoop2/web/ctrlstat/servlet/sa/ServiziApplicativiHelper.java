...
//			String servizioApplicativoServer = this.getParameter(ConnettoriCostanti.PARAMETRO_CONNETTORE_ID_APPLICATIVO_SERVER);
	...
	public List<DataElement> addServizioApplicativoToDati(List<DataElement> dati, String oldNomeSA, String nome, String tipoENomeSoggetto, String fault, TipoOperazione tipoOperazione,  
...
//			}
	...
	private List<DataElement> creaEntryCustom(boolean multitenant, Boolean useIdSogg, boolean showProtocolli, boolean supportatoAutenticazioneApplicativiEsterni,
...
//				de.setRequired(true);
	...
	public boolean servizioApplicativoCredenzialiCertificatiCheckData(TipoOperazione tipoOperazione, long idProvOld, ServizioApplicativo saOld, int idxCertificato) throws Exception {
		try {
			...
			if(!promuoviInCorso && !aggiornatoCertificatoPrecaricato && cSelezionato!=null && saList!=null && saList.size()>0) {
				// dovrebbe essere 1 grazie al precedente controllo
				ServizioApplicativo saCheck = saList.get(0);

 ...
 * 
 */
public final class PorteApplicativeProprietaAutorizzazioneAdd extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			boolean isOk = porteApplicativeHelper.proprietaAutorizzazioneCheckData(TipoOperazione.ADD, idPorta, nome, valore);
			if (!isOk) {

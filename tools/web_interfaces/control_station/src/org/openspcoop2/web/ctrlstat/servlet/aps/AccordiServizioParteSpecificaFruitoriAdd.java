		...
		try {
			...
			if(ServletUtils.isEditModeInProgress(this.editMode)){
				...
				if(soggettiListVector.size()<=0){
					...
					pd.setMessage( ServletUtils.getMessageFromResourceBundle( session, "AccordiServizioParteSpecifica.AggiuntaFruitoriCompletata" ) , Costanti.MESSAGE_TYPE_INFO);	//AccordiServizioParteSpecificaCostanti.LABEL_AGGIUNTA_FRUITORI_COMPLETATA

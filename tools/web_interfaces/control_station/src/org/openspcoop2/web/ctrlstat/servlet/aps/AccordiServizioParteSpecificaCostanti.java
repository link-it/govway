...
public class AccordiServizioParteSpecificaCostanti {
	...
	public final static String LABEL_APS_DATI_INVOCAZIONE = "Dati Invocazione";
	public final static String LABEL_APS_DATI_INVOCAZIONE_DI = "Dati Invocazione di ";
	...
	public final static String PARAMETRO_APS_FRUITORE_VIEW_CONNETTORE_ONLY_MAPPING_ID =  "fruitoreViewConnettoreMapping";

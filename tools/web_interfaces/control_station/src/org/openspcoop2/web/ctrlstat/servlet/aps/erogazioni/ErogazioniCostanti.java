...
public class ErogazioniCostanti extends AccordiServizioParteSpecificaCostanti {
	...
	private final static String ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_XXX_NO_FRUITORI = "Rilevato 'Controllo degli Accessi', con autorizzazione "+CostantiControlStation.MESSAGGIO_ERRORE_XXX+" per richiedente, senza alcun fruitore registrato";
	public final static String ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_TRASPORTO_NO_FRUITORI = ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_XXX_NO_FRUITORI.replaceAll(CostantiControlStation.MESSAGGIO_ERRORE_XXX, CostantiControlStation.MESSAGGIO_ERRORE_TRASPORTO);
	public final static String ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_CANALE_NO_FRUITORI = ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_XXX_NO_FRUITORI.replaceAll(CostantiControlStation.MESSAGGIO_ERRORE_XXX, CostantiControlStation.MESSAGGIO_ERRORE_CANALE);
	public final static String ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_TOKEN_NO_FRUITORI = ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_XXX_NO_FRUITORI.replaceAll(CostantiControlStation.MESSAGGIO_ERRORE_XXX, CostantiControlStation.MESSAGGIO_ERRORE_TOKEN);
	public final static String ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_MESSAGGIO_NO_FRUITORI = ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_XXX_NO_FRUITORI.replaceAll(CostantiControlStation.MESSAGGIO_ERRORE_XXX, CostantiControlStation.MESSAGGIO_ERRORE_MESSAGGIO);
	
	private final static String ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_XXX_NO_RUOLI = "Rilevato 'Controllo degli Accessi', con autorizzazione "+CostantiControlStation.MESSAGGIO_ERRORE_XXX+" per ruoli, senza alcun ruolo registrato";
	public final static String ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_TRASPORTO_NO_RUOLI = ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_XXX_NO_RUOLI.replaceAll(CostantiControlStation.MESSAGGIO_ERRORE_XXX, CostantiControlStation.MESSAGGIO_ERRORE_TRASPORTO);
	public final static String ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_CANALE_NO_RUOLI = ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_XXX_NO_RUOLI.replaceAll(CostantiControlStation.MESSAGGIO_ERRORE_XXX, CostantiControlStation.MESSAGGIO_ERRORE_CANALE);
	public final static String ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_TOKEN_NO_RUOLI = ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_XXX_NO_RUOLI.replaceAll(CostantiControlStation.MESSAGGIO_ERRORE_XXX, CostantiControlStation.MESSAGGIO_ERRORE_TOKEN);
	public final static String ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_MESSAGGIO_NO_RUOLI = ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_XXX_NO_RUOLI.replaceAll(CostantiControlStation.MESSAGGIO_ERRORE_XXX, CostantiControlStation.MESSAGGIO_ERRORE_MESSAGGIO);
	
	public final static String ASPS_EROGAZIONI_ICONA_STATO_CONFIGURAZIONI_CONTROLLO_ACCESSO_AUTORIZZAZIONE_TOKEN_NO_SCOPE = "Rilevato 'Controllo degli Accessi', con autorizzazione token per scope, senza alcun scope registrato";

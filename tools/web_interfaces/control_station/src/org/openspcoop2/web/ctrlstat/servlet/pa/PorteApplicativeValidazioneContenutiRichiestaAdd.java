...
/**
 * PorteApplicativeValidazioneContenutiRichiestaAdd
 * 
 ...
 * 
 */
public class PorteApplicativeValidazioneContenutiRichiestaAdd extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			if (porteApplicativeHelper.isEditModeInProgress()) {
				...
				dati = porteApplicativeHelper.addValidazioneContenutiRichiestaToDati(dati, TipoOperazione.ADD, null, 
				...
				return ServletUtils.getStrutsForwardEditModeInProgress(mapping, PorteApplicativeCostanti.OBJECT_NAME_PORTE_APPLICATIVE_VALIDAZIONE_CONTENUTI_RICHIESTA,	ForwardParams.ADD());
			}
			
			
			boolean isOk = porteApplicativeHelper.validazioneContenutiRichiestaCheckData(TipoOperazione.ADD, null, false, pa.getId());
			...
			if (!isOk) {
				...
				return ServletUtils.getStrutsForwardEditModeCheckError(mapping, PorteApplicativeCostanti.OBJECT_NAME_PORTE_APPLICATIVE_VALIDAZIONE_CONTENUTI_RICHIESTA,	ForwardParams.ADD());
			}
			...
			pa.getValidazioneContenutiApplicativi().addRichiesta(richiesta);
			...
			return ServletUtils.getStrutsForwardEditModeFinished(mapping, PorteApplicativeCostanti.OBJECT_NAME_PORTE_APPLICATIVE_VALIDAZIONE_CONTENUTI_RICHIESTA, ForwardParams.ADD());


		} catch (Exception e) {
			return ServletUtils.getStrutsForwardError(ControlStationCore.getLog(), e, pd, session, gd, mapping, PorteApplicativeCostanti.OBJECT_NAME_PORTE_APPLICATIVE_VALIDAZIONE_CONTENUTI_RICHIESTA, ForwardParams.ADD());
		} 
	}
}

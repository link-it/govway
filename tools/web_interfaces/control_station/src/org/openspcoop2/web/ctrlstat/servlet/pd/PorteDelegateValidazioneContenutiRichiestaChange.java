...
/**
 * PorteDelegateValidazioneContenutiRichiestaChange
 * 
 ...
 * 
 */
public class PorteDelegateValidazioneContenutiRichiestaChange extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			int numeroPattern = porteDelegateCore.numeroPatternValidazioneContenutiRichiesta(idRichiesta);
			...
			if (porteDelegateHelper.isEditModeInProgress()) {
				...
				if(nome == null) {
					...
					if(soapAction == null) {
						if (validazioneContenutiApplicativiStato == null) {
							soapAction = PorteDelegateCostanti.DEFAULT_VALUE_PARAMETRO_PORTE_DELEGATE_VALIDAZIONE_ABILITATO;
						} else {
				...
				dati = porteDelegateHelper.addValidazioneContenutiRichiestaToDati(dati, TipoOperazione.CHANGE, oldRichiesta.getId()+"", 
				...
				return ServletUtils.getStrutsForwardEditModeInProgress(mapping, PorteDelegateCostanti.OBJECT_NAME_PORTE_DELEGATE_VALIDAZIONE_CONTENUTI_RICHIESTA,	ForwardParams.CHANGE());
			}
			
			boolean isOk = porteDelegateHelper.validazioneContenutiRichiestaCheckData(TipoOperazione.CHANGE, oldRichiesta, true, portaDelegata.getId());
			if (!isOk) {
				...
				return ServletUtils.getStrutsForwardEditModeCheckError(mapping, PorteDelegateCostanti.OBJECT_NAME_PORTE_DELEGATE_VALIDAZIONE_CONTENUTI_RICHIESTA,	ForwardParams.CHANGE());
			}
			...
			return ServletUtils.getStrutsForwardEditModeFinished(mapping, PorteDelegateCostanti.OBJECT_NAME_PORTE_DELEGATE_VALIDAZIONE_CONTENUTI_RICHIESTA,	ForwardParams.CHANGE());
		} catch (Exception e) {

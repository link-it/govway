...
public class PorteApplicativeGestioneCanale extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			// Preparo la lista
			pd.setMessage( ServletUtils.getMessageFromResourceBundle( session, "PorteApplicative.PorteApplicativeCanaleConSuccesso" ) , Costanti.MESSAGE_TYPE_INFO);	//PorteApplicativeCostanti.LABEL_PORTE_APPLICATIVE_CANALE_CON_SUCCESSO

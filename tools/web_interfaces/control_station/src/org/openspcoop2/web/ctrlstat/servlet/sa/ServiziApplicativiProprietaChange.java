...
/**
 * ServiziApplicativiProprietaChange
 * 
 ...
 * 
 */
public final class ServiziApplicativiProprietaChange extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			if (saHelper.isEditModeInProgress()) {
				...
				dati = saHelper.addProprietaToDati(TipoOperazione.CHANGE, saHelper.getSize(), nome, valore, dati);
			...
			boolean isOk = saHelper.serviziApplicativiProprietaCheckData(TipoOperazione.CHANGE);
			if (!isOk) {
				// setto la barra del titolo
				ServletUtils.setPageDataTitle(pd, lstParam);

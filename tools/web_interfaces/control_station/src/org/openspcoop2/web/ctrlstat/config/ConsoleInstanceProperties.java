...
class ConsoleInstanceProperties extends InstanceProperties {
	...
	ConsoleInstanceProperties(Properties reader,Logger log,String confDir) throws Exception{
		super(CostantiPdD.OPENSPCOOP2_LOCAL_HOME,reader, log);
		super.setLocalFileImplementation(CostantiControlStation.OPENSPCOOP2_CONSOLE_PROPERTIES, CostantiControlStation.OPENSPCOOP2_CONSOLE_LOCAL_PATH, confDir);
	}
}

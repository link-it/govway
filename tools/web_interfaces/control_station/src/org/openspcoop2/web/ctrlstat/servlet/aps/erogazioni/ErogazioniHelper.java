...
//					}
	...
	public Vector<Vector<DataElement>> addErogazioneToDati(Vector<Vector<DataElement>> datiPagina, TipoOperazione tipoOp,
		...
		if(gestioneErogatori)
			de.setUrl(AccordiServizioParteSpecificaCostanti.SERVLET_NAME_APS_PORTE_APPLICATIVE_LIST, pId, pNomeServizio, pTipoServizio, pIdsoggErogatore );
		if(gestioneFruitori)
			de.setUrl(AccordiServizioParteSpecificaCostanti.SERVLET_NAME_APS_FRUITORI_PORTE_DELEGATE_LIST,	pId, pIdSogg, pIdSoggettoErogatore, pNomeServizio, pTipoServizio, pIdFruitore);
		de.setValue("Risorse e gruppi");
		dati.addElement(de);
		...
		de.setValue("Modifica servizio");
		dati.addElement(de);
		
		// modifica url invocazione
		if(gestioneErogatori) {
			if(!isPddEsterna) {
				// url invocazione
				de = new DataElement();
				...
				de.setValue("Modifica "+ PorteApplicativeCostanti.LABEL_PARAMETRO_TITOLO_PORTE_APPLICATIVE_DATI_INVOCAZIONE);					
				dati.addElement(de);
				...
				de.setValue("Modifica "+ PorteApplicativeCostanti.LABEL_PARAMETRO_PORTE_APPLICATIVE_CONNETTORE);
				dati.addElement(de);
			}
		}

...
public class PorteDelegateTrasformazioniRichiestaHeaderChange extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			String idTrasformazioneRichiestaHeaderS = porteDelegateHelper.getParametroLong(PorteDelegateCostanti.PARAMETRO_PORTE_DELEGATE_ID_TRASFORMAZIONE_RICHIESTA_HEADER);
			...
			if (porteDelegateHelper.isEditModeInProgress()) {
				...
				dati = porteDelegateHelper.addTrasformazioneRichiestaHeaderToDati(TipoOperazione.CHANGE, protocollo, true, dati, idTrasformazioneS, idTrasformazioneRichiestaHeaderS, nome, tipo, valore, identificazione, apc.getServiceBinding());
			...
			porteDelegateHelper.preparePorteDelegateTrasformazioniRichiestaHeaderList(trasformazioneAggiornata.getId(), ricerca, lista); 

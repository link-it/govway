 ...
 * 
 */
public final class PorteDelegateProprietaAutenticazioneAdd extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			if (porteDelegateHelper.isEditModeInProgress()) {
				...
				dati = porteDelegateHelper.addProprietaAutenticazioneCustomToDati(dati, TipoOperazione.ADD, nome ,valore);
			...
			boolean isOk = porteDelegateHelper.proprietaAutenticazioneCheckData(TipoOperazione.ADD, idPorta, nome, valore);
			if (!isOk) {
				// setto la barra del titolo
				ServletUtils.setPageDataTitle(pd, lstParam);

...
public class ArchiviCostanti {
	...
	public static final String PARAMETRO_VALORE_ARCHIVI_ALLEGATO_TIPO_DOCUMENTO_ESTENSIONE_TEMPLATE_FREEMARKER = ".ftl";
	public static final String PARAMETRO_VALORE_ARCHIVI_ALLEGATO_TIPO_DOCUMENTO_ESTENSIONE_TEMPLATE_VELOCITY = ".vm"; //".vtl";
	public static final String PARAMETRO_VALORE_ARCHIVI_ALLEGATO_TIPO_DOCUMENTO_ESTENSIONE_TEMPLATE_GOVWAY = ".gwt";
	public static final String PARAMETRO_VALORE_ARCHIVI_ALLEGATO_TIPO_DOCUMENTO_ESTENSIONE_TEMPLATE_XSLT = ".xslt";

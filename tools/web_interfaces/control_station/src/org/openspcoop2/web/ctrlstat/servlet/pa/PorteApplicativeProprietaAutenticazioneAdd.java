 ...
 * 
 */
public final class PorteApplicativeProprietaAutenticazioneAdd extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			if (porteApplicativeHelper.isEditModeInProgress()) {
				...
				dati = porteApplicativeHelper.addProprietaAutenticazioneCustomToDati(dati, TipoOperazione.ADD, nome, valore);
			...
			boolean isOk = porteApplicativeHelper.proprietaAutenticazioneCheckData(TipoOperazione.ADD, idPorta, nome, valore);
			if (!isOk) {

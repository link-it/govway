	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			if (porteDelegateHelper.isEditModeInProgress()) {
				...
				dati = porteDelegateHelper.addTrasformazioneRichiestaUrlParameterToDati(TipoOperazione.ADD, dati, idTrasformazioneS, null, nome, tipo, valore);
			...
			if (isOk) {
				boolean giaRegistrato = porteDelegateCore.existsTrasformazioneRichiestaUrlParameter(Long.parseLong(id), idTrasformazione, nome, tipo);

 ...
 * 
 */
public final class ConfigurazioneTracciamentoAppenderAdd extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			if (ServletUtils.isEditModeInProgress(request)) {
				...
				dati = confHelper.addTipoTracciamentoAppenderToDati(TipoOperazione.ADD,
						ConfigurazioneCostanti.DEFAULT_VALUE_PARAMETRO_CONFIGURAZIONE_TIPO_TRACCIAMENTO, dati, null , 0);
			...
			boolean isOk = confHelper.tracciamentoAppenderCheckData(TipoOperazione.ADD);
			if (!isOk) {
				// setto la barra del titolo
				List<Parameter> lstParam = new ArrayList<Parameter>();
				...
				dati = confHelper.addTipoTracciamentoAppenderToDati(TipoOperazione.ADD,tipo, dati, null , 0);
			...
			return ServletUtils.getStrutsForwardError(ControlStationCore.getLog(), e, pd, session, gd, mapping, 
					ConfigurazioneCostanti.OBJECT_NAME_CONFIGURAZIONE_TRACCIAMENTO_APPENDER, ForwardParams.ADD());
		}
	}
}

...
public class ServiziApplicativiCostanti {
	...
	public final static String SERVLET_NAME_SERVIZI_APPLICATIVI_PROPRIETA_ADD = OBJECT_NAME_SERVIZI_APPLICATIVI_PROPRIETA+"Add.do";
	public final static String SERVLET_NAME_SERVIZI_APPLICATIVI_PROPRIETA_CHANGE = OBJECT_NAME_SERVIZI_APPLICATIVI_PROPRIETA+"Change.do";
	public final static String SERVLET_NAME_SERVIZI_APPLICATIVI_PROPRIETA_DELETE = OBJECT_NAME_SERVIZI_APPLICATIVI_PROPRIETA+"Del.do";
	public final static String SERVLET_NAME_SERVIZI_APPLICATIVI_PROPRIETA_LIST = OBJECT_NAME_SERVIZI_APPLICATIVI_PROPRIETA+"List.do";
	public final static Vector<String> SERVLET_SERVIZI_APPLICATIVI_PROPRIETA = new Vector<String>();
	static{
...
//	public final static String PARAMETRO_SERVIZI_APPLICATIVI_RUOLO_EROGATORE = "ruoloErogatore";
	...
	public final static String PARAMETRO_SERVIZI_APPLICATIVI_PROP_NOME = "propNome";
	public final static String PARAMETRO_SERVIZI_APPLICATIVI_PROP_VALORE = "propValore";
	...
	public final static String LABEL_PARAMETRO_SERVIZI_APPLICATIVI_PROPRIETA = "Propriet&agrave;";
	public final static String LABEL_PARAMETRO_SERVIZI_APPLICATIVI_PROP_NOME = "Nome";
	public final static String LABEL_PARAMETRO_SERVIZI_APPLICATIVI_PROP_VALORE = CostantiControlStation.LABEL_PARAMETRO_VALORE;

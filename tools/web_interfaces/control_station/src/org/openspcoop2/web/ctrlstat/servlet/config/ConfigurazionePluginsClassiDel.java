...
/**
 * ConfigurazionePluginsClassiDel
 * 
 ...
 * 
 */
public final class ConfigurazionePluginsClassiDel extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			boolean deleteAlmostOnePlugin = false;
			
			for (int i = 0; i < idsToRemove.size(); i++) {

				id = Long.parseLong(idsToRemove.get(i));
				
				boolean deleted = ConfigurazionePluginsUtils.deletePlugin(id, userLogin, confCore, confHelper, inUsoMessage, org.openspcoop2.core.constants.Costanti.WEB_NEW_LINE);
				if(deleted) {
					deleteAlmostOnePlugin = true;
				}

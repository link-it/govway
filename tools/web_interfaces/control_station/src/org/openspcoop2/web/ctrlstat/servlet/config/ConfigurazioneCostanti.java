...
public class ConfigurazioneCostanti {
	...
	public final static String OBJECT_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE = "configurazioneControlloCongestione";
	public final static String OBJECT_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_RUNTIME = "configurazioneControlloCongestioneRuntime";
	public final static String OBJECT_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_ATTIVAZIONE_POLICY = "configurazioneControlloCongestioneAttivazionePolicy";
	public final static String OBJECT_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONFIGURAZIONE_POLICY = "configurazioneControlloCongestioneConfigurazionePolicy";
	...
	public final static String SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE = OBJECT_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE +".do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_RUNTIME = OBJECT_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_RUNTIME +".do";
	
	public final static String SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_ATTIVAZIONE_POLICY_ADD = OBJECT_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_ATTIVAZIONE_POLICY+"Add.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_ATTIVAZIONE_POLICY_CHANGE = OBJECT_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_ATTIVAZIONE_POLICY+"Change.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_ATTIVAZIONE_POLICY_DELETE = OBJECT_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_ATTIVAZIONE_POLICY+"Del.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_ATTIVAZIONE_POLICY_LIST = OBJECT_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_ATTIVAZIONE_POLICY+"List.do";
	
	public final static String SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONFIGURAZIONE_POLICY_ADD = OBJECT_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONFIGURAZIONE_POLICY+"Add.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONFIGURAZIONE_POLICY_CHANGE = OBJECT_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONFIGURAZIONE_POLICY+"Change.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONFIGURAZIONE_POLICY_DELETE = OBJECT_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONFIGURAZIONE_POLICY+"Del.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONFIGURAZIONE_POLICY_LIST = OBJECT_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONFIGURAZIONE_POLICY+"List.do";
	
	public final static Vector<String> SERVLET_CONFIGURAZIONE_CONTROLLO_CONGESTIONE = new Vector<String>();
	static{
		SERVLET_CONFIGURAZIONE_CONTROLLO_CONGESTIONE.add(SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE);
		SERVLET_CONFIGURAZIONE_CONTROLLO_CONGESTIONE.add(SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_RUNTIME);
		SERVLET_CONFIGURAZIONE_CONTROLLO_CONGESTIONE.add(SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_ATTIVAZIONE_POLICY_ADD);
		SERVLET_CONFIGURAZIONE_CONTROLLO_CONGESTIONE.add(SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_ATTIVAZIONE_POLICY_CHANGE);
		SERVLET_CONFIGURAZIONE_CONTROLLO_CONGESTIONE.add(SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_ATTIVAZIONE_POLICY_DELETE);
		SERVLET_CONFIGURAZIONE_CONTROLLO_CONGESTIONE.add(SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_ATTIVAZIONE_POLICY_LIST);
		SERVLET_CONFIGURAZIONE_CONTROLLO_CONGESTIONE.add(SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONFIGURAZIONE_POLICY_ADD);
		SERVLET_CONFIGURAZIONE_CONTROLLO_CONGESTIONE.add(SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONFIGURAZIONE_POLICY_CHANGE);
		SERVLET_CONFIGURAZIONE_CONTROLLO_CONGESTIONE.add(SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONFIGURAZIONE_POLICY_DELETE);
		SERVLET_CONFIGURAZIONE_CONTROLLO_CONGESTIONE.add(SERVLET_NAME_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONFIGURAZIONE_POLICY_LIST);
	}
	...
	public final static String LABEL_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_STATO_CONTROLLO_CONGESTIONE = "Controllo della Congestione";
	...
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_JMX_STATE = "CCViewJmxState";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_FIRST_TIME = "CCFirstTime";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_IS_POLICY = "CCIsPolicy";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_IS_ATTIVAZIONE_GLOBALE = "CCIsPolicyAttivazioneGlobale";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_IS_ATTIVAZIONE_GLOBALE_VALORE = "true";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_NUM_MASSIMO_RICHIESTE_SIMULTANEE_STATO = "CCNumMaxReqStato";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_NUM_MASSIMO_RICHIESTE_SIMULTANEE_SOGLIA = "CCNumMaxReqSoglia";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_NUM_MASSIMO_RICHIESTE_SIMULTANEE_TIPOLOGIA_ERRORE = "CCNumMaxReqTipoErrore";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_NUM_MASSIMO_RICHIESTE_SIMULTANEE_TIPOLOGIA_ERRORE_DESCRIZIONE = "CCNumMaxReqTipoErroreDescr";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_STATO_CONTROLLO_CONGESTIONE = "CCStatoControlloTraffico";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_THRESHOLD_CONTROLLO_CONGESTIONE = "percentualeCCThreshold";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_REDEFINE_TEMPI_RISPOSTA = "CCRedefineTempiRisposta";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONNECTION_TIMEOUT = "CCConnectionTimeout";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_READ_TIMEOUT = "CCReadTimeout";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_TEMPO_MEDIO_RISPOSTA = "CCTempoMedioRisposta";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONNECTION_TIMEOUT_FRUIZIONE = PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONNECTION_TIMEOUT+"Fruizione";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_READ_TIMEOUT_FRUIZIONE = PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_READ_TIMEOUT+"Fruizione";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_TEMPO_MEDIO_RISPOSTA_FRUIZIONE = PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_TEMPO_MEDIO_RISPOSTA+"Fruizione";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONNECTION_TIMEOUT_EROGAZIONE = PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONNECTION_TIMEOUT+"Erogazione";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_READ_TIMEOUT_EROGAZIONE = PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_READ_TIMEOUT+"Erogazione";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_TEMPO_MEDIO_RISPOSTA_EROGAZIONE = PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_TEMPO_MEDIO_RISPOSTA+"Erogazione";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_RATE_LIMITING_POLICY_LINK = "CCVisualizzaPolicy";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_RATE_LIMITING_POLICY_GLOBALI_LINK = "CCVisualizzaPolicyGlobali";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_RATE_LIMITING_POLICY_TIPOLOGIA_ERRORE = "CCRateLimitTipoErrore";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_RATE_LIMITING_POLICY_TIPOLOGIA_ERRORE_DESCRIZIONE = "CCRateLimitTipoErroreDescr";

	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CACHE_STATO = "CCCacheStato";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CACHE_DIMENSIONE = "CCCacheDimensione";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CACHE_LIFE_TIME = "CCCacheLifeTime";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CACHE_IDLE_TIME = "CCCacheIdleTime";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CACHE_ALGORITMO = "CCCacheAlgoritmo";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_VISUALIZZA_STATO = "CCStateView";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_VISUALIZZA_STATO_THREADS_ATTIVI = "CCStateViewActiveThreads";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_VISUALIZZA_STATO_CONGESTIONE = "CCStateViewCongestione";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_NO_EDIT_SUFFIX = "_NoEdit";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_LIST = "CCPolicyList";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_LIST_ENABLED = "CCPolicyListEnabled";

	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_OLD_NOME_SUGGERITO = "CCPolicyOldNomeSuggerito";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_OLD_DESCRIZIONE_SUGGERITA = "CCPolicyOldDescrizioneSuggerita";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_OLD_ID = "CCPolicyOldId";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_JMX_STATE = "CCPolicyActiveViewJmxState";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_JMX_RESET = "CCPolicyActiveViewJmxReset";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_JMX_RESET_ALL_VALUE = "*";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_ID_UNICO = "CCPolicyActiveIdUnico";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_ID = "CCPolicyActiveId";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_IS_GLOBALE = "CCPolicyActiveIsGlobale";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_ENABLED = "CCPolicyActiveEnabled";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_VISUALIZZA_STATO = "CCPolicyActiveStateView";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_VISUALIZZA_RESET = "CCPolicyActiveStateViewReset";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_RIDEFINISCI = "CCPolicyActiveRidefinisci";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_ALIAS = "CCPolicyActiveAlias";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_DESCRIZIONE = "CCPolicyActiveDescrizione";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_VALORE = "CCPolicyActiveValore";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_ENABLED = "CCPolicyActiveFiltroEnabled";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_RUOLO_PDD = "CCPolicyActiveFiltroRuoloPdd";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_PROTOCOLLO = "CCPolicyActiveFiltroRuoloProtocollo";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_RUOLO_FRUITORE = "CCPolicyActiveFiltroRuoloFruitore";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_FRUITORE = "CCPolicyActiveFiltroFruitore";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_SA_FRUITORE = "CCPolicyActiveFiltroSAFruitore";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_RUOLO_EROGATORE = "CCPolicyActiveFiltroRuoloErogatore";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_EROGATORE = "CCPolicyActiveFiltroErogatore";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_SA_EROGATORE = "CCPolicyActiveFiltroSAErogatore";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_SERVIZIO = "CCPolicyActiveFiltroServizio";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_AZIONE = "CCPolicyActiveFiltroAzione";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_PER_CHIAVE_ENABLED = "CCPolicyActiveFiltroPerChiaveEnabled";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_PER_CHIAVE_TIPO = "CCPolicyActiveFiltroPerChiaveTipo";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_PER_CHIAVE_NOME = "CCPolicyActiveFiltroPerChiaveNome";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_PER_CHIAVE_VALORE = "CCPolicyActiveFiltroPerChiaveValore";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_ENABLED = "CCPolicyActiveGroupByEnabled";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_RUOLO_PDD = "CCPolicyActiveGroupByRuoloPdd";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_PROTOCOLLO = "CCPolicyActiveGroupByRuoloProtocollo";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_FRUITORE = "CCPolicyActiveGroupByFruitore";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_SA_FRUITORE = "CCPolicyActiveGroupBySAFruitore";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_EROGATORE = "CCPolicyActiveGroupByErogatore";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_SA_EROGATORE = "CCPolicyActiveGroupBySAErogatore";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_SERVIZIO = "CCPolicyActiveGroupByServizio";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_AZIONE = "CCPolicyActiveGroupByAzione";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_PER_CHIAVE_ENABLED = "CCPolicyActiveGroupByPerChiaveEnabled";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_PER_CHIAVE_TIPO = "CCPolicyActiveGroupByPerChiaveTipo";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_PER_CHIAVE_NOME = "CCPolicyActiveGroupByPerChiaveNome";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ID = "CCPolicyId";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_NOME = "CCPolicyName";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_DESCRIZIONE = "CCPolicyDescrizione";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_RISORSA = "CCPolicyRisorsa";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_RICHIESTE_SIMULTANEE = "CCPolicySogliaRichiesteSimultanee";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE = "CCPolicySogliaValore";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_TIPO_LATENZA = "CCPolicySogliaValoreTipoLatenza";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_TIPO_BANDA = "CCPolicySogliaValoreTipoBanda";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_TIPO_CONTROLLO = "CCPolicySogliaValoreTipoControllo";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_TIPO_PERIODO = "CCPolicySogliaValoreTipoPeriodo";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_PERIODO = "CCPolicySogliaValorePeriodo";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_FINESTRA_PERIODO = "CCPolicySogliaFinestraPeriodo";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_MODIFICATO_CON_ISTANZE_ATTIVE_RICHIESTA_MODIFICA = "CCPolicySogliaValoreRichiestaModificaConIstanzeAttive";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_MODIFICATO_CON_ISTANZE_ATTIVE_MODIFICA_EFFETTIVA = "CCPolicySogliaValoreModificatoConIstanzeAttive";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_TIPO = "CCPolicyApplicabilitaTipo";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_CONGESTIONE = "CCPolicyApplicabilitaConCongestione";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_DEGRADO_PRESTAZIONALE = "CCPolicyApplicabilitaConDegradoPrestazionale";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_STATO_ALLARME = "CCPolicyApplicabilitaStatoAllarme";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_CONGESTIONE_NOTE = "CCPolicyApplicabilitaConCongestioneNote";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_DEGRADO_PRESTAZIONALE_NOTE = "CCPolicyApplicabilitaConDegradoPrestazionaleNote";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_DEGRADO_PRESTAZIONALE_TIPO_CONTROLLO = "CCPolicyApplicabilitaConDegradoPrestazionaleTipoControllo";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_DEGRADO_PRESTAZIONALE_TIPO_LATENZA = "CCPolicyApplicabilitaConDegradoPrestazionaleTipoLatenza";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_DEGRADO_PRESTAZIONALE_TIPO_PERIODO = "CCPolicyApplicabilitaConDegradoPrestazionaleTipoPeriodo";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_DEGRADO_PRESTAZIONALE_PERIODO = "CCPolicyApplicabilitaConDegradoPrestazionalePeriodo";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_DEGRADO_PRESTAZIONALE_FINESTRA_PERIODO = "CCPolicyApplicabilitaConDegradoPrestazionaleFinestraPeriodo";
	
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_STATO_ALLARME_NOTE = "CCPolicyApplicabilitaStatoAllarmeNote";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_STATO_ALLARME_NOME = "CCPolicyApplicabilitaStatoAllarmeNome";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_STATO_ALLARME_NOT_STATO = "CCPolicyApplicabilitaStatoAllarmeNotStato";
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_STATO_ALLARME_STATO = "CCPolicyApplicabilitaStatoAllarmeStato";
	...
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ISTANZIATA = "Utilizzo";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ISTANZIATA_TEMPLATE = "ISTANZA";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ISTANZIATA_VALUE = "La policy risulta utilizzata in "+LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ISTANZIATA_TEMPLATE;
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_LIST = "Policy";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_JMX_STATE = "Stato Runtime";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_ID_UNICO = "Identificativo";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_ID = "Policy";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_ENABLED = "Stato";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_VISUALIZZA_STATO = "Visualizza Informazioni Runtime";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_VISUALIZZA_STATO_REFRESH = "Refresh";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_VISUALIZZA_STATO_RESET = "Reset Contatori";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_VISUALIZZA_STATO_RESET_ALL_NODES = "Reset Contatori su tutti i Nodi";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_RIDEFINISCI = "Ridefinisci Valori di Soglia";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_ALIAS = "Nome";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_DESCRIZIONE = "Descrizione";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_NUMERO_RICHIESTE = "Numero Massimo Richieste";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_NUMERO_RICHIESTE_COMPLETATE_CON_SUCCESSO_NOTE = "Vengono conteggiate solamente le transazioni completate con successo";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_NUMERO_RICHIESTE_FALLITE_NOTE = "Vengono conteggiate solamente le transazioni fallite";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_NUMERO_FAULT_APPLICATIVI_NOTE = "Vengono conteggiate solamente le transazioni contenenti un fault applicativo";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_OCCUPAZIONE_DI_BANDA_LABEL = "Occupazione Massima";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_OCCUPAZIONE_DI_BANDA_NOTE = "Indicazione della banda occupata in (kb)";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_TEMPO_COMPLESSIVO_LABEL = "Tempo Risposta";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_TEMPO_COMPLESSIVO_NOTE = "Indicazione (in secondi) sul tempo di risposta complessivo che deve essere inferiore al valore fornito";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_TEMPO_MEDIO_LABEL = "Tempo Medio di Risposta";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_TEMPO_MEDIO_NOTE = "Indicazione (in millisecondi) sul tempo medio di risposta che deve essere inferiore al valore fornito";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_ENABLED = "Stato";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_RUOLO_PDD = "Ruolo PdD";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_PROTOCOLLO = "Protocollo";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_RUOLO_FRUITORE = "Ruolo Fruitore";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_FRUITORE = "Soggetto Fruitore";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_SA_FRUITORE = "Applicativo Fruitore";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_RUOLO_EROGATORE = "Ruolo Erogatore";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_EROGATORE = "Soggetto Erogatore";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_SA_EROGATORE = "Applicativo Erogatore";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_SERVIZIO = "Servizio";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_AZIONE = "Azione";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_PER_CHIAVE_ENABLED = "Filtro per Chiave";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_PER_CHIAVE_TIPO = "Tipologia";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_PER_CHIAVE_NOME_NOME = "Nome";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_PER_CHIAVE_NOME_ESPRESSIONE_REGOLARE = "Espressione Regolare";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_PER_CHIAVE_NOME_ESPRESSIONE_XPATH = "Espressione XPath";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_PER_CHIAVE_NOME_SOAP_ACTION = "SoapAction";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_PER_CHIAVE_NOME_CUSTOM = "Tipo Personalizzato";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_PER_CHIAVE_VALORE = "Valore";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_ENABLED = "Modalità";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_RUOLO_PDD_LABEL = "Ruolo";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_RUOLO_PDD_NOTE = "Indicazione sul ruolo della PdD (Fruitore/Erogatore)";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_PROTOCOLLO = "Protocollo";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_FRUITORE = "Soggetto Fruitore";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_SA_FRUITORE = "Applicativo Fruitore";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_EROGATORE = "Soggetto Erogatore";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_SA_EROGATORE = "Applicativo Erogatore";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_SERVIZIO = "Servizio";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_AZIONE = "Azione";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_PER_CHIAVE_ENABLED_LABEL = "Chiave";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_PER_CHIAVE_ENABLED_NOTE = "Raggruppamento per Chiave";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_PER_CHIAVE_TIPO = "Tipologia";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_PER_CHIAVE_NOME_NOME = "Nome";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_PER_CHIAVE_NOME_ESPRESSIONE_REGOLARE = "Espressione Regolare";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_PER_CHIAVE_NOME_ESPRESSIONE_XPATH = "Espressione XPath";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_PER_CHIAVE_NOME_SOAP_ACTION = "SoapAction";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_PER_CHIAVE_NOME_CUSTOM = "Tipo Personalizzato";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ID = PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ID;
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_IDENTIFICATIVO = "Identificativo";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_NOME = "Nome";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_DESCRIZIONE = "Descrizione";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_RISORSA = "Risorsa";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_RICHIESTE_SIMULTANEE = "Simultanee";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_NUMERO_RICHIESTE = "Numero Massimo Richieste";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_NUMERO_RICHIESTE_COMPLETATE_CON_SUCCESSO_NOTE = LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_NUMERO_RICHIESTE_COMPLETATE_CON_SUCCESSO_NOTE;
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_NUMERO_RICHIESTE_FALLITE_NOTE = LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_NUMERO_RICHIESTE_FALLITE_NOTE;
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_NUMERO_FAULT_APPLICATIVI_NOTE = LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_NUMERO_FAULT_APPLICATIVI_NOTE;
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_OCCUPAZIONE_DI_BANDA_LABEL = "Occupazione Massima";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_OCCUPAZIONE_DI_BANDA_NOTE = LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_OCCUPAZIONE_DI_BANDA_NOTE;
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_TEMPO_COMPLESSIVO_LABEL = "Tempo Risposta";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_TEMPO_COMPLESSIVO_NOTE = LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_TEMPO_COMPLESSIVO_NOTE;
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_TEMPO_MEDIO_LABEL = "Tempo Medio di Risposta";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_TEMPO_MEDIO_NOTE = LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_TEMPO_MEDIO_NOTE;
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_TEMPO_COMPLESSIVO_TIPO_LATENZA = "Tipo Latenza";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_TEMPO_MEDIO_TIPO_LATENZA = "Tipo Latenza";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_TIPO_BANDA = "Tipo Banda";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_TIPO_CONTROLLO = "Modalità di Controllo";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_VALORE_MODIFICATO_CON_ISTANZE_ATTIVE_RICHIESTA_MODIFICA = "Modifica Valore di Soglia";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_TIPO_PERIODO = "Frequenza";
	//public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_PERIODO = "Intervallo Osservazione";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_SOGLIA_FINESTRA_PERIODO = "Finestra";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_TIPO = "Condizionale";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_CONGESTIONE_LABEL= "Congestione del Traffico";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_CONGESTIONE_NOTE = "Policy applicabile in presenza di Congestione del Traffico";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_DEGRADO_PRESTAZIONALE_LABEL = "Degrado Prestazionale";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_DEGRADO_PRESTAZIONALE_NOTE = "Policy applicabile in presenza di Degrado Prestazionale";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_STATO_ALLARME_LABEL = "Condizioni di Allarme";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_STATO_ALLARME_NOTE = "Policy applicabile in presenza di Condizioni di Allarme";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_CONGESTIONE_NOTE_NUMERO = "_NUMERO_RICHIESTE_PER_CONGESTIONE_"; 
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_CONGESTIONE_NOTE_PREFIX = 
	...
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_CONGESTIONE_NOTE_CONGESTION_ACTIVE_AS_TEXT = 
			LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_CONGESTIONE_NOTE_PREFIX+
	 			"La PdD viene considerata congestionata se vengono superate le "+
	 			LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_CONGESTIONE_NOTE_NUMERO+" richieste simultanee.";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_CONGESTIONE_NOTE_CONGESTION_NOT_ACTIVE_AS_TEXT = 
			LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_CONGESTIONE_NOTE_PREFIX+
	 			"Attualmente non risulta attivo il Controllo della Congestione.";
		
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_DEGRADO_PRESTAZIONALE_NOTE_AS_TEXT = 
	...
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_DEGRADO_PRESTAZIONALE_TIPO_CONTROLLO = "Modalità di Controllo";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_DEGRADO_PRESTAZIONALE_TIPO_LATENZA = "Tempo Medio Risposta";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_DEGRADO_PRESTAZIONALE_TIPO_PERIODO = "Frequenza";
	//public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_DEGRADO_PRESTAZIONALE_PERIODO = "Intervallo Osservazione";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_CON_DEGRADO_PRESTAZIONALE_FINESTRA_PERIODO = "Finestra";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_STATO_ALLARME_NOTE_AS_TEXT = 
			"La policy viene applicata se l'allarme selezionato soddisfa lo stato indicato";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_STATO_ALLARME_NOME = "Nome";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_STATO_ALLARME_NOT_STATO = "Not";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_POLICY_APPLICABILITA_STATO_ALLARME_STATO = "Stato";
	...
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_NUM_MASSIMO_RICHIESTE_SIMULTANEE_STATO = "Stato";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_NUM_MASSIMO_RICHIESTE_SIMULTANEE_SOGLIA = "Max Richieste Simultanee";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_NUM_MASSIMO_RICHIESTE_SIMULTANEE_TIPOLOGIA_ERRORE = "Tipologia Errore";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_NUM_MASSIMO_RICHIESTE_SIMULTANEE_TIPOLOGIA_ERRORE_DESCRIZIONE = "Includi Descrizione Errore";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_STATO_CONTROLLO_CONGESTIONE = "Stato";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_THRESHOLD_CONTROLLO_CONGESTIONE = "Soglia di Attivazione (%)";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_REDEFINE_TEMPI_RISPOSTA = "Ridefinisci Tempi Risposta";
	//public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONNECTION_TIMEOUT = "Connection Timeout (ms)";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CONNECTION_TIMEOUT_LABEL = "Connection Timeout";
	//public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_READ_TIMEOUT = "Read Timeout (ms)";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_READ_TIMEOUT_LABEL = "Read Timeout";
	//public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_TEMPO_MEDIO_RISPOSTA = "Tempo Medio di Risposta (ms)";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_TEMPO_MEDIO_RISPOSTA_LABEL = "Tempo Medio di Risposta";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_MILLISECONDI_NOTE = "Indicazione in millisecondi (ms)";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_RATE_LIMITING_POLICY_LINK = "Policy";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_RATE_LIMITING_TIPOLOGIA_ERRORE = "Tipologia Errore";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_RATE_LIMITING_TIPOLOGIA_ERRORE_DESCRIZIONE = "Includi Descrizione Errore";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CACHE_STATO = "Stato";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CACHE_DIMENSIONE = "Dimensione (Elementi)";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CACHE_LIFE_TIME = "Item Life Time (Secondi)";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CACHE_IDLE_TIME = "Item Idle Time (Secondi)";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CACHE_ALGORITMO = "Algoritmo";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_VISUALIZZA_STATO = "Visualizza Informazioni Runtime";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_STATO_RUNTIME = "Informazioni Runtime";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_VISUALIZZA_STATO_REFRESH = "Refresh";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_VISUALIZZA_STATO_THREADS_ATTIVI = "Richieste Attive";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_VISUALIZZA_STATO_CONGESTIONE = "Porta Congestionata";
	...
	public final static String DEFAULT_VALUE_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_NUM_MASSIMO_RICHIESTE_SIMULTANEE_TIPOLOGIA_ERRORE = TipoErrore.FAULT.getValue();
	
	public final static int DEFAULT_VALUE_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_PARAMETRO_CONTROLLO_CONGESTIONE_THRESHOLD = 80;
	

	public final static boolean DEFAULT_VALUE_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CACHE_STATO = true;
	public final static long DEFAULT_VALUE_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CACHE_DIMENSIONE = 10000;
	public final static long DEFAULT_VALUE_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CACHE_LIFE_TIME = 300;
	public final static Long DEFAULT_VALUE_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CACHE_IDLE_TIME = null;
	public final static CacheAlgorithm DEFAULT_VALUE_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_CACHE_ALGORITMO = CacheAlgorithm.LRU;

	public final static String LABEL_VALUE_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_DEGRADO_AVG_TIPO_LATENZA_SERVIZIO = "Latenza Servizio";
	public final static String LABEL_VALUE_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_DEGRADO_AVG_TIPO_LATENZA_TOTALE = "Latenza Totale";
//	public final static String LABEL_VALUE_PARAMETRO_CONFIGURAZIONE_CONTROLLO_CONGESTIONE_DEGRADO_AVG_TIPO_LATENZA_PORTA = "Latenza introdotta dalla Porta"; // Non supportato
	...
	// DEVO essere presi dal database. DEVONO essere impostati nella insert SQL
	//public final static int DEFAULT_PARAMETRO_CONTROLLO_CONGESTIONE_REGOLA_CONNECTION_TIMEOUT = org.openspcoop2.utils.resources.HttpUtilities.HTTP_CONNECTION_TIMEOUT;
	//public final static int DEFAULT_PARAMETRO_CONTROLLO_CONGESTIONE_REGOLA_READ_TIMEOUT = org.openspcoop2.utils.resources.HttpUtilities.HTTP_READ_CONNECTION_TIMEOUT;
	//public final static long DEFAULT_VALUE_PARAMETRO_CONTROLLO_CONGESTIONE_NUM_MASSIMO_RICHIESTE_SIMULTANEE = 200;
	...
	public final static String CONTROLLO_CONGESTIONE_POLICY_ACTIVE_FILTRO_PER_CHIAVE_TIPO_DEFAULT = TipoFiltroApplicativo.HEADER_BASED.getValue();
	public final static String CONTROLLO_CONGESTIONE_POLICY_ACTIVE_GROUPBY_PER_CHIAVE_TIPO_DEFAULT = TipoFiltroApplicativo.HEADER_BASED.getValue();
}

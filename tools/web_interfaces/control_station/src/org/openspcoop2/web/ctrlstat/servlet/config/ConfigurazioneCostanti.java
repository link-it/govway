...
public class ConfigurazioneCostanti {
	...
	public final static String OBJECT_NAME_CONFIGURAZIONE_PLUGINS_ARCHIVI = "configurazionePluginsArchivi";
	...
	public final static String OBJECT_NAME_CONFIGURAZIONE_HANDLERS_RICHIESTA = "configurazioneHandlersRichiesta";
	public final static String OBJECT_NAME_CONFIGURAZIONE_HANDLERS_RISPOSTA = "configurazioneHandlersRisposta";
	public final static String OBJECT_NAME_CONFIGURAZIONE_HANDLERS_SERVIZIO = "configurazioneHandlersServizio";
	...
	public final static String SERVLET_NAME_CONFIGURAZIONE_PLUGINS_ARCHIVI_ADD = OBJECT_NAME_CONFIGURAZIONE_PLUGINS_ARCHIVI+"Add.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_PLUGINS_ARCHIVI_CHANGE = OBJECT_NAME_CONFIGURAZIONE_PLUGINS_ARCHIVI+"Change.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_PLUGINS_ARCHIVI_DELETE = OBJECT_NAME_CONFIGURAZIONE_PLUGINS_ARCHIVI+"Del.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_PLUGINS_ARCHIVI_LIST = OBJECT_NAME_CONFIGURAZIONE_PLUGINS_ARCHIVI+"List.do";
	public final static Vector<String> SERVLET_CONFIGURAZIONE_PLUGINS_ARCHIVI = new Vector<String>();
	static{
	...
	public final static String SERVLET_NAME_CONFIGURAZIONE_PLUGINS_ARCHIVI_JAR_ADD = OBJECT_NAME_CONFIGURAZIONE_PLUGINS_ARCHIVI_JAR+"Add.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_PLUGINS_ARCHIVI_JAR_DELETE = OBJECT_NAME_CONFIGURAZIONE_PLUGINS_ARCHIVI_JAR+"Del.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_PLUGINS_ARCHIVI_JAR_LIST = OBJECT_NAME_CONFIGURAZIONE_PLUGINS_ARCHIVI_JAR+"List.do";
	public final static Vector<String> SERVLET_CONFIGURAZIONE_PLUGINS_ARCHIVI_JAR = new Vector<String>();
	static{
	...
	public final static String SERVLET_NAME_CONFIGURAZIONE_PLUGINS_CLASSI_ADD = OBJECT_NAME_CONFIGURAZIONE_PLUGINS_CLASSI+"Add.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_PLUGINS_CLASSI_CHANGE = OBJECT_NAME_CONFIGURAZIONE_PLUGINS_CLASSI+"Change.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_PLUGINS_CLASSI_DELETE = OBJECT_NAME_CONFIGURAZIONE_PLUGINS_CLASSI+"Del.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_PLUGINS_CLASSI_LIST = OBJECT_NAME_CONFIGURAZIONE_PLUGINS_CLASSI+"List.do";
	public final static Vector<String> SERVLET_CONFIGURAZIONE_PLUGINS_CLASSI = new Vector<String>();
	static{
	...
	public final static String SERVLET_NAME_CONFIGURAZIONE_HANDLERS_RICHIESTA_ADD = OBJECT_NAME_CONFIGURAZIONE_HANDLERS_RICHIESTA+"Add.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_HANDLERS_RICHIESTA_CHANGE = OBJECT_NAME_CONFIGURAZIONE_HANDLERS_RICHIESTA+"Change.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_HANDLERS_RICHIESTA_DELETE = OBJECT_NAME_CONFIGURAZIONE_HANDLERS_RICHIESTA+"Del.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_HANDLERS_RICHIESTA_LIST = OBJECT_NAME_CONFIGURAZIONE_HANDLERS_RICHIESTA+"List.do";
	public final static Vector<String> SERVLET_CONFIGURAZIONE_HANDLERS_RICHIESTA = new Vector<String>();
	static{
	...
	public final static String SERVLET_NAME_CONFIGURAZIONE_HANDLERS_RISPOSTA_ADD = OBJECT_NAME_CONFIGURAZIONE_HANDLERS_RISPOSTA+"Add.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_HANDLERS_RISPOSTA_CHANGE = OBJECT_NAME_CONFIGURAZIONE_HANDLERS_RISPOSTA+"Change.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_HANDLERS_RISPOSTA_DELETE = OBJECT_NAME_CONFIGURAZIONE_HANDLERS_RISPOSTA+"Del.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_HANDLERS_RISPOSTA_LIST = OBJECT_NAME_CONFIGURAZIONE_HANDLERS_RISPOSTA+"List.do";
	public final static Vector<String> SERVLET_CONFIGURAZIONE_HANDLERS_RISPOSTA = new Vector<String>();
	static{
	...
	public final static String SERVLET_NAME_CONFIGURAZIONE_HANDLERS_SERVIZIO_ADD = OBJECT_NAME_CONFIGURAZIONE_HANDLERS_SERVIZIO+"Add.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_HANDLERS_SERVIZIO_CHANGE = OBJECT_NAME_CONFIGURAZIONE_HANDLERS_SERVIZIO+"Change.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_HANDLERS_SERVIZIO_DELETE = OBJECT_NAME_CONFIGURAZIONE_HANDLERS_SERVIZIO+"Del.do";
	public final static String SERVLET_NAME_CONFIGURAZIONE_HANDLERS_SERVIZIO_LIST = OBJECT_NAME_CONFIGURAZIONE_HANDLERS_SERVIZIO+"List.do";
	public final static Vector<String> SERVLET_CONFIGURAZIONE_HANDLERS_SERVIZIO = new Vector<String>();
	static{
	...
	public final static String LABEL_CONFIGURAZIONE_POLICY_GESTIONE_TOKEN_VERIFICA_CONNETTIVITA = CostantiControlStation.LABEL_VERIFICA_CONNETTIVITA;
	public final static String LABEL_CONFIGURAZIONE_POLICY_GESTIONE_TOKEN_VERIFICA_CONNETTIVITA_DI = CostantiControlStation.LABEL_VERIFICA_CONNETTIVITA_DI;
	...
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_SELEZIONATE_ALLARME = "Allarme";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_SELEZIONATE_AUTENTICAZIONE = "Autenticazione";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_SELEZIONATE_AUTORIZZAZIONE = "Autorizzazione";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_SELEZIONATE_AUTORIZZAZIONE_CONTENUTI = "Autorizzazione Contenuti";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_SELEZIONATE_BEHAVIOUR = "Behaviour";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_SELEZIONATE_CONNETTORE = "Connettore";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_SELEZIONATE_INTEGRAZIONE = "Integrazione";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_SELEZIONATE_MESSAGE_HANDLER = "Message Handler";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_SELEZIONATE_RATE_LIMITING = "Rate Limiting";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_SELEZIONATE_RICERCA = "Ricerca";
	...
	public final static String LABEL_CONFIGURAZIONE_CACHE_CONTROLLO_TRAFFICO = "Cache (Controllo Traffico - Dati Statistici)";
	
	public final static String LABEL_CONFIGURAZIONE_CACHE_DATI_RICHIESTE = "Cache (Dati delle Richieste)";
	...
	public final static String LABEL_CONFIGURAZIONE_RISORSA_DIMENSIONE_MASSIMA = CostantiControlStation.LABEL_CONFIGURAZIONE_RISORSA_DIMENSIONE_MASSIMA;
	...
	public final static String PARAMETRO_CONFIGURAZIONE_STATO_CACHE_CONTROLLO_TRAFFICO = "CTCacheStato";
	public final static String PARAMETRO_CONFIGURAZIONE_DIMENSIONE_CACHE_CONTROLLO_TRAFFICO = "CTCacheDimensione";
	public final static String PARAMETRO_CONFIGURAZIONE_ALGORITMO_CACHE_CONTROLLO_TRAFFICO = "CTCacheAlgoritmo";
	public final static String PARAMETRO_CONFIGURAZIONE_IDLE_CACHE_CONTROLLO_TRAFFICO = "CTCacheIdleTime";
	public final static String PARAMETRO_CONFIGURAZIONE_LIFE_CACHE_CONTROLLO_TRAFFICO = "CTCacheLifeTime";
	
	public final static String PARAMETRO_CONFIGURAZIONE_STATO_CACHE_DATI_RICHIESTE = "statocacheDatiRichieste";
	public final static String PARAMETRO_CONFIGURAZIONE_DIMENSIONE_CACHE_DATI_RICHIESTE = "dimensionecacheDatiRichieste";
	public final static String PARAMETRO_CONFIGURAZIONE_ALGORITMO_CACHE_DATI_RICHIESTE = "algoritmocacheDatiRichieste";
	public final static String PARAMETRO_CONFIGURAZIONE_IDLE_CACHE_DATI_RICHIESTE = "idlecacheDatiRichieste";
	public final static String PARAMETRO_CONFIGURAZIONE_LIFE_CACHE_DATI_RICHIESTE = "lifecacheDatiRichieste";
	...
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_CACHE_STATO = PARAMETRO_CONFIGURAZIONE_STATO_CACHE_CONTROLLO_TRAFFICO;
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_CACHE_DIMENSIONE = PARAMETRO_CONFIGURAZIONE_DIMENSIONE_CACHE_CONTROLLO_TRAFFICO;
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_CACHE_LIFE_TIME = PARAMETRO_CONFIGURAZIONE_LIFE_CACHE_CONTROLLO_TRAFFICO;
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_CACHE_IDLE_TIME = PARAMETRO_CONFIGURAZIONE_IDLE_CACHE_CONTROLLO_TRAFFICO;
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_CACHE_ALGORITMO = PARAMETRO_CONFIGURAZIONE_ALGORITMO_CACHE_CONTROLLO_TRAFFICO;
	...
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_ACTIVE_POLICY_VALORE_2 = "CTPolicyActiveValore2";
	...
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_ACTIVE_FILTRO_TAG = "CTPolicyActiveFiltroTag";
	...
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_ACTIVE_FILTRO_TOKEN_CLAIMS = "CTPolicyActiveFiltroTokenClaims";
	...
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_SOGLIA_VALORE_2 = "CTPolicySogliaValore2";
	...
	public final static String PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_ID_ARCHIVIO = "plId";
	public final static String PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_POSIZIONE = "plPos";
	public final static String PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_NOME = "plNome";
	public final static String PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_OLD_NOME = "plOldNome";
	public final static String PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_DESCRIZIONE = "plDescr";
	public final static String PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_STATO = "plStato";
	public final static String PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_SORGENTE = "plSorg";
	public final static String PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_JAR_ARCHIVIO = "plJar";
	public final static String PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_URL_ARCHIVIO = "plUrl";
	public final static String PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_DIR_ARCHIVIO = "plDir";
	...
	public final static String PARAMETRO_CONFIGURAZIONE_HANDLERS_FASE = "hFase";
	public final static String PARAMETRO_CONFIGURAZIONE_HANDLERS_RUOLO_PORTA = "hRuoloPorta";
	public final static String PARAMETRO_CONFIGURAZIONE_HANDLERS_ID_PORTA = "hIdPorta";
	public final static String PARAMETRO_CONFIGURAZIONE_HANDLERS_SERVICE_BINDING = "hServiceBinding";
	public final static String PARAMETRO_CONFIGURAZIONE_HANDLERS_FIRST_TIME = "hFirstTime";
	public final static String PARAMETRO_CONFIGURAZIONE_HANDLERS_ID_HANDLER = "hId";
	public final static String PARAMETRO_CONFIGURAZIONE_HANDLERS_POSIZIONE = "hPos";
	public final static String PARAMETRO_CONFIGURAZIONE_HANDLERS_LABEL = "hLabel";
	public final static String PARAMETRO_CONFIGURAZIONE_HANDLERS_STATO = "hStato";
	public final static String PARAMETRO_CONFIGURAZIONE_HANDLERS_PLUGIN = "hPlugin";
	public final static String PARAMETRO_CONFIGURAZIONE_HANDLERS_PLUGIN_NOME_SEP = "__$$__$$__";
	...
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_DIMENSIONE_MASSIMA_RICHIESTA_LABEL = "Dimensione Richiesta";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_DIMENSIONE_MASSIMA_RISPOSTA_LABEL = "Dimensione Risposta";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_DIMENSIONE_MASSIMA_NOTE = "Indicazione della dimensione massima in 'kb' di una richiesta e di una risposta";
	...
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_ACTIVE_FILTRO_TAG = "Tag";
	...
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_ACTIVE_FILTRO_TOKEN_CLAIMS = "Token Claims";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_ACTIVE_FILTRO_TOKEN_CLAIMS_PREFIX = "Token-";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_ACTIVE_FILTRO_TOKEN_CLAIMS_NOTE = "Indicare per riga i claims richiesti (nome=valore)";
	...
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_SOGLIA_VALORE_NUMERO_RICHIESTE_FALLITE_O_FAULT_APPLICATIVI_NOTE = LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_NUMERO_RICHIESTE_FALLITE_O_FAULT_NOTE;
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_SOGLIA_VALORE_DIMENSIONE_MASSIMA_RICHIESTA_LABEL = "Dimensione Richiesta";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_SOGLIA_VALORE_DIMENSIONE_MASSIMA_RISPOSTA_LABEL = "Dimensione Risposta";
	...
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_SOGLIA_VALORE_DIMENSIONE_MASSIMA_NOTE = LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_ACTIVE_POLICY_SOGLIA_VALORE_DIMENSIONE_MASSIMA_NOTE;
	...
	public final static String LABEL_CONFIGURAZIONE_MESSAGE_HANDLERS_MODIFICATA_CON_SUCCESSO = "Configurazione "+LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_SELEZIONATE_MESSAGE_HANDLER+" modificata con successo"+RIAVVIO;
	public final static String LABEL_CONFIGURAZIONE_SERVICE_HANDLERS_MODIFICATA_CON_SUCCESSO = "Configurazione "+LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_SELEZIONATE_SERVICE_HANDLER+" modificata con successo"+RIAVVIO;
	...
	public final static String LABEL_POLICY_INFORMAZIONI_SOGLIA_DIMENSIONE_MESSAGGIO = "Soglia (kb)";
	...
	public final static String LABEL_CONFIGURAZIONE_PLUGINS = "Plugins";
	public final static String LABEL_CONFIGURAZIONE_REGISTRO_CLASSI = "Registro Classi";
	public final static String LABEL_CONFIGURAZIONE_REGISTRO_ARCHIVI_ARCHIVI_JAR = "Archivi Jar";
	public final static String LABEL_CONFIGURAZIONE_REGISTRO_ARCHIVI_ARCHIVI_JAR_DI = "Archivi Jar di ";
	
	public final static String LABEL_CONFIGURAZIONE_PLUGINS_REGISTRO_ARCHIVI = "Registro Archivi";
	public final static String LABEL_CONFIGURAZIONE_PLUGINS_REGISTRO_ARCHIVI_DI = "Registro Archivi di";
	public final static String LABEL_CONFIGURAZIONE_PLUGINS_ARCHIVIO = "Archivio";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_ID_ARCHIVIO = "IdArchivio";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_STATO = "Stato";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_NOME = "Nome";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_DESCRIZIONE = "Descrizione";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_POSIZIONE = "Ordine";
	...
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_FORMATO_DATA = "yyyy-MM-dd HH:mm";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_JAR_ARCHIVIO = "Archivio Jar";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_JAR_ARCHIVI = "Archivi Jar";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_DIR_ARCHIVIO = "Directory";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_URL_ARCHIVIO = "URL";
	
	public final static String[] LABELS_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_SORGENTE = {
	...
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_QUALSIASI_IN_LIST = "Qualsiasi Classe";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_QUALSIASI = "Qualsiasi Classe";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_SELEZIONATE = "Classi Selezionate";
	
	public final static String[] LABELS_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN = {
	...
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_PLUGINS_CLASSI_FILTRO_RUOLO = PluginCostanti.FILTRO_RUOLO_LABEL;
	...
	public final static String LABEL_CONFIGURAZIONE_HANDLERS = "Handlers";
	public final static String LABEL_CONFIGURAZIONE_HANDLERS_RICHIESTA = "Handlers per la Richiesta";
	public final static String LABEL_CONFIGURAZIONE_HANDLERS_RISPOSTA = "Handlers per la Risposta";
	public final static String LABEL_CONFIGURAZIONE_HANDLERS_SERVIZIO = "Service Handlers";
	public final static String LABEL_CONFIGURAZIONE_HANDLERS_INFORMAZIONI_GENERALI = "Informazioni Generali";
	public final static String LABEL_CONFIGURAZIONE_HANDLERS_RICHIESTA_TITOLO = "Handlers Richiesta [{0}]";
	public final static String LABEL_CONFIGURAZIONE_HANDLERS_RISPOSTA_TITOLO = "Handlers Risposta [{0}]";
	public final static String LABEL_CONFIGURAZIONE_HANDLERS_SERVIZIO_TITOLO = "Service Handlers [{0}]";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_HANDLERS_POSIZIONE = "Posizione";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_HANDLERS_STATO = "Stato";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_HANDLERS_LABEL = "Nome";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_HANDLERS_DESCRIZIONE = "Descrizione";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_HANDLERS_ID_HANDLER = "Id";
	
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_HANDLERS_RICHIESTA = "Handlers per la Richiesta";
	public final static String LABEL_PARAMETRO_CONFIGURAZIONE_HANDLERS_RICHIESTA_DI = "Handlers per la Richiesta di ";
...
//	public final static String LABEL_VALUE_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_DEGRADO_AVG_TIPO_LATENZA_PORTA = "Latenza introdotta dalla Porta"; // Non supportato
	...
	public final static String  DEFAULT_VALUE_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_SORGENTE_JAR = org.openspcoop2.core.config.constants.PluginSorgenteArchivio.JAR.toString();
	public final static String  DEFAULT_VALUE_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_SORGENTE_URL = org.openspcoop2.core.config.constants.PluginSorgenteArchivio.URL.toString();
	public final static String  DEFAULT_VALUE_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_SORGENTE_DIR = org.openspcoop2.core.config.constants.PluginSorgenteArchivio.DIR.toString();
	
	public final static String[] VALUES_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_SORGENTE = {
	...
	public final static String DEFAULT_VALUE_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_QUALSIASI = "qualsiasi";
	public final static String DEFAULT_VALUE_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN_SELEZIONATE = "selezionate";
	
	public final static String[] VALUES_PARAMETRO_CONFIGURAZIONE_PLUGINS_ARCHIVI_CLASSI_PLUGIN = {
	...
	public final static String CONFIGURAZIONE_SISTEMA_CACHE_STATO_ELEMENTI_VISUALIZZATI_ELEMENTI_IN_CACHE = "ElementiInCache";
	public final static String CONFIGURAZIONE_SISTEMA_CACHE_STATO_ELEMENTI_VISUALIZZATI_MEMORIA_OCCUPATA = "MemoriaOccupata";
	public final static String CONFIGURAZIONE_SISTEMA_CACHE_STATO_ELEMENTI_VISUALIZZATI_IDLE_TIME = "IdleTime";
	public final static String CONFIGURAZIONE_SISTEMA_CACHE_STATO_ELEMENTI_VISUALIZZATI_LIFE_TIME = "LifeTime";
	public final static String CONFIGURAZIONE_SISTEMA_CACHE_STATO_ELEMENTI_VISUALIZZATI_NOME = "Nome";
	
	public final static String CONFIGURAZIONE_SISTEMA_CACHE_STATO_ELEMENTI_VISUALIZZATI_ELEMENTI_IN_CACHE_LABEL = "Elementi in Cache";
	public final static String CONFIGURAZIONE_SISTEMA_CACHE_STATO_ELEMENTI_VISUALIZZATI_MEMORIA_OCCUPATA_LABEL = "Memoria Occupata";
	public final static String CONFIGURAZIONE_SISTEMA_CACHE_STATO_ELEMENTI_VISUALIZZATI_IDLE_TIME_LABEL = "Idle Time";
	public final static String CONFIGURAZIONE_SISTEMA_CACHE_STATO_ELEMENTI_VISUALIZZATI_LIFE_TIME_LABEL = "Life Time";
	...
	public final static List<String> LABEL_RATE_LIMITING_FILTRO_APPLICATIVO_SENZA_CONTENUTO = 
			ModalitaIdentificazione.getLabels(
					ModalitaIdentificazione.HEADER_BASED,
					ModalitaIdentificazione.URL_BASED,
					ModalitaIdentificazione.FORM_BASED,
	...
	public final static String PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_ACTIVE_POLICY_MODALITA_RISORSA_DIMENSIONE_MASSIMA = LABEL_CONFIGURAZIONE_RISORSA_DIMENSIONE_MASSIMA;
	...
	public final static long DEFAULT_VALUE_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_SOGLIA_VALORE_DIMENSIONE_MASSIMA = 10240; // kb
	...
	public final static String MESSAGGIO_ERRORE_RATE_LIMITING_PLUGIN_FILTRO_NON_SELEZIONATO = "Non &egrave; stato selezionato nessun plugin da utilizzare come filtro per chiave";
	public final static String MESSAGGIO_ERRORE_RATE_LIMITING_PLUGIN_GROUP_BY_NON_SELEZIONATO = "Non &egrave; stato selezionato nessun plugin da utilizzare come criterio di raggruppamento per chiave";

	public final static String LABEL_HANDLER_PLUGIN_NON_DISPONIBILI_PER_LA_FASE = "Non sono disponibili Plugin per la fase {0}";
	public final static String MESSAGGIO_HANDLER_RICHIESTA_DUPLICATO = "Esiste gi&agrave; un Handler di Richiesta per la fase {0} che utilizza il plugin {1}";
	public final static String MESSAGGIO_HANDLER_RISPOSTA_DUPLICATO = "Esiste gi&agrave; un Handler di Risposta per la fase {0} che utilizza il plugin {1}";
	public final static String MESSAGGIO_HANDLER_SERVIZIO_DUPLICATO = "Esiste gi&agrave; un Service Handler per la fase {0} che utilizza il plugin {1}";
	...
	public final static String MESSAGE_METADATI_DESCRIZIONE = "Descrizione: {0}";
	
	public final static String MESSAGE_METADATI_SEPARATORE = ", ";
	
	public final static String MESSAGE_METADATI_TOKEN_POLICY_TIPO = "Tipo: {0}";
	public final static String MESSAGE_METADATI_TOKEN_POLICY_DESCRIZIONE = "Descrizione: {0}";
	public final static String MESSAGE_METADATI_TOKEN_POLICY_TOKEN = "Token: {0}";
	public final static String MESSAGE_METADATI_TOKEN_POLICY_VALIDAZIONE = "Validazione: {0}";
	public final static String MESSAGE_METADATI_TOKEN_POLICY_FORWARD = "Forward: {0}";
	public final static String MESSAGE_METADATI_TOKEN_POLICY_MODALITA = "Modalità: {0}";
	
	public final static String MESSAGE_METADATI_ATTRIBUTE_AUTHORITY_SOLO_ATTRIBUTI = "Attributi: {0}";
	public final static String MESSAGE_METADATI_ATTRIBUTE_AUTHORITY_ATTRIBUTI_E_DESCRIZIONE = "Attributi: {0}, Descrizione: {1}";
	...
	public final static String ICONA_VISUALIZZA_RUNTIME_ALLARME = Costanti.ICONA_VISUALIZZA_RUNTIME_ALLARME;
	public final static String ICONA_VISUALIZZA_RUNTIME_ALLARME_TOOLTIP = Costanti.ICONA_VISUALIZZA_RUNTIME_ALLARME_TOOLTIP;

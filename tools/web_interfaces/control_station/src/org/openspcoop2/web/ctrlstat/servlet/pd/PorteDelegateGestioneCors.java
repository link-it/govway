...
public class PorteDelegateGestioneCors extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			// Preparo la lista
			pd.setMessage( ServletUtils.getMessageFromResourceBundle( session, "PorteDelegate.PorteDelegateCorsConSuccesso" ) , Costanti.MESSAGE_TYPE_INFO);	//PorteDelegateCostanti.LABEL_PORTE_DELEGATE_CORS_CON_SUCCESSO

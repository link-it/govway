...
public class PorteApplicativeCostanti {
	...
	public final static String SERVLET_NAME_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_ADD = OBJECT_NAME_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI+"Add.do";
	public final static String SERVLET_NAME_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_CHANGE = OBJECT_NAME_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI+"Change.do";
	public final static String SERVLET_NAME_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_DELETE = OBJECT_NAME_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI+"Del.do";
	public final static String SERVLET_NAME_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_LIST = OBJECT_NAME_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI+"List.do";
	...
	static{
		SERVLET_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI.add(SERVLET_NAME_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_ADD);
		SERVLET_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI.add(SERVLET_NAME_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_CHANGE);
		SERVLET_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI.add(SERVLET_NAME_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_DELETE);
		SERVLET_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI.add(SERVLET_NAME_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_LIST);
		SERVLET_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI.add(SERVLET_NAME_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_ABILITAZIONE);
	}
	...
	public final static String SERVLET_NAME_PORTE_APPLICATIVE_RESPONSE_CACHING_CONFIGURAZIONE_REGOLA_ADD = OBJECT_NAME_PORTE_APPLICATIVE_RESPONSE_CACHING_CONFIGURAZIONE_REGOLA+"Add.do";
	public final static String SERVLET_NAME_PORTE_APPLICATIVE_RESPONSE_CACHING_CONFIGURAZIONE_REGOLA_DELETE = OBJECT_NAME_PORTE_APPLICATIVE_RESPONSE_CACHING_CONFIGURAZIONE_REGOLA+"Del.do";
	public final static String SERVLET_NAME_PORTE_APPLICATIVE_RESPONSE_CACHING_CONFIGURAZIONE_REGOLA_LIST = OBJECT_NAME_PORTE_APPLICATIVE_RESPONSE_CACHING_CONFIGURAZIONE_REGOLA+"List.do";
	public final static Vector<String> SERVLET_PORTE_APPLICATIVE_RESPONSE_CACHING_CONFIGURAZIONE_REGOLA = new Vector<String>();
	static{
		SERVLET_PORTE_APPLICATIVE_RESPONSE_CACHING_CONFIGURAZIONE_REGOLA.add(SERVLET_NAME_PORTE_APPLICATIVE_RESPONSE_CACHING_CONFIGURAZIONE_REGOLA_ADD);
		SERVLET_PORTE_APPLICATIVE_RESPONSE_CACHING_CONFIGURAZIONE_REGOLA.add(SERVLET_NAME_PORTE_APPLICATIVE_RESPONSE_CACHING_CONFIGURAZIONE_REGOLA_DELETE);
		SERVLET_PORTE_APPLICATIVE_RESPONSE_CACHING_CONFIGURAZIONE_REGOLA.add(SERVLET_NAME_PORTE_APPLICATIVE_RESPONSE_CACHING_CONFIGURAZIONE_REGOLA_LIST);
	}
	...
	public final static String PARAMETRO_PORTE_APPLICATIVE_CONFIGURAZIONE_ALTRO = CostantiControlStation.PARAMETRO_CONFIGURAZIONE_ALTRO;
...
//	public final static String PARAMETRO_PORTE_APPLICATIVE_TRASFORMAZIONI_SOAP_ENVELOPE_AS_ATTACH = CostantiControlStation.PARAMETRO_CONFIGURAZIONE_TRASFORMAZIONI_SOAP_ENVELOPE_AS_ATTACH;
	...
	public final static String PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_CONFIGURAZIONE_PROPERTIES = "paCMVProp";
...
//	public final static String LABEL_PARAMETRO_PORTE_APPLICATIVE_CORRELAZIONI_APPLICATIVE_RISPOSTA_DI = "Regole della Risposta";
	...
	public final static String LABEL_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_CONDIZIONALE = "Configurazione Condizionalit&agrave;";
	...
	public final static String VALUE_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_ROUND_ROBIN = "roundRobin";
	public final static String VALUE_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_RANDOM_LOAD_BALANCE = "randomLoadBalance";
	public final static String VALUE_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_IP_HASH = "ipHash";
	public final static String VALUE_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_WEIGHT_ROUND_ROBIN = "weightRoundRobin";
	public final static String VALUE_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_WEIGHT_RANDOM = "weightRandom";
	
	public final static String [] VALUES_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA = {
		VALUE_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_ROUND_ROBIN,
		VALUE_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_RANDOM_LOAD_BALANCE,
		VALUE_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_IP_HASH,
		VALUE_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_WEIGHT_ROUND_ROBIN,
		VALUE_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_WEIGHT_RANDOM
	}; 
	
	public final static String LABEL_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_ROUND_ROBIN = "Round Robin";
	public final static String LABEL_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_RANDOM_LOAD_BALANCE = "Random LoadBalance";
	public final static String LABEL_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_IP_HASH = " IP Hash";
	public final static String LABEL_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_WEIGHT_ROUND_ROBIN = "Weight Round Robin";
	public final static String LABEL_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_WEIGHT_RANDOM = "Weight Random";
	
	public final static String [] LABELS_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA = {
		LABEL_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_ROUND_ROBIN,
		LABEL_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_RANDOM_LOAD_BALANCE,
		LABEL_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_IP_HASH,
		LABEL_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_WEIGHT_ROUND_ROBIN,
		LABEL_PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_MODALITA_CONSEGNA_LOAD_BALANCE_STRATEGIA_WEIGHT_RANDOM
	}; 

...
public class PorteApplicativeTrasformazioniRispostaChange extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			String trasformazioneContenutoRispostaAbilitatoS  = porteApplicativeHelper.getParametroBoolean(PorteApplicativeCostanti.PARAMETRO_PORTE_APPLICATIVE_TRASFORMAZIONI_RISPOSTA_CONVERSIONE_ENABLED);
			...
			String trasformazioneRispostaSoapAbilitatoS = porteApplicativeHelper.getParametroBoolean(PorteApplicativeCostanti.PARAMETRO_PORTE_APPLICATIVE_TRASFORMAZIONI_RISPOSTA_SOAP_TRANSFORMATION); 
			...
			if (porteApplicativeHelper.isEditModeInProgress()) {
				...
				dati = porteApplicativeHelper.addTrasformazioneRispostaToDati(TipoOperazione.CHANGE, protocollo, dati, idInt, oldRisposta, false, idTrasformazioneS, idTrasformazioneRispostaS, 
			...
			if(isOk) {
				...
				TrasformazioneRegolaRisposta regolaRispostaDBCheckApplicabilita = porteApplicativeCore.getTrasformazioneRisposta(Long.parseLong(idPorta), idTrasformazione, statusMinDBCheck, statusMaxDBCheck, patternDBCheck, contentTypeDBCheck);
				TrasformazioneRegolaRisposta regolaRispostaDBCheckNome = porteApplicativeCore.getTrasformazioneRisposta(Long.parseLong(idPorta), idTrasformazione, nomeRisposta);

...
public class ConnettoriHelper extends ConsoleHelper {
	...
	public void setTitleProprietaConnettoriCustom(PageData pd,TipoOperazione tipoOperazione,
		...
		if (AccordiServizioParteSpecificaCostanti.SERVLET_NAME_APS_CHANGE.equals(servlet)) {
			...
			List<Parameter> lstParamsPA_list = new ArrayList<>();
			lstParamsPA_list.addAll(lstParamsPA);
			lstParamsPA_list.add(new Parameter(PorteApplicativeCostanti.PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_CONFIGURAZIONE_DATI_GENERALI, Costanti.CHECK_BOX_ENABLED_TRUE));
			lstParam.add(new Parameter(labelPerPorta,PorteApplicativeCostanti.SERVLET_NAME_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_LIST, lstParamsPA_list.toArray(new Parameter[lstParamsPA_list.size()]))); 
			...
			List<Parameter> lstParamsPA_change = new ArrayList<>();
			lstParamsPA_change.addAll(lstParamsPA);
			lstParamsPA_change.add(new Parameter(PorteApplicativeCostanti.PARAMETRO_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_CONFIGURAZIONE_CONNETTORE, Costanti.CHECK_BOX_ENABLED_TRUE));
			lstParam.add(new Parameter(labelPagina,PorteApplicativeCostanti.SERVLET_NAME_PORTE_APPLICATIVE_CONNETTORI_MULTIPLI_CHANGE, lstParamsPA_change.toArray(new Parameter[lstParamsPA_change.size()]))); 
...
//					}
	...
	public Vector<DataElement> addCredenzialiCertificatiToDati(Vector<DataElement> dati, TipoOperazione tipoOperazione, String idCredenziale, String tipoauth, String subject, String toCall,
			...
			boolean visualizzaPromuoviCertificato, String aggiornaCertificatoCaricato, String servletCredenzialiChange, List<Parameter> parametersServletCredenzialiChange) throws Exception{
...
//							NotAfter:
	...
	public Vector<DataElement> addCredenzialiCertificatiToDatiAsHidden(Vector<DataElement> dati, TipoOperazione tipoOperazione, String idCredenziale, String tipoauth, String subject, String toCall, 
			...
			String tipoCredenzialiSSLAliasCertificatoNotBefore, String tipoCredenzialiSSLAliasCertificatoNotAfter, String tipoCredenzialiSSLVerificaTuttiICampi, String tipoCredenzialiSSLConfigurazioneManualeSelfSigned,
			String issuer, String tipoCredenzialiSSLStatoElaborazioneCertificato, String promuoviCertificato,
			boolean visualizzaPromuoviCertificato, String servletCredenzialiChange, List<Parameter> parametersServletCredenzialiChange) throws Exception{

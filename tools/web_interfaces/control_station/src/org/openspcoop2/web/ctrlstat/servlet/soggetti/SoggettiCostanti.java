...
public class SoggettiCostanti {
	...
	public final static String SERVLET_NAME_SOGGETTI_CREDENZIALI_ADD = OBJECT_NAME_SOGGETTI_CREDENZIALI + "Add.do";
	public final static String SERVLET_NAME_SOGGETTI_CREDENZIALI_CHANGE = OBJECT_NAME_SOGGETTI_CREDENZIALI + "Change.do";
	public final static String SERVLET_NAME_SOGGETTI_CREDENZIALI_DELETE = OBJECT_NAME_SOGGETTI_CREDENZIALI + "Del.do";
	public final static String SERVLET_NAME_SOGGETTI_CREDENZIALI_LIST = OBJECT_NAME_SOGGETTI_CREDENZIALI + "List.do";
	public final static Vector<String> SERVLET_SOGGETTI_CREDENZIALI = new Vector<String>();
	static {

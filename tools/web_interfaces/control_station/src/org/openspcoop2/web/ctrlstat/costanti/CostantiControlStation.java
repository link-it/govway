...
public class CostantiControlStation {
	...
	public final static String LABEL_PARAMETRO_REGISTRO_INTERFACE = "Interfaccia API";
	public static final String LABEL_PATTERN = "Pattern";
	public final static String LABEL_PARAMETRO_SCHEMI_JSON = "Schemi JSON";
	...
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_SOAP_ACTION = "SOAPAction";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_JSON_SCHEMA = "JSON Schema";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_PATTERN_AND = "And";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_PATTERN_NOT = "Not";
	...
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_PATTERN_ID_PATTERN = "id";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_PATTERN_NOME = "Nome";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_PATTERN_REGOLE = "Regole";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_PATTERN_AND = "And";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_PATTERN_NOT = "Not";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA = "Richiesta";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTE = "Richieste";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA = "Risposta";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTE = "Risposte";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_APPLICABILITA = "Applicabilit&agrave;";
	
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_ID_RISPOSTA = "Id";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_POSIZIONE = "Posizione";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_NOME = "Nome";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_AND = "And";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_NOT = "Not";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_SOAP_ACTION = "SOAPAction";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_JSON_SCHEMA = "JSON Schema";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_STATO = "Stato";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_MTOM = "Accetta MTOM";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_TIPO = "Tipo Validazione";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_AZIONI = "Azioni";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_CT = "Content-Type";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_PATTERN = "Pattern";
	
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_ID_RISPOSTA = "Id";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_POSIZIONE = "Posizione";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_NOME = "Nome";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_AND = "And";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_NOT = "Not";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_JSON_SCHEMA = "JSON Schema";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_STATO = "Stato";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_MTOM = "Accetta MTOM";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_TIPO = "Tipo Validazione";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_AZIONI = "Azioni";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_CT = "Content-Type";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_PATTERN = "Pattern";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_STATUS = "Codice Risposta";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_STATUS_MIN = "Min";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_STATUS_MAX = "Max";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_PROBLEM_DETAIL = "Problem Detail";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_EMPTY_RESPONSE = "Risposta Vuota";
	...
	public final static String PARAMETRO_PORTE_VALIDAZIONE_SOAP_ACTION = "valSoapAction";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_JSON_SCHEMA = "valJsonSchema";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_PATTERN_AND = "valPatternAnd";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_PATTERN_NOT = "valPatternNot";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_PATTERN_ID_PATTERN = "valPatternId";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_PATTERN_NOME = "valPatternNome";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_PATTERN_REGOLE = "valPatternRegole";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_PATTERN_AND = "valPatternAnd";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_PATTERN_NOT = "valPatternNot";
	
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_ID_RICHIESTA = "valConId";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_POSIZIONE = "valConPos";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_NOME = "valContNome";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_AND = PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_PATTERN_AND;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_NOT = PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_PATTERN_NOT;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_SOAP_ACTION = PARAMETRO_PORTE_VALIDAZIONE_SOAP_ACTION;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_JSON_SCHEMA = PARAMETRO_PORTE_VALIDAZIONE_JSON_SCHEMA;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_STATO = PARAMETRO_PORTE_XSD;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_MTOM = PARAMETRO_PORTE_APPLICA_MTOM;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_TIPO = PARAMETRO_PORTE_TIPO_VALIDAZIONE;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_AZIONI = "valConAppAz";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_CT = "valConAppCt";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_PATTERN = "valConAppPat";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_AZIONI_ALL = "trAppAzioniAll";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_AZIONI_ALL_VALUE_TRUE = Costanti.CHECK_BOX_ENABLED;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_AZIONI_ALL_VALUE_FALSE = Costanti.CHECK_BOX_DISABLED;
	public final static String [] PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_AZIONI_ALL_VALUES = new String [] {
			PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_AZIONI_ALL_VALUE_TRUE,
			PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_AZIONI_ALL_VALUE_FALSE
	};
	
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_ID_RISPOSTA = PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_ID_RICHIESTA;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_POSIZIONE = PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_POSIZIONE;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_NOME = PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_NOME;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_AND = PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_AND;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_NOT = PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_NOT;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_SOAP_ACTION = PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_SOAP_ACTION;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_JSON_SCHEMA = PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_JSON_SCHEMA;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_STATO = PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_STATO;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_MTOM = PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_MTOM;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_TIPO = PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_TIPO;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_AZIONI = PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_AZIONI;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_CT = PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_CT;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_PATTERN = PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_PATTERN;
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_STATUS = "valRisAppStat";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_STATUS_MIN = "valRisAppStatMin";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_STATUS_MAX = "valRisAppStatMax";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_PROBLEM_DETAIL = "valRisAppProbDet";
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_EMPTY_RESPONSE = "valRisAppEmpRes";
	
	public final static String PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_PATTERN_PARENT = "valPatParent";
...
//	public final static String PARAMETRO_CONFIGURAZIONE_TRASFORMAZIONI_SOAP_ENVELOPE_AS_ATTACH = "trSoapEnvAsAt";
	...
	public final static String DEFAULT_VALUE_PARAMETRO_PORTE_TIPO_VALIDAZIONE_JSON = CostantiConfigurazione.VALIDAZIONE_CONTENUTI_APPLICATIVI_JSON.toString();
	public final static String DEFAULT_VALUE_PARAMETRO_PORTE_TIPO_VALIDAZIONE_PATTERN = CostantiConfigurazione.VALIDAZIONE_CONTENUTI_APPLICATIVI_PATTERN.toString();
	...
	public final static int DEFAULT_VALUE_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_MATCH_LIST_MAX_VALUE = 100;
	...
	public final static String DEFAULT_VALUE_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_PATTERN_PARENT_RICHIESTA = "richiesta";
	public final static String DEFAULT_VALUE_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_PATTERN_PARENT_RISPOSTA = "risposta";
	public final static String DEFAULT_VALUE_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_PATTERN_PARENT_PORTA = "porta";
	...
	/** COSTANTI VISUALIZZAZIONE MESSAGGI MODIFICA POSIZIONE VALIDAZIONE CONTENUTI RICHIESTE/RISPOSTE */
	public static final boolean VISUALIZZA_MESSAGGIO_CONFERMA_SPOSTAMENTO_VALIDAZIONE_CONTENUTI_RICHIESTA = false;
	public static final boolean VISUALIZZA_MESSAGGIO_CONFERMA_SPOSTAMENTO_VALIDAZIONE_CONTENUTI_RISPOSTA = false;
	...
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE = "Lista di Content-Type per i quali la regola di trasformazione verrà utilizzata; di seguito i formati utilizzabili:";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE_VALORE_EMPTY = "<b>empty</b>: valore speciale che rappresenta una richiesta senza Content-Type"; 
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE_VALORE_1 = "<b>type/subtype</b>: indicazione puntuale di un Content-Type"; 
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE_VALORE_2 = "<b>type/*</b>: hanno un match tutti i Content-Type appartenenti al tipo indicato"; 
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE_VALORE_3 = "<b>*/*+xml</b>: hanno un match tutti i Content-Type che terminano con '+xml'";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE_VALORE_4 = "<b>regexpType/regexpSubType</b>: hanno un match tutti i Content-Type che soddisfano le espressioni regolari indicate"; 
	public final static List<String> LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE_VALORI = new ArrayList<>();
	static {
		LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE_VALORI.add(LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE_VALORE_1);
		LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE_VALORI.add(LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE_VALORE_2);
		LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE_VALORI.add(LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE_VALORE_3);
		LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE_VALORI.add(LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE_VALORE_4);
		LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE_VALORI.add(LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_CONTENT_TYPE_VALORE_EMPTY);
	}
	
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_PATTERN_REST_RICHIESTA = "Espressione da applicare sul messaggio di richiesta; se si ha un match la regola di trasformazione verrà utilizzata.<br/>I tipi di espressione utilizzabili sono:";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_PATTERN_REST_RISPOSTA = "Espressione da applicare sul messaggio di risposta; se si ha un match la regola di trasformazione verrà utilizzata.<br/>I tipi di espressione utilizzabili sono:";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_PATTERN_SOAP_RICHIESTA = "Espressione XPath da applicare sul messaggio di richiesta; se si ha un match la regola di trasformazione verrà utilizzata.";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_PATTERN_SOAP_RISPOSTA = "Espressione XPath da applicare sul messaggio di risposta; se si ha un match la regola di trasformazione verrà utilizzata.";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_PATTERN_XPATH = "<b>XPath</b>: utilizzabile con messaggi XML";
	public final static String LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_PATTERN_JSONPATH = "<b>JSONPath</b>: utilizzabile con messaggi JSON";
	public final static List<String> LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_PATTERN_VALORI_REST = new ArrayList<>();
	static {
		LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_PATTERN_VALORI_REST.add(LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_PATTERN_XPATH);
		LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_PATTERN_VALORI_REST.add(LABEL_PARAMETRO_PORTE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_INFO_PATTERN_JSONPATH);
	}
	...
	public static final String MESSAGGIO_CONFERMA_VALIDAZIONE_CONTENUTI_RICHIESTA_SPOSTATA_CORRETTAMENTE ="Posizione della richiesta modificata correttamente.";
	public static final String MESSAGGIO_CONFERMA_VALIDAZIONE_CONTENUTI_RISPOSTA_SPOSTATA_CORRETTAMENTE ="Posizione della risposta modificata correttamente.";
...
//	public static final String MESSAGGIO_ERRORE_SOGGETTI_PRESENTI_TRASFORMAZIONI_AUTORIZZAZIONE_DISABILITATA = "Non &egrave; possibile disabilitare l'autorizzazione senza prima eliminare i soggetti associati alle trasformazioni:";
	...
	public static final String MESSAGGIO_ERRORE_VALIDAZIONE_CONTENUTI_PATTERN_GIA_PRESENTE = "&Egrave; gi&agrave; presente un pattern con il Nome indicato.";
	public static final String MESSAGGIO_ERRORE_VALIDAZIONE_CONTENUTI_PATTERN_NUOVO_NOME_GIA_PRESENTE = "Il nuovo Nome indicato &egrave; gi&agrave; utilizzato da un altro Pattern.";
	
	public static final String MESSAGGIO_ERRORE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_DUPLICATA = "&Egrave; gi&agrave; presente una richiesta con i parametri di applicabilit&agrave; indicati.";
	public static final String MESSAGGIO_ERRORE_VALIDAZIONE_CONTENUTI_RICHIESTA_APPLICABILITA_NOME = "&Egrave; gi&agrave; presente una richiesta con il nome indicato.";
	public static final String MESSAGGIO_ERRORE_VALIDAZIONE_CONTENUTI_RICHIESTA_GIA_PRESENTE = "&Egrave; gi&agrave; presente una richiesta con il Nome indicato.";
	public static final String MESSAGGIO_ERRORE_VALIDAZIONE_CONTENUTI_RICHIESTA_NUOVO_NOME_GIA_PRESENTE = "Il nuovo Nome indicato &egrave; gi&agrave; utilizzato da un'altra richiesta.";
	
	public static final String MESSAGGIO_ERRORE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_DUPLICATA = "&Egrave; gi&agrave; presente una risposta con i parametri di applicabilit&agrave; indicati.";
	public static final String MESSAGGIO_ERRORE_VALIDAZIONE_CONTENUTI_RISPOSTA_APPLICABILITA_NOME = "&Egrave; gi&agrave; presente una risposta con il nome indicato.";
	public static final String MESSAGGIO_ERRORE_VALIDAZIONE_CONTENUTI_RISPOSTA_GIA_PRESENTE = "&Egrave; gi&agrave; presente una risposta con il Nome indicato.";
	public static final String MESSAGGIO_ERRORE_VALIDAZIONE_CONTENUTI_RISPOSTA_NUOVO_NOME_GIA_PRESENTE = "Il nuovo Nome indicato &egrave; gi&agrave; utilizzato da un'altra risposta.";

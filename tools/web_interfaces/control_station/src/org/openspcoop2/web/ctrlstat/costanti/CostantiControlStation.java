...
public class CostantiControlStation {
	...
	public static final String LABEL_PARAMETRO_PORTE_AUTENTICAZIONE_TOKEN_PDND_ORGANIZATION_NAME = "PDND Organization Name";
	public static final String LABEL_PARAMETRO_PORTE_AUTENTICAZIONE_TOKEN_PDND_ORGANIZATION_EXTERNAL_ID = "PDND Organization ExternalId";
	public static final String LABEL_PARAMETRO_PORTE_AUTENTICAZIONE_TOKEN_PDND_ORGANIZATION_CONSUMER_ID = "PDND ConsumerId";
	...
	public static final String LABEL_CONFIGURAZIONE_REGISTRAZIONE_ESITI_OK_FAULT = "Completate con successo - Fault Applicativo";
	...
	public static final String LABEL_CONFIGURAZIONE_RISORSA_NUMERO_TOKEN_INPUT = "Token Input";
	public static final String LABEL_CONFIGURAZIONE_RISORSA_NUMERO_TOKEN_OUTPUT = "Token Output";
	public static final String LABEL_CONFIGURAZIONE_RISORSA_NUMERO_TOKEN_COMPLESSIVI = "Token Complessivi";
	public static final String LABEL_CONFIGURAZIONE_RISORSA_COSTO = "Costo Token LLM";
	...
	public static final String[] LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_TIPI_RISORSE_VALORI = {
			...
			TipoRisorsaPolicyAttiva.NUMERO_RICHIESTE_COMPLETATE_CON_SUCCESSO_OFAULT_APPLICATIVI.getValue(),
			TipoRisorsaPolicyAttiva.NUMERO_RICHIESTE_FALLITE_OFAULT_APPLICATIVI.getValue(),
			TipoRisorsaPolicyAttiva.NUMERO_TOKEN_INPUT.getValue(),
			TipoRisorsaPolicyAttiva.NUMERO_TOKEN_OUTPUT.getValue(),
			TipoRisorsaPolicyAttiva.NUMERO_TOKEN_COMPLESSIVI.getValue(),
			TipoRisorsaPolicyAttiva.COSTO.getValue()
	};
	public static final String[] LABEL_PARAMETRO_CONFIGURAZIONE_CONTROLLO_TRAFFICO_POLICY_TIPI_RISORSE_LABELS = {
			...
			LABEL_CONFIGURAZIONE_RISORSA_NUMERO_RICHIESTE+ " "+LABEL_CONFIGURAZIONE_REGISTRAZIONE_ESITI_OK+" o Fault Applicativi",	
			LABEL_CONFIGURAZIONE_RISORSA_NUMERO_RICHIESTE+ " "+LABEL_CONFIGURAZIONE_REGISTRAZIONE_ESITI_FALLITE+" o Fault Applicativi",
			LABEL_CONFIGURAZIONE_RISORSA_NUMERO_TOKEN_INPUT,
			LABEL_CONFIGURAZIONE_RISORSA_NUMERO_TOKEN_OUTPUT,
			LABEL_CONFIGURAZIONE_RISORSA_NUMERO_TOKEN_COMPLESSIVI,
			LABEL_CONFIGURAZIONE_RISORSA_COSTO,
	};
...
//	public static final String PARAMETRO_CONFIGURAZIONE_TRASFORMAZIONI_SOAP_ENVELOPE_AS_ATTACH = "trSoapEnvAsAt";
	...
	public static final List<String> LABEL_TOKEN_VALUES_WITHOUT_ISSUER_CON_PDND = new ArrayList<>();
	static {
		LABEL_TOKEN_VALUES_WITHOUT_ISSUER_CON_PDND.add(LABEL_PARAMETRO_PORTE_AUTENTICAZIONE_TOKEN_SUBJECT);
		LABEL_TOKEN_VALUES_WITHOUT_ISSUER_CON_PDND.add(LABEL_PARAMETRO_PORTE_AUTENTICAZIONE_TOKEN_CLIENT_ID);
		LABEL_TOKEN_VALUES_WITHOUT_ISSUER_CON_PDND.add(LABEL_PARAMETRO_PORTE_AUTENTICAZIONE_TOKEN_PDND_ORGANIZATION_NAME);
		LABEL_TOKEN_VALUES_WITHOUT_ISSUER_CON_PDND.add(LABEL_PARAMETRO_PORTE_AUTENTICAZIONE_TOKEN_PDND_ORGANIZATION_EXTERNAL_ID);
		LABEL_TOKEN_VALUES_WITHOUT_ISSUER_CON_PDND.add(LABEL_PARAMETRO_PORTE_AUTENTICAZIONE_TOKEN_PDND_ORGANIZATION_CONSUMER_ID);
		LABEL_TOKEN_VALUES_WITHOUT_ISSUER_CON_PDND.add(LABEL_PARAMETRO_PORTE_AUTENTICAZIONE_TOKEN_USERNAME);
		LABEL_TOKEN_VALUES_WITHOUT_ISSUER_CON_PDND.add(LABEL_PARAMETRO_PORTE_AUTENTICAZIONE_TOKEN_MAIL);
	}
	...
	public static final List<String> TOKEN_VALUES_WITHOUT_ISSUER_CON_PDND_INFO = new ArrayList<>();
	static {
		TOKEN_VALUES_WITHOUT_ISSUER_CON_PDND_INFO.add(TipoCredenzialeMittente.TOKEN_SUBJECT.getRawValue());
		TOKEN_VALUES_WITHOUT_ISSUER_CON_PDND_INFO.add(TipoCredenzialeMittente.TOKEN_CLIENT_ID.getRawValue());
		TOKEN_VALUES_WITHOUT_ISSUER_CON_PDND_INFO.add(TipoCredenzialeMittente.PDND_ORGANIZATION_NAME.getRawValue());
		TOKEN_VALUES_WITHOUT_ISSUER_CON_PDND_INFO.add(TipoCredenzialeMittente.PDND_ORGANIZATION_EXTERNAL_ID.getRawValue());
		TOKEN_VALUES_WITHOUT_ISSUER_CON_PDND_INFO.add(TipoCredenzialeMittente.PDND_ORGANIZATION_CONSUMER_ID.getRawValue());
		TOKEN_VALUES_WITHOUT_ISSUER_CON_PDND_INFO.add(TipoCredenzialeMittente.TOKEN_USERNAME.getRawValue());
		TOKEN_VALUES_WITHOUT_ISSUER_CON_PDND_INFO.add(TipoCredenzialeMittente.TOKEN_EMAIL.getRawValue());
	}
	...
	public static final String MESSAGGIO_ERRORE_NON_INIZIARE_O_TERMINARE_CON_SPAZI_NEI_CAMPI_DI_TESTO = "Non iniziare o terminare con spazi nei campi di testo";

 ...
 * This class was generated by Apache CXF 3.2.6
  * 2019-09-19T15:22:21.858+02:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "ScopeSoap12Service",
                  wsdlLocation = "file:deploy/wsdl/ScopeCRUD_PortSoap12.wsdl",
...
public class ScopeSoap12Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/ScopeCRUD_PortSoap12.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ScopeSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/ScopeCRUD_PortSoap12.wsdl");
        }
        WSDL_LOCATION = url;
    }

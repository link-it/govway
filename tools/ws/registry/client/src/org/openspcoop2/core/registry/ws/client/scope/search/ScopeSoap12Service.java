 ...
 * This class was generated by Apache CXF 3.2.6
  * 2019-09-19T15:21:50.069+02:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "ScopeSoap12Service",
                  wsdlLocation = "file:deploy/wsdl/ScopeSearch_PortSoap12.wsdl",
                  targetNamespace = "http://www.openspcoop2.org/core/registry/management")
public class ScopeSoap12Service extends Service {

    public static final URL WSDL_LOCATION;

    public static final QName SERVICE = new QName("http://www.openspcoop2.org/core/registry/management", "ScopeSoap12Service");
    public static final QName ScopePortSoap12 = new QName("http://www.openspcoop2.org/core/registry/management", "ScopePortSoap12");
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/ScopeSearch_PortSoap12.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ScopeSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/ScopeSearch_PortSoap12.wsdl");
        }
        WSDL_LOCATION = url;
    }

 ...
 * This class was generated by Apache CXF 3.2.6
  * 2019-09-19T15:19:12.675+02:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "GruppoSoap12Service",
                  wsdlLocation = "file:deploy/wsdl/GruppoCRUD_PortSoap12.wsdl",
...
public class GruppoSoap12Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/GruppoCRUD_PortSoap12.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GruppoSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/GruppoCRUD_PortSoap12.wsdl");
        }
        WSDL_LOCATION = url;
    }

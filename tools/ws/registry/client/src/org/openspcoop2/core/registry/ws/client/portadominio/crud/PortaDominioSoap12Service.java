 ...
 * 2015-01-26T16:24:54.886+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "PortaDominioSoap12Service", 
                  wsdlLocation = "deploy/wsdl/PortaDominioCRUD_PortSoap12.wsdl",
...
public class PortaDominioSoap12Service extends Service {
    ...
    static {
        URL url = PortaDominioSoap12Service.class.getResource("deploy/wsdl/PortaDominioCRUD_PortSoap12.wsdl");
        if (url == null) {
            url = PortaDominioSoap12Service.class.getClassLoader().getResource("deploy/wsdl/PortaDominioCRUD_PortSoap12.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = PortaDominioSoap12Service.class.getResource("/registry/PortaDominioCRUD_PortSoap12.wsdl");
		}
		if (url==null ){

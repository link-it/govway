 ...
 * 2017-04-24T12:01:56.468+02:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "PortaDominioSoap12Service", 
                  wsdlLocation = "file:deploy/wsdl/PortaDominioCRUD_PortSoap12.wsdl",
...
public class PortaDominioSoap12Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/PortaDominioCRUD_PortSoap12.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PortaDominioSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/PortaDominioCRUD_PortSoap12.wsdl");
        }
        WSDL_LOCATION = url;
    }

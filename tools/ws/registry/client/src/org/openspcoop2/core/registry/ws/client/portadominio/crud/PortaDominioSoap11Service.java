 ...
 * 2015-01-26T16:24:46.299+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "PortaDominioSoap11Service", 
                  wsdlLocation = "deploy/wsdl/PortaDominioCRUD_PortSoap11.wsdl",
...
public class PortaDominioSoap11Service extends Service {
    ...
    static {
        URL url = PortaDominioSoap11Service.class.getResource("deploy/wsdl/PortaDominioCRUD_PortSoap11.wsdl");
        if (url == null) {
            url = PortaDominioSoap11Service.class.getClassLoader().getResource("deploy/wsdl/PortaDominioCRUD_PortSoap11.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = PortaDominioSoap11Service.class.getResource("/registry/PortaDominioCRUD_PortSoap11.wsdl");
		}
		if (url==null ){
			url = PortaDominioSoap11Service.class.getClassLoader().getResource("/registry/PortaDominioCRUD_PortSoap11.wsdl");
		}
		if (url==null ){
			java.util.logging.Logger.getLogger(PortaDominioSoap11Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/PortaDominioCRUD_PortSoap11.wsdl");
        }       
        WSDL_LOCATION = url;
    }

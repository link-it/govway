 ...
 * This class was generated by Apache CXF 3.2.6
  * 2019-03-05T14:06:02.619+01:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "AccordoServizioParteComuneSoap11Service",
                  wsdlLocation = "file:deploy/wsdl/AccordoServizioParteComuneAll_PortSoap11.wsdl",
...
public class AccordoServizioParteComuneSoap11Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/AccordoServizioParteComuneAll_PortSoap11.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccordoServizioParteComuneSoap11Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/AccordoServizioParteComuneAll_PortSoap11.wsdl");
        }
        WSDL_LOCATION = url;
    }

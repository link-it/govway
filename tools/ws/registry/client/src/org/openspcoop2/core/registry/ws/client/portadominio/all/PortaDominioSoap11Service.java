 ...
 * This class was generated by Apache CXF 3.2.6
  * 2019-09-19T15:16:25.314+02:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "PortaDominioSoap11Service",
                  wsdlLocation = "file:deploy/wsdl/PortaDominioAll_PortSoap11.wsdl",
...
public class PortaDominioSoap11Service extends Service {
    ...
    public static final QName SERVICE = new QName("http://www.openspcoop2.org/core/registry/management", "PortaDominioSoap11Service");
    public static final QName PortaDominioPortSoap11 = new QName("http://www.openspcoop2.org/core/registry/management", "PortaDominioPortSoap11");
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/PortaDominioAll_PortSoap11.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PortaDominioSoap11Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/PortaDominioAll_PortSoap11.wsdl");
        }
        WSDL_LOCATION = url;
    }

 ...
 * 2015-01-26T16:24:03.290+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "AccordoServizioParteComuneSoap12Service", 
                  wsdlLocation = "deploy/wsdl/AccordoServizioParteComuneCRUD_PortSoap12.wsdl",
...
public class AccordoServizioParteComuneSoap12Service extends Service {
    ...
    static {
        URL url = AccordoServizioParteComuneSoap12Service.class.getResource("deploy/wsdl/AccordoServizioParteComuneCRUD_PortSoap12.wsdl");
        if (url == null) {
            url = AccordoServizioParteComuneSoap12Service.class.getClassLoader().getResource("deploy/wsdl/AccordoServizioParteComuneCRUD_PortSoap12.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = AccordoServizioParteComuneSoap12Service.class.getResource("/registry/AccordoServizioParteComuneCRUD_PortSoap12.wsdl");
		}
		if (url==null ){

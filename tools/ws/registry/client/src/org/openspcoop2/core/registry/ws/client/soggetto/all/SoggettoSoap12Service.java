 ...
 * This class was generated by Apache CXF 3.2.6
  * 2019-09-19T15:22:51.440+02:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "SoggettoSoap12Service",
                  wsdlLocation = "file:deploy/wsdl/SoggettoAll_PortSoap12.wsdl",
...
public class SoggettoSoap12Service extends Service {
    ...
    public static final QName SERVICE = new QName("http://www.openspcoop2.org/core/registry/management", "SoggettoSoap12Service");
    public static final QName SoggettoPortSoap12 = new QName("http://www.openspcoop2.org/core/registry/management", "SoggettoPortSoap12");
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/SoggettoAll_PortSoap12.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SoggettoSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/SoggettoAll_PortSoap12.wsdl");
        }
        WSDL_LOCATION = url;
    }

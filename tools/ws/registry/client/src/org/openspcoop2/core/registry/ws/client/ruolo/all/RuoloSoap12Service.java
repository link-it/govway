 ...
 * 2018-05-30T09:49:20.208+02:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "RuoloSoap12Service", 
                  wsdlLocation = "file:deploy/wsdl/RuoloAll_PortSoap12.wsdl",
...
public class RuoloSoap12Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/RuoloAll_PortSoap12.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RuoloSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/RuoloAll_PortSoap12.wsdl");
        }
        WSDL_LOCATION = url;
    }

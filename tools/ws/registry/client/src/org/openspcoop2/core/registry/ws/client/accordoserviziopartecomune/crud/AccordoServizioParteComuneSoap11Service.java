 ...
 * 2015-01-26T16:23:54.966+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "AccordoServizioParteComuneSoap11Service", 
                  wsdlLocation = "deploy/wsdl/AccordoServizioParteComuneCRUD_PortSoap11.wsdl",
...
public class AccordoServizioParteComuneSoap11Service extends Service {
    ...
    static {
        URL url = AccordoServizioParteComuneSoap11Service.class.getResource("deploy/wsdl/AccordoServizioParteComuneCRUD_PortSoap11.wsdl");
        if (url == null) {
            url = AccordoServizioParteComuneSoap11Service.class.getClassLoader().getResource("deploy/wsdl/AccordoServizioParteComuneCRUD_PortSoap11.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = AccordoServizioParteComuneSoap11Service.class.getResource("/registry/AccordoServizioParteComuneCRUD_PortSoap11.wsdl");
		}
		if (url==null ){
			url = AccordoServizioParteComuneSoap11Service.class.getClassLoader().getResource("/registry/AccordoServizioParteComuneCRUD_PortSoap11.wsdl");
		}
		if (url==null ){
			java.util.logging.Logger.getLogger(AccordoServizioParteComuneSoap11Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/AccordoServizioParteComuneCRUD_PortSoap11.wsdl");
        }       
        WSDL_LOCATION = url;
    }

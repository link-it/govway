 ...
 * 2015-01-26T16:22:54.876+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "AccordoCooperazioneSoap12Service", 
                  wsdlLocation = "deploy/wsdl/AccordoCooperazioneSearch_PortSoap12.wsdl",
...
public class AccordoCooperazioneSoap12Service extends Service {
    ...
    static {
        URL url = AccordoCooperazioneSoap12Service.class.getResource("deploy/wsdl/AccordoCooperazioneSearch_PortSoap12.wsdl");
        if (url == null) {
            url = AccordoCooperazioneSoap12Service.class.getClassLoader().getResource("deploy/wsdl/AccordoCooperazioneSearch_PortSoap12.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = AccordoCooperazioneSoap12Service.class.getResource("/registry/AccordoCooperazioneSearch_PortSoap12.wsdl");
		}
		if (url==null ){
			url = AccordoCooperazioneSoap12Service.class.getClassLoader().getResource("/registry/AccordoCooperazioneSearch_PortSoap12.wsdl");
		}
		if (url==null ){
			java.util.logging.LoggerWrapperFactory.getLogger(AccordoCooperazioneSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/AccordoCooperazioneSearch_PortSoap12.wsdl");
        }       
        WSDL_LOCATION = url;
    }

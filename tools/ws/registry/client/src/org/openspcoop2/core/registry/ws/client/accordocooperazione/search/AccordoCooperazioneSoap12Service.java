 ...
 * This class was generated by Apache CXF 3.2.6
  * 2019-09-19T15:14:11.838+02:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "AccordoCooperazioneSoap12Service",
                  wsdlLocation = "file:deploy/wsdl/AccordoCooperazioneSearch_PortSoap12.wsdl",
...
public class AccordoCooperazioneSoap12Service extends Service {
    ...
    public static final QName SERVICE = new QName("http://www.openspcoop2.org/core/registry/management", "AccordoCooperazioneSoap12Service");
    public static final QName AccordoCooperazionePortSoap12 = new QName("http://www.openspcoop2.org/core/registry/management", "AccordoCooperazionePortSoap12");
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/AccordoCooperazioneSearch_PortSoap12.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccordoCooperazioneSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/AccordoCooperazioneSearch_PortSoap12.wsdl");
        }
        WSDL_LOCATION = url;
    }

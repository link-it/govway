...
public class RegistryNotFoundException_Exception extends Exception {
    ...
    public RegistryNotFoundException_Exception(String message, org.openspcoop2.core.registry.ws.client.accordoserviziopartecomune.all.RegistryNotFoundException registryNotFoundException, java.lang.Throwable cause) {
        super(message, cause);
        this.registryNotFoundException = registryNotFoundException;
    }

 ...
 * 2015-01-26T16:22:26.790+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "AccordoCooperazioneSoap11Service", 
                  wsdlLocation = "deploy/wsdl/AccordoCooperazioneAll_PortSoap11.wsdl",
...
public class AccordoCooperazioneSoap11Service extends Service {
    ...
    static {
        URL url = AccordoCooperazioneSoap11Service.class.getResource("deploy/wsdl/AccordoCooperazioneAll_PortSoap11.wsdl");
        if (url == null) {
            url = AccordoCooperazioneSoap11Service.class.getClassLoader().getResource("deploy/wsdl/AccordoCooperazioneAll_PortSoap11.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = AccordoCooperazioneSoap11Service.class.getResource("/registry/AccordoCooperazioneAll_PortSoap11.wsdl");
		}
		if (url==null ){
			url = AccordoCooperazioneSoap11Service.class.getClassLoader().getResource("/registry/AccordoCooperazioneAll_PortSoap11.wsdl");
		}
		if (url==null ){
			java.util.logging.Logger.getLogger(AccordoCooperazioneSoap11Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/AccordoCooperazioneAll_PortSoap11.wsdl");
        }       
        WSDL_LOCATION = url;
    }

 ...
 * 2015-01-26T16:26:38.262+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "AccordoServizioParteSpecificaSoap12Service", 
                  wsdlLocation = "deploy/wsdl/AccordoServizioParteSpecificaCRUD_PortSoap12.wsdl",
...
public class AccordoServizioParteSpecificaSoap12Service extends Service {
    ...
    static {
        URL url = AccordoServizioParteSpecificaSoap12Service.class.getResource("deploy/wsdl/AccordoServizioParteSpecificaCRUD_PortSoap12.wsdl");
        if (url == null) {
            url = AccordoServizioParteSpecificaSoap12Service.class.getClassLoader().getResource("deploy/wsdl/AccordoServizioParteSpecificaCRUD_PortSoap12.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = AccordoServizioParteSpecificaSoap12Service.class.getResource("/registry/AccordoServizioParteSpecificaCRUD_PortSoap12.wsdl");
		}
		if (url==null ){
			url = AccordoServizioParteSpecificaSoap12Service.class.getClassLoader().getResource("/registry/AccordoServizioParteSpecificaCRUD_PortSoap12.wsdl");
		}
		if (url==null ){
			java.util.logging.LoggerWrapperFactory.getLogger(AccordoServizioParteSpecificaSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/AccordoServizioParteSpecificaCRUD_PortSoap12.wsdl");
        }       
        WSDL_LOCATION = url;
    }

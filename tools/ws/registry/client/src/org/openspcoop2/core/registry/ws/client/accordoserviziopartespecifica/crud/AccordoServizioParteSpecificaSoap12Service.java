 ...
 * This class was generated by Apache CXF 3.2.6
  * 2019-09-19T15:25:23.359+02:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "AccordoServizioParteSpecificaSoap12Service",
                  wsdlLocation = "file:deploy/wsdl/AccordoServizioParteSpecificaCRUD_PortSoap12.wsdl",
...
public class AccordoServizioParteSpecificaSoap12Service extends Service {
    ...
    public static final QName SERVICE = new QName("http://www.openspcoop2.org/core/registry/management", "AccordoServizioParteSpecificaSoap12Service");
    public static final QName AccordoServizioParteSpecificaPortSoap12 = new QName("http://www.openspcoop2.org/core/registry/management", "AccordoServizioParteSpecificaPortSoap12");
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/AccordoServizioParteSpecificaCRUD_PortSoap12.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccordoServizioParteSpecificaSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/AccordoServizioParteSpecificaCRUD_PortSoap12.wsdl");
        }
        WSDL_LOCATION = url;
    }

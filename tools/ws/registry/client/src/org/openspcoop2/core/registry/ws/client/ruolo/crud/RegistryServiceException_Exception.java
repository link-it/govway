...
public class RegistryServiceException_Exception extends Exception {
    ...
    public RegistryServiceException_Exception(String message, org.openspcoop2.core.registry.ws.client.ruolo.crud.RegistryServiceException registryServiceException, java.lang.Throwable cause) {
        super(message, cause);
        this.registryServiceException = registryServiceException;
    }

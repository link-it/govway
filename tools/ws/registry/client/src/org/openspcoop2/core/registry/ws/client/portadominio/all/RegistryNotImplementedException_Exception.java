...
public class RegistryNotImplementedException_Exception extends Exception {
    ...
    public RegistryNotImplementedException_Exception(String message, org.openspcoop2.core.registry.ws.client.portadominio.all.RegistryNotImplementedException registryNotImplementedException, java.lang.Throwable cause) {
        super(message, cause);
        this.registryNotImplementedException = registryNotImplementedException;
    }

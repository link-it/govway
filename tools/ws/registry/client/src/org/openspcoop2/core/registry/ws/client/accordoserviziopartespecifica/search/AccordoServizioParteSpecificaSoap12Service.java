 ...
 * 2017-04-24T12:06:09.847+02:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "AccordoServizioParteSpecificaSoap12Service", 
                  wsdlLocation = "file:deploy/wsdl/AccordoServizioParteSpecificaSearch_PortSoap12.wsdl",
...
public class AccordoServizioParteSpecificaSoap12Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/AccordoServizioParteSpecificaSearch_PortSoap12.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccordoServizioParteSpecificaSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/AccordoServizioParteSpecificaSearch_PortSoap12.wsdl");
        }
        WSDL_LOCATION = url;
    }

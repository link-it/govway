 ...
 * 2015-01-26T16:24:20.559+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "PortaDominioSoap12Service", 
                  wsdlLocation = "deploy/wsdl/PortaDominioAll_PortSoap12.wsdl",
...
public class PortaDominioSoap12Service extends Service {
    ...
    static {
        URL url = PortaDominioSoap12Service.class.getResource("deploy/wsdl/PortaDominioAll_PortSoap12.wsdl");
        if (url == null) {
            url = PortaDominioSoap12Service.class.getClassLoader().getResource("deploy/wsdl/PortaDominioAll_PortSoap12.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = PortaDominioSoap12Service.class.getResource("/registry/PortaDominioAll_PortSoap12.wsdl");
		}
		if (url==null ){
			url = PortaDominioSoap12Service.class.getClassLoader().getResource("/registry/PortaDominioAll_PortSoap12.wsdl");
		}
		if (url==null ){
			java.util.logging.Logger.getLogger(PortaDominioSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/PortaDominioAll_PortSoap12.wsdl");
        }       
        WSDL_LOCATION = url;
    }

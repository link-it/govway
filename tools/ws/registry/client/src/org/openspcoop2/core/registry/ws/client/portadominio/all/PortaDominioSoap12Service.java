 ...
 * This class was generated by Apache CXF 3.2.6
  * 2019-09-19T15:16:41.065+02:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "PortaDominioSoap12Service",
                  wsdlLocation = "file:deploy/wsdl/PortaDominioAll_PortSoap12.wsdl",
...
public class PortaDominioSoap12Service extends Service {
    ...
    public static final QName SERVICE = new QName("http://www.openspcoop2.org/core/registry/management", "PortaDominioSoap12Service");
    public static final QName PortaDominioPortSoap12 = new QName("http://www.openspcoop2.org/core/registry/management", "PortaDominioPortSoap12");
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/PortaDominioAll_PortSoap12.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PortaDominioSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/PortaDominioAll_PortSoap12.wsdl");
        }
        WSDL_LOCATION = url;
    }

 ...
 * 2016-12-12T11:36:43.017+01:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "AccordoServizioParteComuneSoap12Service", 
                  wsdlLocation = "file:deploy/wsdl/AccordoServizioParteComuneSearch_PortSoap12.wsdl",
...
public class AccordoServizioParteComuneSoap12Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/AccordoServizioParteComuneSearch_PortSoap12.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccordoServizioParteComuneSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/AccordoServizioParteComuneSearch_PortSoap12.wsdl");
        }
        WSDL_LOCATION = url;
    }

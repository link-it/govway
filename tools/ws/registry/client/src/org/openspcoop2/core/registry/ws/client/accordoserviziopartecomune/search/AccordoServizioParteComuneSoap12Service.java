 ...
 * 2015-01-26T16:23:46.430+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "AccordoServizioParteComuneSoap12Service", 
                  wsdlLocation = "deploy/wsdl/AccordoServizioParteComuneSearch_PortSoap12.wsdl",
...
public class AccordoServizioParteComuneSoap12Service extends Service {
    ...
    static {
        URL url = AccordoServizioParteComuneSoap12Service.class.getResource("deploy/wsdl/AccordoServizioParteComuneSearch_PortSoap12.wsdl");
        if (url == null) {
            url = AccordoServizioParteComuneSoap12Service.class.getClassLoader().getResource("deploy/wsdl/AccordoServizioParteComuneSearch_PortSoap12.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = AccordoServizioParteComuneSoap12Service.class.getResource("/registry/AccordoServizioParteComuneSearch_PortSoap12.wsdl");
		}
		if (url==null ){
			url = AccordoServizioParteComuneSoap12Service.class.getClassLoader().getResource("/registry/AccordoServizioParteComuneSearch_PortSoap12.wsdl");
		}
		if (url==null ){
			java.util.logging.Logger.getLogger(AccordoServizioParteComuneSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/AccordoServizioParteComuneSearch_PortSoap12.wsdl");
        }       
        WSDL_LOCATION = url;
    }

...
public class SoggettoSoap11Service extends Service {
    ...
    static {
		...
		if (url==null ){
			url = SoggettoSoap11Service.class.getResource("/registry/SoggettoAll_PortSoap11.wsdl");
		}
		if (url==null ){
			url = SoggettoSoap11Service.class.getClassLoader().getResource("/registry/SoggettoAll_PortSoap11.wsdl");
		}
		if (url==null ){

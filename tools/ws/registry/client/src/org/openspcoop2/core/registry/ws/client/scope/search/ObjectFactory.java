 ...
 * generated in the org.openspcoop2.core.registry.ws.client.scope.search package. 
...
public class ObjectFactory {
    ...
    private final static QName _SearchFilterScope_QNAME = new QName("http://www.openspcoop2.org/core/registry/management", "search-filter-scope");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.openspcoop2.core.registry.ws.client.scope.search
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link SearchFilterScope }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link SearchFilterScope }{@code >}
     */
    @XmlElementDecl(namespace = "http://www.openspcoop2.org/core/registry/management", name = "search-filter-scope")
    public JAXBElement<SearchFilterScope> createSearchFilterScope(SearchFilterScope value) {
        return new JAXBElement<SearchFilterScope>(ObjectFactory._SearchFilterScope_QNAME, SearchFilterScope.class, null, value);
    }

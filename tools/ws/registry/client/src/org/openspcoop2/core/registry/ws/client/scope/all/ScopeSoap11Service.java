 ...
 * This class was generated by Apache CXF 3.2.6
  * 2019-09-19T15:21:02.860+02:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "ScopeSoap11Service",
                  wsdlLocation = "file:deploy/wsdl/ScopeAll_PortSoap11.wsdl",
...
public class ScopeSoap11Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/ScopeAll_PortSoap11.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ScopeSoap11Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/ScopeAll_PortSoap11.wsdl");
        }
        WSDL_LOCATION = url;
    }

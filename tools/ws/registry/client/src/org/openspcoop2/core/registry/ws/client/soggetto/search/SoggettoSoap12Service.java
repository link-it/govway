 ...
 * 2015-01-26T16:25:29.567+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "SoggettoSoap12Service", 
                  wsdlLocation = "deploy/wsdl/SoggettoSearch_PortSoap12.wsdl",
...
public class SoggettoSoap12Service extends Service {
    ...
    static {
        URL url = SoggettoSoap12Service.class.getResource("deploy/wsdl/SoggettoSearch_PortSoap12.wsdl");
        if (url == null) {
            url = SoggettoSoap12Service.class.getClassLoader().getResource("deploy/wsdl/SoggettoSearch_PortSoap12.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = SoggettoSoap12Service.class.getResource("/registry/SoggettoSearch_PortSoap12.wsdl");
		}
		if (url==null ){
			url = SoggettoSoap12Service.class.getClassLoader().getResource("/registry/SoggettoSearch_PortSoap12.wsdl");
		}
		if (url==null ){
			java.util.logging.Logger.getLogger(SoggettoSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/SoggettoSearch_PortSoap12.wsdl");
        }       
        WSDL_LOCATION = url;
    }

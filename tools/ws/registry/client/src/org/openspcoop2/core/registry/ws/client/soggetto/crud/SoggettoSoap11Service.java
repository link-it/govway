 ...
 * 2015-01-26T16:25:38.117+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "SoggettoSoap11Service", 
                  wsdlLocation = "deploy/wsdl/SoggettoCRUD_PortSoap11.wsdl",
...
public class SoggettoSoap11Service extends Service {
    ...
    static {
        URL url = SoggettoSoap11Service.class.getResource("deploy/wsdl/SoggettoCRUD_PortSoap11.wsdl");
        if (url == null) {
            url = SoggettoSoap11Service.class.getClassLoader().getResource("deploy/wsdl/SoggettoCRUD_PortSoap11.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = SoggettoSoap11Service.class.getResource("/registry/SoggettoCRUD_PortSoap11.wsdl");
		}
		if (url==null ){
			url = SoggettoSoap11Service.class.getClassLoader().getResource("/registry/SoggettoCRUD_PortSoap11.wsdl");
		}
		if (url==null ){
			java.util.logging.LoggerWrapperFactory.getLogger(SoggettoSoap11Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/SoggettoCRUD_PortSoap11.wsdl");
        }       
        WSDL_LOCATION = url;
    }

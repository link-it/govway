...
public class RegistryMultipleResultException_Exception extends Exception {
    ...
    public RegistryMultipleResultException_Exception(String message, org.openspcoop2.core.registry.ws.client.portadominio.search.RegistryMultipleResultException registryMultipleResultException, java.lang.Throwable cause) {
        super(message, cause);
        this.registryMultipleResultException = registryMultipleResultException;
    }

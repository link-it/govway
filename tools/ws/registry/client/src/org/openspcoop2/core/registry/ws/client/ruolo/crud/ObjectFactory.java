 ...
 * generated in the org.openspcoop2.core.registry.ws.client.ruolo.crud package. 
...
public class ObjectFactory {
    ...
    private final static QName _SearchFilterRuolo_QNAME = new QName("http://www.openspcoop2.org/core/registry/management", "search-filter-ruolo");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.openspcoop2.core.registry.ws.client.ruolo.crud
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link SearchFilterRuolo }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link SearchFilterRuolo }{@code >}
     */
    @XmlElementDecl(namespace = "http://www.openspcoop2.org/core/registry/management", name = "search-filter-ruolo")
    public JAXBElement<SearchFilterRuolo> createSearchFilterRuolo(SearchFilterRuolo value) {
        return new JAXBElement<SearchFilterRuolo>(ObjectFactory._SearchFilterRuolo_QNAME, SearchFilterRuolo.class, null, value);
    }

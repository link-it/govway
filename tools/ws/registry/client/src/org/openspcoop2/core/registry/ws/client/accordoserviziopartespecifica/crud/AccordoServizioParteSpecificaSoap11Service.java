 ...
 * This class was generated by Apache CXF 3.2.6
  * 2019-09-19T15:25:08.182+02:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "AccordoServizioParteSpecificaSoap11Service",
                  wsdlLocation = "file:deploy/wsdl/AccordoServizioParteSpecificaCRUD_PortSoap11.wsdl",
...
public class AccordoServizioParteSpecificaSoap11Service extends Service {
    ...
    public static final QName SERVICE = new QName("http://www.openspcoop2.org/core/registry/management", "AccordoServizioParteSpecificaSoap11Service");
    public static final QName AccordoServizioParteSpecificaPortSoap11 = new QName("http://www.openspcoop2.org/core/registry/management", "AccordoServizioParteSpecificaPortSoap11");
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/AccordoServizioParteSpecificaCRUD_PortSoap11.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccordoServizioParteSpecificaSoap11Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/AccordoServizioParteSpecificaCRUD_PortSoap11.wsdl");
        }
        WSDL_LOCATION = url;
    }

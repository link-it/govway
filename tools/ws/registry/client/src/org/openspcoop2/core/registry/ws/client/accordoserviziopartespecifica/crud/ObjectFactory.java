 ...
 * generated in the org.openspcoop2.core.registry.ws.client.accordoserviziopartespecifica.crud package. 
...
public class ObjectFactory {
    ...
    private static final QName _SearchFilterAccordoServizioParteSpecifica_QNAME = new QName("http://www.openspcoop2.org/core/registry/management", "search-filter-accordo-servizio-parte-specifica");
    private static final QName _Connettore_QNAME = new QName("http://www.openspcoop2.org/core/registry/management", "connettore");
    private static final QName _ConfigurazioneServizio_QNAME = new QName("http://www.openspcoop2.org/core/registry/management", "configurazione-servizio");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.openspcoop2.core.registry.ws.client.accordoserviziopartespecifica.crud
     * 
     */
    ...
    public JAXBElement<SearchFilterAccordoServizioParteSpecifica> createSearchFilterAccordoServizioParteSpecifica(SearchFilterAccordoServizioParteSpecifica value) {
        return new JAXBElement<SearchFilterAccordoServizioParteSpecifica>(ObjectFactory._SearchFilterAccordoServizioParteSpecifica_QNAME, SearchFilterAccordoServizioParteSpecifica.class, null, value);
    }

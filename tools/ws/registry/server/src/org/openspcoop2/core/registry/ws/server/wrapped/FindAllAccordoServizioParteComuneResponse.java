...
/**
 * <p>Java class for FindAllAccordoServizioParteComuneResponse complex type.
 * 
...
/**     
 * FindAllAccordoServizioParteComuneResponse
 *
...
public class FindAllAccordoServizioParteComuneResponse extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
	
	private static final long serialVersionUID = -1L;
	
	@XmlElement(name="findReturn",required=true,nillable=false)
	private java.util.List<AccordoServizioParteComune> findReturn;
	
	public void setFindReturn(java.util.List<AccordoServizioParteComune> findReturn){
		this.findReturn = findReturn;
	}
	
	public java.util.List<AccordoServizioParteComune> getFindReturn(){

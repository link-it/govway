...
@javax.xml.bind.annotation.XmlType(name = "wrapperIdRuolo", namespace="http://www.openspcoop2.org/core/registry/management", propOrder = {
    "id"
})
@javax.xml.bind.annotation.XmlRootElement(name = "wrapperIdRuolo")
public class WrapperIdRuolo extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {

...
/**
 * <p>Java class for RegistryMultipleResultException complex type.
 * 
...
/**     
 * RegistryMultipleResultException
 *
...
@javax.xml.bind.annotation.XmlType(name = "registry-multiple-result-exception", namespace="http://www.openspcoop2.org/core/registry/management", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class RegistryMultipleResultException extends Exception implements Serializable {
	
	private static final long serialVersionUID = -1L;

	// Deprecated: Costruttori utili se i beans vengono usati al posto di quelli generati tramite tools automatici
	@Deprecated
	public RegistryMultipleResultException(String message, java.lang.Throwable t){
		super(message, t);
		this.errorMessage = message;
	}
	@Deprecated
	public RegistryMultipleResultException(String message){
		super(message);
		this.errorMessage = message;
	}
	
	public RegistryMultipleResultException(String method, String message, java.lang.Throwable t){
		super(message, t);
		this.methodName = method;
		this.errorMessage = message;
	}
	public RegistryMultipleResultException(String method, String message){
		super(message);
		this.methodName = method;
		this.errorMessage = message;
	}	

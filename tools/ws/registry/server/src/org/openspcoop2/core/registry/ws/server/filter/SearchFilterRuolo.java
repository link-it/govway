...
/**
 * <p>Java class for SearchFilterRuolo complex type.
 * 
...
@javax.xml.bind.annotation.XmlType(name = "search-filter-ruolo", namespace="http://www.openspcoop2.org/core/registry/management", propOrder = {
    "nome",
    "descrizione",
    "tipologia",
    "nomeEsterno",
...
@javax.xml.bind.annotation.XmlRootElement(name = "search-filter-ruolo")
public class SearchFilterRuolo extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  ...
  @XmlElement(name="descrizione",required=false,nillable=false)
	...
	@XmlElement(name="tipologia",required=false,nillable=false,defaultValue="qualsiasi")
	private RuoloTipologia tipologia = (RuoloTipologia) RuoloTipologia.toEnumConstantFromString("qualsiasi");
  ...
  @XmlElement(name="nome-esterno",required=false,nillable=false)
	...
	private RuoloContesto contestoUtilizzo = (RuoloContesto) RuoloContesto.toEnumConstantFromString("qualsiasi");
	
	public void setContestoUtilizzo(RuoloContesto contestoUtilizzo){

...
/**
 * <p>Java class for RegistryServiceException complex type.
 * 
...
@javax.xml.bind.annotation.XmlType(name = "registry-service-exception", namespace="http://www.openspcoop2.org/core/registry/management", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class RegistryServiceException extends Exception implements Serializable {
	
	private static final long serialVersionUID = -1L;

	// Deprecated: Costruttori utili se i beans vengono usati al posto di quelli generati tramite tools automatici
	@Deprecated
	public RegistryServiceException(String message, java.lang.Throwable t){
		super(message, t);
	...
	public RegistryServiceException(String method, String message, java.lang.Throwable t){
		super(message, t);
		this.methodName = method;
		this.errorMessage = message;
	}
	public RegistryServiceException(String method, String message){
		super(message);
		this.methodName = method;
		this.errorMessage = message;
	}	

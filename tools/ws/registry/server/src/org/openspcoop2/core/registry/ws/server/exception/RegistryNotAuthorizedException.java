...
/**
 * <p>Java class for RegistryNotAuthorizedException complex type.
 * 
...
/**     
 * RegistryNotAuthorizedException
 *
...
@javax.xml.bind.annotation.XmlType(name = "registry-not-authorized-exception", namespace="http://www.openspcoop2.org/core/registry/management", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class RegistryNotAuthorizedException extends Exception implements Serializable {
	
	private static final long serialVersionUID = -1L;

	// Deprecated: Costruttori utili se i beans vengono usati al posto di quelli generati tramite tools automatici
	@Deprecated
	public RegistryNotAuthorizedException(String message, java.lang.Throwable t){
		super(message, t);
		this.errorMessage = message;
	}
	@Deprecated
	public RegistryNotAuthorizedException(String message){
		super(message);
		this.errorMessage = message;
	}
	
	public RegistryNotAuthorizedException(String method, String message, java.lang.Throwable t){
		super(message, t);
		this.methodName = method;
		this.errorMessage = message;
	}
	public RegistryNotAuthorizedException(String method, String message){
		super(message);
		this.methodName = method;
		this.errorMessage = message;
	}	

...
/**
 * <p>Java class for RegistryNotFoundException complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="registry-not-found-exception">
 *     &lt;sequence>
...
@javax.xml.bind.annotation.XmlType(name = "registry-not-found-exception", namespace="http://www.openspcoop2.org/core/registry/management", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class RegistryNotFoundException extends Exception implements Serializable {
	
	private static final long serialVersionUID = -1L;

	// Deprecated: Costruttori utili se i beans vengono usati al posto di quelli generati tramite tools automatici
	@Deprecated
	public RegistryNotFoundException(String message, java.lang.Throwable t){
		super(message, t);
	...
	public RegistryNotFoundException(String method, String message, java.lang.Throwable t){
		super(message, t);
		this.methodName = method;
		this.errorMessage = message;
	}
	public RegistryNotFoundException(String method, String message){
		super(message);
		this.methodName = method;
		this.errorMessage = message;
	}	

...
public class ServerProperties  {
	...
	/** Reader delle proprieta' impostate nel file 'wsregistry.properties' */
	...
	public ServerProperties(String confDir,Logger log) throws Exception {
		...
		try{  
			properties = BackendProperties.class.getResourceAsStream("/wsregistry.properties");
			if(properties==null){
				throw new Exception("File '/wsregistry.properties' not found");
			}
			propertiesReader.load(properties);
		}catch(Exception e) {
			this.log.error("Riscontrato errore durante la lettura del file 'wsregistry.properties': \n\n"+e.getMessage());
	...
	public String getUser() throws UtilsException{
		return this.readProperty(true, "user");
	}
}
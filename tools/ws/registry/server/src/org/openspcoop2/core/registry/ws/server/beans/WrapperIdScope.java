...
@javax.xml.bind.annotation.XmlType(name = "wrapperIdScope", namespace="http://www.openspcoop2.org/core/registry/management", propOrder = {
    "id"
})
@javax.xml.bind.annotation.XmlRootElement(name = "wrapperIdScope")
public class WrapperIdScope extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {

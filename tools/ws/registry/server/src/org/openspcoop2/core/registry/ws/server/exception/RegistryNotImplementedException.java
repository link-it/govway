...
/**
 * <p>Java class for RegistryNotImplementedException complex type.
 * 
...
/**     
 * RegistryNotImplementedException
 *
...
@javax.xml.bind.annotation.XmlType(name = "registry-not-implemented-exception", namespace="http://www.openspcoop2.org/core/registry/management", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
@javax.xml.ws.WebFault(name = "registry-not-implemented-exception", targetNamespace = "http://www.openspcoop2.org/core/registry/management")
public class RegistryNotImplementedException extends Exception implements Serializable {
	
	private static final long serialVersionUID = -1L;

	// Deprecated: Costruttori utili se i beans vengono usati al posto di quelli generati tramite tools automatici
	@Deprecated
	public RegistryNotImplementedException(String message, java.lang.Throwable t){
		super(message, t);
		this.errorMessage = message;
	}
	@Deprecated
	public RegistryNotImplementedException(String message){
		super(message);
		this.errorMessage = message;
	}
	
	public RegistryNotImplementedException(String method, String message, java.lang.Throwable t){
		super(message, t);
		this.methodName = method;
		this.errorMessage = message;
	}
	public RegistryNotImplementedException(String method, String message){
		super(message);
		this.methodName = method;
		this.errorMessage = message;
	}	

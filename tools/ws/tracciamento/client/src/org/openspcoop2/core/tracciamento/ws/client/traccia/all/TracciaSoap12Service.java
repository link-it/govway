...
public class TracciaSoap12Service extends Service {
    ...
    static {
		...
		if (url==null ){
			url = TracciaSoap12Service.class.getResource("/tracciamento/TracciaAll_PortSoap12.wsdl");
		}
		if (url==null ){
			url = TracciaSoap12Service.class.getClassLoader().getResource("/tracciamento/TracciaAll_PortSoap12.wsdl");
		}
		if (url==null ){

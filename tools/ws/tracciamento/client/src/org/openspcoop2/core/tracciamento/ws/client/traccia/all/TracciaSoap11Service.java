...
public class TracciaSoap11Service extends Service {
    ...
    static {
		...
		if (url==null ){
			url = TracciaSoap11Service.class.getResource("/tracciamento/TracciaAll_PortSoap11.wsdl");
		}
		if (url==null ){
			url = TracciaSoap11Service.class.getClassLoader().getResource("/tracciamento/TracciaAll_PortSoap11.wsdl");
		}
		if (url==null ){

...
/**
 * <p>Java class for tracciamento-multiple-result-exception complex type.
 * 
...
@XmlType(name = "tracciamento-multiple-result-exception", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class TracciamentoMultipleResultException {

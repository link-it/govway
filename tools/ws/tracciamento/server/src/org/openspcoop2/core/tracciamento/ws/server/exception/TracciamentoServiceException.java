...
/**
 * <p>Java class for TracciamentoServiceException complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="tracciamento-service-exception">
 *     &lt;sequence>
...
@javax.xml.bind.annotation.XmlType(name = "tracciamento-service-exception", namespace="http://www.openspcoop2.org/core/tracciamento/management", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
@javax.xml.ws.WebFault(name = "tracciamento-service-exception", targetNamespace = "http://www.openspcoop2.org/core/tracciamento/management")
public class TracciamentoServiceException extends Exception implements Serializable {
	
	private static final long serialVersionUID = -1L;

	// Deprecated: Costruttori utili se i beans vengono usati al posto di quelli generati tramite tools automatici
	@Deprecated
	public TracciamentoServiceException(String message, java.lang.Throwable t){
		super(message, t);
		this.errorMessage = message;
	}
	@Deprecated
	public TracciamentoServiceException(String message){
		super(message);
		this.errorMessage = message;
	}
	
	public TracciamentoServiceException(String method, String message, java.lang.Throwable t){
		super(message, t);
		this.methodName = method;
		this.errorMessage = message;
	}
	public TracciamentoServiceException(String method, String message){
		super(message);
		this.methodName = method;
		this.errorMessage = message;
	}	

...
/**
 * <p>Java class for TracciamentoNotImplementedException complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="tracciamento-not-implemented-exception">
 *     &lt;sequence>
...
/**     
 * TracciamentoNotImplementedException
 *
...
@javax.xml.bind.annotation.XmlType(name = "tracciamento-not-implemented-exception", namespace="http://www.openspcoop2.org/core/tracciamento/management", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class TracciamentoNotImplementedException extends Exception implements Serializable {
	
	private static final long serialVersionUID = -1L;

	// Deprecated: Costruttori utili se i beans vengono usati al posto di quelli generati tramite tools automatici
	@Deprecated
	public TracciamentoNotImplementedException(String message, java.lang.Throwable t){
		super(message, t);
		this.errorMessage = message;
	}
	@Deprecated
	public TracciamentoNotImplementedException(String message){
		super(message);
		this.errorMessage = message;
	}
	
	public TracciamentoNotImplementedException(String method, String message, java.lang.Throwable t){
		super(message, t);
		this.methodName = method;
		this.errorMessage = message;
	}
	public TracciamentoNotImplementedException(String method, String message){
		super(message);
		this.methodName = method;
		this.errorMessage = message;
	}	

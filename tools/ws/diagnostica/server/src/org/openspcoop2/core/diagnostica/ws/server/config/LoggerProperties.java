...
public class LoggerProperties {
	...
	public static void initialize(Logger logConsole,String rootDirectory,Properties objectProperties) throws IOException{
		...
		if(rootDirectory!=null)
			loggerFile = new java.io.File(rootDirectory+"wsdiagnostica.log4j.properties");
		else
			loggerFile = new java.io.File("wsdiagnostica.log4j.properties");
		if(loggerFile .exists() == false ){
			loggerProperties.load(LoggerProperties.class.getResourceAsStream("/wsdiagnostica.log4j.properties"));
		}else{
	...
	public static Logger getLoggerWS(){
		...
		return Logger.getLogger("diagnostica.ws");
	}
	
	public static Logger getLoggerDAO(){
		return Logger.getLogger("diagnostica.dao");
	}
}

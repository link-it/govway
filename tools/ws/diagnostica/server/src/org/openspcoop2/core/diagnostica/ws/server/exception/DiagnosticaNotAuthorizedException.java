...
/**
 * <p>Java class for DiagnosticaNotAuthorizedException complex type.
 * 
...
/**     
 * DiagnosticaNotAuthorizedException
 *
...
@javax.xml.bind.annotation.XmlType(name = "diagnostica-not-authorized-exception", namespace="http://www.openspcoop2.org/core/diagnostica/management", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class DiagnosticaNotAuthorizedException extends Exception implements Serializable {
	
	private static final long serialVersionUID = -1L;

	// Deprecated: Costruttori utili se i beans vengono usati al posto di quelli generati tramite tools automatici
	@Deprecated
	public DiagnosticaNotAuthorizedException(String message, java.lang.Throwable t){
		super(message, t);
		this.errorMessage = message;
	}
	@Deprecated
	public DiagnosticaNotAuthorizedException(String message){
		super(message);
		this.errorMessage = message;
	}
	
	public DiagnosticaNotAuthorizedException(String method, String message, java.lang.Throwable t){
		super(message, t);
		this.methodName = method;
		this.errorMessage = message;
	}
	public DiagnosticaNotAuthorizedException(String method, String message){
		super(message);
		this.methodName = method;
		this.errorMessage = message;
	}	

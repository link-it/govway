...
/**
 * <p>Java class for DiagnosticaMultipleResultException complex type.
 * 
...
/**     
 * DiagnosticaMultipleResultException
 *
...
@javax.xml.bind.annotation.XmlType(name = "diagnostica-multiple-result-exception", namespace="http://www.openspcoop2.org/core/diagnostica/management", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class DiagnosticaMultipleResultException extends Exception implements Serializable {
	
	private static final long serialVersionUID = -1L;

	// Deprecated: Costruttori utili se i beans vengono usati al posto di quelli generati tramite tools automatici
	@Deprecated
	public DiagnosticaMultipleResultException(String message, java.lang.Throwable t){
		super(message, t);
		this.errorMessage = message;
	}
	@Deprecated
	public DiagnosticaMultipleResultException(String message){
		super(message);
		this.errorMessage = message;
	}
	
	public DiagnosticaMultipleResultException(String method, String message, java.lang.Throwable t){
		super(message, t);
		this.methodName = method;
		this.errorMessage = message;
	}
	public DiagnosticaMultipleResultException(String method, String message){
		super(message);
		this.methodName = method;
		this.errorMessage = message;
	}	

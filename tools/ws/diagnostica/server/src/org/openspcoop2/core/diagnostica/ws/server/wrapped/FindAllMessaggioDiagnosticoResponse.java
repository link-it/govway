...
/**
 * <p>Java class for FindAllMessaggioDiagnosticoResponse complex type.
 * 
 ...
 *     &lt;sequence>
 *         &lt;element name="findReturn" type="{http://www.openspcoop2.org/core/diagnostica}messaggio-diagnostico" maxOccurs="unbounded" />
 *     &lt;/sequence>
 * &lt;/complexType>
 * </pre>
 * 
...
/**     
 * FindAllMessaggioDiagnosticoResponse
 *
...
@javax.xml.bind.annotation.XmlType(name = "findAllResponse", namespace="http://www.openspcoop2.org/core/diagnostica/management", propOrder = {
    "findReturn"
})
...
public class FindAllMessaggioDiagnosticoResponse extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
	...
	public void setFindReturn(java.util.List<MessaggioDiagnostico> findReturn){
		this.findReturn = findReturn;
	}
	
	public java.util.List<MessaggioDiagnostico> getFindReturn(){

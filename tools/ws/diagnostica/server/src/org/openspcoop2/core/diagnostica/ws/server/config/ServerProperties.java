...
public class ServerProperties  {
	...
	/** Reader delle proprieta' impostate nel file 'wsdiagnostica.properties' */
	...
	public ServerProperties(String confDir,Logger log) throws Exception {
		...
		try{  
			properties = DatasourceProperties.class.getResourceAsStream("/wsdiagnostica.properties");
			if(properties==null){
				throw new Exception("File '/wsdiagnostica.properties' not found");
			}
			propertiesReader.load(properties);
		}catch(Exception e) {
			this.log.error("Riscontrato errore durante la lettura del file 'wsdiagnostica.properties': \n\n"+e.getMessage());

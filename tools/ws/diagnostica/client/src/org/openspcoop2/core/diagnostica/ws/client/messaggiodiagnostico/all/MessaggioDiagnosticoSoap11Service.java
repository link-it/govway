...
public class MessaggioDiagnosticoSoap11Service extends Service {
    ...
    static {
		...
		if (url==null ){
			url = MessaggioDiagnosticoSoap11Service.class.getResource("/diagnostica/MessaggioDiagnosticoAll_PortSoap11.wsdl");
		}
		if (url==null ){
			url = MessaggioDiagnosticoSoap11Service.class.getClassLoader().getResource("/diagnostica/MessaggioDiagnosticoAll_PortSoap11.wsdl");
		}
		if (url==null ){

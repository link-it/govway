...
/**
 * <p>Java class for monitor-not-authorized-exception complex type.
 * 
...
@XmlType(name = "monitor-not-authorized-exception", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class MonitorNotAuthorizedException {

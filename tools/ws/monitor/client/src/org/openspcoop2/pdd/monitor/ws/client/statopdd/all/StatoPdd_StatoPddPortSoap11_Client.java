 ...
 * 2014-12-01T13:15:40.751+01:00
 * Generated source version: 2.7.4
 * 
 */
public final class StatoPdd_StatoPddPortSoap11_Client {

    private static final QName SERVICE_NAME = new QName("http://www.openspcoop2.org/pdd/monitor/management", "StatoPddSoap11Service");

    private StatoPdd_StatoPddPortSoap11_Client() {
    }

    public static void main(String args[]) throws java.lang.Exception {
        URL wsdlURL = StatoPddSoap11Service.WSDL_LOCATION;
        ...
        StatoPddSoap11Service ss = new StatoPddSoap11Service(wsdlURL, StatoPdd_StatoPddPortSoap11_Client.SERVICE_NAME);
        StatoPdd port = ss.getStatoPddPortSoap11();
	
		new org.openspcoop2.pdd.monitor.ws.client.utils.RequestContextUtils("statoPdd.soap11").addRequestContextParameters((javax.xml.ws.BindingProvider)port);  
        
        {
        System.out.println("Invoking find...");
        org.openspcoop2.pdd.monitor.ws.client.statopdd.all.SearchFilterStatoPdd _find_filter = new SearchFilterStatoPdd();
        try {
            org.openspcoop2.pdd.monitor.StatoPdd _find__return = port.find(_find_filter);
            System.out.println("find.result TOT=" + _find__return.getTotMessaggi());

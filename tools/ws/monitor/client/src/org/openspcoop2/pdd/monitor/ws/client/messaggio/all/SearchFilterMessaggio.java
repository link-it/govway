...
/**
 * <p>Java class for search-filter-messaggio complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="filtro" type="{http://www.openspcoop2.org/pdd/monitor/management}filtro" minOccurs="0"/>
...
@XmlType(name = "search-filter-messaggio", propOrder = {
    "filtro",
    "orCondition",
    "limit",
    "offset"
})
public class SearchFilterMessaggio {
     ...
     *     
     */
    public void setFiltro(Filtro value) {
        this.filtro = value;
    }

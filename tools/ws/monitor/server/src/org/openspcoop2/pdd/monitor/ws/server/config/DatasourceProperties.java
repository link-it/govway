...
public class DatasourceProperties {	
	...
	/** Reader delle proprieta' impostate nel file 'wsmonitor.datasource.properties' */
	...
	public DatasourceProperties(String confDir,Logger log) throws Exception {
		...
		try{  
			properties = DatasourceProperties.class.getResourceAsStream("/wsmonitor.datasource.properties");
			if(properties==null){
				throw new Exception("File '/wsmonitor.datasource.properties' not found");
			}
			propertiesReader.load(properties);
		}catch(Exception e) {
			this.log.error("Riscontrato errore durante la lettura del file 'wsmonitor.datasource.properties': \n\n"+e.getMessage());

...
/**
 * <p>Java class for FindStatoPdd complex type.
 * 
...
@javax.xml.bind.annotation.XmlType(name = "find", namespace="http://www.openspcoop2.org/pdd/monitor/management", propOrder = {
    "filter"
})
@javax.xml.bind.annotation.XmlRootElement(name = "find")
public class FindStatoPdd extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
	
	private static final long serialVersionUID = -1L;
	
	@XmlElement(name="filter",required=true,nillable=false)
	private SearchFilterStatoPdd filter;
	
	public void setFilter(SearchFilterStatoPdd filter){
		this.filter = filter;
	}

...
public enum Identified implements IEnumeration , Serializable , Cloneable {
	...
	@javax.xml.bind.annotation.XmlEnumValue("StatoPdd")
	STATO_PDD ("StatoPdd"),
	@javax.xml.bind.annotation.XmlEnumValue("Messaggio")
	MESSAGGIO ("Messaggio");
	...
	public static Identified toEnumConstant(String value){
		Identified res = null;
		if(Identified.STATO_PDD.getValue().equals(value)){
			res = Identified.STATO_PDD;
		}else if(Identified.MESSAGGIO.getValue().equals(value)){
			res = Identified.MESSAGGIO;
		}
		return res;
	}
	...
	public static IEnumeration toEnumConstantFromString(String value){
		Identified res = null;
		if(Identified.STATO_PDD.toString().equals(value)){
			res = Identified.STATO_PDD;
		}else if(Identified.MESSAGGIO.toString().equals(value)){
			res = Identified.MESSAGGIO;
		}
		return res;
	}

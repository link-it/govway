...
/**
 * <p>Java class for SearchFilterStatoPdd complex type.
 * 
...
@javax.xml.bind.annotation.XmlType(name = "search-filter-stato-pdd", namespace="http://www.openspcoop2.org/pdd/monitor/management", propOrder = {
    "filtro",
    "orCondition",
    "limit",
    "offset"
})
@javax.xml.bind.annotation.XmlRootElement(name = "search-filter-stato-pdd")
public class SearchFilterStatoPdd extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {

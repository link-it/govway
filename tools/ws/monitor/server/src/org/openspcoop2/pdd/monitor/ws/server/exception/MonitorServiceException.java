...
/**
 * <p>Java class for MonitorServiceException complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="monitor-service-exception">
 *     &lt;sequence>
...
@javax.xml.bind.annotation.XmlType(name = "monitor-service-exception", namespace="http://www.openspcoop2.org/pdd/monitor/management", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class MonitorServiceException extends Exception implements Serializable {
	
	private static final long serialVersionUID = -1L;

	// Deprecated: Costruttori utili se i beans vengono usati al posto di quelli generati tramite tools automatici
	@Deprecated
	public MonitorServiceException(String message, java.lang.Throwable t){
		super(message, t);
	...
	public MonitorServiceException(String method, String message, java.lang.Throwable t){
		super(message, t);
		this.methodName = method;
		this.errorMessage = message;
	}
	public MonitorServiceException(String method, String message){
		super(message);
		this.methodName = method;
		this.errorMessage = message;
	}	

...
/**
 * <p>Java class for MonitorNotAuthorizedException complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="monitor-not-authorized-exception">
 *     &lt;sequence>
...
@javax.xml.bind.annotation.XmlType(name = "monitor-not-authorized-exception", namespace="http://www.openspcoop2.org/pdd/monitor/management", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class MonitorNotAuthorizedException extends Exception implements Serializable {
	
	private static final long serialVersionUID = -1L;

	// Deprecated: Costruttori utili se i beans vengono usati al posto di quelli generati tramite tools automatici
	@Deprecated
	public MonitorNotAuthorizedException(String message, java.lang.Throwable t){
		super(message, t);
		this.errorMessage = message;
	}
	@Deprecated
	public MonitorNotAuthorizedException(String message){
		super(message);
		this.errorMessage = message;
	}
	
	public MonitorNotAuthorizedException(String method, String message, java.lang.Throwable t){
		super(message, t);
		this.methodName = method;
		this.errorMessage = message;
	}
	public MonitorNotAuthorizedException(String method, String message){
		super(message);
		this.methodName = method;
		this.errorMessage = message;
	}	

...
public class LoggerProperties {
	...
	public static void initialize(Logger logConsole,String rootDirectory,Properties objectProperties) throws IOException, UtilsException{
		...
		if(rootDirectory!=null)
			loggerFile = new java.io.File(rootDirectory+"wsmonitor.log4j2.properties");
		else
			loggerFile = new java.io.File("wsmonitor.log4j2.properties");
		if(loggerFile .exists() == false ){
			loggerProperties.load(LoggerProperties.class.getResourceAsStream("/wsmonitor.log4j2.properties"));
		}else{

...
public class LoggerProperties {
	...
	public static void initialize(Logger logConsole,String rootDirectory,Properties objectProperties) throws IOException{
		...
		if(rootDirectory!=null)
			loggerFile = new java.io.File(rootDirectory+"wsmonitor.log4j.properties");
		else
			loggerFile = new java.io.File("wsmonitor.log4j.properties");
		if(loggerFile .exists() == false ){
			loggerProperties.load(LoggerProperties.class.getResourceAsStream("/wsmonitor.log4j.properties"));
		}else{

...
/**
 * <p>Java class for MonitorMultipleResultException complex type.
 * 
...
/**     
 * MonitorMultipleResultException
 *
...
@javax.xml.bind.annotation.XmlType(name = "monitor-multiple-result-exception", namespace="http://www.openspcoop2.org/pdd/monitor/management", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class MonitorMultipleResultException extends Exception implements Serializable {
	
	private static final long serialVersionUID = -1L;

	// Deprecated: Costruttori utili se i beans vengono usati al posto di quelli generati tramite tools automatici
	@Deprecated
	public MonitorMultipleResultException(String message, java.lang.Throwable t){
		super(message, t);
		this.errorMessage = message;
	}
	@Deprecated
	public MonitorMultipleResultException(String message){
		super(message);
		this.errorMessage = message;
	}
	
	public MonitorMultipleResultException(String method, String message, java.lang.Throwable t){
		super(message, t);
		this.methodName = method;
		this.errorMessage = message;
	}
	public MonitorMultipleResultException(String method, String message){
		super(message);
		this.methodName = method;
		this.errorMessage = message;
	}	

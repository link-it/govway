...
/**
 * <p>Java class for ConfigServiceException complex type.
 * 
...
@javax.xml.bind.annotation.XmlType(name = "config-service-exception", namespace="http://www.openspcoop2.org/core/config/management", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class ConfigServiceException extends Exception implements Serializable {
	
	private static final long serialVersionUID = -1L;

	// Deprecated: Costruttori utili se i beans vengono usati al posto di quelli generati tramite tools automatici
	@Deprecated
	public ConfigServiceException(String message, java.lang.Throwable t){
		super(message, t);
	...
	public ConfigServiceException(String method, String message, java.lang.Throwable t){
		super(message, t);
		this.methodName = method;
		this.errorMessage = message;
	}
	public ConfigServiceException(String method, String message){
		super(message);
		this.methodName = method;
		this.errorMessage = message;
	}	

...
@javax.xml.bind.annotation.XmlType(name = "wrapperIdPortaApplicativa", namespace="http://www.openspcoop2.org/core/config/management", propOrder = {
    "id"
})
@javax.xml.bind.annotation.XmlRootElement(name = "wrapperIdPortaApplicativa")
public class WrapperIdPortaApplicativa extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {

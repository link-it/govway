...
public class ServerProperties  {
	...
	/** Reader delle proprieta' impostate nel file 'wsconfig.properties' */
	...
	public ServerProperties(String confDir,Logger log) throws Exception {
		...
		try{  
			properties = BackendProperties.class.getResourceAsStream("/wsconfig.properties");
			if(properties==null){
				throw new Exception("File '/wsconfig.properties' not found");
			}
			propertiesReader.load(properties);
		}catch(Exception e) {
			this.log.error("Riscontrato errore durante la lettura del file 'wsconfig.properties': \n\n"+e.getMessage());

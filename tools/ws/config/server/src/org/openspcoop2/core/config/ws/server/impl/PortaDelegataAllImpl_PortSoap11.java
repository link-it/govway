...
import org.openspcoop2.core.config.ws.server.PortaDelegataAll;
import org.openspcoop2.core.config.ws.server.exception.ConfigServiceException_Exception;

/**     
 * PortaDelegataAllImpl_PortSoap11
 *
...
@javax.jws.WebService(name = "PortaDelegata",
		serviceName = "PortaDelegataSoap11Service",
		portName = "PortaDelegataPortSoap11",
		targetNamespace = "http://www.openspcoop2.org/core/config/management",
		endpointInterface = "org.openspcoop2.core.config.ws.server.PortaDelegataAll")
public class PortaDelegataAllImpl_PortSoap11 extends PortaDelegataImpl implements PortaDelegataAll {

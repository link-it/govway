...
import org.openspcoop2.core.config.ws.server.PortaApplicativaAll;
import org.openspcoop2.core.config.ws.server.exception.ConfigServiceException_Exception;

/**     
 * PortaApplicativaAllImpl_PortSoap12
 *
...
@javax.jws.WebService(name = "PortaApplicativa",
		serviceName = "PortaApplicativaSoap12Service",
		portName = "PortaApplicativaPortSoap12",
		targetNamespace = "http://www.openspcoop2.org/core/config/management",
		endpointInterface = "org.openspcoop2.core.config.ws.server.PortaApplicativaAll")
public class PortaApplicativaAllImpl_PortSoap12 extends PortaApplicativaImpl implements PortaApplicativaAll {

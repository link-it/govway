...
/**
 * <p>Java class for UpdatePortaApplicativa complex type.
 * 
 ...
 *         &lt;element name="obj" type="{http://www.openspcoop2.org/core/config}porta-applicativa" maxOccurs="1" />
 *     &lt;/sequence>
 * &lt;/complexType>
 * </pre>
 * 
...
public class UpdatePortaApplicativa extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
	...
	private PortaApplicativa obj;
	
	public void setObj(PortaApplicativa obj){
		this.obj = obj;
	}
	
	public PortaApplicativa getObj(){
		return this.obj;
	}

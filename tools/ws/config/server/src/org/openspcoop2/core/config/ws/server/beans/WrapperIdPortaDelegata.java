...
@javax.xml.bind.annotation.XmlType(name = "wrapperIdPortaDelegata", namespace="http://www.openspcoop2.org/core/config/management", propOrder = {
    "id"
})
@javax.xml.bind.annotation.XmlRootElement(name = "wrapperIdPortaDelegata")
public class WrapperIdPortaDelegata extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {

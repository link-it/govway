...
/**
 * <p>Java class for ConfigMultipleResultException complex type.
 * 
...
@javax.xml.bind.annotation.XmlType(name = "config-multiple-result-exception", namespace="http://www.openspcoop2.org/core/config/management", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class ConfigMultipleResultException extends Exception implements Serializable {
	
	private static final long serialVersionUID = -1L;

	// Deprecated: Costruttori utili se i beans vengono usati al posto di quelli generati tramite tools automatici
	@Deprecated
	public ConfigMultipleResultException(String message, java.lang.Throwable t){
		super(message, t);
		this.errorMessage = message;
	}
	@Deprecated
	public ConfigMultipleResultException(String message){
		super(message);
		this.errorMessage = message;
	}
	
	public ConfigMultipleResultException(String method, String message, java.lang.Throwable t){
		super(message, t);
		this.methodName = method;
		this.errorMessage = message;
	}
	public ConfigMultipleResultException(String method, String message){
		super(message);
		this.methodName = method;
		this.errorMessage = message;
	}	

...
/**
 * <p>Java class for ConfigNotFoundException complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="config-not-found-exception">
 *     &lt;sequence>
...
@javax.xml.bind.annotation.XmlType(name = "config-not-found-exception", namespace="http://www.openspcoop2.org/core/config/management", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class ConfigNotFoundException extends Exception implements Serializable {
	
	private static final long serialVersionUID = -1L;

	// Deprecated: Costruttori utili se i beans vengono usati al posto di quelli generati tramite tools automatici
	@Deprecated
	public ConfigNotFoundException(String message, java.lang.Throwable t){
		super(message, t);
	...
	public ConfigNotFoundException(String method, String message, java.lang.Throwable t){
		super(message, t);
		this.methodName = method;
		this.errorMessage = message;
	}
	public ConfigNotFoundException(String method, String message){
		super(message);
		this.methodName = method;
		this.errorMessage = message;
	}	

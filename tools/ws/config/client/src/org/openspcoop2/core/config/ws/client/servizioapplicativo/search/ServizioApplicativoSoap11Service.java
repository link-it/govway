 ...
 * 2017-04-24T11:51:16.783+02:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "ServizioApplicativoSoap11Service", 
                  wsdlLocation = "file:deploy/wsdl/ServizioApplicativoSearch_PortSoap11.wsdl",
...
public class ServizioApplicativoSoap11Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/ServizioApplicativoSearch_PortSoap11.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ServizioApplicativoSoap11Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/ServizioApplicativoSearch_PortSoap11.wsdl");
        }
        WSDL_LOCATION = url;
    }

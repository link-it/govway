 ...
 * 2017-04-24T11:46:16.110+02:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "PortaDelegataSoap11Service", 
                  wsdlLocation = "file:deploy/wsdl/PortaDelegataCRUD_PortSoap11.wsdl",
...
public class PortaDelegataSoap11Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/PortaDelegataCRUD_PortSoap11.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PortaDelegataSoap11Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/PortaDelegataCRUD_PortSoap11.wsdl");
        }
        WSDL_LOCATION = url;
    }

 ...
 * 2015-01-26T16:35:23.484+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "PortaApplicativaSoap12Service", 
                  wsdlLocation = "deploy/wsdl/PortaApplicativaSearch_PortSoap12.wsdl",
...
public class PortaApplicativaSoap12Service extends Service {
    ...
    static {
        URL url = PortaApplicativaSoap12Service.class.getResource("deploy/wsdl/PortaApplicativaSearch_PortSoap12.wsdl");
        if (url == null) {
            url = PortaApplicativaSoap12Service.class.getClassLoader().getResource("deploy/wsdl/PortaApplicativaSearch_PortSoap12.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = PortaApplicativaSoap12Service.class.getResource("/config/PortaApplicativaSearch_PortSoap12.wsdl");
		}
		if (url==null ){
			url = PortaApplicativaSoap12Service.class.getClassLoader().getResource("/config/PortaApplicativaSearch_PortSoap12.wsdl");
		}
		if (url==null ){
			java.util.logging.LoggerWrapperFactory.getLogger(PortaApplicativaSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/PortaApplicativaSearch_PortSoap12.wsdl");
        }       
        WSDL_LOCATION = url;
    }

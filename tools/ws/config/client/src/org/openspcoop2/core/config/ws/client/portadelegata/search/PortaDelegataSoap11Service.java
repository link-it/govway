 ...
 * 2015-01-26T16:33:10.196+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "PortaDelegataSoap11Service", 
                  wsdlLocation = "deploy/wsdl/PortaDelegataSearch_PortSoap11.wsdl",
...
public class PortaDelegataSoap11Service extends Service {
    ...
    static {
        URL url = PortaDelegataSoap11Service.class.getResource("deploy/wsdl/PortaDelegataSearch_PortSoap11.wsdl");
        if (url == null) {
            url = PortaDelegataSoap11Service.class.getClassLoader().getResource("deploy/wsdl/PortaDelegataSearch_PortSoap11.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = PortaDelegataSoap11Service.class.getResource("/config/PortaDelegataSearch_PortSoap11.wsdl");
		}
		if (url==null ){
			url = PortaDelegataSoap11Service.class.getClassLoader().getResource("/config/PortaDelegataSearch_PortSoap11.wsdl");
		}
		if (url==null ){
			java.util.logging.Logger.getLogger(PortaDelegataSoap11Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/PortaDelegataSearch_PortSoap11.wsdl");
        }       
        WSDL_LOCATION = url;
    }

 ...
 * 2015-01-26T16:32:32.468+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "PortaDelegataSoap11Service", 
                  wsdlLocation = "deploy/wsdl/PortaDelegataAll_PortSoap11.wsdl",
...
public class PortaDelegataSoap11Service extends Service {
    ...
    static {
        URL url = PortaDelegataSoap11Service.class.getResource("deploy/wsdl/PortaDelegataAll_PortSoap11.wsdl");
        if (url == null) {
            url = PortaDelegataSoap11Service.class.getClassLoader().getResource("deploy/wsdl/PortaDelegataAll_PortSoap11.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = PortaDelegataSoap11Service.class.getResource("/config/PortaDelegataAll_PortSoap11.wsdl");
		}
		if (url==null ){
			url = PortaDelegataSoap11Service.class.getClassLoader().getResource("/config/PortaDelegataAll_PortSoap11.wsdl");
		}
		if (url==null ){
			java.util.logging.Logger.getLogger(PortaDelegataSoap11Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/PortaDelegataAll_PortSoap11.wsdl");
        }       
        WSDL_LOCATION = url;
    }

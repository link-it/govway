...
public class ConfigMultipleResultException_Exception extends Exception {
    ...
    public ConfigMultipleResultException_Exception(String message, org.openspcoop2.core.config.ws.client.portaapplicativa.search.ConfigMultipleResultException configMultipleResultException) {
        super(message);
        this.configMultipleResultException = configMultipleResultException;
    }

    public ConfigMultipleResultException_Exception(String message, org.openspcoop2.core.config.ws.client.portaapplicativa.search.ConfigMultipleResultException configMultipleResultException, Throwable cause) {
        super(message, cause);
        this.configMultipleResultException = configMultipleResultException;
    }

    public org.openspcoop2.core.config.ws.client.portaapplicativa.search.ConfigMultipleResultException getFaultInfo() {

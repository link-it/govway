...
/**
 * <p>Java class for config-not-implemented-exception complex type.
 * 
...
@XmlType(name = "config-not-implemented-exception", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class ConfigNotImplementedException {

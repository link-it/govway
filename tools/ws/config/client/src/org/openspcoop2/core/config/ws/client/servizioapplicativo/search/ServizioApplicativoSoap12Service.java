 ...
 * 2015-01-26T16:37:18.773+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "ServizioApplicativoSoap12Service", 
                  wsdlLocation = "deploy/wsdl/ServizioApplicativoSearch_PortSoap12.wsdl",
...
public class ServizioApplicativoSoap12Service extends Service {
    ...
    static {
        URL url = ServizioApplicativoSoap12Service.class.getResource("deploy/wsdl/ServizioApplicativoSearch_PortSoap12.wsdl");
        if (url == null) {
            url = ServizioApplicativoSoap12Service.class.getClassLoader().getResource("deploy/wsdl/ServizioApplicativoSearch_PortSoap12.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = ServizioApplicativoSoap12Service.class.getResource("/config/ServizioApplicativoSearch_PortSoap12.wsdl");
		}
		if (url==null ){
			url = ServizioApplicativoSoap12Service.class.getClassLoader().getResource("/config/ServizioApplicativoSearch_PortSoap12.wsdl");
		}
		if (url==null ){
			java.util.logging.LoggerWrapperFactory.getLogger(ServizioApplicativoSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/ServizioApplicativoSearch_PortSoap12.wsdl");
        }       
        WSDL_LOCATION = url;
    }

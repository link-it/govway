...
public class SoggettoSoap12Service extends Service {
    ...
    static {
		...
		if (url==null ){
			url = SoggettoSoap12Service.class.getResource("/config/SoggettoAll_PortSoap12.wsdl");
		}
		if (url==null ){
			url = SoggettoSoap12Service.class.getClassLoader().getResource("/config/SoggettoAll_PortSoap12.wsdl");
		}
		if (url==null ){

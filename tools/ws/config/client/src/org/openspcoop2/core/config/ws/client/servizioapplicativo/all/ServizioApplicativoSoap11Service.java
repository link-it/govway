 ...
 * 2015-01-26T16:36:21.521+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "ServizioApplicativoSoap11Service", 
                  wsdlLocation = "deploy/wsdl/ServizioApplicativoAll_PortSoap11.wsdl",
...
public class ServizioApplicativoSoap11Service extends Service {
    ...
    static {
        URL url = ServizioApplicativoSoap11Service.class.getResource("deploy/wsdl/ServizioApplicativoAll_PortSoap11.wsdl");
        if (url == null) {
            url = ServizioApplicativoSoap11Service.class.getClassLoader().getResource("deploy/wsdl/ServizioApplicativoAll_PortSoap11.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = ServizioApplicativoSoap11Service.class.getResource("/config/ServizioApplicativoAll_PortSoap11.wsdl");
		}
		if (url==null ){

 ...
 * 2015-01-26T16:36:01.878+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "PortaApplicativaSoap12Service", 
                  wsdlLocation = "deploy/wsdl/PortaApplicativaCRUD_PortSoap12.wsdl",
...
public class PortaApplicativaSoap12Service extends Service {
    ...
    static {
        URL url = PortaApplicativaSoap12Service.class.getResource("deploy/wsdl/PortaApplicativaCRUD_PortSoap12.wsdl");
        if (url == null) {
            url = PortaApplicativaSoap12Service.class.getClassLoader().getResource("deploy/wsdl/PortaApplicativaCRUD_PortSoap12.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = PortaApplicativaSoap12Service.class.getResource("/config/PortaApplicativaCRUD_PortSoap12.wsdl");
		}
		if (url==null ){
			url = PortaApplicativaSoap12Service.class.getClassLoader().getResource("/config/PortaApplicativaCRUD_PortSoap12.wsdl");
		}
		if (url==null ){
			java.util.logging.Logger.getLogger(PortaApplicativaSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/PortaApplicativaCRUD_PortSoap12.wsdl");
        }       
        WSDL_LOCATION = url;
    }

 ...
 * 2015-01-26T16:32:51.678+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "PortaDelegataSoap12Service", 
                  wsdlLocation = "deploy/wsdl/PortaDelegataAll_PortSoap12.wsdl",
...
public class PortaDelegataSoap12Service extends Service {
    ...
    static {
        URL url = PortaDelegataSoap12Service.class.getResource("deploy/wsdl/PortaDelegataAll_PortSoap12.wsdl");
        if (url == null) {
            url = PortaDelegataSoap12Service.class.getClassLoader().getResource("deploy/wsdl/PortaDelegataAll_PortSoap12.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = PortaDelegataSoap12Service.class.getResource("/config/PortaDelegataAll_PortSoap12.wsdl");
		}
		if (url==null ){
			url = PortaDelegataSoap12Service.class.getClassLoader().getResource("/config/PortaDelegataAll_PortSoap12.wsdl");
		}
		if (url==null ){
			java.util.logging.LoggerWrapperFactory.getLogger(PortaDelegataSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/PortaDelegataAll_PortSoap12.wsdl");
        }       
        WSDL_LOCATION = url;
    }

 ...
 * 2017-04-24T11:52:18.093+02:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "ServizioApplicativoSoap11Service", 
                  wsdlLocation = "file:deploy/wsdl/ServizioApplicativoCRUD_PortSoap11.wsdl",
...
public class ServizioApplicativoSoap11Service extends Service {
    ...
    public static final QName SERVICE = new QName("http://www.openspcoop2.org/core/config/management", "ServizioApplicativoSoap11Service");
    public static final QName ServizioApplicativoPortSoap11 = new QName("http://www.openspcoop2.org/core/config/management", "ServizioApplicativoPortSoap11");
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/ServizioApplicativoCRUD_PortSoap11.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ServizioApplicativoSoap11Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/ServizioApplicativoCRUD_PortSoap11.wsdl");
        }
        WSDL_LOCATION = url;
    }

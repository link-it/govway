 ...
 * 2015-01-26T16:37:38.063+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "ServizioApplicativoSoap11Service", 
                  wsdlLocation = "deploy/wsdl/ServizioApplicativoCRUD_PortSoap11.wsdl",
...
public class ServizioApplicativoSoap11Service extends Service {
    ...
    static {
        URL url = ServizioApplicativoSoap11Service.class.getResource("deploy/wsdl/ServizioApplicativoCRUD_PortSoap11.wsdl");
        if (url == null) {
            url = ServizioApplicativoSoap11Service.class.getClassLoader().getResource("deploy/wsdl/ServizioApplicativoCRUD_PortSoap11.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = ServizioApplicativoSoap11Service.class.getResource("/config/ServizioApplicativoCRUD_PortSoap11.wsdl");
		}
		if (url==null ){
			url = ServizioApplicativoSoap11Service.class.getClassLoader().getResource("/config/ServizioApplicativoCRUD_PortSoap11.wsdl");
		}
		if (url==null ){
			java.util.logging.Logger.getLogger(ServizioApplicativoSoap11Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/ServizioApplicativoCRUD_PortSoap11.wsdl");
        }       
        WSDL_LOCATION = url;
    }

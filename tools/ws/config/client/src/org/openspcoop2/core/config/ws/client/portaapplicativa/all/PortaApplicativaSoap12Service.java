 ...
 * 2015-01-26T16:34:45.185+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "PortaApplicativaSoap12Service", 
                  wsdlLocation = "deploy/wsdl/PortaApplicativaAll_PortSoap12.wsdl",
...
public class PortaApplicativaSoap12Service extends Service {
    ...
    static {
        URL url = PortaApplicativaSoap12Service.class.getResource("deploy/wsdl/PortaApplicativaAll_PortSoap12.wsdl");
        if (url == null) {
            url = PortaApplicativaSoap12Service.class.getClassLoader().getResource("deploy/wsdl/PortaApplicativaAll_PortSoap12.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = PortaApplicativaSoap12Service.class.getResource("/config/PortaApplicativaAll_PortSoap12.wsdl");
		}
		if (url==null ){
			url = PortaApplicativaSoap12Service.class.getClassLoader().getResource("/config/PortaApplicativaAll_PortSoap12.wsdl");
		}
		if (url==null ){
			java.util.logging.Logger.getLogger(PortaApplicativaSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/PortaApplicativaAll_PortSoap12.wsdl");
        }       
        WSDL_LOCATION = url;
    }

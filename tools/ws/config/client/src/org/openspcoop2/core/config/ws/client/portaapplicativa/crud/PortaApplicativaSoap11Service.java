 ...
 * 2016-12-12T11:23:47.478+01:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "PortaApplicativaSoap11Service", 
                  wsdlLocation = "file:deploy/wsdl/PortaApplicativaCRUD_PortSoap11.wsdl",
...
public class PortaApplicativaSoap11Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/PortaApplicativaCRUD_PortSoap11.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PortaApplicativaSoap11Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/PortaApplicativaCRUD_PortSoap11.wsdl");
        }
        WSDL_LOCATION = url;
    }

 ...
 * 2015-01-26T16:35:42.995+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "PortaApplicativaSoap11Service", 
                  wsdlLocation = "deploy/wsdl/PortaApplicativaCRUD_PortSoap11.wsdl",
...
public class PortaApplicativaSoap11Service extends Service {
    ...
    static {
        URL url = PortaApplicativaSoap11Service.class.getResource("deploy/wsdl/PortaApplicativaCRUD_PortSoap11.wsdl");
        if (url == null) {
            url = PortaApplicativaSoap11Service.class.getClassLoader().getResource("deploy/wsdl/PortaApplicativaCRUD_PortSoap11.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = PortaApplicativaSoap11Service.class.getResource("/config/PortaApplicativaCRUD_PortSoap11.wsdl");
		}
		if (url==null ){
			url = PortaApplicativaSoap11Service.class.getClassLoader().getResource("/config/PortaApplicativaCRUD_PortSoap11.wsdl");
		}
		if (url==null ){
			java.util.logging.Logger.getLogger(PortaApplicativaSoap11Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/PortaApplicativaCRUD_PortSoap11.wsdl");
        }       
        WSDL_LOCATION = url;
    }

 ...
 * 2015-01-26T16:36:40.503+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "ServizioApplicativoSoap12Service", 
                  wsdlLocation = "deploy/wsdl/ServizioApplicativoAll_PortSoap12.wsdl",
...
public class ServizioApplicativoSoap12Service extends Service {
    ...
    static {
        URL url = ServizioApplicativoSoap12Service.class.getResource("deploy/wsdl/ServizioApplicativoAll_PortSoap12.wsdl");
        if (url == null) {
            url = ServizioApplicativoSoap12Service.class.getClassLoader().getResource("deploy/wsdl/ServizioApplicativoAll_PortSoap12.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = ServizioApplicativoSoap12Service.class.getResource("/config/ServizioApplicativoAll_PortSoap12.wsdl");
		}
		if (url==null ){
			url = ServizioApplicativoSoap12Service.class.getClassLoader().getResource("/config/ServizioApplicativoAll_PortSoap12.wsdl");
		}
		if (url==null ){
			java.util.logging.Logger.getLogger(ServizioApplicativoSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "deploy/wsdl/ServizioApplicativoAll_PortSoap12.wsdl");
        }       
        WSDL_LOCATION = url;
    }

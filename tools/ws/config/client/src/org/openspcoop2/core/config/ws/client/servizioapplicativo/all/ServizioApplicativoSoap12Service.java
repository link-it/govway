 ...
 * 2017-04-24T11:50:47.562+02:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "ServizioApplicativoSoap12Service", 
                  wsdlLocation = "file:deploy/wsdl/ServizioApplicativoAll_PortSoap12.wsdl",
...
public class ServizioApplicativoSoap12Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:deploy/wsdl/ServizioApplicativoAll_PortSoap12.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ServizioApplicativoSoap12Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:deploy/wsdl/ServizioApplicativoAll_PortSoap12.wsdl");
        }
        WSDL_LOCATION = url;
    }

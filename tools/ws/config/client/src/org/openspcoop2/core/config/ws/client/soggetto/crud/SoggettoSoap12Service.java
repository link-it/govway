 ...
 * 2015-01-26T16:32:13.106+01:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "SoggettoSoap12Service", 
                  wsdlLocation = "deploy/wsdl/SoggettoCRUD_PortSoap12.wsdl",
...
public class SoggettoSoap12Service extends Service {
    ...
    static {
        URL url = SoggettoSoap12Service.class.getResource("deploy/wsdl/SoggettoCRUD_PortSoap12.wsdl");
        if (url == null) {
            url = SoggettoSoap12Service.class.getClassLoader().getResource("deploy/wsdl/SoggettoCRUD_PortSoap12.wsdl");
        } 
        if (url == null) {
            
		}
		if (url==null ){
			url = SoggettoSoap12Service.class.getResource("/config/SoggettoCRUD_PortSoap12.wsdl");
		}
		if (url==null ){

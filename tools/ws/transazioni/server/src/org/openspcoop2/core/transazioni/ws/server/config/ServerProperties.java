...
public class ServerProperties {
	...
	/** Reader delle proprieta' impostate nel file 'wstransazioni.properties' */
	...
	public ServerProperties(String confDir,Logger log) throws Exception {
		...
		try{  
			properties = DatasourceProperties.class.getResourceAsStream("/wstransazioni.properties");
			if(properties==null){
				throw new Exception("File '/wstransazioni.properties' not found");
			}
			propertiesReader.load(properties);
		}catch(Exception e) {
			this.log.error("Riscontrato errore durante la lettura del file 'wstransazioni.properties': \n\n"+e.getMessage());

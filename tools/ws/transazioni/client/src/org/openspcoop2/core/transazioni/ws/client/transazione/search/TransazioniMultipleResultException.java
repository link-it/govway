...
/**
 * <p>Java class for transazioni-multiple-result-exception complex type.
 * 
...
@XmlType(name = "transazioni-multiple-result-exception", propOrder = {
    "methodName",
    "objectId",
    "errorMessage",
    "errorCode",
...
public class TransazioniMultipleResultException {

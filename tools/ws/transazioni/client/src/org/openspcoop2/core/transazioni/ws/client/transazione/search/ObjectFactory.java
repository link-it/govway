 ...
 * generated in the org.openspcoop2.core.transazioni.ws.client.transazione.search package. 
...
public class ObjectFactory {
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link SearchFilterTransazione }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.openspcoop2.org/core/transazioni/management", name = "search-filter-transazione")
    public JAXBElement<SearchFilterTransazione> createSearchFilterTransazione(SearchFilterTransazione value) {
        return new JAXBElement<SearchFilterTransazione>(ObjectFactory._SearchFilterTransazione_QNAME, SearchFilterTransazione.class, null, value);
    }

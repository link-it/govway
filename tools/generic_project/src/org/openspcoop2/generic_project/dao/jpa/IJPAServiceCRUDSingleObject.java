...
public interface IJPAServiceCRUDSingleObject<T,SM>  extends IJPAServiceCRUD_DB<T,SM> {
	...
	public void updateFields(Logger log,EntityManager em,IExpression condition, UpdateField ... updateFields) throws ServiceException,NotFoundException,NotImplementedException,Exception;

...
/**
 * JPAServiceManagerProperties
 * 
 * @author Poli Andrea (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public class JPAServiceManagerProperties extends ServiceManagerProperties {

	public JPAServiceManagerProperties(){
	}
	public JPAServiceManagerProperties(ServiceManagerProperties serviceManagerProperties){
		super();

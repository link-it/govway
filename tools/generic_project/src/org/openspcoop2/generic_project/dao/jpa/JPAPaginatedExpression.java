...
/**
 * JPAPaginatedExpression
 * 
 * @author Poli Andrea (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public class JPAPaginatedExpression extends PaginatedExpressionSQL  {

	public JPAPaginatedExpression(ISQLFieldConverter sqlFieldConverter) throws ExpressionException{
		super(sqlFieldConverter);
	}
	public JPAPaginatedExpression(JPAExpression expression) throws ExpressionException{
		super(expression);
	}

 ...
 * @version $Rev$, $Date$
 */
public class JPAProperties extends LoaderProperties {

	public JPAProperties(IProjectInfo project) throws ServiceException {
		super(Utilities.normalizedProjectName(project.getProjectName())+".dao.jpa.properties");
	}

	public static JPAProperties getInstance(IProjectInfo project) throws ServiceException {
		return new JPAProperties(project);
	}

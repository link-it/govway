...
/**
 * JDBC_DB2SQLQueryObject
 * 
 * @author Poli Andrea (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public class JDBC_DB2SQLQueryObject extends DB2QueryObject {

	private JDBC_SQLObjectFactory factory;

	public JDBC_DB2SQLQueryObject(JDBC_SQLObjectFactory factory) {
		super(TipiDatabase.DB2);

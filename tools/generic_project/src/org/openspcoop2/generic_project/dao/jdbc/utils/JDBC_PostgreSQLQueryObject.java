...
/**
 * JDBC_PostgreSQLQueryObject
 * 
 * @author Poli Andrea (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public class JDBC_PostgreSQLQueryObject extends PostgreSQLQueryObject {

	private JDBC_SQLObjectFactory factory;

	public JDBC_PostgreSQLQueryObject(JDBC_SQLObjectFactory factory) {
		super(TipiDatabase.POSTGRESQL);

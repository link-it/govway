...
/**
 * JDBC_SQLServerQueryObject
 * 
 * @author Poli Andrea (apoli@link.it)
 * @author $Author$
 * @version $Rev$, $Date$
 */
public class JDBC_SQLServerQueryObject extends SQLServerQueryObject {

	private JDBC_SQLObjectFactory factory;

	public JDBC_SQLServerQueryObject(JDBC_SQLObjectFactory factory) {
		super(TipiDatabase.SQLSERVER);

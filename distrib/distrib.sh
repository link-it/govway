...
then
	...
	mv ${WORKING_COPY}/lib/git/org.eclipse.jgit-7.3.0.202506031305-r.jar ${WORKING_COPY}/lib/git/org.eclipse.jgit-7.3.0.202506031305-r.jar.rename
	...
	mv ${WORKING_COPY}/lib/git/org.eclipse.jgit-7.3.0.202506031305-r.jar.rename ${WORKING_COPY}/lib/git/org.eclipse.jgit-7.3.0.202506031305-r.jar
...
if [ -z "${ANT_OPTS}" ]
then
	export ANT_OPTS="-Xmx2048m -XX:MaxMetaspaceSize=2048m"
fi
